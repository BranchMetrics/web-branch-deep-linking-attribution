...
// Input 1
var config = {link_service_endpoint:"https://bnc.lt", api_endpoint:"https://api.branch.io", version:"1.6.7"}, WEB_BUILD = !0, CORDOVA_BUILD = !1, TITANIUM_BUILD = !1;
// Input 2
var Queue = function() {
  var a = [], b = function() {
    if (a.length) {
...
WEB_BUILD && (Branch.prototype.addListener = function(a, b) {
  ...
  "showAgain" in b && "forgetHide" in b && (b.showAgain = b.forgetHide);
