...
// Input 1
var config = {link_service_endpoint:"https://bnc.lt", api_endpoint:"https://api.branch.io", version:"1.6.6"}, WEB_BUILD = !0, CORDOVA_BUILD = !1, TITANIUM_BUILD = !1;
// Input 2
var Queue = function() {
  var a = [], b = function() {
    if (a.length) {
...
utils.whiteListSessionData = function(a) {
  return {data:"data" in a ? a.data : null, data_parsed:"data_parsed" in a ? a.data_parsed : null, referring_identity:"referring_identity" in a ? a.referring_identity : null, identity:"identity" in a ? a.identity : null, has_app:"has_app" in a ? a.has_app : null, referring_link:"referring_link" in a ? a.referring_link : null};
};
