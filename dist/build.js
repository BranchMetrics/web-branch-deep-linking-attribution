...
// Input 1
var config = {link_service_endpoint:"https://bnc.lt", api_endpoint:"https://api.branch.io", version:"1.0.0"};
// Input 2
...
resources.referrals = {destination:config.api_endpoint, endpoint:"/v1/referrals", method:utils.httpMethod.GET, queryPart:{identity_id:validator(!0, branch_id)}, params:{sdk:validator(!1, validationTypes.str)}};
resources.credits = {destination:config.api_endpoint, endpoint:"/v1/credits", method:utils.httpMethod.GET, queryPart:{identity_id:validator(!0, branch_id)}, params:{sdk:validator(!1, validationTypes.str)}};
resources.creditHistory = {destination:config.api_endpoint, endpoint:"/v1/credithistory", method:utils.httpMethod.GET, params:{app_id:validator(!0, branch_id), identity_id:validator(!0, branch_id), session_id:validator(!0, branch_id), link_click_id:validator(!1, branch_id), sdk:validator(!1, validationTypes.str), device_fingerprint_id:validator(!0, branch_id), length:validator(!1, validationTypes.num), direction:validator(!1, validationTypes.num), begin_after_id:validator(!1, branch_id), bucket:validator(!1, 
validationTypes.str)}};
...
resources.getCode = {destination:config.api_endpoint, endpoint:"/v1/referralcode", method:utils.httpMethod.POST, params:{app_id:validator(!0, branch_id), session_id:validator(!0, branch_id), identity_id:validator(!0, branch_id), device_fingerprint_id:validator(!0, branch_id), sdk:validator(!1, validationTypes.str), prefix:validator(!1, validationTypes.str), amount:validator(!0, validationTypes.num), expiration:validator(!1, validationTypes.str), calculation_type:validator(!0, validationTypes.num), 
location:validator(!0, validationTypes.num), creation_type:validator(!0, validationTypes.num), type:validator(!0, validationTypes.str), bucket:validator(!1, validationTypes.str)}};
resources.validateCode = {destination:config.api_endpoint, endpoint:"/v1/referralcode", method:utils.httpMethod.POST, queryPart:{code:validator(!0, validationTypes.str)}, params:{app_id:validator(!0, branch_id), session_id:validator(!0, branch_id), identity_id:validator(!0, branch_id), device_fingerprint_id:validator(!0, branch_id), sdk:validator(!1, validationTypes.str)}};
resources.applyCode = {destination:config.api_endpoint, endpoint:"/v1/applycode", method:utils.httpMethod.POST, queryPart:{code:validator(!0, validationTypes.str)}, params:{app_id:validator(!0, branch_id), session_id:validator(!0, branch_id), identity_id:validator(!0, branch_id), device_fingerprint_id:validator(!0, branch_id), sdk:validator(!1, validationTypes.str)}};
resources.redeem = {destination:config.api_endpoint, endpoint:"/v1/redeem", method:utils.httpMethod.POST, params:{app_id:validator(!0, branch_id), session_id:validator(!0, branch_id), identity_id:validator(!0, branch_id), device_fingerprint_id:validator(!0, branch_id), sdk:validator(!1, validationTypes.str), amount:validator(!0, validationTypes.num), bucket:validator(!1, validationTypes.str)}};
resources.link = {destination:config.api_endpoint, endpoint:"/v1/url", method:utils.httpMethod.POST, ref:"obj", params:{app_id:validator(!0, branch_id), identity_id:validator(!0, branch_id), sdk:validator(!1, validationTypes.str), data:validator(!1, validationTypes.str), alias:validator(!1, validationTypes.str), tags:validator(!1, validationTypes.arr), feature:validator(!1, validationTypes.str), channel:validator(!1, validationTypes.str), stage:validator(!1, validationTypes.str), type:validator(!1, 
validationTypes.num)}};
...
resources.SMSLinkSend = {destination:config.link_service_endpoint, endpoint:"/c", method:utils.httpMethod.POST, queryPart:{link_url:validator(!0, validationTypes.str)}, params:{phone:validator(!0, validationTypes.str), app_id:validator(!0, branch_id)}};
resources.event = {destination:config.api_endpoint, endpoint:"/v1/event", method:utils.httpMethod.POST, params:{app_id:validator(!0, branch_id), session_id:validator(!0, branch_id), identity_id:validator(!0, branch_id), device_fingerprint_id:validator(!0, branch_id), sdk:validator(!1, validationTypes.str), event:validator(!0, validationTypes.str), metadata:validator(!0, validationTypes.obj)}};
// Input 9
var banner_css = {};
...
var Branch = function() {
  ...
  this._permStorage = storage(!0);
  this._server = new Server;
  this.sdk = "cordova" + config.version;
  this.debug = this.initialized = !1;
};
Branch.prototype._api = function(a, b, c) {
  ...
  this._queue(function(e) {
    ...
    (a.params && a.params.device_fingerprint_id || a.queryPart && a.queryPart.device_fingerprint_id) && d.device_fingerprint_id && (b.device_fingerprint_id = d.device_fingerprint_id);
    (a.params && a.params.link_click_id || a.queryPart && a.queryPart.link_click_id) && d.link_click_id && (b.link_click_id = d.link_click_id);
...
Branch.prototype.first = function(a) {
  if (a) {
    var b = this;
    this._queue(function(c) {
...
Branch.prototype.logout = function(a) {
  ...
  var b = this;
  this._api(resources.logout, {}, wrapErrorFunc(function(c) {
    b.session_id = c.session_id;
    b.identity_id = c.identity_id;
    b.sessionLink = c.link;
    delete b.identity;
    utils.clearStore(b._storage);
    utils.clearStore(b._permStorage);
    a && a(null);
  }, a));
};
Branch.prototype.close = function(a) {
  ...
  var b = this;
  this._api(resources.close, {}, wrapErrorFunc(function(c) {
    delete b.session_id;
...
Branch.prototype.getCode = function(a, b) {
  if (!this.initialized) {
    return wrapError(Error(utils.message(utils.messages.nonInit)), b);
  }
  a.type = "credit";
  a.creation_type = 2;
  this._api(resources.getCode, a, wrapErrorCallback2(b));
};
Branch.prototype.validateCode = function(a, b) {
  if (!this.initialized) {
    return wrapError(Error(utils.message(utils.messages.nonInit)), b);
  }
  this._api(resources.validateCode, {code:a}, wrapErrorCallback2(b));
};
Branch.prototype.applyCode = function(a, b) {
  if (!this.initialized) {
    return wrapError(Error(utils.message(utils.messages.nonInit)), b);
  }
  this._api(resources.applyCode, {code:a}, wrapErrorCallback2(b));
};
...
Branch.prototype.creditHistory = function(a, b) {
  if (!this.initialized) {
    return wrapError(Error(utils.message(utils.messages.nonInit)), b);
  }
  this._api(resources.creditHistory, a ? a : {}, wrapErrorCallback2(b));
};
