...
// Input 2
var config = {link_service_endpoint:"https://bnc.lt", api_endpoint:"https://api.branch.io", version:"1.6.11"}, WEB_BUILD = !0, CORDOVA_BUILD = !1, TITANIUM_BUILD = !1, isApp = -1 === document.URL.indexOf("http://") && -1 === document.URL.indexOf("https://");
isApp && WEB_BUILD && console.warning("Please use Branch Cordova SDK instead. Visit https://github.com/BranchMetrics/Cordova-Ionic-PhoneGap-Deferred-Deep-Linking-SDK for more details.");
// Input 3
