...
goog.exportPath_ = function(a, b, c) {
  ...
  for (var d;a.length && (d = a.shift());) {
    !a.length && goog.isDef(b) ? c[d] = b : c[d] ? c = c[d] : c = c[d] = {};
  }
};
...
goog.loadFileSync_ = function(a) {
  ...
  try {
    ...
    b.open("get", a, !1);
    b.send();
    return b.status && 200 != b.status ? null : b.responseText;
  } catch (c) {
    return null;
  }
};
...
goog.removeUid = function(a) {
  a && "removeAttribute" in a && a.removeAttribute(goog.UID_PROPERTY_);
  try {
...
goog.defineClass = function(a, b) {
  ...
  d && (d instanceof Function ? d(c) : goog.defineClass.applyProperties_(c, d));
  return c;
};
...
var COOKIE_MS = 31536E6, BRANCH_KEY_PREFIX = "BRANCH_WEBSDK_KEY", storage, BranchStorage = function(a) {
  ...
  return {getAll:function() {
    ...
    var a = null, d;
    for (d in b) {
      d.indexOf(BRANCH_KEY_PREFIX) || (a || (a = {}), a[trimPrefix(d)] = retrieveValue(b.getItem(d)));
    }
    return a;
  }, get:function(a, d) {
    ...
    Object.keys(b).forEach(function(a) {
      a.indexOf(BRANCH_KEY_PREFIX) || b.removeItem(a);
    });
  }, isEnabled:function() {
    try {
...
Server.prototype.getUrl = function(a, b) {
  ...
  "/v1/open" === a.endpoint && (k.options = JSON.stringify(k.options || {}));
...
Server.prototype.Server_prototype$request = function(a, b, c, d) {
  ...
  if (!(document.getElementById("branch-banner") || document.getElementById("branch-banner-iframe") || document.getElementById("branch-banner-container"))) {
    ...
    if (!d.get("hideBanner", !0)) {
      ...
      if (b.url) {
        ...
        a.XHRRequest(b.url + "&callback=" + m + ("&data=" + c), {}, "GET", {}, function(a, b) {
          var c = !1;
          if (!a && b) {
...
Branch.prototype._api = function(a, b, c) {
  ...
  return this._server.Server_prototype$request(a, b, this._storage, function(a, b) {
    c(a, b);
  });
};
  ...
  var l = function(a, b) {
    ...
    d._api(resources.event, {event:"pageview", metadata:{url:document.URL, user_agent:navigator.userAgent, language:navigator.language}}, function(c, f) {
      if (!c && "object" === typeof f) {
        ...
        h && d.renderQueue(function() {
          branch_view.handleBranchViewData(d._server, h, d._branchViewData, d._storage, g.has_app);
        });
      }
      try {
    ...
    d._api(resources._r, g, function(a, f) {
      ...
      d._api(resources.open, {link_identifier:h, is_referrable:1, browser_fingerprint_id:f, options:c}, function(a, c) {
        if (!a && "object" === typeof c) {
          ...
          d._storage.set("branch_view_enabled", d._branchViewEnabled);
          var f = null;
          e ? f = {id:e, number_of_use:-1, url:config.api_endpoint + "/v1/branchview/" + b + "/" + e + "?_a=audience_rule_id"} : c.hasOwnProperty("branch_view_data") && (f = c.branch_view_data);
          f && d.renderQueue(function() {
            branch_view.handleBranchViewData(d._server, f, d._branchViewData, d._storage, c.has_app);
          });
          h && (c.click_id = h);
        }
        n();
