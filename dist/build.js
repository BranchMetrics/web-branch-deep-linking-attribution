...
Branch.prototype.banner = function(a) {
  if (!document.getElementById("branch-banner")) {
    var b = document.head, d = document.body, c = document.createElement("style"), f = document.createElement("div"), e = document.createElement("div");
    ...
    f.id = "branch-banner";
    f.innerHTML = '<div class="content"><div class="left"><div class="close-x" id="branch-banner-close">&times;</div><div class="icon" style="float: left;"><img src="' + a.icon + '"></div><div class="details"><span class="title">' + a.title + '</span><span class="description">' + a.description + '</span></div></div><div class="right" id="branch-banner-action"></div></div>';
    var g = function() {
    ...
    b.appendChild(c);
    d.appendChild(f);
    document.getElementById("branch-banner-action").appendChild(e);
    ...
    navigator.userAgent.match(/android|i(os|p(hone|od|ad))/i) ? this.link({channel:"appBanner", data:a.data || {}}, function(a) {
      c.innerHTML += "#branch-banner .content .right a { font-size: 16px; font-weight: 500; color: #007aff; }#branch-banner-action div { float: right; margin-right: 8px; }";
      e.innerHTML = '<a href="' + a + '">View in App</a>';
    ...
    e.innerHTML = '<div id="branch-sms-block"><input type="phone" name="branch-sms-phone" id="branch-sms-phone" placeholder="(999) 999-9999"><button id="branch-sms-send">TXT Me The App!</button></div>', document.getElementById("branch-sms-send").onclick = g);
  }
};
// Input 5
