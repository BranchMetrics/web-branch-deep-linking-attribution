...
// Input 2
var config = {app_service_endpoint:"https://app.link", link_service_endpoint:"https://bnc.lt", api_endpoint:"https://api.branch.io", version:"2.13.0"};
// Input 3
...
// Input 14
var journeys_utils = {position:"top", sticky:"absolute", bannerHeight:"76px", isFullPage:!1};
...
branch_view.handleBranchViewData = function(a, b, c, d, e, f) {
  var g = null, k = null;
  c = c || {};
  c.feature = "journeys";
  ...
  if (!(document.getElementById("branch-banner") || document.getElementById("branch-banner-iframe") || document.getElementById("branch-banner-container"))) {
    ...
    if (b.url) {
      ...
      a.XHRRequest(b.url + "&callback=" + l + ("&data=" + c), {}, "GET", {}, function(a, c) {
        var m = !1;
        if (!a && c) {
          ...
          window[l] = function(a) {
            ...
            m || (k = a, journeys_utils.finalHookups(b, d, k, g, q));
          };
          ...
          journeys_utils.finalHookups(b, d, k, g, q);
        }
...
Branch.prototype.init = wrap(callback_params.CALLBACK_ERR_DATA, function(a, b, c) {
  ...
  var f = function(a) {
    ...
    return a;
  }, g = session.get(d._storage), k = utils.getParamValue("_branch_match_id") || utils.hashValue("r"), h = !g || !g.identity_id;
  ...
  var l = function(a, b) {
    ...
    g && (g = f(g), session.set(d._storage, g, h), d.init_state = init_states.INIT_SUCCEEDED, g.data_parsed = g.data ? safejson.parse(g.data) : null);
    if (c) {
    ...
    d._api(resources.event, {event:"pageview", metadata:{url:document.URL, user_agent:navigator.userAgent, language:navigator.language}, initial_referrer:document.referrer}, function(c, f) {
      if (!c && "object" === typeof f) {
        ...
        var h = null, k = null;
        e && utils.mobileUserAgent() ? (h = {id:e, number_of_use:-1, url:config.api_endpoint + "/v1/branchview/" + b + "/" + e + "?_a=audience_rule_id&_t=" + g.browser_fingerprint_id}, k = !0) : f.hasOwnProperty("branch_view_data") && (h = f.branch_view_data);
        if (h) {
          ...
          d.renderQueue(function() {
            ...
            branch_view.handleBranchViewData(d._server, h, a, d._storage, g.has_app, k);
          });
        }
      }
      try {
  ...
  if (g && g.session_id && !k) {
    ...
    d._api(resources._r, g, function(a, b) {
      if (a) {
