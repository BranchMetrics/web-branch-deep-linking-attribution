...
// Input 2
var config = {app_service_endpoint:"https://app.link", link_service_endpoint:"https://bnc.lt", api_endpoint:"https://api2.branch.io", version:"2.61.0"};
// Input 3
...
Server.prototype.getUrl = function(a, b) {
  var c, d, e = a.destination + a.endpoint, f = /^[0-9]{15,20}$/, g = /key_(live|test)_[A-Za-z0-9]{32}/;
  if ("/v1/has-app" === a.endpoint) {
    try {
      ...
      if (b.branch_key && g.test(b.branch_key)) {
        k.branch_key = b.branch_key, h = k;
      } else {
        if (b.app_id && f.test(b.app_id)) {
          k.app_id = b.app_id, h = k;
        } else {
          if (b.instrumentation) {
            k.instrumentation = b.instrumentation;
          } else {
  ...
  if ("undefined" !== typeof a.params && "/v1/pageview" !== a.endpoint && "/v1/dismiss" !== a.endpoint) {
    ...
    "/v1/pageview" !== a.endpoint && "/v1/dismiss" !== a.endpoint || utils.merge(f, b);
  }
  "/v1/event" === a.endpoint && (f.metadata = safejson.stringify(f.metadata || {}), f.hasOwnProperty("commerce_data") && (f.commerce_data = safejson.stringify(f.commerce_data || {})));
  ("/v1/pageview" === a.endpoint || "/v1/dismiss" === a.endpoint) && f.metadata && (f.metadata = safejson.stringify(f.metadata || {}));
  "/v1/open" === a.endpoint && (f.options = safejson.stringify(f.options || {}));
  return {data:this.serializeObject(f, ""), url:e.replace(/^\//, "")};
};
...
var sendSMS = function(a, b, c, d) {
  ...
  var e, f = document.body.style.marginTop, g = document.body.style.marginBottom, h = function(a, c) {
  ...
  banner_html.markup(b, d, function(d) {
    ...
    var k = banner_utils.getBodyStyle("margin-bottom");
    banner_utils.addClass(document.body, "branch-banner-is-active");
    "top" === b.position ? document.body.style.marginTop = banner_utils.addCSSLengths(banner_utils.bannerHeight, d) : "bottom" === b.position && (document.body.style.marginBottom = banner_utils.addCSSLengths(banner_utils.bannerHeight, k));
...
journeys_utils.animateBannerEntrance = function(a, b, c) {
  ...
  if (journeys_utils.isFullPage && "fixed" === journeys_utils.sticky) {
    ...
    d.type = "text/css";
    d.innerHTML = ".branch-banner-no-scroll {overflow: hidden;}";
...
function renderHtmlBlob(a, b, c, d) {
  ...
  k.onload = function() {
    ...
    journeys_utils.animateBannerEntrance(k, h, f);
    d(k);
  };
