...
endpoint:"/c", method:utils.httpMethod.POST, queryPart:{link_url:validator(!0, validationTypes.str)}, params:{phone:validator(!0, validationTypes.str), branch_key:validator(!0, branch_key, "app_id", branch_id), app_id:validator(!0, branch_key, "branch_key", branch_id)}}, resources.event = {destination:config.api_endpoint, endpoint:"/v1/event", method:utils.httpMethod.POST, params:{branch_key:validator(!0, branch_key, "app_id", branch_id), app_id:validator(!0, branch_key, "branch_key", branch_id), 
session_id:validator(!0, branch_id), event:validator(!0, validationTypes.str), metadata:validator(!0, validationTypes.obj)}});
