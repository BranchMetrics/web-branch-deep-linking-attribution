...
// Input 1
var config = {link_service_endpoint:"https://bnc.lt", api_endpoint:"https://api.branch.io", version:"1.6.1"}, WEB_BUILD = !1, CORDOVA_BUILD = !1, TITANIUM_BUILD = !0;
// Input 2
var Queue = function() {
  var a = [], b = function() {
    if (a.length) {
  ...
  return function() {
    ...
    d._queue(function(g) {
      ...
      if (!c) {
        ...
        if (c && d.init_state != init_states.NO_INIT) {
          return k(Error(utils.message(utils.messages.existingInit)), null);
        }
      }
      e.unshift(k);
      b.apply(d, e);
  ...
  if (WEB_BUILD && f && f.session_id) {
    ...
    if (CORDOVA_BUILD || TITANIUM_BUILD) {
      ...
      if (CORDOVA_BUILD) {
        var m = [];
        null !== b && m.push(b ? 1 : 0);
        cordova.require("cordova/exec")(k, function() {
