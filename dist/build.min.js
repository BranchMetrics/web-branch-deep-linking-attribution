...
function Xa(a){var b={},b=E(b,"http_origin",document.URL),b=E(b,"user_agent",navigator.userAgent),b=E(b,"language",Ma()),b=E(b,"screen_width",screen.width),b=E(b,"screen_height",screen.height),b=E(b,"http_referrer",document.referrer),b=E(b,"browser_fingerprint_id",a.B),b=E(b,"developer_identity",a.C),b=E(b,"sdk","web");return b=E(b,"sdk_version","2.47.0")}function x(){return window.self!==window.top}
...
d.l)),null);if(0===d.j||!d.j)return g(Error(w("Branch SDK not initialized")),null)}e.unshift(g);b.apply(d,e)})}}function Z(){if(!(this instanceof Z))return Kc||(Kc=new Z),Kc;this.$=ma();this.c=new vb(["session","cookie","pojo"]);this.ca=new Cb;this.g=[];this.V="web2.47.0";this.i=this.j=0;this.l=null}
