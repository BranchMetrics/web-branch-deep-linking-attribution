...
function Nc(a,b,c,d,e,f,k,l,g){Array.prototype.forEach.call(d.contentWindow.document.querySelectorAll(a),function(a){a.addEventListener("click",function(){Pc(b,c,d,e,f,k,l,g)})})}function Qc(a,b,c){var d=a.get("journeyDismissals",!0),d=d?p(d):{};d[c]={view_id:b,dismiss_time:Date.now()};a.set("journeyDismissals",q(d),!0)}
function Rc(a,b){var c={},d=D();d&&0<Object.keys(d).length&&(c.hosted_deeplink_data=d);c=a.I(Sc(null,c),null,S,!0);if(T&&T.journey_link_data){G(c,"journey_id",T.journey_link_data.journey_id);G(c,"journey_name",T.journey_link_data.journey_name);G(c,"view_id",T.journey_link_data.view_id);G(c,"view_name",T.journey_link_data.view_name);G(c,"channel",T.journey_link_data.channel);G(c,"campaign",T.journey_link_data.campaign);try{G(c,"tags",JSON.stringify(T.journey_link_data.tags))}catch(e){c.tags=JSON.stringify([])}}G(c,
"dismissal_source",b);return c}
function Pc(a,b,c,d,e,f,k,l){var g=k?0:Kc(f);O(S,a,T);zc=!0;Mc(c);if(!k)if(void 0!==g&&b.set("globalJourneysDismiss",g,!0),Qc(b,d,e),f.dismissRedirect)window.location=f.dismissRedirect;else{var n=function(){S.removeListener(n);var b=Rc(l,va[a]);S.b(Cb,b,function(a,c){!a&&"object"===typeof c&&c.template&&l.N(c,null,!1)&&l.J(c.template,b,b.branch_view_id||c.event_data.branch_view_data.id,c.event_data.branch_view_data,!1,c.journey_link_data)})};S.addListener("branch_internal_event_didCloseJourney",n)}}
function Sc(a,b){return A({url:a&&a.url||Fa(),user_agent:navigator.userAgent,language:navigator.language,screen_width:screen.width||-1,screen_height:screen.height||-1,window_device_pixel_ratio:window.devicePixelRatio||1},b||{})}
...
Jc));O(S,"didCloseJourney",T);b||O(S,"branch_internal_event_didCloseJourney",T);wc=!1},xc?0:270)}function Tc(a){var b={banner_id:fc};if(a&&"object"===typeof a&&0<Object.keys(a).length){var c=["browser_fingerprint_id","app_id","source","open_app","link_click_id"];if(a&&"object"===typeof a&&!Array.isArray(a)&&0<Object.keys(a).length&&c&&Array.isArray(c)&&0<c.length)for(var d in a)a.hasOwnProperty(d)&&-1<c.indexOf(d)&&delete a[d];b.journey_link_data={};A(b.journey_link_data,a)}T=b};var U={};
function Uc(a,b){var c=b?"OPEN":"GET",d=a,e=Dc(d);e&&e.bannerHeight&&e.position&&e.sticky?(Q=e.bannerHeight,P=e.position,hc=e.sticky):(d=d.match(tc))?(P="top",(d=d[1].match(uc))&&(Q=d[1]),hc="absolute"):(P="bottom",hc="fixed");if(-1!==Q.indexOf("vh")||-1!==Q.indexOf("%"))d=Q.indexOf("vh")?Q.slice(0,-2):Q.slice(0,-1),Q=d/100*lc+"px",100>d?jc=!0:ic=!0;if(d=Dc(a)){var f;b&&d&&d.ctaText&&d.ctaText.has_app?f=d.ctaText.has_app:d&&d.ctaText&&d.ctaText.no_app&&(f=d.ctaText.no_app);c=f;R=[];if(d&&d.injectorSelector&&
...
U.J=function(a,b,c,d,e,f){fc=c;Tc(f);var k=d.audience_rule_id;(f=document.getElementById("branch-iframe-css"))&&f.parentElement.removeChild(f);f=document.createElement("div");f.id="branch-banner";document.body.insertBefore(f,null);Ub(f,"branch-banner-is-active");var l=!1,g=b.callback_string,n=null,m=null,t=S.c;if(a){var z=Dc(a)||{},Oc=window.setTimeout(function(){window[g]=function(){}},ra);window[g]=function(a){window.clearTimeout(Oc);l||(m=a,Lc(c,k,t,m,n,z,e))};vc=n=Uc(a,b.has_app_websdk);if(null===
...
return e=Ga(e)};var W={androidAppIndexingTagsPresent:!1,iosAppIndexingTagsPresent:!1,androidDetailsComplete:!1,iosDetailsComplete:!1},X={};function Vc(a){var b;"android"===a&&W.androidDetailsComplete&&(b="android-app://"+X.androidPackageName+"/"+X.androidURL,b=Wc(b),Xc(b));"ios"===a&&W.iosDetailsComplete&&(b="ios-app://"+X.iosAppId+"/"+X.iosURL,b=Wc(b),Xc(b))}
function Wc(a){var b={"~channel":"Firebase App Indexing","~feature":"Auto App Indexing",$canonical_url:Fa()};if("object"===typeof X.data)for(var c in X.data)X.data.hasOwnProperty(c)&&!b.hasOwnProperty(c)&&(b[c]=X.data[c]);return a+(-1<a.indexOf("?")?"&":"?")+"link_click_id=a-"+btoa(q(b))}function Xc(a){var b=document.createElement("link");b.setAttribute("rel","alternate");b.setAttribute("href",a);document.head.appendChild(b)}
function Yc(a){"android"===a&&"string"===typeof X.androidPackageName&&"string"===typeof X.androidURL&&(W.androidDetailsComplete=!0,Vc("android"));"ios"===a&&"string"===typeof X.iosAppId&&"string"===typeof X.iosURL&&(W.iosDetailsComplete=!0,Vc("ios"))}
function Zc(a){for(var b=document.getElementsByTagName("meta"),c=0;c<b.length;c++){var d=b[c];"ios"===a&&"al:ios:app_store_id"===d.getAttribute("property")&&(X.iosAppId=d.getAttribute("content"));"ios"===a&&"al:ios:url"===d.getAttribute("property")&&(X.iosURL=d.getAttribute("content").replace("://","/"));"android"===a&&"al:android:package"===d.getAttribute("property")&&(X.androidPackageName=d.getAttribute("content"));"android"===a&&"al:android:url"===d.getAttribute("property")&&(X.androidURL=d.getAttribute("content").replace("://",
"/"))}Yc(a)};var $c;
...
d.m)),null);if(0===d.l||!d.l)return g(Error(w("Branch SDK not initialized")),null)}e.unshift(g);b.apply(d,e)})}}function Z(){if(!(this instanceof Z))return $c||($c=new Z),$c;this.$=oa();this.c=new Fb(["session","cookie","pojo"]);this.ca=new Nb;this.h=[];this.V="web2.52.6";this.j=this.l=0;this.m=null}
...
d){d&&(d=l(d),v||(d=f(d),Ca(g.c,d,t)),g.l=3,d.data_parsed=d.data&&0!==d.data.length?p(d.data):{});if(b)return g.l=2,g.j||(g.j=1,g.m=b.message),a(b,d&&Da(d));try{a(b,d&&Da(d))}catch(fd){}finally{g.renderFinalize()}var e=$a(),k=H(c.metadata,"object")?c.metadata:null;k&&(k=gb(e.hosted_deeplink_data,k))&&0<Object.keys(k).length&&(e.hosted_deeplink_data=k);var m=U.I(Sc(c,e),c,g,!1);g.renderQueue(function(){g.b(Bb,m,function(a,b){if(!a&&"object"===typeof b){var d=m.branch_view_id?!0:!1;U.N(b,c,d)?U.J(b.template,
...
c.nonce:r;v=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;xa=!1;v&&Ba(g);b=M(g.c);var n=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,m=n||Na("_branch_match_id")||Ia(),t=!b||!b.identity_id;g.B=!!g.c.get("branch_view_enabled");if(b&&b.session_id&&!m&&!Na("branchify_url"))Lb(g.c,{data:""}),Lb(g.c,{referring_link:""}),d(),k(e);else{b={sdk:"2.52.6",branch_key:g.i};var z=M(g.c,!0)||{};z.browser_fingerprint_id&&(b._t=z.browser_fingerprint_id);z.identity&&
...
Z.prototype.addListener=function(a,b){"function"===typeof a&&void 0===b&&(b=a,a=null);b&&this.h.push({listener:b,event:a||null})};Z.prototype.removeListener=function(a){a&&(this.h=this.h.filter(function(b){if(b.listener!==a)return b}))};function ad(a,b,c){c=c||{};try{a.H=p(q(c))}finally{a.H=a.H||{}}b()}Z.prototype.setBranchViewData=Y(1,function(a,b){ad.call(null,this,a,b)});
...
Z.prototype.autoAppIndex=Y(1,function(a,b){b=b||{};var c=document.getElementsByTagName("link"),d=c.length;if(d)for(var e=0;e<d;e++){var f=c[e],k=f.href;k&&(k.includes("ios-app")&&(W.iosAppIndexingTagsPresent=!0,f.setAttribute("href",Wc(k))),k.includes("android-app")&&(W.androidAppIndexingTagsPresent=!0,f.setAttribute("href",Wc(k))))}X=b;W.androidAppIndexingTagsPresent||(Yc("android"),W.androidDetailsComplete||Zc("android"));W.iosAppIndexingTagsPresent||(Yc("ios"),W.iosDetailsComplete||Zc("ios"));
...
Z.prototype.disableTracking=Y(1,function(a,b){if(!1===b||"false"===b)xa=v=!1,this.i&&this.F&&(!0===this.F.tracking_disabled&&delete this.F.tracking_disabled,this.init(this.i,this.F));else if(void 0===b||!0===b||"true"===b)Ba(this),xa=v=!0,this.closeBanner(),this.closeJourney();a()});var bd=new Z;if(window.branch&&window.branch._q)for(var cd=window.branch._q,dd=0;dd<cd.length;dd++){var ed=cd[dd];bd[ed[0]].apply(bd,ed[1])}"function"===typeof define&&define.amd?define("branch",function(){return bd}):"object"===typeof exports&&(module.exports=bd);window&&(window.branch=bd);})();
