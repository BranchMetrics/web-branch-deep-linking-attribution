...
m.appendChild(t);h.style.opacity="0";l.style.opacity="0";n.style.opacity="0";setTimeout(function(){t.style.opacity="1"},20);l.value=""}function k(){h.removeAttribute("disabled");l.removeAttribute("disabled");h.style.opacity="1";l.style.opacity="1";n.style.opacity="0"}var l=a.getElementById("branch-sms-phone"),h=a.getElementById("branch-sms-send"),n=a.getElementById("branch-loader-wrapper"),m=a.getElementById("branch-sms-form-container"),t;if(l){var x=l.value;/^\d{7,}$/.test(x.replace(/[\s()+\-\.]|ext/gi,
""))?(N(b,"willSendBannerSMS"),h.setAttribute("disabled",""),l.setAttribute("disabled",""),h.style.opacity=".4",l.style.opacity=".4",n.style.opacity="1",l.className="",b.sendSMS(x,d,c,function(a){a?(N(b,"sendBannerSMSError"),e()):(N(b,"didSendBannerSMS"),f(),setTimeout(function(){m.removeChild(t);k()},3E3))})):e()}}
...
T.J=function(a,b,c,d,e,f){if(!uc){kc=c;Zc(f);var k=d.audience_rule_id;(f=document.getElementById("branch-iframe-css"))&&f.parentElement.removeChild(f);f=document.createElement("div");f.id="branch-banner";document.body.insertBefore(f,null);Yb(f,"branch-banner-is-active");var l=!1,h=b.callback_string,n=null,m=null,t=R.c;if(a){var x=Jc(a)||{};a=bd(a);var W=window.setTimeout(function(){window[h]=function(){}},qa);window[h]=function(a){window.clearTimeout(W);l||(m=a,Rc(c,k,t,m,n,x,e))};Bc=n=cd(a,b.has_app_websdk);
if(null===n){l=!0;return}Rc(c,k,t,m,n,x,e);ra&&(u["journey-load-time"]=(Date.now()-window.performance.timing.navigationStart).toString())}document.body.removeChild(f);v||e||T.ka(d)}};
...
d.s)),null);if(0===d.o||!d.o)return h(Error(w("Branch SDK not initialized")),null)}e.unshift(h);b.apply(d,e)})}}function Z(){if(!(this instanceof Z))return id||(id=new Z),id;this.ba=na();this.c=new Jb(["session","cookie","pojo"]);this.V=new Rb;this.h=[];this.X="web2.58.3";this.l=this.o=0;this.s=null}
...
r=c&&c.nonce?c.nonce:r;v=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;wa=!1;v&&Aa(h);b=L(h.c,!0);h.j=b&&b.identity_id;b=L(h.c);var n=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,m=n||Ma("_branch_match_id")||Ga(),t=!h.j;h.C=!!h.c.get("branch_view_enabled");if(b&&b.session_id&&!m&&!Ma("branchify_url"))Pb(h.c,{data:""}),Pb(h.c,{referring_link:""}),d(),k(e);else{b={sdk:"2.58.3",branch_key:h.i};var x=L(h.c,!0)||{};x.browser_fingerprint_id&&(b._t=
x.browser_fingerprint_id);x.identity&&(h.g=x.identity);var W=parseInt(Ma("[?&]_open_delay_ms"),10);Ka()||La()?ib(function(){h.b(jb,{link_identifier:m,browser_fingerprint_id:m||x.browser_fingerprint_id,alternative_browser_fingerprint_id:x.browser_fingerprint_id,options:c,initial_referrer:gb(U(h)),current_url:y()&&Ha()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(h.l=2,h.s=a.message);a||"object"!==typeof b||(b.branch_view_enabled&&
(h.C=!!b.branch_view_enabled,h.c.set("branch_view_enabled",h.C)),m&&(b.click_id=m));d();e(a,b)})},W):h.b(kb,b,function(a,b){if(a)return h.l=3,h.s=a.message,e(a,null);ib(function(){h.b(jb,{link_identifier:m,browser_fingerprint_id:m||b,alternative_browser_fingerprint_id:x.browser_fingerprint_id,options:c,initial_referrer:gb(U(h)),current_url:y()&&Ha()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(h.l=2,h.s=a.message);a||
