...
endpoint:"",method:"GET",f:{link_url:I(!0,1)},a:{click:I(!0,1)}},mb={destination:"https://link.stage.branch.iot",endpoint:"/c",method:"POST",f:{link_url:I(!0,1)},a:{sdk:I(!1,1),phone:I(!0,1)}},nb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/referralcode",method:"POST",a:J({amount:I(!0,2),bucket:I(!1,1),calculation_type:I(!0,2),creation_source:I(!0,2),expiration:I(!1,1),location:I(!0,2),prefix:I(!1,1),type:I(!0,1)})},ob={destination:"https://nightlyregression.api.beta.branch.io",
endpoint:"/v1/referralcode",method:"POST",f:{code:I(!0,1)},a:J({})},pb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/applycode",method:"POST",f:{code:I(!0,1)},a:J({})},qb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/logout",method:"POST",a:J({session_id:I(!0,1)})},rb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/profile",method:"POST",a:J({identity_id:I(!0,1),identity:I(!0,1)})},sb={destination:"https://nightlyregression.api.beta.branch.io",
endpoint:"/v1/referrals",method:"GET",f:{identity_id:I(!0,1)},a:J({})},tb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/credithistory",method:"GET",a:J({begin_after_id:I(!1,1),bucket:I(!1,1),direction:I(!1,2),length:I(!1,2),link_click_id:I(!1,1)})},ub={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/credits",method:"GET",a:J({branch_key:I(!0,1),identity:I(!0,1)})},vb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/redeem",
method:"POST",a:J({amount:I(!0,2),bucket:I(!0,1),identity_id:I(!0,1)})},wb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/url",method:"POST",qa:"obj",a:J({alias:I(!1,1),campaign:I(!1,1),channel:I(!1,1),data:I(!1,1),feature:I(!1,1),identity_id:I(!0,1),stage:I(!1,1),tags:I(!1,3),type:I(!1,2),source:I(!1,1),instrumentation:I(!1,1)})},xb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/qr-code",method:"POST",qa:"obj",a:J({alias:I(!1,1),campaign:I(!1,
1),channel:I(!1,1),data:I(!1,1),qr_code_settings:I(!1,1),feature:I(!1,1),identity_id:I(!0,1),stage:I(!1,1),tags:I(!1,3),type:I(!1,2),source:I(!1,1)})},yb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/deepview",L:!0,method:"POST",a:J({campaign:I(!1,1),_t:I(!1,1),channel:I(!1,1),data:I(!0,1),feature:I(!1,1),link_click_id:I(!1,1),open_app:I(!1,4),append_deeplink_path:I(!1,4),stage:I(!1,1),tags:I(!1,3),deepview_type:I(!0,1),source:I(!0,1)})},zb={destination:"https://nightlyregression.api.beta.branch.io",
endpoint:"/v1/has-app",method:"GET",a:{browser_fingerprint_id:I(!0,1),instrumentation:I(!1,1)}},Ab={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/event",method:"POST",a:J({event:I(!0,1),metadata:I(!0,0),initial_referrer:I(!1,1),tracking_disabled:I(!1,4)})},Bb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/event",method:"POST",a:J({event:I(!0,1),metadata:I(!1,0),initial_referrer:I(!1,1),commerce_data:I(!0,0)})},Cb={destination:"https://nightlyregression.api.beta.branch.io",
endpoint:"/v2/event/standard",method:"POST",a:{name:I(!0,1),user_data:I(!0,1),custom_data:I(!1,1),event_data:I(!1,1),content_items:I(!1,1),customer_event_alias:I(!1,1)}},Db={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v2/event/custom",method:"POST",a:{name:I(!0,1),user_data:I(!0,1),custom_data:I(!1,1),event_data:I(!1,1),content_items:I(!1,1),customer_event_alias:I(!1,1)}},Eb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/pageview",method:"POST",
a:J({event:I(!0,1),metadata:I(!1,0),initial_referrer:I(!1,1),tracking_disabled:I(!1,4),branch_view_id:I(!1,1),no_journeys:I(!1,4),user_language:I(!1,1),open_app:I(!1,4),has_app_websdk:I(!1,4),source:I(!1,1),feature:I(!1,1),is_iframe:I(!1,4),data:I(!1,0),callback_string:I(!1,1),journey_displayed:I(!1,4),audience_rule_id:I(!1,1),journey_dismissals:I(!1,0),identity_id:I(!1,1)})},Fb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/dismiss",method:"POST",a:J({event:I(!0,1),metadata:I(!1,
0),initial_referrer:I(!1,1),tracking_disabled:I(!1,4),branch_view_id:I(!1,1),no_journeys:I(!1,4),user_language:I(!1,1),open_app:I(!1,4),has_app_websdk:I(!1,4),source:I(!1,1),feature:I(!1,1),is_iframe:I(!1,4),data:I(!1,0),callback_string:I(!1,1),journey_displayed:I(!1,4),audience_rule_id:I(!1,1),journey_dismissals:I(!1,0),dismissal_source:I(!1,1)})},Gb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/cpid",method:"POST",a:{user_data:I(!0,1)}},Ib={destination:"https://nightlyregression.api.beta.branch.io",
...
function ld(a,b,c){var d=b?"OPEN":"GET";Kc(a);var e=Lc(a);e&&(d=Nc(e,b),Oc(e));var f=Pc(a);Qc(a);var l=Mc(a);a=Rc(a);var k=Sc();k.onload=function(){var b=a,n=C(),m=k.contentDocument||k.contentWindow.document;m.head=m.createElement("head");m.body=m.createElement("body");m.body.innerHTML=b;m.body.className="ios"===n||"ipad"===n?"branch-banner-ios":"android"===n?"branch-banner-android":"branch-banner-desktop";Tc(l,e);b=document.createElement("style");b.type="text/css";b.id="branch-css";b.innerHTML=f;
H(b);n=k.contentWindow.document;n.head.appendChild(b);if(pc||oc){var t=n.getElementsByClassName("branch-banner-content")[0];t&&(t.style.height=P)}"top"===O?k.style.top="-"+P:"bottom"===O&&(k.style.bottom="-"+P);try{var t=n.getElementsByClassName("branch-banner-content")[0],y=window.getComputedStyle(t).getPropertyValue("background-color").split(", ");y[3]&&!parseFloat(y[3])&&(k.style.boxShadow="none")}catch(T){}k.contentWindow.document.getElementById("branch-mobile-action").innerHTML=d;N(R,"willShowJourney",
S);Vc(k,l,e);c(k)};document.body.appendChild(k)}U.O=function(a,b,c){if(document.getElementById("branch-banner")||document.getElementById("branch-banner-iframe")||document.getElementById("branch-banner-container")||!C()||!a.event_data||!a.template)return!1;if(c)return!0;(a=!a.event_data.branch_view_data.id||b&&b.no_journeys)||(a=R,b=a.c.get("globalJourneysDismiss",!0),!0===b||b>Date.now()?a=!0:(a.c.remove("globalJourneysDismiss",!0),a=!1));return a?(U.Ba=1,!1):!0};
...
b.substring(0,4)?"https://link.stage.branch.iot"+b:b:null}!a.click_id&&a.referring_link&&(a.click_id=Fa(a.referring_link));h.D=a.browser_fingerprint_id;return a}ra&&(u["init-began-at"]=(Date.now()-window.performance.timing.navigationStart).toString());var h=this;h.o=1;-1<b.indexOf("key_")?h.i=b:h.W=b;c=c&&G(c,"object")?c:{};oa=(h.G=c)&&c.retries&&Number.isInteger(c.retries)?c.retries:oa;pa=c&&c.retry_delay&&Number.isInteger(c.retry_delay)?c.retry_delay:pa;qa=c&&c.timeout&&Number.isInteger(c.timeout)?
...
(b._t=y.browser_fingerprint_id);y.identity&&(h.g=y.identity);var T=parseInt(Ma("[?&]_open_delay_ms"),10);Ka()||La()?ib(function(){h.b(jb,{link_identifier:m,browser_fingerprint_id:m||y.browser_fingerprint_id,alternative_browser_fingerprint_id:y.browser_fingerprint_id,options:c,initial_referrer:gb(V(h)),current_url:x()&&Ha()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(h.l=2,h.s=a.message);a||"object"!==typeof b||(b.branch_view_enabled&&
