...
function Mc(a,b){Yb(document.body,"branch-banner-is-active");nc&&"fixed"===mc&&Yb(document.body,"branch-banner-no-scroll");setTimeout(function(){b?(a.style.top=null,a.style.bottom=null):"bottom"===O&&(S&&S.journey_link_data&&!S.journey_link_data.safeAreaRequired?a.style.transform="translate(0px, -"+P+") ":(pc=!0,document.getElementById("branch-banner-iframe").style.transition="all 0s",Nc(!1,!0),window.addEventListener("resize",Oc),window.addEventListener("scroll",Pc)));N(R,"didShowJourney",S);Cc=
