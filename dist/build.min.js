...
e(c.click_id)})})});Z.prototype.qrCode=Y(2,function(a,b,c){z(b).qr_code_settings=q(eb(c||{}));this.b(xb,z(b),function(b,c){var d={};if(!b&&c){d.rawBuffer=c;try{d.base64=btoa(String.fromCharCode.apply(null,new Uint8Array(c)))}catch(k){b=k}}return a(b||null,d||null)})});
