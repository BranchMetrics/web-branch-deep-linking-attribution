...
function eb(a){var b={};b=G(b,"http_origin",document.URL);b=G(b,"user_agent",navigator.userAgent);b=G(b,"language",Ua());b=G(b,"screen_width",screen.width||0);b=G(b,"screen_height",screen.height||0);b=G(b,"http_referrer",document.referrer);b=G(b,"browser_fingerprint_id",a.J);b=G(b,"developer_identity",a.m);b=G(b,"identity",a.m);b=G(b,"sdk","web");return b=G(b,"sdk_version","2.64.0")}function z(){return window.self!==window.top}
...
function Uc(a,b,c,d,e,f,m,k){var g=m?0:Qc(f);P(U,a,V);xc=!0;Sc(c);if(!m)if(void 0!==g&&b.set("globalJourneysDismiss",g,!0),Vc(b,d,e),f.dismissRedirect)window.location=f.dismissRedirect;else{var n=function(){U.removeListener(n);var l=Xc(k,qa[a]);U.i(xb,l,function(p,u){!p&&"object"===typeof u&&u.template&&k.U(u,null,!1)&&k.O(u.template,l,l.branch_view_id||u.event_data.branch_view_data.id,u.event_data.branch_view_data,!1,u.journey_link_data)})};U.addListener("branch_internal_event_didCloseJourney",n)}}
...
d.B)),null);if(0===d.A||!d.A)return g(Error(y("Branch SDK not initialized")),null)}m.unshift(g);b.apply(d,m)})}}function Z(){if(!(this instanceof Z))return dd||=new Z,dd;this.ha=ac();this.h=new Ab;this.$=new Gb;this.l=[];this.ca="web2.64.0";this.u=this.A=0;this.B=null}
...
B.branch_view_id||K.event_data.branch_view_data.id,K.event_data.branch_view_data,E,K.journey_link_data):((K.auto_branchify||!n&&Ka("branchify_url")&&X(g))&&this.branch.deepview({},{make_new_link:!1,open_app:!0,auto_branchify:!0}),P(U,"willNotShowJourney")));x&&(sa=!0)})})}function f(q){p&&(q.identity=g.m);return q}function m(q){var r={sdk:"2.64.0",branch_key:g.o},B=O(g.h)||{},E=O(g.h,!0)||{};E.browser_fingerprint_id&&(r._t=E.browser_fingerprint_id);Ia()||Ja()||g.i(jb,r,function(K,Ha){K&&(g.u=3,g.B=
