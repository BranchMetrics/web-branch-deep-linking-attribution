...
function Ca(a){a&&(a.ga=null,a.M=null,a.H=null,a.A=null,a.g=null,a.D=null,a.u&&delete a.u,a.v&&delete a.v,a.c.remove("branch_view_enabled"),Da(a.c,{},!0))}function w(a,b,c){a=a.replace(/\$(\d)/g,function(a,c){return b[parseInt(c,10)-1]});c&&(a+="\n Failure Code:"+c);return a}
...
var jb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/open",method:"POST",a:{browser_fingerprint_id:J(!1,1),alternative_browser_fingerprint_id:J(!1,1),identity_id:J(!1,1),link_identifier:J(!1,1),sdk:J(!1,1),options:J(!1,0),initial_referrer:J(!1,1),tracking_disabled:J(!1,4),current_url:J(!1,1),screen_height:J(!1,2),screen_width:J(!1,2),identity:J(!1,1)}},kb={destination:"https://app.link",endpoint:"/_r",method:"GET",Y:!0,a:{sdk:J(!0,1),_t:J(!1,1),branch_key:J(!0,1)}},lb=
{destination:"",endpoint:"",method:"GET",f:{link_url:J(!0,1)},a:{click:J(!0,1)}},mb={destination:"https://bnc.lt",endpoint:"/c",method:"POST",f:{link_url:J(!0,1)},a:{sdk:J(!1,1),phone:J(!0,1)}},nb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/referralcode",method:"POST",a:K({amount:J(!0,2),bucket:J(!1,1),calculation_type:J(!0,2),creation_source:J(!0,2),expiration:J(!1,1),location:J(!0,2),prefix:J(!1,1),type:J(!0,1)})},ob={destination:"https://nightlyregression.api.beta.branch.io",
endpoint:"/v1/referralcode",method:"POST",f:{code:J(!0,1)},a:K({})},pb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/applycode",method:"POST",f:{code:J(!0,1)},a:K({})},qb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/logout",method:"POST",a:K({session_id:J(!0,1)})},rb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/profile",method:"POST",a:K({identity_id:J(!0,1),identity:J(!0,1)})},sb={destination:"https://nightlyregression.api.beta.branch.io",
endpoint:"/v1/referrals",method:"GET",f:{identity_id:J(!0,1)},a:K({})},tb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/credithistory",method:"GET",a:K({begin_after_id:J(!1,1),bucket:J(!1,1),direction:J(!1,2),length:J(!1,2),link_click_id:J(!1,1)})},ub={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/credits",method:"GET",a:K({branch_key:J(!0,1),identity:J(!0,1)})},vb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/redeem",
method:"POST",a:K({amount:J(!0,2),bucket:J(!0,1),identity_id:J(!0,1)})},wb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/url",method:"POST",Aa:"obj",a:K({alias:J(!1,1),campaign:J(!1,1),channel:J(!1,1),data:J(!1,1),feature:J(!1,1),identity_id:J(!0,1),stage:J(!1,1),tags:J(!1,3),type:J(!1,2),source:J(!1,1),instrumentation:J(!1,1)})},xb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/deepview",Y:!0,method:"POST",a:K({campaign:J(!1,1),_t:J(!1,1),channel:J(!1,
1),data:J(!0,1),feature:J(!1,1),link_click_id:J(!1,1),open_app:J(!1,4),append_deeplink_path:J(!1,4),stage:J(!1,1),tags:J(!1,3),deepview_type:J(!0,1),source:J(!0,1)})},yb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/has-app",method:"GET",a:{browser_fingerprint_id:J(!0,1),instrumentation:J(!1,1)}},zb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/event",method:"POST",a:K({event:J(!0,1),metadata:J(!0,0),initial_referrer:J(!1,1),tracking_disabled:J(!1,
4)})},Ab={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/event",method:"POST",a:K({event:J(!0,1),metadata:J(!1,0),initial_referrer:J(!1,1),commerce_data:J(!0,0)})},Bb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v2/event/standard",method:"POST",a:{name:J(!0,1),user_data:J(!0,1),custom_data:J(!1,1),event_data:J(!1,1),content_items:J(!1,1),customer_event_alias:J(!1,1)}},Cb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v2/event/custom",
method:"POST",a:{name:J(!0,1),user_data:J(!0,1),custom_data:J(!1,1),content_items:J(!1,1),customer_event_alias:J(!1,1)}},Db={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/pageview",method:"POST",a:K({event:J(!0,1),metadata:J(!1,0),initial_referrer:J(!1,1),tracking_disabled:J(!1,4),branch_view_id:J(!1,1),no_journeys:J(!1,4),user_language:J(!1,1),open_app:J(!1,4),has_app_websdk:J(!1,4),source:J(!1,1),feature:J(!1,1),is_iframe:J(!1,4),data:J(!1,0),callback_string:J(!1,1),journey_displayed:J(!1,
4),audience_rule_id:J(!1,1),journey_dismissals:J(!1,0),identity:J(!1,1)})},Eb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/dismiss",method:"POST",a:K({event:J(!0,1),metadata:J(!1,0),initial_referrer:J(!1,1),tracking_disabled:J(!1,4),branch_view_id:J(!1,1),no_journeys:J(!1,4),user_language:J(!1,1),open_app:J(!1,4),has_app_websdk:J(!1,4),source:J(!1,1),feature:J(!1,1),is_iframe:J(!1,4),data:J(!1,0),callback_string:J(!1,1),journey_displayed:J(!1,4),audience_rule_id:J(!1,
1),journey_dismissals:J(!1,0),dismissal_source:J(!1,1)})},Fb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/cpid",method:"POST",a:{user_data:J(!0,1)}},Gb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/cpid/latd",method:"POST",a:{user_data:J(!0,1)}};function Hb(a){for(var b=0;b<a.length;b++){var c=this[a[b]],c="function"===typeof c?c():c;if(c.isEnabled())return c.w={},c}}function L(a){return"branch_session"===a||"branch_session_first"===a?a:"BRANCH_WEBSDK_KEY"+a}function Ib(a){return"true"===a?!0:"false"===a?!1:a}function Jb(a){return"branch_session"===a||"branch_session_first"===a||0===a.indexOf("BRANCH_WEBSDK_KEY")}function Kb(a){a=a.trim();var b=a.indexOf("=");return{name:a.substring(0,b),value:Ib(a.substring(b+1,a.length))}}
...
Hb.prototype.pojo={getAll:function(){return this.w},get:function(a){return this.w[a]||null},set:function(a,b){this.w[a]=b},remove:function(a){delete this.w[a]},clear:function(){this.w={}},isEnabled:function(){return!0}};function M(a,b){try{var c=p(a.get(b?"branch_session_first":"branch_session",b))||null;return Ta(c)}catch(d){return null}}function Da(a,b,c){b=Sa(b);a.set("branch_session",h(b));c&&a.set("branch_session_first",h(b),!0)}function Nb(a,b){if(b){var c=M(a)||{},c=h(Sa(z(c,b)));a.set("branch_session",c)}}
function Ob(a,b,c){function d(a,b){return Sa(z(ia(a),b,c))}var e=a.get("branch_session",!1)||{};a.set("branch_session",h(d(e,b)));e=a.get("branch_session_first",!0)||{};a.set("branch_session_first",h(d(e,b)),!0)};function Pb(){}Pb.prototype.h=0;function Qb(a,b,c){if("undefined"===typeof b)return"";var d=[];if(b instanceof Array){for(a=0;a<b.length;a++)d.push(encodeURIComponent(c)+"="+encodeURIComponent(b[a]));return d.join("&")}for(var e in b)b.hasOwnProperty(e)&&(b[e]instanceof Array||"object"===typeof b[e]?d.push(Qb(a,b[e],c?c+"."+e:e)):d.push(encodeURIComponent(c?c+"."+e:e)+"="+encodeURIComponent(b[e])));return d.join("&")}
...
c()},270),setTimeout(function(){"top"===b.position?document.body.style.marginTop=n:"bottom"===b.position&&(document.body.style.marginBottom=t);Xb("branch-banner-is-active")},20))}function f(){"top"===b.position?k.style.top="0":"bottom"===b.position&&(k.style.bottom="0");O(a,"didShowBanner")}if(!ac(d,b))return O(a,"willNotShowBanner"),null;O(a,"willShowBanner");var k=ec(b,d);cc(b,k);c.channel=c.channel||"app banner";var l=b.F?k.contentWindow.document:document;if(B()){b.open_app=b.na;b.append_deeplink_path=
...
n=document.body.style.marginTop,m=Zb("margin-bottom"),t=document.body.style.marginBottom,A=l.getElementById("branch-banner-close");A&&(A.onclick=function(b){b.preventDefault();O(a,"willCloseBanner");e({},function(){O(a,"didCloseBanner")})});Wb(document.body,"branch-banner-is-active");"top"===b.position?document.body.style.marginTop=$b(g):"bottom"===b.position&&(document.body.style.marginBottom=$b(m));b.X?f():setTimeout(f,20);return e};var hc={},ic,jc=1,P="top",kc="absolute",Q="76px",lc=!1,mc=!1,R=[],nc=!1,oc=window.innerHeight,pc=window.innerWidth;window.innerHeight<window.innerWidth&&(oc=window.innerWidth,pc=window.innerHeight);
...
function Sc(a,b,c,d,e,f,k,l){var g=k?0:Oc(f);O(S,a,T);Dc=!0;Qc(c);if(!k)if(void 0!==g&&b.set("globalJourneysDismiss",g,!0),Tc(b,d,e),f.dismissRedirect)window.location=f.dismissRedirect;else{var n=function(){S.removeListener(n);var b=Vc(l,wa[a]);S.b(Eb,b,function(a,c){!a&&"object"===typeof c&&c.template&&l.N(c,null,!1)&&l.J(c.template,b,b.branch_view_id||c.event_data.branch_view_data.id,c.event_data.branch_view_data,!1,c.journey_link_data)})};S.addListener("branch_internal_event_didCloseJourney",n)}}
function Wc(a,b){return z({url:a&&a.url||Ga(),user_agent:navigator.userAgent,language:navigator.language,screen_width:screen.width||-1,screen_height:screen.height||-1,window_device_pixel_ratio:window.devicePixelRatio||1},b||{})}
...
function Xc(a){var b={banner_id:ic};if(a&&"object"===typeof a&&0<Object.keys(a).length){var c=["browser_fingerprint_id","app_id","source","open_app","link_click_id"];if(a&&"object"===typeof a&&!Array.isArray(a)&&0<Object.keys(a).length&&c&&Array.isArray(c)&&0<c.length)for(var d in a)a.hasOwnProperty(d)&&-1<c.indexOf(d)&&delete a[d];b.journey_link_data={};z(b.journey_link_data,a)}T=b}function Yc(){return hc&&S&&S.l&&S.l.data?S.l.data.$journeys_cta:!1}
function Zc(){if(Yc())return S.l.data.$journeys_cta}function $c(a){try{if(Yc()&&0<Zc().length)return a.replace(/validate[(].+[)];/g,'validate("'+Zc()+'")')}catch(b){}return a};var U={};
...
U.J=function(a,b,c,d,e,f){if(!sc){ic=c;Xc(f);var k=d.audience_rule_id;(f=document.getElementById("branch-iframe-css"))&&f.parentElement.removeChild(f);f=document.createElement("div");f.id="branch-banner";document.body.insertBefore(f,null);Wb(f,"branch-banner-is-active");var l=!1,g=b.callback_string,n=null,m=null,t=S.c;if(a){var A=Hc(a)||{};console.log(a);a=$c(a);console.log(a);var ta=window.setTimeout(function(){window[g]=function(){}},ra);window[g]=function(a){window.clearTimeout(ta);l||(m=a,Pc(c,
k,t,m,n,A,e))};zc=n=ad(a,b.has_app_websdk);if(null===n){l=!0;return}Pc(c,k,t,m,n,A,e);sa&&(u["journey-load-time"]=(Date.now()-window.performance.timing.navigationStart).toString())}document.body.removeChild(f);v||e||U.ja(d)}};
U.I=function(a,b,c,d){S=c;b||(b={});a||(a={});Cc=b.disable_entry_animation||!1;Bc=b.disable_exit_animation||!1;var e=z({},c.l),f=M(c.c)||{},k=f.hasOwnProperty("has_app")?f.has_app:!1,l=c.c.get("journeyDismissals",!0),g=(b.user_language||Wa()||"en").toLowerCase()||null,n=gb(V(c)),m;(m=b.branch_view_id)||(m="_branch_view_id".replace(/[\[\]]/g,"\\$&"),m=(m=(new RegExp("[?&]"+m+"(=([^&#]*)|&|#|$)")).exec(Ga()))&&m[2]?decodeURIComponent(m[2].replace(/\+/g," ")):"");m=m||null;c=b.make_new_link?null:Ia(V(c));
e.event=d?"dismiss":"pageview";e.metadata=a;e=G(e,"initial_referrer",n);e=G(e,"branch_view_id",m);e=G(e,"no_journeys",b.no_journeys);e=G(e,"is_iframe",x());e=G(e,"journey_dismissals",l);e.user_language=g;e.open_app=b.open_app||!1;e.has_app_websdk=k;e.feature="journeys";e.callback_string="branch_view_callback__"+jc++;e.data||(e.data={});e.data=z(D(),e.data);e.data=z(Fa(f||{}),e.data);c&&(e.data.link_click_id=c);(a=f.data?JSON.parse(f.data):null)&&a["+referrer"]&&(e.data["+referrer"]=a["+referrer"]);
...
function cd(a){var b={"~channel":"Firebase App Indexing","~feature":"Auto App Indexing",$canonical_url:Ga()};if("object"===typeof X.data)for(var c in X.data)X.data.hasOwnProperty(c)&&!b.hasOwnProperty(c)&&(b[c]=X.data[c]);return a+(-1<a.indexOf("?")?"&":"?")+"link_click_id=a-"+btoa(q(b))}function dd(a){var b=document.createElement("link");b.setAttribute("rel","alternate");b.setAttribute("href",a);document.head.appendChild(b)}
...
"/"))}ed(a)};var gd;
function Y(a,b,c){return function(){var d=this,e,f,k=arguments[arguments.length-1];a&&"function"===typeof k?(e=Array.prototype.slice.call(arguments,0,arguments.length-1)||[],f=k):(f=function(){},e=Array.prototype.slice.call(arguments));d.$(function(k){function g(b,c){try{if(b&&!a)throw b;1===a?f(b):2===a&&f(b,c)}finally{k()}}if(!c){if(1===d.m)return g(Error(w("Branch SDK initialization pending and a Branch method was called outside of the queue order")),null);if(2===d.m)return g(Error(w("Branch SDK initialization failed, so further methods cannot be called",d.j,
d.o)),null);if(0===d.m||!d.m)return g(Error(w("Branch SDK not initialized")),null)}e.unshift(g);b.apply(d,e)})}}function Z(){if(!(this instanceof Z))return gd||(gd=new Z),gd;this.$=oa();this.c=new Hb(["session","cookie","pojo"]);this.ca=new Pb;this.h=[];this.V="web2.55.0";this.j=this.m=0;this.o=null}
...
this.Z);(a.a&&a.a.sdk||a.f&&a.f.sdk)&&this.V&&(b.sdk=this.V);(a.a&&a.a.browser_fingerprint_id||a.f&&a.f.browser_fingerprint_id)&&this.D&&(b.browser_fingerprint_id=this.D);v&&(b.tracking_disabled=v);return Vb(this.ca,a,b,this.c,function(a,b){c(a,b)})};function V(a){var b=M(a.c);return(b=b&&b.referring_link)?b:(a=a.c.get("click_id"))?"https://bnc.lt/c/"+a:null}function O(a,b,c){for(var d=0;d<a.h.length;d++)a.h[d].event&&a.h[d].event!==b||a.h[d].listener(b,c)}
...
d){d&&(d=l(d),v||(d=f(d),Da(g.c,d,t)),g.m=3,d.data_parsed=d.data&&0!==d.data.length?p(d.data):{});if(b)return g.m=2,g.j||(g.j=1,g.o=b.message),a(b,d&&Ea(d));try{a(b,d&&Ea(d))}catch(md){}finally{g.renderFinalize()}var e=ab(),k=H(c.metadata,"object")?c.metadata:null;k&&(k=hb(e.hosted_deeplink_data,k))&&0<Object.keys(k).length&&(e.hosted_deeplink_data=k);var m=U.I(Wc(c,e),c,g,!1);g.renderQueue(function(){g.b(Db,m,function(a,b){if(!a&&"object"===typeof b){var d=m.branch_view_id?!0:!1;U.N(b,c,d)?U.J(b.template,
m,m.branch_view_id||b.event_data.branch_view_data.id,b.event_data.branch_view_data,d,b.journey_link_data):((b.auto_branchify||!n&&Oa("branchify_url")&&V(g))&&this.branch.deepview({},{make_new_link:!1,open_app:!0,auto_branchify:!0}),O(S,"willNotShowJourney"))}v&&(ya=!0)})})}function f(a){t&&(a.identity=g.g);return a}function k(a){var b={sdk:"2.55.0",branch_key:g.i},c=M(g.c)||{},d=M(g.c,!0)||{};d.browser_fingerprint_id&&(b._t=d.browser_fingerprint_id);Na()||g.b(kb,b,function(a,b){a&&(g.j=3,g.o=a.message);
b&&(c.browser_fingerprint_id=b)});g.b(yb,{browser_fingerprint_id:c.browser_fingerprint_id},function(b,d){b&&(g.j=4,g.o=b.message);b||!d||c.has_app||(c.has_app=!0,Nb(g.c,c),O(g,"didDownloadApp"));a&&a(null,c)})}function l(a){a.link_click_id&&(g.Z=a.link_click_id.toString());a.session_id&&(g.H=a.session_id.toString());a.identity_id&&(g.A=a.identity_id.toString());a.identity&&(g.g=a.identity.toString());a.link&&(g.M=a.link);if(a.referring_link){var b=a.referring_link;a.referring_link=b?"http"!==b.substring(0,
4)?"https://bnc.lt"+b:b:null}!a.click_id&&a.referring_link&&(a.click_id=Ia(a.referring_link));g.D=a.browser_fingerprint_id;return a}sa&&(u["init-began-at"]=(Date.now()-window.performance.timing.navigationStart).toString());var g=this;g.m=1;-1<b.indexOf("key_")?g.i=b:g.U=b;c=c&&H(c,"object")?c:{};pa=(g.G=c)&&c.retries&&Number.isInteger(c.retries)?c.retries:pa;qa=c&&c.retry_delay&&Number.isInteger(c.retry_delay)?c.retry_delay:qa;ra=c&&c.timeout&&Number.isInteger(c.timeout)?c.timeout:ra;r=c&&c.nonce?
c.nonce:r;v=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;ya=!1;v&&Ca(g);b=M(g.c);var n=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,m=n||Oa("_branch_match_id")||Ja(),t=!b||!b.identity_id;g.C=!!g.c.get("branch_view_enabled");if(b&&b.session_id&&!m&&!Oa("branchify_url"))Nb(g.c,{data:""}),Nb(g.c,{referring_link:""}),d(),k(e);else{b={sdk:"2.55.0",branch_key:g.i};var A=M(g.c,!0)||{};A.browser_fingerprint_id&&(b._t=A.browser_fingerprint_id);A.identity&&
(g.g=A.identity);var ta=parseInt(Oa("[?&]_open_delay_ms"),10);Na()?ib(function(){g.b(jb,{link_identifier:m,browser_fingerprint_id:m||A.browser_fingerprint_id,alternative_browser_fingerprint_id:A.browser_fingerprint_id,options:c,initial_referrer:gb(V(g)),current_url:x()&&Ka()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(g.j=2,g.o=a.message);a||"object"!==typeof b||(b.branch_view_enabled&&(g.C=!!b.branch_view_enabled,g.c.set("branch_view_enabled",
g.C)),m&&(b.click_id=m));d();e(a,b)})},ta):g.b(kb,b,function(a,b){if(a)return g.j=3,g.o=a.message,e(a,null);ib(function(){g.b(jb,{link_identifier:m,browser_fingerprint_id:m||b,alternative_browser_fingerprint_id:A.browser_fingerprint_id,options:c,initial_referrer:gb(V(g)),current_url:x()&&Ka()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(g.j=2,g.o=a.message);a||"object"!==typeof b||(b.branch_view_enabled&&(g.C=!!b.branch_view_enabled,
g.c.set("branch_view_enabled",g.C)),m&&(b.click_id=m));d();e(a,b)})},ta)})}},!0);Z.prototype.renderQueue=Y(0,function(a,b){this.aa?b():(this.s=this.s||[],this.s.push(b));a(null,null)});Z.prototype.renderFinalize=Y(2,function(a){this.s&&0<this.s.length&&(this.s.forEach(function(a){a.call(this)}),delete this.s);this.aa=!0;a(null,null)});Z.prototype.data=Y(2,function(a){var b=Ea(M(this.c));b.referring_link=V(this);b.data_parsed=b.data&&0!==b.data.length?p(b.data):{};a(null,b)});
Z.prototype.first=Y(2,function(a){a(null,Ea(M(this.c,!0)))});Z.prototype.setIdentity=Y(2,function(a,b){var c=this;this.b(rb,{identity:b},function(d,e){d&&a(d);e=e||{};c.A=e.identity_id?e.identity_id.toString():null;c.M=e.link;c.g=b;e.developer_identity=b;e.referring_data_parsed=e.referring_data?p(e.referring_data):null;Ob(c.c,{identity:b});a(null,e)})});
Z.prototype.logout=Y(1,function(a){var b=this;this.b(qb,{},function(c,d){c&&a(c);d=d||{};d={data_parsed:null,data:null,referring_link:null,click_id:null,link_click_id:null,identity:null,session_id:d.session_id,identity_id:d.identity_id,link:d.link,device_fingerprint_id:b.ga||null};b.M=d.link;b.H=d.session_id;b.A=d.identity_id;b.g=null;Ob(b.c,d,!0);a(null)})});Z.prototype.getBrowserFingerprintId=Y(2,function(a){var b=M(this.c,!0)||{};a(null,b.browser_fingerprint_id||null)});
...
metadata:z({url:Ga(),user_agent:navigator.userAgent,language:navigator.language},c),initial_referrer:gb(V(this))},function(b,c){"function"===typeof a&&a.apply(this,arguments)})});
...
e(c.click_id)})})});
Z.prototype.deepview=Y(1,function(a,b,c){var d=this;c||(c={});c.deepview_type="undefined"===typeof c.deepview_type?"deepview":"banner";b.data=z(D(),b.data);b=x()?z({is_iframe:!0},b):b;b=Ha(b);var e=Aa(this.i,b);if(c.open_app||null===c.open_app||"undefined"===typeof c.open_app)b.open_app=!0;b.append_deeplink_path=!!c.append_deeplink_path;b.deepview_type=c.deepview_type;var f=V(d);f&&!c.make_new_link&&(b.link_click_id=Ia(f));b.banner_options=c;c.auto_branchify&&(b.auto_branchify=!0);d.v=ga(this.b,d,
xb,b,function(b,c){if(b)return v||(d.u=function(){window.top.location=e}),a(b);"function"===typeof c&&(d.u=c);a(null)});d.v()});
Z.prototype.deepviewCta=Y(1,function(a){if("undefined"===typeof this.u)return v?a(Error("Requested operation cannot be completed since tracking is disabled"),null):a(Error("Cannot call Deepview CTA, please call branch.deepview() first"),null);window.event&&(window.event.preventDefault?window.event.preventDefault():window.event.returnValue=!1);O(this,"didDeepviewCTA");this.u();a()});Z.prototype.referrals=Y(2,function(a){this.b(sb,{},a)});
...
Z.prototype.addListener=function(a,b){"function"===typeof a&&void 0===b&&(b=a,a=null);b&&this.h.push({listener:b,event:a||null})};Z.prototype.removeListener=function(a){a&&(this.h=this.h.filter(function(b){if(b.listener!==a)return b}))};function hd(a,b,c){c=c||{};try{a.l=p(q(c))}finally{a.l=a.l||{}}b()}Z.prototype.setBranchViewData=Y(1,function(a,b){hd.call(null,this,a,b)},!0);
...
W.iosDetailsComplete||W.androidDetailsComplete?a(null):a("Firebase App Indexing tags were not added to your webpage. Please check your configuration.")});Z.prototype.trackCommerceEvent=Y(1,function(a,b,c,d){var e=this;e.renderQueue(function(){var f=$a(b,c);if(f)return a(Error(f));e.b(Ab,{event:b,metadata:z({url:document.URL,user_agent:navigator.userAgent,language:navigator.language},d||{}),initial_referrer:gb(V(e)),commerce_data:c},function(b){a(b||null)})});a()});
Z.prototype.disableTracking=Y(1,function(a,b){if(!1===b||"false"===b)ya=v=!1,this.i&&this.G&&(!0===this.G.tracking_disabled&&delete this.G.tracking_disabled,this.init(this.i,this.G));else if(void 0===b||!0===b||"true"===b)Ca(this),ya=v=!0,this.closeBanner(),this.closeJourney();a()},!0);var id=new Z;if(window.branch&&window.branch._q)for(var jd=window.branch._q,kd=0;kd<jd.length;kd++){var ld=jd[kd];id[ld[0]].apply(id,ld[1])}"function"===typeof define&&define.amd?define("branch",function(){return id}):"object"===typeof exports&&(module.exports=id);window&&(window.branch=id);})();
