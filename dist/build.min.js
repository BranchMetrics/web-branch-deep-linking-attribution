...
function Sa(){var a={},b;b={};b=E(b,"$og_title",y("title"));b=E(b,"$og_description",y("description"));b=E(b,"$og_image_url",y("image"));b=(b=E(b,"$og_video",y("video")))&&0<Object.keys(b).length?b:null;a=E(a,"og_data",b);a=E(a,"hosted_deeplink_data",C());b=document.getElementsByTagName("title");a=E(a,"title",0<b.length?b[0].innerText:null);b=document.querySelector('meta[name="description"]');a=E(a,"description",b&&b.content?b.content:null);b=document.querySelector('link[rel="canonical"]');return(a=
...
function Xa(a){var b={},b=E(b,"http_origin",document.URL),b=E(b,"user_agent",navigator.userAgent),b=E(b,"language",Ma()),b=E(b,"screen_width",screen.width),b=E(b,"screen_height",screen.height),b=E(b,"http_referrer",document.referrer),b=E(b,"browser_fingerprint_id",a.B),b=E(b,"developer_identity",a.C),b=E(b,"sdk","web");return b=E(b,"sdk_version","2.44.0")}function x(){return window.self!==window.top}
...
d.l)),null);if(0===d.j||!d.j)return g(Error(w("Branch SDK not initialized")),null)}e.unshift(g);b.apply(d,e)})}}function Z(){if(!(this instanceof Z))return Kc||(Kc=new Z),Kc;this.$=ma();this.c=new vb(["session","cookie","pojo"]);this.ca=new Cb;this.g=[];this.V="web2.44.0";this.i=this.j=0;this.l=null}
