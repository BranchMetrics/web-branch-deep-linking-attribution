...
function fa(a,b){b.push('"',a.replace(ia,function(c){let d=ha[c];d||(d="\\u"+(c.charCodeAt(0)|65536).toString(16).slice(1),ha[c]=d);return d}),'"')};function t(a){a=String(a);try{return JSON.parse(a)}catch(b){}throw Error("Invalid JSON string: "+a);}function u(a){try{return"object"===typeof JSON&&"function"===typeof JSON.stringify?JSON.stringify(a):h(a)}catch(b){}throw Error("Could not stringify object");};var ja=2,ka=200,la=5E3,ma="",w={},na="undefined"!==typeof window&&!!(window.performance&&window.performance.timing&&window.performance.timing.navigationStart),oa="";function pa(a){return a&&"number"===typeof a?(Date.now()-a).toString():null}
...
if(e)return e;if(d.length)return Xa.invalidKeysForProducts+d.join(", ")}return null}function Za(a,b){return a&&"string"===typeof a&&-1!==Wa.indexOf(a.toLowerCase())?b&&"object"===typeof b&&0!==Object.keys(b||{}).length?(a=Ya(b))?a:null:Xa.missingCommerceData:Xa.missingPurchaseEvent}function G(a){return"string"!==typeof a?null:a.replace(/</g,"&lt;").replace(/>/g,"&gt;")}function H(a,b,c){if(null!==c&&void 0!==c){if("object"===typeof c&&0===Object.keys(c||{}).length)return a;a[b]=c}return a}
function $a(){var a={};var b={};b=H(b,"$og_title",A("title"));b=H(b,"$og_description",A("description"));b=H(b,"$og_image_url",A("image"));b=H(b,"$og_video",A("video"));b=(b=H(b,"$og_type",A("type")))&&0<Object.keys(b).length?b:null;a=H(a,"og_data",b);a=H(a,"hosted_deeplink_data",Ta());b=document.getElementsByTagName("title");a=H(a,"title",0<b.length?b[0].innerText:null);b=document.querySelector('meta[name="description"]');a=H(a,"description",b&&b.content?b.content:null);b=document.querySelector('link[rel="canonical"]');
return(a=H(a,"canonical_url",b&&b.href?b.href:null))&&0<Object.keys(a).length?a:{}}var ab="ADD_TO_CART ADD_TO_WISHLIST VIEW_CART INITIATE_PURCHASE ADD_PAYMENT_INFO PURCHASE SPEND_CREDITS SEARCH VIEW_ITEM VIEW_ITEMS RATE SHARE COMPLETE_REGISTRATION COMPLETE_TUTORIAL ACHIEVE_LEVEL UNLOCK_ACHIEVEMENT LOGIN SUBSCRIBE START_TRIAL INVITE RESERVE VIEW_AD CLICK_AD INITIATE_STREAM COMPLETE_STREAM".split(" "),bb="transaction_id revenue currency shipping tax coupon affiliation search_query description".split(" ");
function cb(a){if(!a||0===Object.keys(a).length)return null;for(var b=Va(bb,Object.keys(a)),c={},d=0;d<b.length;d++){var e=b[d];c[e]=a[e];delete a[e]}return{custom_data:db(c),event_data:a}}function I(a,b){return!b||null===a&&"object"===b?!1:"array"===b?Array.isArray(a):typeof a===b&&!Array.isArray(a)}
function eb(a){var b={};b=H(b,"http_origin",document.URL);b=H(b,"user_agent",navigator.userAgent);b=H(b,"language",Ua());b=H(b,"screen_width",screen.width||0);b=H(b,"screen_height",screen.height||0);b=H(b,"http_referrer",document.referrer);b=H(b,"browser_fingerprint_id",a.J);b=H(b,"developer_identity",a.m);b=H(b,"identity",a.m);b=H(b,"sdk","web");return b=H(b,"sdk_version","2.62.0")}function z(){return window.self!==window.top}
function Ea(){var a="true";try{window.top.location.search&&(a="true")}catch(b){return!1}return"true"===a}function fb(a){return a?a:z()?Ea()?window.top.document.referrer:"":document.referrer}function db(a){if(!I(a,"object")||0===Object.keys(a).length)return{};for(var b in a)if(a.hasOwnProperty(b)){var c=b;var d=a[b];d=I(d,"object")||I(d,"array")?u(d):null===d?"null":d.toString();a[c]=d}return a}
function gb(a,b){a=a?C({},a):{};return b&&0<Object.keys(b).length?0<Object.keys(a).length?C(a,b):C({},b):a}function J(a){""!==ma&&a.setAttribute("nonce",ma)}function hb(a,b){isNaN(b)||0>=b?a():setTimeout(a,b)};function K(a,b){return function(c,d,e){if(x)return!1;if("number"===typeof e||e)if(0===b){if("object"!==typeof e)return y("API request $1, parameter $2 is not $3",[c,d,"an object"])}else if(3===b){if(!(e instanceof Array))return y("API request $1, parameter $2 is not $3",[c,d,"an array"])}else if(2===b){if("number"!==typeof e)return y("API request $1, parameter $2 is not $3",[c,d,"a number"])}else if(4===b){if("boolean"!==typeof e)return y("API request $1, parameter $2 is not $3",[c,d,"a boolean"])}else{if("string"!==
typeof e)return y("API request $1, parameter $2 is not $3",[c,d,"a string"]);if(1!==b&&!b.test(e))return y("API request $1, parameter $2 is not $3",[c,d,"in the proper format"])}else if(a)return y("API request $1 missing parameter $2",[c,d]);return!1}}function M(a){return C(a,{browser_fingerprint_id:K(!0,1),identity_id:K(!0,1),sdk:K(!0,1),session_id:K(!0,1)})}
var ib={destination:"https://api2.branch.io",endpoint:"/v1/open",method:"POST",g:{browser_fingerprint_id:K(!1,1),alternative_browser_fingerprint_id:K(!1,1),identity_id:K(!1,1),link_identifier:K(!1,1),sdk:K(!1,1),options:K(!1,0),initial_referrer:K(!1,1),tracking_disabled:K(!1,4),current_url:K(!1,1),screen_height:K(!1,2),screen_width:K(!1,2)}},jb={destination:"https://app.link",endpoint:"/_r",method:"GET",R:!0,g:{sdk:K(!0,1),_t:K(!1,1),branch_key:K(!0,1)}},kb={destination:"",endpoint:"",method:"GET",
j:{link_url:K(!0,1)},g:{click:K(!0,1)}},lb={destination:"https://bnc.lt",endpoint:"/c",method:"POST",j:{link_url:K(!0,1)},g:{sdk:K(!1,1),phone:K(!0,1)}},mb={destination:"https://api2.branch.io",endpoint:"/v1/logout",method:"POST",g:M({session_id:K(!0,1)})},nb={destination:"https://api2.branch.io",endpoint:"/v1/profile",method:"POST",g:M({identity_id:K(!0,1),identity:K(!0,1)})},ob={destination:"https://api2.branch.io",endpoint:"/v1/url",method:"POST",va:"obj",g:M({alias:K(!1,1),campaign:K(!1,1),channel:K(!1,
1),data:K(!1,1),feature:K(!1,1),identity_id:K(!0,1),stage:K(!1,1),tags:K(!1,3),type:K(!1,2),source:K(!1,1),instrumentation:K(!1,1)})},pb={destination:"https://api2.branch.io",endpoint:"/v1/qr-code",method:"POST",va:"obj",g:M({alias:K(!1,1),campaign:K(!1,1),channel:K(!1,1),data:K(!1,1),qr_code_settings:K(!1,1),feature:K(!1,1),identity_id:K(!0,1),stage:K(!1,1),tags:K(!1,3),type:K(!1,2),source:K(!1,1)})},qb={destination:"https://api2.branch.io",endpoint:"/v1/deepview",R:!0,method:"POST",g:M({campaign:K(!1,
1),_t:K(!1,1),channel:K(!1,1),data:K(!0,1),feature:K(!1,1),link_click_id:K(!1,1),open_app:K(!1,4),append_deeplink_path:K(!1,4),stage:K(!1,1),tags:K(!1,3),deepview_type:K(!0,1),source:K(!0,1)})},rb={destination:"https://api2.branch.io",endpoint:"/v1/has-app",method:"GET",g:{browser_fingerprint_id:K(!0,1),instrumentation:K(!1,1)}},sb={destination:"https://api2.branch.io",endpoint:"/v1/event",method:"POST",g:M({event:K(!0,1),metadata:K(!0,0),initial_referrer:K(!1,1),tracking_disabled:K(!1,4)})},tb={destination:"https://api2.branch.io",
endpoint:"/v1/event",method:"POST",g:M({event:K(!0,1),metadata:K(!1,0),initial_referrer:K(!1,1),commerce_data:K(!0,0)})},ub={destination:"https://api2.branch.io",endpoint:"/v2/event/standard",method:"POST",g:{name:K(!0,1),user_data:K(!0,1),custom_data:K(!1,1),event_data:K(!1,1),content_items:K(!1,1),customer_event_alias:K(!1,1)}},vb={destination:"https://api2.branch.io",endpoint:"/v2/event/custom",method:"POST",g:{name:K(!0,1),user_data:K(!0,1),custom_data:K(!1,1),event_data:K(!1,1),content_items:K(!1,
1),customer_event_alias:K(!1,1)}},wb={destination:"https://api2.branch.io",endpoint:"/v1/pageview",method:"POST",g:M({event:K(!0,1),metadata:K(!1,0),initial_referrer:K(!1,1),tracking_disabled:K(!1,4),branch_view_id:K(!1,1),no_journeys:K(!1,4),user_language:K(!1,1),open_app:K(!1,4),has_app_websdk:K(!1,4),source:K(!1,1),feature:K(!1,1),is_iframe:K(!1,4),data:K(!1,0),callback_string:K(!1,1),journey_displayed:K(!1,4),audience_rule_id:K(!1,1),journey_dismissals:K(!1,0),identity_id:K(!1,1)})},xb={destination:"https://api2.branch.io",
endpoint:"/v1/dismiss",method:"POST",g:M({event:K(!0,1),metadata:K(!1,0),initial_referrer:K(!1,1),tracking_disabled:K(!1,4),branch_view_id:K(!1,1),no_journeys:K(!1,4),user_language:K(!1,1),open_app:K(!1,4),has_app_websdk:K(!1,4),source:K(!1,1),feature:K(!1,1),is_iframe:K(!1,4),data:K(!1,0),callback_string:K(!1,1),journey_displayed:K(!1,4),audience_rule_id:K(!1,1),journey_dismissals:K(!1,0),dismissal_source:K(!1,1)})},yb={destination:"https://api2.branch.io",endpoint:"/v1/cpid",method:"POST",g:{user_data:K(!0,
1)}},zb={destination:"https://api2.branch.io",endpoint:"/v1/cpid/latd",method:"POST",g:{user_data:K(!0,1)}};function Ab(){for(var a=["session","cookie","pojo"],b=0;b<a.length;b++){var c=this[a[b]];c="function"===typeof c?c():c;if(c.isEnabled())return c.G={},c}}function N(a){return"branch_session"===a||"branch_session_first"===a?a:"BRANCH_WEBSDK_KEY"+a}function Bb(a){return"true"===a?!0:"false"===a?!1:a}function Cb(a){return"branch_session"===a||"branch_session_first"===a||0===a.indexOf("BRANCH_WEBSDK_KEY")}
function Db(a){a=a.trim();var b=a.indexOf("=");return{name:a.substring(0,b),value:Bb(a.substring(b+1,a.length))}}
function Eb(a){try{var b=a&&localStorage?localStorage:sessionStorage}catch(c){return{isEnabled:function(){return!1}}}return{getAll:function(){if("undefined"===typeof b)return null;var c=null,d;for(d in b)0===d.indexOf("BRANCH_WEBSDK_KEY")&&(null===c&&(c={}),c[d.replace("BRANCH_WEBSDK_KEY","")]=Bb(b.getItem(d)));return Pa(c)},get:function(c,d){return"browser_fingerprint_id"===c||"alternative_browser_fingerprint_id"===c?d&&localStorage?Ma(localStorage.getItem(N(c))):Ma(b.getItem(N(c))):Bb(d&&localStorage?
localStorage.getItem(N(c)):b.getItem(N(c)))},set:function(c,d,e){e&&localStorage?localStorage.setItem(N(c),d):b.setItem(N(c),d)},remove:function(c,d){d&&localStorage?localStorage.removeItem(N(c)):b.removeItem(N(c))},clear:function(){Object.keys(b).forEach(function(c){0===c.indexOf("BRANCH_WEBSDK_KEY")&&b.removeItem(c)})},isEnabled:function(){try{return b.setItem("test",""),b.removeItem("test"),!0}catch(c){return!1}}}}Ab.prototype.local=function(){return Eb(!0)};Ab.prototype.session=function(){return Eb(!1)};
function Fb(){function a(b,c){c&&(b=N(b));document.cookie=b+"=; expires=Thu, 01 Jan 1970 00:00:01 GMT; path=/"}return{getAll:function(){for(var b={},c=document.cookie.split(";"),d=0;d<c.length;d++){var e=Db(c[d]);e&&e.hasOwnProperty("name")&&e.hasOwnProperty("value")&&Cb(e.name)&&(b[e.name.replace("BRANCH_WEBSDK_KEY","")]=e.value)}return b},get:function(b){b=N(b);for(var c=document.cookie.split(";"),d=0;d<c.length;d++){var e=Db(c[d]);if(e&&e.hasOwnProperty("name")&&e.hasOwnProperty("value")&&e.name===
b)return e.value}return null},set:function(b,c){document.cookie=N(b)+"="+c+"; path=/"},remove:function(b){a(b,!0)},clear:function(){for(var b=document.cookie.split(";"),c=0;c<b.length;c++){var d=Db(b[c]);d&&d.hasOwnProperty("name")&&Cb(d.name)&&a(d.name,!1)}},isEnabled:function(){return navigator.cookieEnabled}}}Ab.prototype.cookie=function(){return Fb()};
...
function Ib(a,b,c){function d(l,q){"undefined"===typeof q&&(q={});if(l.branch_key&&g.test(l.branch_key))return q.branch_key=l.branch_key,q;if(l.app_id&&k.test(l.app_id))return q.app_id=l.app_id,q;if(l.instrumentation)q.instrumentation=l.instrumentation;else throw Error(y("API request $1 missing parameter $2",[b.endpoint,"branch_key or app_id"]));}var e,f,m=b.destination+b.endpoint,k=/^[0-9]{15,20}$/,g=/key_(live|test)_[A-Za-z0-9]{32}/;if("/v1/has-app"===b.endpoint)try{b.j=d(c,b.j)}catch(l){return{error:l.message}}if("undefined"!==
...
b.endpoint&&(n.metadata=u(n.metadata||{}),n.hasOwnProperty("commerce_data")&&(n.commerce_data=u(n.commerce_data||{})));("/v1/pageview"===b.endpoint||"/v1/dismiss"===b.endpoint)&&n.metadata&&(n.metadata=u(n.metadata||{}));"/v1/open"===b.endpoint&&(n.options=u(n.options||{}));return{data:Hb(a,n,""),url:m.replace(/^\//,"")}}
Gb.prototype.createScript=function(a,b,c){var d=document.createElement("script");d.type="text/javascript";d.async=!0;d.src=a;J(d);a=document.getElementsByTagName("head");!a||1>a.length?"function"===typeof b&&b():(a[0].appendChild(d),"function"===typeof b&&Qa(d,"error",b),"function"===typeof c&&Qa(d,"load",c))};
function Jb(a,b,c,d,e){var f=Date.now(),m=oa;0===a.l&&Ia()&&a.l++;var k="branch_callback__"+a.l++,g=0<=b.indexOf("branch.io")?"&data=":"&post_data=";c="POST"===d?encodeURIComponent(va(h(c))):"";var n=window.setTimeout(function(){window[k]=function(){};H(w,m,pa(f));e(Error("Request timed out"),null,504)},la);window[k]=function(l){window.clearTimeout(n);e(null,l)};a.createScript(b+(0>b.indexOf("?")?"?":"")+(c?g+c:"")+(0<=b.indexOf("/c/")?"&click=1":"")+"&callback="+k,function(){e(Error("Request blocked by client, probably adblock"),
null)},function(){H(w,m,pa(f));try{"function"===typeof this.remove?this.remove():this.parentNode.removeChild(this)}catch(l){}delete window[k]})}
function Kb(a,b,c,d,e,f,m,k){var g=Date.now(),n=oa,l=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");k&&(l.responseType=k);l.ontimeout=function(){H(w,n,pa(g));f(Error("Request timed out"),null,504)};l.onerror=function(q){f(Error(q.error||"Error in API: "+l.status),null,l.status)};l.onreadystatechange=function(){if(4===l.readyState)if(H(w,n,pa(g)),200===l.status){if("arraybuffer"===l.responseType)var q=l.response;else if(m)q=l.responseText;else try{q=t(l.responseText)}catch(v){q=
{}}f(null,q,l.status)}else if("4"===l.status.toString().substring(0,1)||"5"===l.status.toString().substring(0,1))l.responseURL&&l.responseURL.includes("v2/event")?f(l.responseText,null,l.status):f(Error("Error in API: "+l.status),null,l.status)};try{l.open(d,b,!0),l.timeout=la,l.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),l.send(c)}catch(q){e.set("use_jsonp",!0),Jb(a,b,c,d,f)}}
function Lb(a,b,c,d,e){function f(){d.get("use_jsonp")||b.R?Jb(a,l,c,b.method,m):Kb(a,l,n,b.method,d,m,D,p)}function m(r,B,F){"function"===typeof a.ga&&a.ga(l,b.method,q,r,F,B);r&&0<v&&"5"===(F||"").toString().substring(0,1)?(v--,window.setTimeout(function(){f()},ka)):e(r,B)}oa="/v1/pageview"===b.endpoint&&c&&c.journey_displayed?b.endpoint+"-1-brtt":b.endpoint+"-brtt";("/v1/url"===b.endpoint||"/v1/has-app"===b.endpoint)&&1<Object.keys(w).length&&(delete w["-brtt"],c.instrumentation=u(C({},w)),w={});
if(x)for(var k=["browser_fingerprint_id","alternative_browser_fingerprint_id","identity_id","session_id"],g=0;g<k.length;g++)c.hasOwnProperty(k[g])&&delete c[k[g]];k=Ib(a,b,c);if(k.error)return e(Error(u({message:k.error,endpoint:b.endpoint,data:c})));var n="";if("GET"===b.method)var l=k.url+"?"+k.data;else l=k.url,n=k.data;var q;d.get("use_jsonp")||b.R?q=c:q=n;var v=ja;if(x&&ta(l,c))return sa?m(Error("Requested operation cannot be completed since tracking is disabled"),null,300):m(null,{},200);var D=
!1;if("/v1/qr-code"===b.endpoint){D=!0;var p="arraybuffer"}f()};function O(a){a&&a.parentNode.removeChild(a)}function Mb(a,b){a&&!a.className.match(new RegExp("(\\s|^)"+b+"(\\s|$)"))&&(a.className+=" "+b)}function Nb(a){var b=document.body;b&&b.className.match(new RegExp("(\\s|^)"+a+"(\\s|$)"))&&(b.className=b.className.replace(new RegExp("(\\s|^)"+a+"(\\s|$)")," "))}function Ob(a){var b=new Date;return b.setDate(b.getDate()+a)}
...
function Rb(a,b){a=a.get("hideBanner",!0);if(b.wa&&navigator&&Number(navigator.doNotTrack))return!1;try{"string"===typeof a&&(a=t(a))}catch(d){a=!1}a="number"===typeof a?new Date>=new Date(a):!a;var c=b.P;"number"===typeof c&&(c=!1);return!document.getElementById("branch-banner")&&!document.getElementById("branch-banner-iframe")&&(a||c)&&(b.ya&&!E()||b.V&&"android"===E()||b.za&&"ipad"===E()||b.Z&&"ios"===E()||b.W&&"blackberry"===E()||b.Y&&"windows_phone"===E()||b.X&&"kindle"===E())};function Sb(a,b){return"#branch-banner-iframe { position: "+("top"!==b||a?"fixed":"absolute")+"; }\n"}
...
c+=a.la;a.K&&(c+="body { margin: 0; }\n",d=document.createElement("style"),d.type="text/css",d.id="branch-iframe-css",J(d),d.innerHTML="body { -webkit-transition: all 0.375s ease; transition: all 00.375s ease; }\n#branch-banner-iframe { box-shadow: 0 0 5px rgba(0, 0, 0, .35); width: 1px; min-width:100%; left: 0; right: 0; border: 0; height: 76px; z-index: 99999; -webkit-transition: all 0.25s ease; transition: all 00.25s ease; }\n"+(E()?Sb(a.ra,a.position):Sb(a.ma,a.position)),(document.head||document.getElementsByTagName("head")[0]).appendChild(d));
d=document.createElement("style");d.type="text/css";d.id="branch-css";d.innerHTML=c;J(d);c=a.K?b.contentWindow.document:document;(c=c.head||c.getElementsByTagName("head")[0])&&"function"===typeof c.appendChild&&c.appendChild(d);"top"===a.position?b.style.top="-76px":"bottom"===a.position&&(b.style.bottom="-76px")};function P(a,b){try{var c=t(a.get(b?"branch_session_first":"branch_session",b))||null;return Pa(c)}catch(d){return null}}function xa(a,b,c){b=Oa(b);a.set("branch_session",h(b));c&&a.set("branch_session_first",h(b),!0)}function Ub(a,b){if(b){var c=P(a)||{};b=h(Oa(C(c,b)));a.set("branch_session",b)}}
function Vb(a,b,c){function d(f,m){return Oa(C(t(f),m,c))}var e=a.get("branch_session",!1)||{};a.set("branch_session",h(d(e,b)));e=a.get("branch_session_first",!0)||{};a.set("branch_session_first",h(d(e,b)),!0)};function Wb(a,b,c){var d=document.createElement("iframe");d.src="about:blank";d.style.overflow="hidden";d.scrolling="no";d.id="branch-banner-iframe";d.className="branch-animation";J(d);d.onload=function(){var e=E(),f=d.contentDocument||d.contentWindow.document;f.head=f.createElement("head");f.body=f.createElement("body");f.body.className="ios"===e||"ipad"===e?"branch-banner-ios":"android"===e?"branch-banner-android":"branch-banner-desktop";Xb(a,b,f);c(d)};document.body.appendChild(d)}
...
function Yb(a,b,c){var d;E()?d='<a id="branch-mobile-action" class="button" href="#" target="_parent">'+((P(b)||{}).has_app?a.sa:a.pa)+"</a>":d='<div class="branch-icon-wrapper" id="branch-loader-wrapper" style="opacity: 0;"><div id="branch-spinner"></div></div><div id="branch-sms-block"><form id="sms-form"><input type="phone" aria-label="Enter phone number" class="branch-animation" name="branch-sms-phone" id="branch-sms-phone" placeholder="'+a.ua+'"><button type="submit" id="branch-sms-send" class="branch-animation button">'+
a.xa+"</button></form></div>";b='<div id="branch-sms-form-container">'+d+"</div>";a.K?Wb(a,b,c):(a=Xb(a,b,document),c(a))};function Zb(a,b,c,d){function e(){m();g.style.background="#FFD4D4";k.className="error";setTimeout(function(){g.style.background="#FFFFFF";k.className=""},2E3)}function f(){q=a.createElement("div");q.className="branch-icon-wrapper";q.id="branch-checkmark";q.style="opacity: 0;";q.innerHTML=window.ActiveXObject?'<span class="checkmark">&#x2713;</span>':'<svg version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 98.5 98.5" enable-background="new 0 0 98.5 98.5" xml:space="preserve"><path class="checkmark" fill="none" stroke-width="8" stroke-miterlimit="10" d="M81.7,17.8C73.5,9.3,62,4,49.2,4C24.3,4,4,24.3,4,49.2s20.3,45.2,45.2,45.2s45.2-20.3,45.2-45.2c0-8.6-2.4-16.6-6.5-23.4l0,0L45.6,68.2L24.7,47.3"/></svg>';
l.appendChild(q);g.style.opacity="0";k.style.opacity="0";n.style.opacity="0";setTimeout(function(){q.style.opacity="1"},20);k.value=""}function m(){g.removeAttribute("disabled");k.removeAttribute("disabled");g.style.opacity="1";k.style.opacity="1";n.style.opacity="0"}var k=a.getElementById("branch-sms-phone"),g=a.getElementById("branch-sms-send"),n=a.getElementById("branch-loader-wrapper"),l=a.getElementById("branch-sms-form-container"),q;if(k){var v=k.value;/^\d{7,}$/.test(v.replace(/[\s()+\-\.]|ext/gi,
""))?(Q(b,"willSendBannerSMS"),g.setAttribute("disabled",""),k.setAttribute("disabled",""),g.style.opacity=".4",k.style.opacity=".4",n.style.opacity="1",k.className="",b.sendSMS(v,d,c,function(D){D?(Q(b,"sendBannerSMSError"),e()):(Q(b,"didSendBannerSMS"),f(),setTimeout(function(){l.removeChild(q);m()},3E3))})):e()}}
function $b(a,b,c,d){function e(g,n){"function"===typeof g&&(n=g,g={});g=g||{};"top"===b.position?f.style.top="-76px":"bottom"===b.position&&(f.style.bottom="-76px");"number"===typeof b.P?d.set("hideBanner",Ob(b.P),!0):d.set("hideBanner",!0,!0);g.da?("top"===b.position?document.body.style.marginTop=m:"bottom"===b.position&&(document.body.style.marginBottom=k),Nb("branch-banner-is-active"),O(f),O(document.getElementById("branch-css")),n()):(setTimeout(function(){O(f);O(document.getElementById("branch-css"));
n()},270),setTimeout(function(){"top"===b.position?document.body.style.marginTop=m:"bottom"===b.position&&(document.body.style.marginBottom=k);Nb("branch-banner-is-active")},20))}if(!Rb(d,b))return Q(a,"willNotShowBanner"),null;Q(a,"willShowBanner");var f,m=document.body.style.marginTop,k=document.body.style.marginBottom;Yb(b,d,function(g){function n(D){D.preventDefault();Q(a,"willCloseBanner");e({},function(){Q(a,"didCloseBanner")})}function l(){"top"===b.position?f.style.top="0":"bottom"===b.position&&
(f.style.bottom="0");Q(a,"didShowBanner")}f=g;Tb(b,f);c.channel=c.channel||"app banner";var q=b.K?f.contentWindow.document:document;if(E()){if(b.open_app=b.ta,b.append_deeplink_path=b.ja,b.make_new_link=b.qa,b.deepview_type="banner",a.deepview(c,b),g=q.getElementById("branch-mobile-action"))g.onclick=function(D){D.preventDefault();a.deepviewCta()}}else q.getElementById("sms-form")?q.getElementById("sms-form").addEventListener("submit",function(D){D.preventDefault();Zb(q,a,b,c)}):f.onload=function(){q=
f.contentWindow.document;q.getElementById("sms-form")&&q.getElementById("sms-form").addEventListener("submit",function(D){D.preventDefault();Zb(q,a,b,c)})};g=Pb("margin-top");var v=Pb("margin-bottom");Mb(document.body,"branch-banner-is-active");"top"===b.position?document.body.style.marginTop=Qb(g):"bottom"===b.position&&(document.body.style.marginBottom=Qb(v));(g=q.getElementById("branch-banner-close"))&&g.addEventListener("click",n);(g=q.getElementById("branch-banner-modal-background"))&&g.addEventListener("click",
n);b.da?l():setTimeout(l,20)});return e};function ac(){function a(){if(b.length)b[0](function(){b.shift();a()})}var b=[];return function(c){b.push(c);1===b.length&&a()}};var bc={},cc,dc=1,R="top",ec="absolute",S="76px",fc=!1,gc=!1,T=[],hc=!1,ic=window.innerHeight,jc=window.innerWidth;window.innerHeight<window.innerWidth&&(ic=window.innerWidth,jc=window.innerHeight);
...
function Bc(a){var b=Cc(a)||{};b&&b.bannerHeight&&b.position&&b.sticky?(S=b.bannerHeight,R=b.position,ec=b.sticky):(a=a.match(rc))?(R="top",(a=a[1].match(sc))&&(S=a[1]),ec="absolute"):(R="bottom",ec="fixed");if(-1!==S.indexOf("vh")||-1!==S.indexOf("%"))a=S.indexOf("vh")?S.slice(0,-2):S.slice(0,-1),S=a/100*ic+"px",100>a?gc=!0:fc=!0}function Cc(a){if(a=a.match(nc))return t(a[1])}function Dc(a){if(a=a.match(qc))return a[1]}
...
function Ic(a){var b=a.match(nc),c=a.match(oc),d=a.match(pc),e=a.match(qc);b&&(a=a.replace(nc,""));c&&(a=a.replace(oc,""));d&&(a=a.replace(pc,""));e&&(a=a.replace(qc,""));return a}function Jc(){var a=document.createElement("iframe");a.src="about:blank";a.style.overflow="hidden";a.scrolling="no";a.id="branch-banner-iframe";a.className="branch-animation";a.title="Branch Banner";a.setAttribute("aria-label","Branch Banner");J(a);return a}
function Kc(a){var b=document.createElement("style");b.type="text/css";b.id="branch-iframe-css";kc=Pb("margin-top");var c=+kc.slice(0,-2);lc=Pb("margin-bottom");var d=+lc.slice(0,-2),e=+S.slice(0,-2);a||("top"===R?document.body.style.marginTop=(+e+c).toString()+"px":"bottom"===R&&(document.body.style.marginBottom=(+e+d).toString()+"px"));0<T.length&&T.forEach(function(f){var m,k=window.getComputedStyle(f);k&&(m=fc&&"fixed"===k.getPropertyValue("position"));m||(f.style.marginTop=S)});"top"===zc&&zc!==
R&&yc&&Ac&&0<Ac.length&&Ac.forEach(function(f){f.style.marginTop=0});yc=!1;zc="";Ac=[];xc=!1;b.innerHTML=a?a:Lc();J(b);document.head.appendChild(b)}
...
function Xc(a,b){var c={},d=Ta();d&&0<Object.keys(d).length&&(c.hosted_deeplink_data=d);a=a.N(Yc(null,c),null,U,!0);if(V&&V.journey_link_data){H(a,"journey_id",V.journey_link_data.journey_id);H(a,"journey_name",Wc(V.journey_link_data.journey_name));H(a,"view_id",V.journey_link_data.view_id);H(a,"view_name",Wc(V.journey_link_data.view_name));H(a,"channel",Wc(V.journey_link_data.channel));H(a,"campaign",Wc(V.journey_link_data.campaign));try{H(a,"tags",JSON.stringify(V.journey_link_data.tags))}catch(e){a.tags=
JSON.stringify([])}}H(a,"dismissal_source",b);return a}
function Uc(a,b,c,d,e,f,m,k){var g=m?0:Qc(f);Q(U,a,V);xc=!0;Sc(c);if(!m)if(void 0!==g&&b.set("globalJourneysDismiss",g,!0),Vc(b,d,e),f.dismissRedirect)window.location=f.dismissRedirect;else{var n=function(){U.removeListener(n);var l=Xc(k,qa[a]);U.i(xb,l,function(q,v){!q&&"object"===typeof v&&v.template&&k.U(v,null,!1)&&k.O(v.template,l,l.branch_view_id||v.event_data.branch_view_data.id,v.event_data.branch_view_data,!1,v.journey_link_data)})};U.addListener("branch_internal_event_didCloseJourney",n)}}
...
function Sc(a,b){vc||(mc=!0);if(wc&&!vc){document.body.style.transition="all 00.375s ease";document.getElementById("branch-banner-iframe").style.transition="all 00.25s ease";var c=document.getElementById("branch-iframe-css").innerHTML+"\n";c+="body { -webkit-transition: all 0.375s ease; }\n#branch-banner-iframe { -webkit-transition: all 0.25s ease; }\n";document.getElementById("branch-iframe-css").innerHTML="";document.getElementById("branch-iframe-css").innerHTML=c}"top"===R?a.style.top="-"+S:"bottom"===
R&&(a.style.bottom="-"+S);Q(U,"willCloseJourney",V);setTimeout(function(){O(a);O(document.getElementById("branch-css"));O(document.getElementById("branch-iframe-css"));O(document.getElementById("branch-journey-cta"));(!vc||xc)&&T&&0<T.length?T.forEach(function(d){d.style.marginTop=0}):(yc=vc,zc=R,Ac=T);"top"===R?document.body.style.marginTop=kc:"bottom"===R&&(document.body.style.marginBottom=lc);Nb("branch-banner-is-active");Nb("branch-banner-no-scroll");hc&&(hc=!1,window.removeEventListener("resize",
Oc),window.removeEventListener("scroll",Pc));Q(U,"didCloseJourney",V);b||Q(U,"branch_internal_event_didCloseJourney",V);uc=!1;setTimeout(function(){mc=!1},250)},vc?0:270)}
...
function cd(a,b,c){var d=b?"OPEN":"GET";Bc(a);var e=Cc(a);e&&(d=Ec(e,b),Fc(e));var f=Gc(a);Hc(a);var m=Dc(a);a=Ic(a);var k=Jc();k.onload=function(){var g=a,n=E(),l=k.contentDocument||k.contentWindow.document;l.head=l.createElement("head");l.body=l.createElement("body");l.body.innerHTML=g;l.body.className="ios"===n||"ipad"===n?"branch-banner-ios":"android"===n?"branch-banner-android":"branch-banner-desktop";(g=l.querySelector('meta[name="accessibility"]'))&&"wcag"===g.content&&(g=l.createElement("script"),g.type=
...
l.querySelector("body").append(g));Kc(m);l=document.createElement("style");l.type="text/css";l.id="branch-css";l.innerHTML=f;J(l);g=k.contentWindow.document;g.head.appendChild(l);if(gc||fc){var q=g.getElementsByClassName("branch-banner-content")[0];!g.getElementsByClassName("branch-banner-dismiss-background")[0]&&q&&(q.style.height=S)}"top"===R?k.style.top="-"+S:"bottom"===R&&(k.style.bottom="-"+S);try{q=g.getElementsByClassName("branch-banner-content")[0];var v=window.getComputedStyle(q).getPropertyValue("background-color").split(", ");
v[3]&&0===parseFloat(v[3])&&(k.style.boxShadow="none")}catch(D){}q=d;k.contentWindow.document.getElementById("branch-mobile-action").innerHTML=q;Q(U,"willShowJourney",V);Mc(k,m);c(k)};document.body.appendChild(k)}
...
W.ea=function(a){U.i(wb,{event:"pageview",journey_displayed:!0,audience_rule_id:a.audience_rule_id,branch_view_id:a.branch_view_id},function(){})};
W.O=function(a,b,c,d,e,f){if(!mc){cc=c;Zc(f);var m=d.audience_rule_id;(f=document.getElementById("branch-iframe-css"))&&f.parentElement.removeChild(f);var k=document.createElement("div");k.id="branch-banner";document.body.insertBefore(k,null);Mb(k,"branch-banner-is-active");var g=!1,n=b.callback_string,l=null,q=U.h;if(a){var v=Cc(a)||{};a=bd(a);var D=window.setTimeout(function(){window[n]=function(){}},la);window[n]=function(p){window.clearTimeout(D);g||(l=p,Rc(c,m,q,l,null,v,e))};cd(a,b.has_app_websdk,
function(p){tc=p;null===p?g=!0:(Rc(c,m,q,l,p,v,e),na&&(w["journey-load-time"]=(Date.now()-window.performance.timing.navigationStart).toString()),document.body.removeChild(k),x||e||W.ea(d))})}else document.body.removeChild(k),x||e||W.ea(d)}};
W.N=function(a,b,c,d){U=c;b||={};a||={};wc=b.disable_entry_animation||!1;vc=b.disable_exit_animation||!1;var e=C({},c.v),f=P(c.h)||{},m=f.hasOwnProperty("has_app")?f.has_app:!1,k=c.h.get("journeyDismissals",!0),g=(b.user_language||Ua()||"en").toLowerCase()||null,n=fb(X(c)),l;(l=b.branch_view_id)||(l="_branch_view_id".replace(/[\[\]]/g,"\\$&"),l=(l=(new RegExp("[?&]"+l+"(=([^&#]*)|&|#|$)")).exec(Aa()))&&l[2]?decodeURIComponent(l[2].replace(/\+/g," ")):"");l=l||null;c=b.make_new_link?null:Ca(X(c));
e.event=d?"dismiss":"pageview";e.metadata=a;e=H(e,"initial_referrer",n);e=H(e,"branch_view_id",l);e=H(e,"no_journeys",b.no_journeys);e=H(e,"is_iframe",z());e=H(e,"journey_dismissals",k);e.user_language=g;e.open_app=b.open_app||!1;e.has_app_websdk=m;e.feature="journeys";e.callback_string="branch_view_callback__"+dc++;e.data||(e.data={});e.data=C(Ta(),e.data);e.data=C(za(f||{}),e.data);c&&(e.data.link_click_id=c);(a=f.data?t(f.data):null)&&a["+referrer"]&&(e.data["+referrer"]=a["+referrer"]);return e=
Ba(e)};var dd;
...
d.B)),null);if(0===d.A||!d.A)return g(Error(y("Branch SDK not initialized")),null)}m.unshift(g);b.apply(d,m)})}}function Z(){if(!(this instanceof Z))return dd||=new Z,dd;this.ha=ac();this.h=new Ab;this.$=new Gb;this.l=[];this.ca="web2.62.0";this.u=this.A=0;this.B=null}
...
this.fa);(a.g&&a.g.sdk||a.j&&a.j.sdk)&&this.ca&&(b.sdk=this.ca);(a.g&&a.g.browser_fingerprint_id||a.j&&a.j.browser_fingerprint_id)&&this.J&&(b.browser_fingerprint_id=this.J);x&&(b.tracking_disabled=x);return Lb(this.$,a,b,this.h,function(d,e){c(d,e)})};function X(a){var b=P(a.h);return(b=b&&b.referring_link)?b:(a=a.h.get("click_id"))?"https://bnc.lt/c/"+a:null}function Q(a,b,c){for(var d=0;d<a.l.length;d++)a.l[d].event&&a.l[d].event!==b||a.l[d].listener(b,c)}
Z.prototype.init=Y(2,function(a,b,c){function d(){if("undefined"!==typeof document.hidden){var p="hidden";var r="visibilitychange"}else"undefined"!==typeof document.mozHidden?(p="mozHidden",r="mozvisibilitychange"):"undefined"!==typeof document.msHidden?(p="msHidden",r="msvisibilitychange"):"undefined"!==typeof document.webkitHidden&&(p="webkitHidden",r="webkitvisibilitychange");r&&!g.ka&&(g.ka=!0,document.addEventListener(r,function(){document[p]||(m(null),"function"===typeof g.F&&g.F())},!1))}function e(p,
r){r&&(r=k(r),x||(r=f(r),xa(g.h,r,q)),g.A=3,r.data_parsed=r.data&&0!==r.data.length?t(r.data):{});if(p)return g.A=2,g.u||(g.u=1,g.B=p.message),a(p,r&&ya(r));try{a(p,r&&ya(r))}catch(F){}finally{g.renderFinalize()}p=$a();(r=I(c.metadata,"object")?c.metadata:null)&&(r=gb(p.hosted_deeplink_data,r))&&0<Object.keys(r).length&&(p.hosted_deeplink_data=r);var B=W.N(Yc(c,p),c,g,!1);g.renderQueue(function(){g.i(wb,B,function(F,L){F||"object"!==typeof L||(F=B.branch_view_id?!0:!1,W.U(L,c,F)?W.O(L.template,B,
B.branch_view_id||L.event_data.branch_view_data.id,L.event_data.branch_view_data,F,L.journey_link_data):((L.auto_branchify||!n&&Ka("branchify_url")&&X(g))&&this.branch.deepview({},{make_new_link:!1,open_app:!0,auto_branchify:!0}),Q(U,"willNotShowJourney")));x&&(sa=!0)})})}function f(p){q&&(p.identity=g.m);return p}function m(p){var r={sdk:"2.62.0",branch_key:g.o},B=P(g.h)||{},F=P(g.h,!0)||{};F.browser_fingerprint_id&&(r._t=F.browser_fingerprint_id);Ia()||Ja()||g.i(jb,r,function(L,Ha){L&&(g.u=3,g.B=
L.message);Ha&&(B.browser_fingerprint_id=Ha)});g.i(rb,{browser_fingerprint_id:B.browser_fingerprint_id},function(L,Ha){L&&(g.u=4,g.B=L.message);L||!Ha||B.has_app||(B.has_app=!0,Ub(g.h,B),Q(g,"didDownloadApp"));p&&p(null,B)})}function k(p){p.link_click_id&&(g.fa=p.link_click_id.toString());p.session_id&&(g.M=p.session_id.toString());p.identity_id&&(g.s=p.identity_id.toString());p.identity&&(g.m=p.identity.toString());p.link&&(g.T=p.link);if(p.referring_link){var r=p.referring_link;p.referring_link=
r?"http"!==r.substring(0,4)?"https://bnc.lt"+r:r:null}!p.click_id&&p.referring_link&&(p.click_id=Ca(p.referring_link));g.J=p.browser_fingerprint_id;return p}na&&(w["init-began-at"]=(Date.now()-window.performance.timing.navigationStart).toString());var g=this;g.A=1;-1<b.indexOf("key_")?g.o=b:g.aa=b;c=c&&I(c,"object")?c:{};ja=(g.L=c)&&c.retries&&Number.isInteger(c.retries)?c.retries:ja;ka=c&&c.retry_delay&&Number.isInteger(c.retry_delay)?c.retry_delay:ka;la=c&&c.timeout&&Number.isInteger(c.timeout)?
c.timeout:la;ma=c&&c.nonce?c.nonce:ma;x=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;sa=!1;x&&wa(g);b=P(g.h,!0);g.s=b&&b.identity_id;b=P(g.h);var n=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,l=n||Ka("_branch_match_id")||Da(),q=!g.s;g.I=!!g.h.get("branch_view_enabled");if(b&&b.session_id&&!l&&!Ka("branchify_url"))Ub(g.h,{data:""}),Ub(g.h,{referring_link:""}),d(),m(e);else{b={sdk:"2.62.0",branch_key:g.o};var v=P(g.h,!0)||{};v.browser_fingerprint_id&&
(b._t=v.browser_fingerprint_id);v.identity&&(g.m=v.identity);var D=parseInt(Ka("[?&]_open_delay_ms"),10);Ia()||Ja()?hb(function(){g.i(ib,{link_identifier:l,browser_fingerprint_id:l||v.browser_fingerprint_id,alternative_browser_fingerprint_id:v.browser_fingerprint_id,options:c,initial_referrer:fb(X(g)),current_url:z()&&Ea()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(p,r){p&&(g.u=2,g.B=p.message);p||"object"!==typeof r||(r.branch_view_enabled&&
(g.I=!!r.branch_view_enabled,g.h.set("branch_view_enabled",g.I)),l&&(r.click_id=l));d();e(p,r)})},D):g.i(jb,b,function(p,r){if(p)return g.u=3,g.B=p.message,e(p,null);hb(function(){g.i(ib,{link_identifier:l,browser_fingerprint_id:l||r,alternative_browser_fingerprint_id:v.browser_fingerprint_id,options:c,initial_referrer:fb(X(g)),current_url:z()&&Ea()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(B,F){B&&(g.u=2,g.B=B.message);B||
"object"!==typeof F||(F.branch_view_enabled&&(g.I=!!F.branch_view_enabled,g.h.set("branch_view_enabled",g.I)),l&&(F.click_id=l));d();e(B,F)})},D)})}},!0);Z.prototype.renderQueue=Y(0,function(a,b){this.ia?b():(this.C=this.C||[],this.C.push(b));a(null,null)});Z.prototype.renderFinalize=Y(2,function(a){this.C&&0<this.C.length&&(this.C.forEach(function(b){b.call(this)}),delete this.C);this.ia=!0;a(null,null)});
Z.prototype.data=Y(2,function(a){var b=ya(P(this.h));b.referring_link=X(this);b.data_parsed=b.data&&0!==b.data.length?t(b.data):{};a(null,b)});Z.prototype.first=Y(2,function(a){a(null,ya(P(this.h,!0)))});
...
Z.prototype.logout=Y(1,function(a){var b=this;this.i(mb,{},function(c,d){c&&a(c);d=d||{};d={data_parsed:null,data:null,referring_link:null,click_id:null,link_click_id:null,identity:null,session_id:d.session_id,identity_id:d.identity_id,link:d.link,device_fingerprint_id:b.na||null};b.T=d.link;b.M=d.session_id;b.s=d.identity_id;b.m=null;Vb(b.h,d,!0);a(null)})});Z.prototype.getBrowserFingerprintId=Y(2,function(a){var b=P(this.h,!0)||{};a(null,b.browser_fingerprint_id||null)});
Z.prototype.crossPlatformIds=Y(2,function(a){this.i(yb,{user_data:u(eb(this))},function(b,c){return a(b||null,c&&c.user_data||null)})});Z.prototype.lastAttributedTouchData=Y(2,function(a,b){b=I(b,"number")?b:null;var c=eb(this);H(c,"attribution_window",b);this.i(zb,{user_data:u(c)},function(d,e){return a(d||null,e||null)})});
Z.prototype.track=Y(1,function(a,b,c,d){c=c||{};d=d||{};ma=d.nonce?d.nonce:ma;if("pageview"===b){(b=gb(Ta(),c))&&0<Object.keys(b).length&&(c.hosted_deeplink_data=b);var e=W.N(Yc(d,c),d,this,!1);this.i(wb,e,function(f,m){if(!f&&"object"===typeof m){var k=e.branch_view_id?!0:!1;W.U(m,d,k)?W.O(m.template,e,e.branch_view_id||m.event_data.branch_view_data.id,m.event_data.branch_view_data,k,m.journey_link_data):Q(U,"willNotShowJourney")}"function"===typeof a&&a.apply(this,arguments)})}else this.i(sb,{event:b,
...
Z.prototype.logEvent=Y(1,function(a,b,c,d,e){b=I(b,"string")?b:null;c=I(c,"object")?c:null;e=I(e,"string")?e:null;c=cb(c);b&&-1<ab.indexOf(b)?(d=I(d,"array")?d:null,this.i(ub,{name:b,user_data:u(eb(this)),custom_data:u(c&&c.custom_data||{}),event_data:u(c&&c.event_data||{}),content_items:u(d||[]),customer_event_alias:e},function(f){return a(f||null)})):this.i(vb,{name:b,user_data:u(eb(this)),custom_data:u(c&&c.custom_data||{}),event_data:u(c&&c.event_data||{}),content_items:u(d||[]),customer_event_alias:e},
...
Z.prototype.closeJourney=Y(1,function(a){var b=this;b.renderQueue(function(){if(tc&&uc)Q(b,"didCallJourneyClose",V),Sc(tc,!0);else return a("Journey already dismissed.")});a()});
Z.prototype.banner=Y(1,function(a,b,c){c=c||{};ed.call(null,this,function(){},c);"undefined"===typeof b.showAgain&&"undefined"!==typeof b.forgetHide&&(b.showAgain=b.forgetHide);var d={icon:G(b.icon)||"",title:G(b.title)||"",description:G(b.description)||"",S:"number"===typeof b.reviewCount&&0<b.reviewCount?Math.floor(b.reviewCount):null,H:"number"===typeof b.rating&&5>=b.rating&&0<b.rating?Math.round(2*b.rating)/2:null,sa:G(b.openAppButtonText)||"View in app",pa:G(b.downloadAppButtonText)||"Download App",
xa:G(b.sendLinkText)||"Send Link",ua:G(b.phonePreviewText)||"(999) 999-9999",K:"undefined"===typeof b.iframe?!0:b.iframe,Z:"undefined"===typeof b.showiOS?!0:b.showiOS,za:"undefined"===typeof b.showiPad?!0:b.showiPad,V:"undefined"===typeof b.showAndroid?!0:b.showAndroid,W:"undefined"===typeof b.showBlackberry?!0:b.showBlackberry,Y:"undefined"===typeof b.showWindowsPhone?!0:b.showWindowsPhone,X:"undefined"===typeof b.showKindle?!0:b.showKindle,ya:"undefined"===typeof b.showDesktop?!0:b.showDesktop,
