...
function eb(a){var b={},b=G(b,"http_origin",document.URL),b=G(b,"user_agent",navigator.userAgent),b=G(b,"language",Va()),b=G(b,"screen_width",screen.width||0),b=G(b,"screen_height",screen.height||0),b=G(b,"http_referrer",document.referrer),b=G(b,"browser_fingerprint_id",a.C),b=G(b,"developer_identity",a.g),b=G(b,"identity",a.g),b=G(b,"sdk","web");return b=G(b,"sdk_version","2.54.2")}function x(){return window.self!==window.top}
...
d.m)),null);if(0===d.l||!d.l)return g(Error(w("Branch SDK not initialized")),null)}e.unshift(g);b.apply(d,e)})}}function Z(){if(!(this instanceof Z))return ad||(ad=new Z),ad;this.$=oa();this.c=new Fb(["session","cookie","pojo"]);this.ca=new Nb;this.h=[];this.V="web2.54.2";this.j=this.l=0;this.m=null}
...
c.nonce:r;v=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;xa=!1;v&&Ba(g);b=M(g.c);var n=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,m=n||Na("_branch_match_id")||Ia(),t=!b||!b.identity_id;g.B=!!g.c.get("branch_view_enabled");if(b&&b.session_id&&!m&&!Na("branchify_url"))Lb(g.c,{data:""}),Lb(g.c,{referring_link:""}),d(),k(e);else{b={sdk:"2.54.2",branch_key:g.i};var z=M(g.c,!0)||{};z.browser_fingerprint_id&&(b._t=z.browser_fingerprint_id);z.identity&&
