...
function fb(a){var b={},b=F(b,"http_origin",document.URL),b=F(b,"user_agent",navigator.userAgent),b=F(b,"language",Va()),b=F(b,"screen_width",screen.width||0),b=F(b,"screen_height",screen.height||0),b=F(b,"http_referrer",document.referrer),b=F(b,"browser_fingerprint_id",a.D),b=F(b,"developer_identity",a.g),b=F(b,"identity",a.g),b=F(b,"sdk","web");return b=F(b,"sdk_version","2.57.1")}function x(){return window.self!==window.top}
function Ha(){var a="true";try{window.top.location.search&&(a="true")}catch(b){return!1}return"true"===a}function gb(a){return a?a:x()?Ha()?window.top.document.referrer:"":document.referrer}function eb(a){if(!G(a,"object")||!Object.keys(a).length)return{};for(var b in a)a.hasOwnProperty(b)&&(a[b]=G(a[b],"object")||G(a[b],"array")?q(a[b]):a[b].toString());return a}function hb(a,b){var c=a?B({},a):{};return b&&0<Object.keys(b).length?0<Object.keys(c).length?B(c,b):B({},b):c}
...
method:"POST",a:J({event:I(!0,1),metadata:I(!1,0),initial_referrer:I(!1,1),tracking_disabled:I(!1,4),branch_view_id:I(!1,1),no_journeys:I(!1,4),user_language:I(!1,1),open_app:I(!1,4),has_app_websdk:I(!1,4),source:I(!1,1),feature:I(!1,1),is_iframe:I(!1,4),data:I(!1,0),callback_string:I(!1,1),journey_displayed:I(!1,4),audience_rule_id:I(!1,1),journey_dismissals:I(!1,0),dismissal_source:I(!1,1)})},Gb={destination:"https://api2.branch.io",endpoint:"/v1/cpid",method:"POST",a:{user_data:I(!0,1)}},Hb={destination:"https://api2.branch.io",
endpoint:"/v1/cpid/latd",method:"POST",a:{user_data:I(!0,1)}};function Ib(a){for(var b=0;b<a.length;b++){var c=this[a[b]],c="function"===typeof c?c():c;if(c.isEnabled())return c.A={},c}}function K(a){return"branch_session"===a||"branch_session_first"===a?a:"BRANCH_WEBSDK_KEY"+a}function Jb(a){return"true"===a?!0:"false"===a?!1:a}function Kb(a){return"branch_session"===a||"branch_session_first"===a||0===a.indexOf("BRANCH_WEBSDK_KEY")}function Lb(a){a=a.trim();var b=a.indexOf("=");return{name:a.substring(0,b),value:Jb(a.substring(b+1,a.length))}}
function Mb(a){var b;try{b=a&&localStorage?localStorage:sessionStorage}catch(c){return{isEnabled:function(){return!1}}}return{getAll:function(){if("undefined"===typeof b)return null;var a=null,d;for(d in b)d.indexOf("BRANCH_WEBSDK_KEY")||(null===a&&(a={}),a[d.replace("BRANCH_WEBSDK_KEY","")]=Jb(b.getItem(d)));return Ra(a)},get:function(a,d){return"browser_fingerprint_id"===a||"alternative_browser_fingerprint_id"===a?d&&localStorage?Oa(localStorage.getItem(K(a))):Oa(b.getItem(K(a))):Jb(d&&localStorage?
...
function Nb(){function a(a,c){c&&(a=K(a));document.cookie=a+"=; expires=Thu, 01 Jan 1970 00:00:01 GMT; path=/"}return{getAll:function(){for(var a={},c=document.cookie.split(";"),d=0;d<c.length;d++){var e=Lb(c[d]);e&&e.hasOwnProperty("name")&&e.hasOwnProperty("value")&&Kb(e.name)&&(a[e.name.replace("BRANCH_WEBSDK_KEY","")]=e.value)}return a},get:function(a){a=K(a);for(var b=document.cookie.split(";"),d=0;d<b.length;d++){var e=Lb(b[d]);if(e&&e.hasOwnProperty("name")&&e.hasOwnProperty("value")&&e.name===
...
Ib.prototype.pojo={getAll:function(){return this.A},get:function(a){return this.A[a]||null},set:function(a,b){this.A[a]=b},remove:function(a){delete this.A[a]},clear:function(){this.A={}},isEnabled:function(){return!0}};function L(a,b){try{var c=p(a.get(b?"branch_session_first":"branch_session",b))||null;return Ra(c)}catch(d){return null}}function Ba(a,b,c){b=Qa(b);a.set("branch_session",g(b));c&&a.set("branch_session_first",g(b),!0)}function Ob(a,b){if(b){var c=L(a)||{},c=g(Qa(B(c,b)));a.set("branch_session",c)}}
function Pb(a,b,c){function d(a,b){return Qa(B(p(a),b,c))}var e=a.get("branch_session",!1)||{};a.set("branch_session",g(d(e,b)));e=a.get("branch_session_first",!0)||{};a.set("branch_session_first",g(d(e,b)),!0)};function Qb(){}Qb.prototype.h=0;function Rb(a,b,c){if("undefined"===typeof b)return"";var d=[];if(b instanceof Array){for(a=0;a<b.length;a++)d.push(encodeURIComponent(c)+"="+encodeURIComponent(b[a]));return d.join("&")}for(var e in b)b.hasOwnProperty(e)&&(b[e]instanceof Array||"object"===typeof b[e]?d.push(Rb(a,b[e],c?c+"."+e:e)):d.push(encodeURIComponent(c?c+"."+e:e)+"="+encodeURIComponent(b[e])));return d.join("&")}
function Sb(a,b,c){function d(a,c){"undefined"===typeof c&&(c={});if(a.branch_key&&h.test(a.branch_key))return c.branch_key=a.branch_key,c;if(a.app_id&&l.test(a.app_id))return c.app_id=a.app_id,c;if(a.instrumentation)c.instrumentation=a.instrumentation;else throw Error(w("API request $1 missing parameter $2",[b.endpoint,"branch_key or app_id"]));}var e,f,k=b.destination+b.endpoint,l=/^[0-9]{15,20}$/,h=/key_(live|test)_[A-Za-z0-9]{32}/;if("/v1/has-app"===b.endpoint)try{b.f=d(c,b.f)}catch(n){return{error:n.message}}if("undefined"!==
typeof b.f)for(e in b.f)if(b.f.hasOwnProperty(e)){if(f="function"===typeof b.f[e]?b.f[e](b.endpoint,e,c[e]):f)return{error:f};k+="/"+c[e]}var m={};if("undefined"!==typeof b.a&&"/v1/pageview"!==b.endpoint&&"/v1/dismiss"!==b.endpoint)for(e in b.a){if(b.a.hasOwnProperty(e)){if(f=b.a[e](b.endpoint,e,c[e]))return{error:f};f=c[e];"undefined"!==typeof f&&""!==f&&null!==f&&(m[e]=f)}}else"/v1/pageview"!==b.endpoint&&"/v1/dismiss"!==b.endpoint||B(m,c);if("POST"===b.method||"/v1/credithistory"===b.endpoint)try{c=
d(c,m)}catch(n){return{error:n.message}}"/v1/event"===b.endpoint&&(m.metadata=q(m.metadata||{}),m.hasOwnProperty("commerce_data")&&(m.commerce_data=q(m.commerce_data||{})));("/v1/pageview"===b.endpoint||"/v1/dismiss"===b.endpoint)&&m.metadata&&(m.metadata=q(m.metadata||{}));"/v1/open"===b.endpoint&&(m.options=q(m.options||{}));return{data:Rb(a,m,""),url:k.replace(/^\//,"")}}
function Tb(a,b,c){var d=document.createElement("script");d.type="text/javascript";d.async=!0;d.src=a;H(d);a=document.getElementsByTagName("head");!a||1>a.length?"function"===typeof b&&b():(a[0].appendChild(d),"function"===typeof b&&Sa(d,"error",b),"function"===typeof c&&Sa(d,"load",c))}
...
null)},function(){F(u,k,ta(f));try{"function"===typeof this.remove?this.remove():this.parentNode.removeChild(this)}catch(m){}delete window[l]})}
function Vb(a,b,c,d,e,f,k){var l=Date.now(),h=sa,m=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");alert("request.responseType: "+m.responseType);m.responseType="arraybuffer";m.ontimeout=function(){F(u,h,ta(l));f(Error("Request timed out"),null,504)};m.onerror=function(a){f(Error(a.error||"Error in API: "+m.status),null,m.status)};m.onreadystatechange=function(){var a;if(4===m.readyState)if(F(u,h,ta(l)),200===m.status){if(k)alert("request.responseType2: "+m.getResponseHeader("content-type")),
a=m.response;else try{a=p(m.responseText)}catch(t){a={}}f(null,a,m.status)}else if(402===m.status)f(Error("Not enough credits to redeem."),null,m.status);else if("4"===m.status.toString().substring(0,1)||"5"===m.status.toString().substring(0,1))m.responseURL&&m.responseURL.includes("v2/event")?f(m.responseText,null,m.status):f(Error("Error in API: "+m.status),null,m.status)};try{m.open(d,b,!0),m.timeout=qa,m.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),m.send(c)}catch(n){e.set("use_jsonp",
!0),Ub(a,b,c,d,f)}}
function Wb(a,b,c,d,e){function f(){d.get("use_jsonp")||b.L?Ub(a,m,c,b.method,k):Vb(a,m,n,b.method,d,k,W)}function k(c,d,h){"function"===typeof a.aa&&a.aa(m,b.method,t,c,h,d);c&&0<y&&"5"===(h||"").toString().substring(0,1)?(y--,window.setTimeout(function(){f()},pa)):e(c,d)}sa="/v1/pageview"===b.endpoint&&c&&c.journey_displayed?b.endpoint+"-1-brtt":b.endpoint+"-brtt";("/v1/url"===b.endpoint||"/v1/has-app"===b.endpoint)&&1<Object.keys(u).length&&(delete u["-brtt"],c.instrumentation=q(B({},u)),u={});
if(v)for(var l=["browser_fingerprint_id","alternative_browser_fingerprint_id","identity_id","session_id"],h=0;h<l.length;h++)c.hasOwnProperty(l[h])&&delete c[l[h]];l=Sb(a,b,c);if(l.error)return e(Error(q({message:l.error,endpoint:b.endpoint,data:c})));var m,n="";"GET"===b.method?m=l.url+"?"+l.data:(m=l.url,n=l.data);var t;d.get("use_jsonp")||b.L?t=c:t=n;var y=oa;if(v&&xa(m,c))return wa?k(Error("Requested operation cannot be completed since tracking is disabled"),null,300):k(null,{},200);var W=!1;
"/v1/qr-code"===b.endpoint&&(W=!0);f()};function M(a){a&&a.parentNode.removeChild(a)}function Xb(a,b){a&&!a.className.match(new RegExp("(\\s|^)"+b+"(\\s|$)"))&&(a.className+=" "+b)}function Yb(a){var b=document.body;b&&b.className.match(new RegExp("(\\s|^)"+a+"(\\s|$)"))&&(b.className=b.className.replace(new RegExp("(\\s|^)"+a+"(\\s|$)")," "))}function Zb(a){var b=new Date;return b.setDate(b.getDate()+a)}
function $b(a){return document.body.currentStyle?document.body.currentStyle[Na(a)]:window.getComputedStyle(document.body).getPropertyValue(a)}
...
a.sa+"</button></form></div>")+"</div>";if(a.F){var d=document.createElement("iframe");d.src="about:blank";d.style.overflow="hidden";d.scrolling="no";d.id="branch-banner-iframe";d.className="branch-animation";H(d);document.body.appendChild(d);var e=C(),c='<html><head></head><body class="'+("ios"===e||"ipad"===e?"branch-banner-ios":"android"===e?"branch-banner-android":"branch-banner-desktop")+'"><div id="branch-banner" class="branch-animation">'+ec(a,c)+"</body></html>";d.contentWindow.document.open();
...
n.appendChild(t);h.style.opacity="0";l.style.opacity="0";m.style.opacity="0";setTimeout(function(){t.style.opacity="1"},20);l.value=""}function k(){h.removeAttribute("disabled");l.removeAttribute("disabled");h.style.opacity="1";l.style.opacity="1";m.style.opacity="0"}var l=a.getElementById("branch-sms-phone"),h=a.getElementById("branch-sms-send"),m=a.getElementById("branch-loader-wrapper"),n=a.getElementById("branch-sms-form-container"),t;if(l){var y=l.value;/^\d{7,}$/.test(y.replace(/[\s()+\-\.]|ext/gi,
""))?(N(b,"willSendBannerSMS"),h.setAttribute("disabled",""),l.setAttribute("disabled",""),h.style.opacity=".4",l.style.opacity=".4",m.style.opacity="1",l.className="",b.sendSMS(y,d,c,function(a){a?(N(b,"sendBannerSMSError"),e()):(N(b,"didSendBannerSMS"),f(),setTimeout(function(){n.removeChild(t);k()},3E3))})):e()}}
function hc(a,b,c,d){function e(a,c){"function"===typeof a&&(c=a,a={});a=a||{};"top"===b.position?k.style.top="-76px":"bottom"===b.position&&(k.style.bottom="-76px");"number"===typeof b.K?d.set("hideBanner",Zb(b.K),!0):d.set("hideBanner",!0,!0);a.Z?("top"===b.position?document.body.style.marginTop=m:"bottom"===b.position&&(document.body.style.marginBottom=t),Yb("branch-banner-is-active"),M(k),M(document.getElementById("branch-css")),c()):(setTimeout(function(){M(k);M(document.getElementById("branch-css"));
c()},270),setTimeout(function(){"top"===b.position?document.body.style.marginTop=m:"bottom"===b.position&&(document.body.style.marginBottom=t);Yb("branch-banner-is-active")},20))}function f(){"top"===b.position?k.style.top="0":"bottom"===b.position&&(k.style.bottom="0");N(a,"didShowBanner")}if(!bc(d,b))return N(a,"willNotShowBanner"),null;N(a,"willShowBanner");var k=fc(b,d);dc(b,k);c.channel=c.channel||"app banner";var l=b.F?k.contentWindow.document:document;if(C()){b.open_app=b.oa;b.append_deeplink_path=
...
m=document.body.style.marginTop,n=$b("margin-bottom"),t=document.body.style.marginBottom,y=l.getElementById("branch-banner-close");y&&(y.onclick=function(b){b.preventDefault();N(a,"willCloseBanner");e({},function(){N(a,"didCloseBanner")})});Xb(document.body,"branch-banner-is-active");"top"===b.position?document.body.style.marginTop=ac(h):"bottom"===b.position&&(document.body.style.marginBottom=ac(n));b.Z?f():setTimeout(f,20);return e};var ic={},jc,kc=1,O="top",lc="absolute",P="76px",mc=!1,nc=!1,Q=[],oc=!1,pc=window.innerHeight,qc=window.innerWidth;window.innerHeight<window.innerWidth&&(pc=window.innerWidth,qc=window.innerHeight);
var rc=0,sc=0,tc=!1,uc=/<script type="application\/json">((.|\s)*?)<\/script>/,vc=/<script type="text\/javascript">((.|\s)*?)<\/script>/,wc=/<style type="text\/css" id="branch-css">((.|\s)*?)<\/style>/,xc=/<style type="text\/css" id="branch-iframe-css">((.|\s)*?)<\/style>/,yc=/#branch-banner-spacer {((.|\s)*?)}/,zc=/margin-bottom: (.*?);/,R=null,Ac=null,Bc=!1,Cc=!1,Dc=!1,Ec=!1,Fc=!1,Gc="",Hc=[],S=null;function Ic(a){if(a=a.match(uc))return p(a[1])}
function Jc(a){var b=document.createElement("style");b.type="text/css";b.id="branch-iframe-css";rc=$b("margin-top");var c=+rc.slice(0,-2);sc=$b("margin-bottom");var d=+sc.slice(0,-2),e=+P.slice(0,-2);a||("top"===O?document.body.style.marginTop=(+e+c).toString()+"px":"bottom"===O&&(document.body.style.marginBottom=(+e+d).toString()+"px"));0<Q.length&&Q.forEach(function(a){var b,c=window.getComputedStyle(a);c&&(b=mc&&"fixed"===c.getPropertyValue("position"));b||(a.style.marginTop=P)});"top"===Gc&&Gc!==
O&&Fc&&Hc&&0<Hc.length&&Hc.forEach(function(a){a.style.marginTop=0});Fc=!1;Gc="";Hc=[];Ec=!1;a?b.innerHTML=a:b.innerHTML=Kc();H(b);document.head.appendChild(b)}
...
P+"; z-index: 99999; "+b+" }\n#branch-banner-iframe { position: "+lc+"; }\n@media only screen and (orientation: landscape) { body { "+("top"===O?"margin-top: ":"margin-bottom: ")+(mc?qc+"px":P)+"; }\n#branch-banner-iframe { height: "+(mc?qc+"px":P)+"; }")}
function Lc(a,b){Xb(document.body,"branch-banner-is-active");mc&&"fixed"===lc&&Xb(document.body,"branch-banner-no-scroll");setTimeout(function(){b?(a.style.top=null,a.style.bottom=null):"top"===O?a.style.top="0":"bottom"===O&&(S&&S.journey_link_data&&!S.journey_link_data.safeAreaRequired?a.style.bottom="0":(oc=!0,document.getElementById("branch-banner-iframe").style.transition="all 0s",Mc(!1,!0),window.addEventListener("resize",Nc),window.addEventListener("scroll",Oc)));N(R,"didShowJourney",S);Bc=
...
function Qc(a,b,c,d,e,f,k){var l=T;d&&e&&(Array.prototype.forEach.call(e.contentWindow.document.querySelectorAll("#branch-mobile-action"),function(a){a.addEventListener("click",function(){N(R,"didClickJourneyCTA",S);Ec=!0;d();Rc(e)})}),Sc(".branch-banner-continue","didClickJourneyContinue",c,e,a,b,f,k,l),Sc(".branch-banner-close","didClickJourneyClose",c,e,a,b,f,k,l))}
...
function Wc(a,b){var c={},d=Ua();d&&0<Object.keys(d).length&&(c.hosted_deeplink_data=d);c=a.I(Xc(null,c),null,R,!0);if(S&&S.journey_link_data){F(c,"journey_id",S.journey_link_data.journey_id);F(c,"journey_name",Vc(S.journey_link_data.journey_name));F(c,"view_id",S.journey_link_data.view_id);F(c,"view_name",Vc(S.journey_link_data.view_name));F(c,"channel",Vc(S.journey_link_data.channel));F(c,"campaign",Vc(S.journey_link_data.campaign));try{F(c,"tags",JSON.stringify(S.journey_link_data.tags))}catch(e){c.tags=
JSON.stringify([])}}F(c,"dismissal_source",b);return c}
function Tc(a,b,c,d,e,f,k,l){var h=k?0:Pc(f);N(R,a,S);Ec=!0;Rc(c);if(!k)if(void 0!==h&&b.set("globalJourneysDismiss",h,!0),Uc(b,d,e),f.dismissRedirect)window.location=f.dismissRedirect;else{var m=function(){R.removeListener(m);var b=Wc(l,ua[a]);R.b(Fb,b,function(a,c){!a&&"object"===typeof c&&c.template&&l.O(c,null,!1)&&l.J(c.template,b,b.branch_view_id||c.event_data.branch_view_data.id,c.event_data.branch_view_data,!1,c.journey_link_data)})};R.addListener("branch_internal_event_didCloseJourney",m)}}
function Xc(a,b){return B({url:a&&a.url||Ea(),user_agent:navigator.userAgent,language:navigator.language,screen_width:screen.width||-1,screen_height:screen.height||-1,window_device_pixel_ratio:window.devicePixelRatio||1},b||{})}
...
O&&(a.style.bottom="-"+P);N(R,"willCloseJourney",S);setTimeout(function(){M(a);M(document.getElementById("branch-css"));M(document.getElementById("branch-iframe-css"));M(document.getElementById("branch-journey-cta"));(!Cc||Ec)&&Q&&0<Q.length?Q.forEach(function(a){a.style.marginTop=0}):(Fc=Cc,Gc=O,Hc=Q);"top"===O?document.body.style.marginTop=rc:"bottom"===O&&(document.body.style.marginBottom=sc);Yb("branch-banner-is-active");Yb("branch-banner-no-scroll");oc&&(oc=!1,window.removeEventListener("resize",
Nc),window.removeEventListener("scroll",Oc));N(R,"didCloseJourney",S);b||N(R,"branch_internal_event_didCloseJourney",S);Bc=!1;setTimeout(function(){tc=!1},250)},Cc?0:270)}
function Yc(a){var b={banner_id:jc};if(a&&"object"===typeof a&&0<Object.keys(a).length){var c=["browser_fingerprint_id","app_id","source","open_app","link_click_id"];if(a&&"object"===typeof a&&!Array.isArray(a)&&0<Object.keys(a).length&&c&&Array.isArray(c)&&0<c.length)for(var d in a)a.hasOwnProperty(d)&&-1<c.indexOf(d)&&delete a[d];b.journey_link_data={};B(b.journey_link_data,a)}S=b}function Zc(){return ic&&R&&R.m&&R.m.data?R.m.data.$journeys_cta:!1}
function $c(){if(Zc())return R.m.data.$journeys_cta}function ad(a){try{if(Zc()&&0<$c().length)return a.replace(/validate[(].+[)];/g,'validate("'+$c()+'")').replace("window.top.location.replace(","window.top.location = ")}catch(b){}return a};var T={};
function bd(a,b){var c=b?"OPEN":"GET",d=a,e=Ic(d);e&&e.bannerHeight&&e.position&&e.sticky?(P=e.bannerHeight,O=e.position,lc=e.sticky):(d=d.match(yc))?(O="top",(d=d[1].match(zc))&&(P=d[1]),lc="absolute"):(O="bottom",lc="fixed");if(-1!==P.indexOf("vh")||-1!==P.indexOf("%"))d=P.indexOf("vh")?P.slice(0,-2):P.slice(0,-1),P=d/100*pc+"px",100>d?nc=!0:mc=!0;if(d=Ic(a)){var f;b&&d&&d.ctaText&&d.ctaText.has_app?f=d.ctaText.has_app:d&&d.ctaText&&d.ctaText.no_app&&(f=d.ctaText.no_app);c=f;Q=[];if(d&&d.injectorSelector&&
(f=document.querySelectorAll(d.injectorSelector)))for(d=0;d<f.length;d++)Q.push(f[d].parentElement)}f=(f=a.match(wc))?f[1]:void 0;if(d=a.match(vc))d=d[1],e=document.createElement("script"),e.id="branch-journey-cta",H(e),e.innerHTML=d,document.body.appendChild(e);d=(d=a.match(xc))?d[1]:void 0;var e=a,k=e.match(uc),l=e.match(vc),h=e.match(wc),m=e.match(xc);k&&(e=e.replace(uc,""));l&&(e=e.replace(vc,""));h&&(e=e.replace(wc,""));m&&(e=e.replace(xc,""));a=e;e=document.createElement("iframe");e.src="about:blank";
e.style.overflow="hidden";e.scrolling="no";e.id="branch-banner-iframe";e.className="branch-animation";e.title="Branch Banner";e.setAttribute("aria-label","Branch Banner");H(e);document.body.appendChild(e);k=C();k='<html><head></head><body class="'+("ios"===k||"ipad"===k?"branch-banner-ios":"android"===k?"branch-banner-android":"branch-banner-desktop")+'">'+a+"</body></html>";e.contentWindow.document.open();e.contentWindow.document.write(k);e.contentWindow.document.close();Jc(d);k=document.createElement("style");
k.type="text/css";k.id="branch-css";k.innerHTML=f;H(k);f=e.contentWindow.document;f.head.appendChild(k);if(nc||mc){var n=f.getElementsByClassName("branch-banner-content")[0];n&&(n.style.height=P)}"top"===O?e.style.top="-"+P:"bottom"===O&&(e.style.bottom="-"+P);try{var n=f.getElementsByClassName("branch-banner-content")[0],t=window.getComputedStyle(n).getPropertyValue("background-color").split(", ");t[3]&&!parseFloat(t[3])&&(e.style.boxShadow="none")}catch(y){}e.contentWindow.document.getElementById("branch-mobile-action").innerHTML=
c;N(R,"willShowJourney",S);Lc(e,d);return e}T.O=function(a,b,c){if(document.getElementById("branch-banner")||document.getElementById("branch-banner-iframe")||document.getElementById("branch-banner-container")||!C()||!a.event_data||!a.template)return!1;if(c)return!0;(a=!a.event_data.branch_view_data.id||b&&b.no_journeys)||(a=R,b=a.c.get("globalJourneysDismiss",!0),!0===b||b>Date.now()?a=!0:(a.c.remove("globalJourneysDismiss",!0),a=!1));return a?(T.Ba=1,!1):!0};
...
T.J=function(a,b,c,d,e,f){if(!tc){jc=c;Yc(f);var k=d.audience_rule_id;(f=document.getElementById("branch-iframe-css"))&&f.parentElement.removeChild(f);f=document.createElement("div");f.id="branch-banner";document.body.insertBefore(f,null);Xb(f,"branch-banner-is-active");var l=!1,h=b.callback_string,m=null,n=null,t=R.c;if(a){var y=Ic(a)||{};a=ad(a);var W=window.setTimeout(function(){window[h]=function(){}},qa);window[h]=function(a){window.clearTimeout(W);l||(n=a,Qc(c,k,t,n,m,y,e))};Ac=m=bd(a,b.has_app_websdk);
if(null===m){l=!0;return}Qc(c,k,t,n,m,y,e);ra&&(u["journey-load-time"]=(Date.now()-window.performance.timing.navigationStart).toString())}document.body.removeChild(f);v||e||T.ka(d)}};
T.I=function(a,b,c,d){R=c;b||(b={});a||(a={});Dc=b.disable_entry_animation||!1;Cc=b.disable_exit_animation||!1;var e=B({},c.m),f=L(c.c)||{},k=f.hasOwnProperty("has_app")?f.has_app:!1,l=c.c.get("journeyDismissals",!0),h=(b.user_language||Va()||"en").toLowerCase()||null,m=gb(U(c)),n;(n=b.branch_view_id)||(n="_branch_view_id".replace(/[\[\]]/g,"\\$&"),n=(n=(new RegExp("[?&]"+n+"(=([^&#]*)|&|#|$)")).exec(Ea()))&&n[2]?decodeURIComponent(n[2].replace(/\+/g," ")):"");n=n||null;c=b.make_new_link?null:Fa(U(c));
e.event=d?"dismiss":"pageview";e.metadata=a;e=F(e,"initial_referrer",m);e=F(e,"branch_view_id",n);e=F(e,"no_journeys",b.no_journeys);e=F(e,"is_iframe",x());e=F(e,"journey_dismissals",l);e.user_language=h;e.open_app=b.open_app||!1;e.has_app_websdk=k;e.feature="journeys";e.callback_string="branch_view_callback__"+kc++;e.data||(e.data={});e.data=B(Ua(),e.data);e.data=B(Da(f||{}),e.data);c&&(e.data.link_click_id=c);(a=f.data?p(f.data):null)&&a["+referrer"]&&(e.data["+referrer"]=a["+referrer"]);return e=
z(e)};var V={androidAppIndexingTagsPresent:!1,iosAppIndexingTagsPresent:!1,androidDetailsComplete:!1,iosDetailsComplete:!1},X={};function cd(a){var b;"android"===a&&V.androidDetailsComplete&&(b="android-app://"+X.androidPackageName+"/"+X.androidURL,b=dd(b),ed(b));"ios"===a&&V.iosDetailsComplete&&(b="ios-app://"+X.iosAppId+"/"+X.iosURL,b=dd(b),ed(b))}
function dd(a){var b={"~channel":"Firebase App Indexing","~feature":"Auto App Indexing",$canonical_url:Ea()};if("object"===typeof X.data)for(var c in X.data)X.data.hasOwnProperty(c)&&!b.hasOwnProperty(c)&&(b[c]=X.data[c]);return a+(-1<a.indexOf("?")?"&":"?")+"link_click_id=a-"+btoa(q(b))}function ed(a){var b=document.createElement("link");b.setAttribute("rel","alternate");b.setAttribute("href",a);document.head.appendChild(b)}
function fd(a){"android"===a&&"string"===typeof X.androidPackageName&&"string"===typeof X.androidURL&&(V.androidDetailsComplete=!0,cd("android"));"ios"===a&&"string"===typeof X.iosAppId&&"string"===typeof X.iosURL&&(V.iosDetailsComplete=!0,cd("ios"))}
...
d){d&&(d=l(d),v||(d=f(d),Ba(h.c,d,t)),h.o=3,d.data_parsed=d.data&&0!==d.data.length?p(d.data):{});if(b)return h.o=2,h.l||(h.l=1,h.s=b.message),a(b,d&&Ca(d));try{a(b,d&&Ca(d))}catch(nd){}finally{h.renderFinalize()}var e=ab(),k=G(c.metadata,"object")?c.metadata:null;k&&(k=hb(e.hosted_deeplink_data,k))&&0<Object.keys(k).length&&(e.hosted_deeplink_data=k);var n=T.I(Xc(c,e),c,h,!1);h.renderQueue(function(){h.b(Eb,n,function(a,b){if(!a&&"object"===typeof b){var d=n.branch_view_id?!0:!1;T.O(b,c,d)?T.J(b.template,
n,n.branch_view_id||b.event_data.branch_view_data.id,b.event_data.branch_view_data,d,b.journey_link_data):((b.auto_branchify||!m&&Ma("branchify_url")&&U(h))&&this.branch.deepview({},{make_new_link:!1,open_app:!0,auto_branchify:!0}),N(R,"willNotShowJourney"))}v&&(wa=!0)})})}function f(a){t&&(a.identity=h.g);return a}function k(a){var b={sdk:"2.57.1",branch_key:h.i},c=L(h.c)||{},d=L(h.c,!0)||{};d.browser_fingerprint_id&&(b._t=d.browser_fingerprint_id);Ka()||La()||h.b(kb,b,function(a,b){a&&(h.l=3,h.s=
a.message);b&&(c.browser_fingerprint_id=b)});h.b(zb,{browser_fingerprint_id:c.browser_fingerprint_id},function(b,d){b&&(h.l=4,h.s=b.message);b||!d||c.has_app||(c.has_app=!0,Ob(h.c,c),N(h,"didDownloadApp"));a&&a(null,c)})}function l(a){a.link_click_id&&(h.$=a.link_click_id.toString());a.session_id&&(h.H=a.session_id.toString());a.identity_id&&(h.j=a.identity_id.toString());a.identity&&(h.g=a.identity.toString());a.link&&(h.N=a.link);if(a.referring_link){var b=a.referring_link;a.referring_link=b?"http"!==
...
r=c&&c.nonce?c.nonce:r;v=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;wa=!1;v&&Aa(h);b=L(h.c,!0);h.j=b&&b.identity_id;b=L(h.c);var m=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,n=m||Ma("_branch_match_id")||Ga(),t=!h.j;h.C=!!h.c.get("branch_view_enabled");if(b&&b.session_id&&!n&&!Ma("branchify_url"))Ob(h.c,{data:""}),Ob(h.c,{referring_link:""}),d(),k(e);else{b={sdk:"2.57.1",branch_key:h.i};var y=L(h.c,!0)||{};y.browser_fingerprint_id&&(b._t=
y.browser_fingerprint_id);y.identity&&(h.g=y.identity);var W=parseInt(Ma("[?&]_open_delay_ms"),10);Ka()||La()?ib(function(){h.b(jb,{link_identifier:n,browser_fingerprint_id:n||y.browser_fingerprint_id,alternative_browser_fingerprint_id:y.browser_fingerprint_id,options:c,initial_referrer:gb(U(h)),current_url:x()&&Ha()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(h.l=2,h.s=a.message);a||"object"!==typeof b||(b.branch_view_enabled&&
(h.C=!!b.branch_view_enabled,h.c.set("branch_view_enabled",h.C)),n&&(b.click_id=n));d();e(a,b)})},W):h.b(kb,b,function(a,b){if(a)return h.l=3,h.s=a.message,e(a,null);ib(function(){h.b(jb,{link_identifier:n,browser_fingerprint_id:n||b,alternative_browser_fingerprint_id:y.browser_fingerprint_id,options:c,initial_referrer:gb(U(h)),current_url:x()&&Ha()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(h.l=2,h.s=a.message);a||
...
e(c.click_id)})})});Z.prototype.qrCode=Y(2,function(a,b,c){z(b).qr_code_settings=q(eb(c||{}));this.b(xb,z(b),function(b,c){return a(b||null,c||null)})});
...
Z.prototype.closeJourney=Y(1,function(a){var b=this;b.renderQueue(function(){if(Ac&&Bc)N(b,"didCallJourneyClose",S),Rc(Ac,!0);else return a("Journey already dismissed.")});a()});
...
Z:!!b.immediate,da:!!b.append_deeplink_path};"undefined"!==typeof b.showMobile&&(d.U=b.showMobile,d.P=b.showMobile,d.R=b.showMobile,d.T=b.showMobile,d.S=b.showMobile);c.data=B(Ua(),c.data);var e=this;e.renderQueue(function(){e.Y=hc(e,d,c,e.c)});a()});Z.prototype.closeBanner=Y(0,function(a){var b=this;b.renderQueue(function(){b.Y&&(N(b,"willCloseBanner"),b.Y(function(){N(b,"didCloseBanner")}))});a()});
Z.prototype.autoAppIndex=Y(1,function(a,b){b=b||{};var c=document.getElementsByTagName("link"),d=c.length;if(d)for(var e=0;e<d;e++){var f=c[e],k=f.href;k&&(k.includes("ios-app")&&(V.iosAppIndexingTagsPresent=!0,f.setAttribute("href",dd(k))),k.includes("android-app")&&(V.androidAppIndexingTagsPresent=!0,f.setAttribute("href",dd(k))))}X=b;V.androidAppIndexingTagsPresent||(fd("android"),V.androidDetailsComplete||gd("android"));V.iosAppIndexingTagsPresent||(fd("ios"),V.iosDetailsComplete||gd("ios"));
