...
var jb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/open",method:"POST",a:{browser_fingerprint_id:I(!1,1),alternative_browser_fingerprint_id:I(!1,1),identity_id:I(!1,1),link_identifier:I(!1,1),sdk:I(!1,1),options:I(!1,0),initial_referrer:I(!1,1),tracking_disabled:I(!1,4),current_url:I(!1,1),screen_height:I(!1,2),screen_width:I(!1,2)}},kb={destination:"https://app.stage.branch.io",endpoint:"/_r",method:"GET",L:!0,a:{sdk:I(!0,1),_t:I(!1,1),branch_key:I(!0,1)}},lb={destination:"",
endpoint:"",method:"GET",f:{link_url:I(!0,1)},a:{click:I(!0,1)}},mb={destination:"https://link.stage.branch.io",endpoint:"/c",method:"POST",f:{link_url:I(!0,1)},a:{sdk:I(!1,1),phone:I(!0,1)}},nb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/referralcode",method:"POST",a:J({amount:I(!0,2),bucket:I(!1,1),calculation_type:I(!0,2),creation_source:I(!0,2),expiration:I(!1,1),location:I(!0,2),prefix:I(!1,1),type:I(!0,1)})},ob={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/referralcode",
method:"POST",f:{code:I(!0,1)},a:J({})},pb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/applycode",method:"POST",f:{code:I(!0,1)},a:J({})},qb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/logout",method:"POST",a:J({session_id:I(!0,1)})},rb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/profile",method:"POST",a:J({identity_id:I(!0,1),identity:I(!0,1)})},sb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/referrals",method:"GET",
f:{identity_id:I(!0,1)},a:J({})},tb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/credithistory",method:"GET",a:J({begin_after_id:I(!1,1),bucket:I(!1,1),direction:I(!1,2),length:I(!1,2),link_click_id:I(!1,1)})},ub={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/credits",method:"GET",a:J({branch_key:I(!0,1),identity:I(!0,1)})},vb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/redeem",method:"POST",a:J({amount:I(!0,2),bucket:I(!0,1),identity_id:I(!0,
1)})},wb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/url",method:"POST",qa:"obj",a:J({alias:I(!1,1),campaign:I(!1,1),channel:I(!1,1),data:I(!1,1),feature:I(!1,1),identity_id:I(!0,1),stage:I(!1,1),tags:I(!1,3),type:I(!1,2),source:I(!1,1),instrumentation:I(!1,1)})},xb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/qr-code",method:"POST",qa:"obj",a:J({alias:I(!1,1),campaign:I(!1,1),channel:I(!1,1),data:I(!1,1),qr_code_settings:I(!1,1),feature:I(!1,1),identity_id:I(!0,
1),stage:I(!1,1),tags:I(!1,3),type:I(!1,2),source:I(!1,1)})},yb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/deepview",L:!0,method:"POST",a:J({campaign:I(!1,1),_t:I(!1,1),channel:I(!1,1),data:I(!0,1),feature:I(!1,1),link_click_id:I(!1,1),open_app:I(!1,4),append_deeplink_path:I(!1,4),stage:I(!1,1),tags:I(!1,3),deepview_type:I(!0,1),source:I(!0,1)})},zb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/has-app",method:"GET",a:{browser_fingerprint_id:I(!0,1),instrumentation:I(!1,
1)}},Ab={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/event",method:"POST",a:J({event:I(!0,1),metadata:I(!0,0),initial_referrer:I(!1,1),tracking_disabled:I(!1,4)})},Bb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/event",method:"POST",a:J({event:I(!0,1),metadata:I(!1,0),initial_referrer:I(!1,1),commerce_data:I(!0,0)})},Cb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v2/event/standard",method:"POST",a:{name:I(!0,1),user_data:I(!0,1),custom_data:I(!1,
1),event_data:I(!1,1),content_items:I(!1,1),customer_event_alias:I(!1,1)}},Db={destination:"https://instacart.api.beta.branch.io",endpoint:"/v2/event/custom",method:"POST",a:{name:I(!0,1),user_data:I(!0,1),custom_data:I(!1,1),event_data:I(!1,1),content_items:I(!1,1),customer_event_alias:I(!1,1)}},Eb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/pageview",method:"POST",a:J({event:I(!0,1),metadata:I(!1,0),initial_referrer:I(!1,1),tracking_disabled:I(!1,4),branch_view_id:I(!1,1),
no_journeys:I(!1,4),user_language:I(!1,1),open_app:I(!1,4),has_app_websdk:I(!1,4),source:I(!1,1),feature:I(!1,1),is_iframe:I(!1,4),data:I(!1,0),callback_string:I(!1,1),journey_displayed:I(!1,4),audience_rule_id:I(!1,1),journey_dismissals:I(!1,0),identity_id:I(!1,1)})},Fb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/dismiss",method:"POST",a:J({event:I(!0,1),metadata:I(!1,0),initial_referrer:I(!1,1),tracking_disabled:I(!1,4),branch_view_id:I(!1,1),no_journeys:I(!1,4),user_language:I(!1,
1),open_app:I(!1,4),has_app_websdk:I(!1,4),source:I(!1,1),feature:I(!1,1),is_iframe:I(!1,4),data:I(!1,0),callback_string:I(!1,1),journey_displayed:I(!1,4),audience_rule_id:I(!1,1),journey_dismissals:I(!1,0),dismissal_source:I(!1,1)})},Gb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/cpid",method:"POST",a:{user_data:I(!0,1)}},Ib={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/cpid/latd",method:"POST",a:{user_data:I(!0,1)}};function Jb(a){for(var b=0;b<a.length;b++){var c=this[a[b]],c="function"===typeof c?c():c;if(c.isEnabled())return c.A={},c}}function K(a){return"branch_session"===a||"branch_session_first"===a?a:"BRANCH_WEBSDK_KEY"+a}function Kb(a){return"true"===a?!0:"false"===a?!1:a}function Lb(a){return"branch_session"===a||"branch_session_first"===a||0===a.indexOf("BRANCH_WEBSDK_KEY")}function Mb(a){a=a.trim();var b=a.indexOf("=");return{name:a.substring(0,b),value:Kb(a.substring(b+1,a.length))}}
...
d(c,n)}catch(k){return{error:k.message}}"/v1/event"===b.endpoint&&(n.metadata=q(n.metadata||{}),n.hasOwnProperty("commerce_data")&&(n.commerce_data=q(n.commerce_data||{})));("/v1/pageview"===b.endpoint||"/v1/dismiss"===b.endpoint)&&n.metadata&&(n.metadata=q(n.metadata||{}));"/v1/open"===b.endpoint&&(n.options=q(n.options||{}));return{data:Sb(a,n,""),url:m.replace(/^\//,"")}}
...
{}}f(null,a,k.status)}else if(402===k.status)f(Error("Not enough credits to redeem."),null,k.status);else if("4"===k.status.toString().substring(0,1)||"5"===k.status.toString().substring(0,1))k.responseURL&&k.responseURL.includes("v2/event")?f(k.responseText,null,k.status):f(Error("Error in API: "+k.status),null,k.status)};try{k.open(d,b,!0),k.timeout=qa,k.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),k.send(c)}catch(t){e.set("use_jsonp",!0),Vb(a,b,c,d,f)}}
function Xb(a,b,c,d,e){function f(){d.get("use_jsonp")||b.L?Vb(a,n,c,b.method,m):Wb(a,n,k,b.method,d,m,T,Hb)}function m(c,d,h){"function"===typeof a.ba&&a.ba(n,b.method,t,c,h,d);c&&0<y&&"5"===(h||"").toString().substring(0,1)?(y--,window.setTimeout(function(){f()},pa)):e(c,d)}sa="/v1/pageview"===b.endpoint&&c&&c.journey_displayed?b.endpoint+"-1-brtt":b.endpoint+"-brtt";("/v1/url"===b.endpoint||"/v1/has-app"===b.endpoint)&&1<Object.keys(u).length&&(delete u["-brtt"],c.instrumentation=q(B({},u)),u=
{});if(v)for(var l=["browser_fingerprint_id","alternative_browser_fingerprint_id","identity_id","session_id"],h=0;h<l.length;h++)c.hasOwnProperty(l[h])&&delete c[l[h]];l=Tb(a,b,c);if(l.error)return e(Error(q({message:l.error,endpoint:b.endpoint,data:c})));var n,k="";"GET"===b.method?n=l.url+"?"+l.data:(n=l.url,k=l.data);var t;d.get("use_jsonp")||b.L?t=c:t=k;var y=oa;if(v&&xa(n,c))return wa?m(Error("Requested operation cannot be completed since tracking is disabled"),null,300):m(null,{},200);var T=
...
function jc(a,b,c,d){function e(a,c){"function"===typeof a&&(c=a,a={});a=a||{};"top"===b.position?f.style.top="-76px":"bottom"===b.position&&(f.style.bottom="-76px");"number"===typeof b.K?d.set("hideBanner",$b(b.K),!0):d.set("hideBanner",!0,!0);a.Z?("top"===b.position?document.body.style.marginTop=m:"bottom"===b.position&&(document.body.style.marginBottom=l),Zb("branch-banner-is-active"),M(f),M(document.getElementById("branch-css")),c()):(setTimeout(function(){M(f);M(document.getElementById("branch-css"));
c()},270),setTimeout(function(){"top"===b.position?document.body.style.marginTop=m:"bottom"===b.position&&(document.body.style.marginBottom=l);Zb("branch-banner-is-active")},20))}if(!cc(d,b))return N(a,"willNotShowBanner"),null;N(a,"willShowBanner");var f,m=document.body.style.marginTop,l=document.body.style.marginBottom;hc(b,d,function(d){function h(){"top"===b.position?f.style.top="0":"bottom"===b.position&&(f.style.bottom="0");N(a,"didShowBanner")}f=d;ec(b,f);c.channel=c.channel||"app banner";
...
function Kc(a){var b=Lc(a);b&&b.bannerHeight&&b.position&&b.sticky?(P=b.bannerHeight,O=b.position,nc=b.sticky):((a=a.match(Ac))?(O="top",(a=a[1].match(Bc))&&(P=a[1]),nc="absolute"):(O="bottom",nc="fixed"),"center_overlay"===b.type&&(P=b.bannerHeight));if(-1!==P.indexOf("vh")||-1!==P.indexOf("%"))b=P.indexOf("vh")?P.slice(0,-2):P.slice(0,-1),P=b/100*rc+"px",100>b?pc=!0:oc=!0}function Lc(a){if(a=a.match(wc))return p(a[1])}function Mc(a){if(a=a.match(zc))return a[1]}
...
function Tc(a,b){var c=document.createElement("style");c.type="text/css";c.id="branch-iframe-css";tc=ac("margin-top");var d=+tc.slice(0,-2);uc=ac("margin-bottom");var e=+uc.slice(0,-2),f=+P.slice(0,-2);a||("top"===O?document.body.style.marginTop=(+f+d).toString()+"px":"bottom"===O&&(document.body.style.marginBottom=(+f+e).toString()+"px"));0<Q.length&&Q.forEach(function(a){var b,c=window.getComputedStyle(a);c&&(b=oc&&"fixed"===c.getPropertyValue("position"));b||(a.style.marginTop=P)});"top"===Ic&&
...
function Vc(a,b,c){Yb(document.body,"branch-banner-is-active");if(oc&&"fixed"===nc){var d=document.createElement("style");d.type="text/css";d.innerHTML=".branch-banner-no-scroll {overflow: hidden;}";document.head.appendChild(d);Yb(document.body,"branch-banner-no-scroll")}setTimeout(function(){b?(a.style.top=null,a.style.bottom=null):"top"===O?a.style.top="0":"bottom"===O&&(S&&S.journey_link_data&&!S.journey_link_data.safeAreaRequired?(a.style.bottom="0","center_overlay"===c.type&&(a.style.bottom=
"140px",a.style.width="94%",a.style.borderRadius="20px",a.style.margin="auto")):(qc=!0,document.getElementById("branch-banner-iframe").style.transition="all 0s",Wc(!1,!0),window.addEventListener("resize",Xc),window.addEventListener("scroll",Yc)));N(R,"didShowJourney",S);Dc=!0},20)}function Xc(){qc&&Wc(!1,!1)}function Yc(){qc&&(window.pageYOffset>window.innerHeight?Wc(!0,!1):Wc(!1,!1))}
...
function $c(a,b,c,d,e,f,m){var l=U;d&&e&&(Array.prototype.forEach.call(e.contentWindow.document.querySelectorAll("#branch-mobile-action"),function(a){a.addEventListener("click",function(){N(R,"didClickJourneyCTA",S);Gc=!0;d();ad(e)})}),bd(".branch-banner-continue","didClickJourneyContinue",c,e,a,b,f,m,l),bd(".branch-banner-close","didClickJourneyClose",c,e,a,b,f,m,l))}
function bd(a,b,c,d,e,f,m,l,h){Array.prototype.forEach.call(d.contentWindow.document.querySelectorAll(a),function(a){a.addEventListener("click",function(){cd(b,c,d,e,f,m,l,h)})})}function dd(a,b,c){var d=a.get("journeyDismissals",!0),d=d?p(d):{};d[c]={view_id:b,dismiss_time:Date.now()};a.set("journeyDismissals",q(d),!0)}
...
function cd(a,b,c,d,e,f,m,l){var h=m?0:Zc(f);N(R,a,S);Gc=!0;ad(c);if(!m)if(void 0!==h&&b.set("globalJourneysDismiss",h,!0),dd(b,d,e),f.dismissRedirect)window.location=f.dismissRedirect;else{var n=function(){R.removeListener(n);var b=fd(l,ua[a]);R.b(Fb,b,function(a,c){!a&&"object"===typeof c&&c.template&&l.O(c,null,!1)&&l.J(c.template,b,b.branch_view_id||c.event_data.branch_view_data.id,c.event_data.branch_view_data,!1,c.journey_link_data)})};R.addListener("branch_internal_event_didCloseJourney",n)}}
...
function ld(a,b,c){var d=b?"OPEN":"GET";Kc(a);var e=Lc(a);e&&(d=Nc(e,b),Oc(e));var f=Pc(a);Qc(a);var m=Mc(a);a=Rc(a);var l=Sc();l.onload=function(){var b=a,n=C(),k=l.contentDocument||l.contentWindow.document;k.head=k.createElement("head");k.body=k.createElement("body");k.body.innerHTML=b;k.body.className="ios"===n||"ipad"===n?"branch-banner-ios":"android"===n?"branch-banner-android":"branch-banner-desktop";(b=k.querySelector('meta[name="accessibility"]'))&&"wcag"===b.content&&(b=k.createElement("script"),b.type=
...
k.querySelector("body").append(b));Tc(m,e);k=document.createElement("style");k.type="text/css";k.id="branch-css";k.innerHTML=f;H(k);b=l.contentWindow.document;b.head.appendChild(k);if(pc||oc){var t=b.getElementsByClassName("branch-banner-content")[0];t&&(t.style.height=P)}"top"===O?l.style.top="-"+P:"bottom"===O&&(l.style.bottom="-"+P);try{var t=b.getElementsByClassName("branch-banner-content")[0],y=window.getComputedStyle(t).getPropertyValue("background-color").split(", ");y[3]&&!parseFloat(y[3])&&
(l.style.boxShadow="none")}catch(T){}l.contentWindow.document.getElementById("branch-mobile-action").innerHTML=d;N(R,"willShowJourney",S);Vc(l,m,e);c(l)};document.body.appendChild(l)}
...
U.J=function(a,b,c,d,e,f){if(!vc){lc=c;hd(f);var m=d.audience_rule_id;(f=document.getElementById("branch-iframe-css"))&&f.parentElement.removeChild(f);var l=document.createElement("div");l.id="branch-banner";document.body.insertBefore(l,null);Yb(l,"branch-banner-is-active");var h=!1,n=b.callback_string,k=null,t=R.c;if(a){var y=Lc(a)||{};a=kd(a);var T=window.setTimeout(function(){window[n]=function(){}},qa);window[n]=function(a){window.clearTimeout(T);h||(k=a,$c(c,m,t,k,null,y,e))};ld(a,b.has_app_websdk,
function(a){Cc=a;null===a?h=!0:($c(c,m,t,k,a,y,e),ra&&(u["journey-load-time"]=(Date.now()-window.performance.timing.navigationStart).toString()),document.body.removeChild(l),v||e||U.$(d))})}else document.body.removeChild(l),v||e||U.$(d)}};
U.I=function(a,b,c,d){R=c;b||(b={});a||(a={});Fc=b.disable_entry_animation||!1;Ec=b.disable_exit_animation||!1;var e=B({},c.m),f=L(c.c)||{},m=f.hasOwnProperty("has_app")?f.has_app:!1,l=c.c.get("journeyDismissals",!0),h=(b.user_language||Va()||"en").toLowerCase()||null,n=gb(V(c)),k;(k=b.branch_view_id)||(k="_branch_view_id".replace(/[\[\]]/g,"\\$&"),k=(k=(new RegExp("[?&]"+k+"(=([^&#]*)|&|#|$)")).exec(Ea()))&&k[2]?decodeURIComponent(k[2].replace(/\+/g," ")):"");k=k||null;c=b.make_new_link?null:Fa(V(c));
e.event=d?"dismiss":"pageview";e.metadata=a;e=F(e,"initial_referrer",n);e=F(e,"branch_view_id",k);e=F(e,"no_journeys",b.no_journeys);e=F(e,"is_iframe",x());e=F(e,"journey_dismissals",l);e.user_language=h;e.open_app=b.open_app||!1;e.has_app_websdk=m;e.feature="journeys";e.callback_string="branch_view_callback__"+mc++;e.data||(e.data={});e.data=B(Ua(),e.data);e.data=B(Da(f||{}),e.data);c&&(e.data.link_click_id=c);(a=f.data?p(f.data):null)&&a["+referrer"]&&(e.data["+referrer"]=a["+referrer"]);return e=
...
d){d&&(d=l(d),v||(d=f(d),Ba(h.c,d,t)),h.o=3,d.data_parsed=d.data&&0!==d.data.length?p(d.data):{});if(b)return h.o=2,h.l||(h.l=1,h.s=b.message),a(b,d&&Ca(d));try{a(b,d&&Ca(d))}catch(xd){}finally{h.renderFinalize()}var e=ab(),k=G(c.metadata,"object")?c.metadata:null;k&&(k=hb(e.hosted_deeplink_data,k))&&0<Object.keys(k).length&&(e.hosted_deeplink_data=k);var m=U.I(gd(c,e),c,h,!1);h.renderQueue(function(){h.b(Eb,m,function(a,b){if(!a&&"object"===typeof b){var d=m.branch_view_id?!0:!1;U.O(b,c,d)?U.J(b.template,
m,m.branch_view_id||b.event_data.branch_view_data.id,b.event_data.branch_view_data,d,b.journey_link_data):((b.auto_branchify||!n&&Ma("branchify_url")&&V(h))&&this.branch.deepview({},{make_new_link:!1,open_app:!0,auto_branchify:!0}),N(R,"willNotShowJourney"))}v&&(wa=!0)})})}function f(a){t&&(a.identity=h.g);return a}function m(a){var b={sdk:"2.59.0",branch_key:h.i},c=L(h.c)||{},d=L(h.c,!0)||{};d.browser_fingerprint_id&&(b._t=d.browser_fingerprint_id);Ka()||La()||h.b(kb,b,function(a,b){a&&(h.l=3,h.s=
a.message);b&&(c.browser_fingerprint_id=b)});h.b(zb,{browser_fingerprint_id:c.browser_fingerprint_id},function(b,d){b&&(h.l=4,h.s=b.message);b||!d||c.has_app||(c.has_app=!0,Pb(h.c,c),N(h,"didDownloadApp"));a&&a(null,c)})}function l(a){a.link_click_id&&(h.aa=a.link_click_id.toString());a.session_id&&(h.H=a.session_id.toString());a.identity_id&&(h.j=a.identity_id.toString());a.identity&&(h.g=a.identity.toString());a.link&&(h.N=a.link);if(a.referring_link){var b=a.referring_link;a.referring_link=b?"http"!==
b.substring(0,4)?"https://link.stage.branch.io"+b:b:null}!a.click_id&&a.referring_link&&(a.click_id=Fa(a.referring_link));h.D=a.browser_fingerprint_id;return a}ra&&(u["init-began-at"]=(Date.now()-window.performance.timing.navigationStart).toString());var h=this;h.o=1;-1<b.indexOf("key_")?h.i=b:h.W=b;c=c&&G(c,"object")?c:{};oa=(h.G=c)&&c.retries&&Number.isInteger(c.retries)?c.retries:oa;pa=c&&c.retry_delay&&Number.isInteger(c.retry_delay)?c.retry_delay:pa;qa=c&&c.timeout&&Number.isInteger(c.timeout)?
c.timeout:qa;r=c&&c.nonce?c.nonce:r;v=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;wa=!1;v&&Aa(h);b=L(h.c,!0);h.j=b&&b.identity_id;b=L(h.c);var n=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,k=n||Ma("_branch_match_id")||Ga(),t=!h.j;h.C=!!h.c.get("branch_view_enabled");if(b&&b.session_id&&!k&&!Ma("branchify_url"))Pb(h.c,{data:""}),Pb(h.c,{referring_link:""}),d(),m(e);else{b={sdk:"2.59.0",branch_key:h.i};var y=L(h.c,!0)||{};y.browser_fingerprint_id&&
(b._t=y.browser_fingerprint_id);y.identity&&(h.g=y.identity);var T=parseInt(Ma("[?&]_open_delay_ms"),10);Ka()||La()?ib(function(){h.b(jb,{link_identifier:k,browser_fingerprint_id:k||y.browser_fingerprint_id,alternative_browser_fingerprint_id:y.browser_fingerprint_id,options:c,initial_referrer:gb(V(h)),current_url:x()&&Ha()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(h.l=2,h.s=a.message);a||"object"!==typeof b||(b.branch_view_enabled&&
(h.C=!!b.branch_view_enabled,h.c.set("branch_view_enabled",h.C)),k&&(b.click_id=k));d();e(a,b)})},T):h.b(kb,b,function(a,b){if(a)return h.l=3,h.s=a.message,e(a,null);ib(function(){h.b(jb,{link_identifier:k,browser_fingerprint_id:k||b,alternative_browser_fingerprint_id:y.browser_fingerprint_id,options:c,initial_referrer:gb(V(h)),current_url:x()&&Ha()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(h.l=2,h.s=a.message);a||
