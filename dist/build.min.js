...
function Ba(a){a&&(a.ha=null,a.N=null,a.H=null,a.A=null,a.g=null,a.D=null,a.u&&delete a.u,a.v&&delete a.v,a.c.remove("branch_view_enabled"),Ca(a.c,{},!0))}function w(a,b,c){a=a.replace(/\$(\d)/g,function(a,c){return b[parseInt(c,10)-1]});c&&(a+="\n Failure Code:"+c);return a}
...
method:"POST",a:K({amount:J(!0,2),bucket:J(!0,1),identity_id:J(!0,1)})},ub={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/url",method:"POST",Ba:"obj",a:K({alias:J(!1,1),campaign:J(!1,1),channel:J(!1,1),data:J(!1,1),feature:J(!1,1),identity_id:J(!0,1),stage:J(!1,1),tags:J(!1,3),type:J(!1,2),source:J(!1,1),instrumentation:J(!1,1)})},vb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/deepview",Z:!0,method:"POST",a:K({campaign:J(!1,1),_t:J(!1,1),channel:J(!1,
...
function Tb(a,b,c,d,e){function f(){d.get("use_jsonp")||b.Z?Rb(a,n,c,b.method,k):Sb(a,n,m,b.method,d,k)}function k(a,b,c){a&&0<t&&"5"===(c||"").toString().substring(0,1)?(t--,window.setTimeout(function(){f()},qa)):e(a,b)}ta="/v1/pageview"===b.endpoint&&c&&c.journey_displayed?b.endpoint+"-1-brtt":b.endpoint+"-brtt";("/v1/url"===b.endpoint||"/v1/has-app"===b.endpoint)&&1<Object.keys(u).length&&(delete u["-brtt"],c.instrumentation=q(z({},u)),u={});if(v)for(var l=["browser_fingerprint_id","alternative_browser_fingerprint_id",
...
d=document.createElement("style");d.type="text/css";d.id="branch-css";d.innerHTML=c;I(d);c=a.F?b.contentWindow.document:document;(c=c.head||c.getElementsByTagName("head")[0])&&"function"===typeof c.appendChild&&c.appendChild(d);"top"===a.position?b.style.top="-76px":"bottom"===a.position&&(b.style.bottom="-76px")};function bc(a,b){var c;if(a.B||a.M){if(a.B){c="";for(var d=0;5>d;d++)c+='<span class="star"><svg class="star" fill="#555555" height="12" viewBox="3 2 20 19" width="12"><path d="M22 9.24l-7.19-.62L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21 12 17.27 18.18 21l-1.63-7.03L22 9.24zM12 15.4l-3.76 2.27 1-4.28-3.32-2.88 4.38-.38L12 6.1l1.71 4.04 4.38.38-3.32 2.88 1 4.28L12 15.4z"/><path d="M0 0h24v24H0z" fill="none"/><foreignObject display="none"><span class="star">\u2606</span></foreignObject></svg>',a.B>d&&
...
m.appendChild(t);g.style.opacity="0";l.style.opacity="0";n.style.opacity="0";setTimeout(function(){t.style.opacity="1"},20);l.value=""}function k(){g.removeAttribute("disabled");l.removeAttribute("disabled");g.style.opacity="1";l.style.opacity="1";n.style.opacity="0"}var l=a.getElementById("branch-sms-phone"),g=a.getElementById("branch-sms-send"),n=a.getElementById("branch-loader-wrapper"),m=a.getElementById("branch-sms-form-container"),t;if(l){var A=l.value;/^\d{7,}$/.test(A.replace(/[\s()+\-\.]|ext/gi,
""))?(O(b,"willSendBannerSMS"),g.setAttribute("disabled",""),l.setAttribute("disabled",""),g.style.opacity=".4",l.style.opacity=".4",n.style.opacity="1",l.className="",b.sendSMS(A,d,c,function(a){a?(O(b,"sendBannerSMSError"),e()):(O(b,"didSendBannerSMS"),f(),setTimeout(function(){m.removeChild(t);k()},3E3))})):e()}}
function ec(a,b,c,d){function e(a,c){"function"===typeof a&&(c=a,a={});a=a||{};"top"===b.position?k.style.top="-76px":"bottom"===b.position&&(k.style.bottom="-76px");"number"===typeof b.L?d.set("hideBanner",Wb(b.L),!0):d.set("hideBanner",!0,!0);a.Y?("top"===b.position?document.body.style.marginTop=n:"bottom"===b.position&&(document.body.style.marginBottom=t),Vb("branch-banner-is-active"),N(k),N(document.getElementById("branch-css")),c()):(setTimeout(function(){N(k);N(document.getElementById("branch-css"));
c()},270),setTimeout(function(){"top"===b.position?document.body.style.marginTop=n:"bottom"===b.position&&(document.body.style.marginBottom=t);Vb("branch-banner-is-active")},20))}function f(){"top"===b.position?k.style.top="0":"bottom"===b.position&&(k.style.bottom="0");O(a,"didShowBanner")}if(!Zb(d,b))return O(a,"willNotShowBanner"),null;O(a,"willShowBanner");var k=cc(b,d);ac(b,k);c.channel=c.channel||"app banner";var l=b.F?k.contentWindow.document:document;if(B()){b.open_app=b.oa;b.append_deeplink_path=
...
n=document.body.style.marginTop,m=Xb("margin-bottom"),t=document.body.style.marginBottom,A=l.getElementById("branch-banner-close");A&&(A.onclick=function(b){b.preventDefault();O(a,"willCloseBanner");e({},function(){O(a,"didCloseBanner")})});Ub(document.body,"branch-banner-is-active");"top"===b.position?document.body.style.marginTop=Yb(g):"bottom"===b.position&&(document.body.style.marginBottom=Yb(m));b.Y?f():setTimeout(f,20);return e};var fc={},gc,hc=1,P="top",ic="absolute",Q="76px",jc=!1,kc=!1,R=[],lc=!1,mc=window.innerHeight,nc=window.innerWidth;window.innerHeight<window.innerWidth&&(mc=window.innerWidth,nc=window.innerHeight);
...
function Oc(a,b,c,d,e,f,k,l,g){Array.prototype.forEach.call(d.contentWindow.document.querySelectorAll(a),function(a){a.addEventListener("click",function(){Qc(b,c,d,e,f,k,l,g)})})}function Rc(a,b,c){var d=a.get("journeyDismissals",!0),d=d?p(d):{};d[c]={view_id:b,dismiss_time:Date.now()};a.set("journeyDismissals",q(d),!0)}
...
function Tc(a,b){var c={},d=D();d&&0<Object.keys(d).length&&(c.hosted_deeplink_data=d);c=a.J(Uc(null,c),null,S,!0);if(T&&T.journey_link_data){G(c,"journey_id",T.journey_link_data.journey_id);G(c,"journey_name",Sc(T.journey_link_data.journey_name));G(c,"view_id",T.journey_link_data.view_id);G(c,"view_name",Sc(T.journey_link_data.view_name));G(c,"channel",Sc(T.journey_link_data.channel));G(c,"campaign",Sc(T.journey_link_data.campaign));try{G(c,"tags",JSON.stringify(T.journey_link_data.tags))}catch(e){c.tags=
JSON.stringify([])}}G(c,"dismissal_source",b);return c}
function Qc(a,b,c,d,e,f,k,l){var g=k?0:Lc(f);O(S,a,T);Ac=!0;Nc(c);if(!k)if(void 0!==g&&b.set("globalJourneysDismiss",g,!0),Rc(b,d,e),f.dismissRedirect)window.location=f.dismissRedirect;else{var n=function(){S.removeListener(n);var b=Tc(l,va[a]);S.b(Cb,b,function(a,c){!a&&"object"===typeof c&&c.template&&l.O(c,null,!1)&&l.K(c.template,b,b.branch_view_id||c.event_data.branch_view_data.id,c.event_data.branch_view_data,!1,c.journey_link_data)})};S.addListener("branch_internal_event_didCloseJourney",n)}}
...
function Wc(a,b){var c=b?"OPEN":"GET",d=a,e=Ec(d);e&&e.bannerHeight&&e.position&&e.sticky?(Q=e.bannerHeight,P=e.position,ic=e.sticky):(d=d.match(uc))?(P="top",(d=d[1].match(vc))&&(Q=d[1]),ic="absolute"):(P="bottom",ic="fixed");if(-1!==Q.indexOf("vh")||-1!==Q.indexOf("%"))d=Q.indexOf("vh")?Q.slice(0,-2):Q.slice(0,-1),Q=d/100*mc+"px",100>d?kc=!0:jc=!0;if(d=Ec(a)){var f;b&&d&&d.ctaText&&d.ctaText.has_app?f=d.ctaText.has_app:d&&d.ctaText&&d.ctaText.no_app&&(f=d.ctaText.no_app);c=f;R=[];if(d&&d.injectorSelector&&
...
U.K=function(a,b,c,d,e,f){gc=c;Vc(f);var k=d.audience_rule_id;(f=document.getElementById("branch-iframe-css"))&&f.parentElement.removeChild(f);f=document.createElement("div");f.id="branch-banner";document.body.insertBefore(f,null);Ub(f,"branch-banner-is-active");var l=!1,g=b.callback_string,n=null,m=null,t=S.c;if(a){var A=Ec(a)||{},Pc=window.setTimeout(function(){window[g]=function(){}},ra);window[g]=function(a){window.clearTimeout(Pc);l||(m=a,Mc(c,k,t,m,n,A,e))};wc=n=Wc(a,b.has_app_websdk);if(null===
n){l=!0;return}Mc(c,k,t,m,n,A,e);sa&&(u["journey-load-time"]=(Date.now()-window.performance.timing.navigationStart).toString())}document.body.removeChild(f);v||e||U.ka(d)};
U.J=function(a,b,c,d){console.log("PAGEVIEW");S=c;b||(b={});a||(a={});zc=b.disable_entry_animation||!1;yc=b.disable_exit_animation||!1;var e=z({},c.j);console.log(e);var f=M(c.c)||{},k=f.hasOwnProperty("has_app")?f.has_app:!1,l=c.c.get("journeyDismissals",!0),g=(b.user_language||Va()||"en").toLowerCase()||null,n=fb(V(c)),m;(m=b.branch_view_id)||(m="_branch_view_id".replace(/[\[\]]/g,"\\$&"),m=(m=(new RegExp("[?&]"+m+"(=([^&#]*)|&|#|$)")).exec(Fa()))&&m[2]?decodeURIComponent(m[2].replace(/\+/g," ")):
"");m=m||null;c=b.make_new_link?null:Ha(V(c));e.event=d?"dismiss":"pageview";e.metadata=a;e=G(e,"initial_referrer",n);e=G(e,"branch_view_id",m);e=G(e,"no_journeys",b.no_journeys);e=G(e,"is_iframe",x());e=G(e,"journey_dismissals",l);e.user_language=g;e.open_app=b.open_app||!1;e.has_app_websdk=k;e.feature="journeys";e.callback_string="branch_view_callback__"+hc++;e.data||(e.data={});e.data=z(D(),e.data);e.data=z(Ea(f||{}),e.data);c&&(e.data.link_click_id=c);(a=f.data?JSON.parse(f.data):null)&&a["+referrer"]&&
(e.data["+referrer"]=a["+referrer"]);return e=Ga(e)};var W={androidAppIndexingTagsPresent:!1,iosAppIndexingTagsPresent:!1,androidDetailsComplete:!1,iosDetailsComplete:!1},X={};function Xc(a){var b;"android"===a&&W.androidDetailsComplete&&(b="android-app://"+X.androidPackageName+"/"+X.androidURL,b=Yc(b),Zc(b));"ios"===a&&W.iosDetailsComplete&&(b="ios-app://"+X.iosAppId+"/"+X.iosURL,b=Yc(b),Zc(b))}
function Yc(a){var b={"~channel":"Firebase App Indexing","~feature":"Auto App Indexing",$canonical_url:Fa()};if("object"===typeof X.data)for(var c in X.data)X.data.hasOwnProperty(c)&&!b.hasOwnProperty(c)&&(b[c]=X.data[c]);return a+(-1<a.indexOf("?")?"&":"?")+"link_click_id=a-"+btoa(q(b))}function Zc(a){var b=document.createElement("link");b.setAttribute("rel","alternate");b.setAttribute("href",a);document.head.appendChild(b)}
function $c(a){"android"===a&&"string"===typeof X.androidPackageName&&"string"===typeof X.androidURL&&(W.androidDetailsComplete=!0,Xc("android"));"ios"===a&&"string"===typeof X.iosAppId&&"string"===typeof X.iosURL&&(W.iosDetailsComplete=!0,Xc("ios"))}
function ad(a){for(var b=document.getElementsByTagName("meta"),c=0;c<b.length;c++){var d=b[c];"ios"===a&&"al:ios:app_store_id"===d.getAttribute("property")&&(X.iosAppId=d.getAttribute("content"));"ios"===a&&"al:ios:url"===d.getAttribute("property")&&(X.iosURL=d.getAttribute("content").replace("://","/"));"android"===a&&"al:android:package"===d.getAttribute("property")&&(X.androidPackageName=d.getAttribute("content"));"android"===a&&"al:android:url"===d.getAttribute("property")&&(X.androidURL=d.getAttribute("content").replace("://",
"/"))}$c(a)};var bd;
...
d.o)),null);if(0===d.m||!d.m)return g(Error(w("Branch SDK not initialized")),null)}e.unshift(g);b.apply(d,e)})}}function Z(){if(!(this instanceof Z))return bd||(bd=new Z),bd;this.aa=oa();this.c=new Fb(["session","cookie","pojo"]);this.da=new Nb;this.h=[];this.W="web2.52.6";this.l=this.m=0;this.o=null}
Z.prototype.b=function(a,b,c){this.V&&(b.app_id=this.V);this.i&&(b.branch_key=this.i);(a.a&&a.a.session_id||a.f&&a.f.session_id)&&this.H&&(b.session_id=this.H);(a.a&&a.a.identity_id||a.f&&a.f.identity_id)&&this.A&&(b.identity_id=this.A);0>a.endpoint.indexOf("/v1/")?(a.a&&a.a.developer_identity||a.f&&a.f.developer_identity)&&this.g&&(b.developer_identity=this.g):(a.a&&a.a.identity||a.f&&a.f.identity)&&this.g&&(b.identity=this.g);(a.a&&a.a.link_click_id||a.f&&a.f.link_click_id)&&this.$&&(b.link_click_id=
this.$);(a.a&&a.a.sdk||a.f&&a.f.sdk)&&this.W&&(b.sdk=this.W);(a.a&&a.a.browser_fingerprint_id||a.f&&a.f.browser_fingerprint_id)&&this.D&&(b.browser_fingerprint_id=this.D);v&&(b.tracking_disabled=v);return Tb(this.da,a,b,this.c,function(a,b){c(a,b)})};function V(a){var b=M(a.c);return(b=b&&b.referring_link)?b:(a=a.c.get("click_id"))?"https://bnc.lt/c/"+a:null}function O(a,b,c){for(var d=0;d<a.h.length;d++)a.h[d].event&&a.h[d].event!==b||a.h[d].listener(b,c)}
...
d){d&&(d=l(d),v||(d=f(d),Ca(g.c,d,t)),g.m=3,d.data_parsed=d.data&&0!==d.data.length?p(d.data):{});if(b)return g.m=2,g.l||(g.l=1,g.o=b.message),a(b,d&&Da(d));try{a(b,d&&Da(d))}catch(hd){}finally{g.renderFinalize()}var e=$a(),k=H(c.metadata,"object")?c.metadata:null;k&&(k=gb(e.hosted_deeplink_data,k))&&0<Object.keys(k).length&&(e.hosted_deeplink_data=k);var m=U.J(Uc(c,e),c,g,!1);g.renderQueue(function(){g.b(Bb,m,function(a,b){if(!a&&"object"===typeof b){var d=m.branch_view_id?!0:!1;U.O(b,c,d)?U.K(b.template,
m,m.branch_view_id||b.event_data.branch_view_data.id,b.event_data.branch_view_data,d,b.journey_link_data):((b.auto_branchify||!n&&Na("branchify_url")&&V(g))&&this.branch.deepview({},{make_new_link:!1,open_app:!0,auto_branchify:!0}),O(S,"willNotShowJourney"))}v&&(xa=!0)})})}function f(a){t&&(a.identity=g.g);return a}function k(a){var b={sdk:"2.52.6",branch_key:g.i},c=M(g.c)||{},d=M(g.c,!0)||{};d.browser_fingerprint_id&&(b._t=d.browser_fingerprint_id);Ma()||g.b(ib,b,function(a,b){a&&(g.l=3,g.o=a.message);
b&&(c.browser_fingerprint_id=b)});g.b(wb,{browser_fingerprint_id:c.browser_fingerprint_id},function(b,d){b&&(g.l=4,g.o=b.message);b||!d||c.has_app||(c.has_app=!0,Lb(g.c,c),O(g,"didDownloadApp"));a&&a(null,c)})}function l(a){a.link_click_id&&(g.$=a.link_click_id.toString());a.session_id&&(g.H=a.session_id.toString());a.identity_id&&(g.A=a.identity_id.toString());a.identity&&(g.g=a.identity.toString());a.link&&(g.N=a.link);if(a.referring_link){var b=a.referring_link;a.referring_link=b?"http"!==b.substring(0,
4)?"https://bnc.lt"+b:b:null}!a.click_id&&a.referring_link&&(a.click_id=Ha(a.referring_link));g.D=a.browser_fingerprint_id;return a}sa&&(u["init-began-at"]=(Date.now()-window.performance.timing.navigationStart).toString());var g=this;g.m=1;-1<b.indexOf("key_")?g.i=b:g.V=b;c=c&&H(c,"object")?c:{};pa=(g.G=c)&&c.retries&&Number.isInteger(c.retries)?c.retries:pa;qa=c&&c.retry_delay&&Number.isInteger(c.retry_delay)?c.retry_delay:qa;ra=c&&c.timeout&&Number.isInteger(c.timeout)?c.timeout:ra;r=c&&c.nonce?
c.nonce:r;v=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;xa=!1;v&&Ba(g);b=M(g.c);var n=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,m=n||Na("_branch_match_id")||Ia(),t=!b||!b.identity_id;g.C=!!g.c.get("branch_view_enabled");if(b&&b.session_id&&!m&&!Na("branchify_url"))Lb(g.c,{data:""}),Lb(g.c,{referring_link:""}),d(),k(e);else{b={sdk:"2.52.6",branch_key:g.i};var A=M(g.c,!0)||{};A.browser_fingerprint_id&&(b._t=A.browser_fingerprint_id);A.identity&&
...
Z.prototype.setIdentity=Y(2,function(a,b){var c=this;this.b(pb,{identity:b},function(d,e){d&&a(d);e=e||{};c.A=e.identity_id?e.identity_id.toString():null;c.N=e.link;c.g=b;e.developer_identity=b;e.referring_data_parsed=e.referring_data?p(e.referring_data):null;Mb(c.c,{identity:b});a(null,e)})});
Z.prototype.logout=Y(1,function(a){var b=this;this.b(ob,{},function(c,d){c&&a(c);d=d||{};d={data_parsed:null,data:null,referring_link:null,click_id:null,link_click_id:null,identity:d.identity,session_id:d.session_id,identity_id:d.identity_id,link:d.link,device_fingerprint_id:b.ha||null};b.N=d.link;b.H=d.session_id;b.A=d.identity_id;b.g=d.identity;Lb(b.c,d);a(null)})});Z.prototype.getBrowserFingerprintId=Y(2,function(a){var b=M(this.c,!0)||{};a(null,b.browser_fingerprint_id||null)});
...
Z.prototype.link=Y(2,function(a,b){var c=Ga(b),d=this.i;this.b(ub,c,function(b,f){if(b)return a(b,za(d,c));if(fc&&S&&S.j&&S.j.data.I&&S.j.data.I&&0<S.j.data.I.length)return a(null,S.j.data.I);a(null,f&&f.url)})});
...
Z.prototype.addListener=function(a,b){"function"===typeof a&&void 0===b&&(b=a,a=null);b&&this.h.push({listener:b,event:a||null})};Z.prototype.removeListener=function(a){a&&(this.h=this.h.filter(function(b){if(b.listener!==a)return b}))};function cd(a,b,c){c=c||{};try{a.j=p(q(c))}finally{a.j=a.j||{}}b()}Z.prototype.setBranchViewData=Y(1,function(a,b){cd.call(null,this,a,b)});
...
ia:!!b.disableHide,L:"number"===typeof b.forgetHide?b.forgetHide:!!b.forgetHide,qa:"undefined"===typeof b.respectDNT?!1:b.respectDNT,position:b.position||"top",fa:b.customCSS||"",ma:"undefined"===typeof b.mobileSticky?!1:b.mobileSticky,ga:"undefined"===typeof b.desktopSticky?!0:b.desktopSticky,wa:b.buttonBorderColor||"",ua:b.buttonBackgroundColor||"",ya:b.buttonFontColor||"",xa:b.buttonBorderColorHover||"",va:b.buttonBackgroundColorHover||"",za:b.buttonFontColorHover||"",la:!!b.make_new_link,oa:!!b.open_app,
Y:!!b.immediate,ca:!!b.append_deeplink_path};"undefined"!==typeof b.showMobile&&(d.U=b.showMobile,d.P=b.showMobile,d.R=b.showMobile,d.T=b.showMobile,d.S=b.showMobile);c.data=z(D(),c.data);var e=this;e.renderQueue(function(){e.X=ec(e,d,c,e.c)});a()});Z.prototype.closeBanner=Y(0,function(a){var b=this;b.renderQueue(function(){b.X&&(O(b,"willCloseBanner"),b.X(function(){O(b,"didCloseBanner")}))});a()});
Z.prototype.autoAppIndex=Y(1,function(a,b){b=b||{};var c=document.getElementsByTagName("link"),d=c.length;if(d)for(var e=0;e<d;e++){var f=c[e],k=f.href;k&&(k.includes("ios-app")&&(W.iosAppIndexingTagsPresent=!0,f.setAttribute("href",Yc(k))),k.includes("android-app")&&(W.androidAppIndexingTagsPresent=!0,f.setAttribute("href",Yc(k))))}X=b;W.androidAppIndexingTagsPresent||($c("android"),W.androidDetailsComplete||ad("android"));W.iosAppIndexingTagsPresent||($c("ios"),W.iosDetailsComplete||ad("ios"));
...
Z.prototype.disableTracking=Y(1,function(a,b){if(!1===b||"false"===b)xa=v=!1,this.i&&this.G&&(!0===this.G.tracking_disabled&&delete this.G.tracking_disabled,this.init(this.i,this.G));else if(void 0===b||!0===b||"true"===b)Ba(this),xa=v=!0,this.closeBanner(),this.closeJourney();a()});var dd=new Z;if(window.branch&&window.branch._q)for(var ed=window.branch._q,fd=0;fd<ed.length;fd++){var gd=ed[fd];dd[gd[0]].apply(dd,gd[1])}"function"===typeof define&&define.amd?define("branch",function(){return dd}):"object"===typeof exports&&(module.exports=dd);window&&(window.branch=dd);})();
