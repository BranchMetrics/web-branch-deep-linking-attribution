...
Z.prototype.link=Y(2,function(a,b){var c=Ga(b),c=Yc(b),d=this.i;this.b(ub,c,function(b,f){if(b)return a(b,za(d,c));if(Wc("$journeys_cta")&&0<Xc("$journeys_cta").length)return a(null,Xc("$journeys_cta"));a(null,f&&f.url)})});
