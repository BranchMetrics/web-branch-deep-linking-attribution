...
function fb(a){var b={},b=F(b,"http_origin",document.URL),b=F(b,"user_agent",navigator.userAgent),b=F(b,"language",Va()),b=F(b,"screen_width",screen.width||0),b=F(b,"screen_height",screen.height||0),b=F(b,"http_referrer",document.referrer),b=F(b,"browser_fingerprint_id",a.D),b=F(b,"developer_identity",a.g),b=F(b,"identity",a.g),b=F(b,"sdk","web");return b=F(b,"sdk_version","2.57.1")}function y(){return window.self!==window.top}
...
k.type="text/css";k.id="branch-css";k.innerHTML=f;H(k);f=e.contentWindow.document;f.head.appendChild(k);if(oc||nc){var m=f.getElementsByClassName("branch-banner-content")[0];m&&(m.style.height=P)}"top"===O?e.style.top="-"+P:"bottom"===O&&(e.style.bottom="-"+P);try{var m=f.getElementsByClassName("branch-banner-content")[0],t=window.getComputedStyle(m).getPropertyValue("background-color").split(", ");t[3]&&!parseFloat(t[3])&&(e.style.boxShadow="none")}catch(w){}e.contentWindow.document.getElementById("branch-mobile-action").innerHTML=
...
d.s)),null);if(0===d.o||!d.o)return h(Error(x("Branch SDK not initialized")),null)}e.unshift(h);b.apply(d,e)})}}function Z(){if(!(this instanceof Z))return id||(id=new Z),id;this.ba=na();this.c=new Jb(["session","cookie","pojo"]);this.V=new Rb;this.h=[];this.X="web2.57.1";this.l=this.o=0;this.s=null}
...
r=c&&c.nonce?c.nonce:r;v=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;wa=!1;v&&Aa(h);b=L(h.c,!0);h.j=b&&b.identity_id;b=L(h.c);var n=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,m=n||Ma("_branch_match_id")||Ga(),t=!h.j;h.C=!!h.c.get("branch_view_enabled");if(b&&b.session_id&&!m&&!Ma("branchify_url"))Pb(h.c,{data:""}),Pb(h.c,{referring_link:""}),d(),k(e);else{b={sdk:"2.57.1",branch_key:h.i};var w=L(h.c,!0)||{};w.browser_fingerprint_id&&(b._t=
...
e(c.click_id)})})});Z.prototype.qrCode=Y(2,function(a,b,c){z(b).qr_code_settings=q(eb(c||{}));this.b(xb,z(b),function(b,c){var d={};if(!b&&c){d.Da=c;try{d.va=btoa(String.fromCharCode.apply(null,new Uint8Array(c)))}catch(k){b=k}}return a(b||null,d||null)})});
