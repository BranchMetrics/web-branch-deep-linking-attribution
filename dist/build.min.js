...
function Aa(a){a&&(a.ia=null,a.N=null,a.H=null,a.j=null,a.h=null,a.D=null,a.v&&delete a.v,a.w&&delete a.w,a.c.remove("branch_view_enabled"),Ba(a.c,{},!0))}function x(a,b,c){a=a.replace(/\$(\d)/g,function(a,c){return b[parseInt(c,10)-1]});c&&(a+="\n Failure Code:"+c);return a}
...
function fb(a){var b={},b=F(b,"http_origin",document.URL),b=F(b,"user_agent",navigator.userAgent),b=F(b,"language",Va()),b=F(b,"screen_width",screen.width||0),b=F(b,"screen_height",screen.height||0),b=F(b,"http_referrer",document.referrer),b=F(b,"browser_fingerprint_id",a.D),b=F(b,"developer_identity",a.h),b=F(b,"identity",a.h),b=F(b,"sdk","web");return b=F(b,"sdk_version","2.57.1")}function y(){return window.self!==window.top}
...
function cc(a,b){var c=a.get("hideBanner",!0);if(b.sa&&navigator&&Number(navigator.doNotTrack))return!1;try{"string"===typeof c&&(c=p(c))}catch(e){c=!1}var c="number"===typeof c?new Date>=new Date(c):!c,d=b.K;"number"===typeof d&&(d=!1);return!document.getElementById("branch-banner")&&!document.getElementById("branch-banner-iframe")&&(c||d)&&(b.ua&&!C()||b.P&&"android"===C()||b.va&&"ipad"===C()||b.U&&"ios"===C()||b.R&&"blackberry"===C()||b.T&&"windows_phone"===C()||b.S&&"kindle"===C())};function dc(a,b){return"#branch-banner-iframe { position: "+("top"!==b||a?"fixed":"absolute")+"; }\n"}
...
function gc(a,b){var c='<div id="branch-sms-form-container">'+(C()?'<a id="branch-mobile-action" class="button" href="#" target="_parent">'+((L(b)||{}).has_app?a.oa:a.ka)+"</a>":'<div class="branch-icon-wrapper" id="branch-loader-wrapper" style="opacity: 0;"><div id="branch-spinner"></div></div><div id="branch-sms-block"><form id="sms-form"><input type="phone" aria-label="Enter phone number" class="branch-animation" name="branch-sms-phone" id="branch-sms-phone" placeholder="'+a.qa+'"><button type="submit" id="branch-sms-send" class="branch-animation button">'+
...
c()},270),setTimeout(function(){"top"===b.position?document.body.style.marginTop=n:"bottom"===b.position&&(document.body.style.marginBottom=t);Zb("branch-banner-is-active")},20))}function f(){"top"===b.position?k.style.top="0":"bottom"===b.position&&(k.style.bottom="0");N(a,"didShowBanner")}if(!cc(d,b))return N(a,"willNotShowBanner"),null;N(a,"willShowBanner");var k=gc(b,d);ec(b,k);c.channel=c.channel||"app banner";var m=b.F?k.contentWindow.document:document;if(C()){b.open_app=b.pa;b.append_deeplink_path=
b.ea;b.make_new_link=b.ma;b.deepview_type="banner";a.deepview(c,b);var h=m.getElementById("branch-mobile-action");h&&(h.onclick=function(b){b.preventDefault();a.deepviewCta()})}else m.getElementById("sms-form")?m.getElementById("sms-form").addEventListener("submit",function(d){d.preventDefault();hc(m,a,b,c)}):k.onload=function(){m=k.contentWindow.document;m.getElementById("sms-form")&&m.getElementById("sms-form").addEventListener("submit",function(d){d.preventDefault();hc(m,a,b,c)})};var h=ac("margin-top"),
...
T.la=function(a){R.b(Eb,{event:"pageview",journey_displayed:!0,audience_rule_id:a.audience_rule_id,branch_view_id:a.branch_view_id},function(){})};
...
if(null===n){m=!0;return}Rc(c,k,t,l,n,w,e);ra&&(u["journey-load-time"]=(Date.now()-window.performance.timing.navigationStart).toString())}document.body.removeChild(f);v||e||T.la(d)}};
...
d.s)),null);if(0===d.o||!d.o)return h(Error(x("Branch SDK not initialized")),null)}e.unshift(h);b.apply(d,e)})}}function Z(){if(!(this instanceof Z))return id||(id=new Z),id;this.ca=na();this.c=new Jb(["session","cookie","pojo"]);this.V=new Rb;this.g=[];this.X="web2.57.1";this.l=this.o=0;this.s=null}
Z.prototype.b=function(a,b,c){this.W&&(b.app_id=this.W);this.i&&(b.branch_key=this.i);(a.a&&a.a.session_id||a.f&&a.f.session_id)&&this.H&&(b.session_id=this.H);(a.a&&a.a.identity_id||a.f&&a.f.identity_id)&&this.j&&(b.identity_id=this.j);0>a.endpoint.indexOf("/v1/")?(a.a&&a.a.developer_identity||a.f&&a.f.developer_identity)&&this.h&&(b.developer_identity=this.h):(a.a&&a.a.identity||a.f&&a.f.identity)&&this.h&&(b.identity=this.h);(a.a&&a.a.link_click_id||a.f&&a.f.link_click_id)&&this.$&&(b.link_click_id=
this.$);(a.a&&a.a.sdk||a.f&&a.f.sdk)&&this.X&&(b.sdk=this.X);(a.a&&a.a.browser_fingerprint_id||a.f&&a.f.browser_fingerprint_id)&&this.D&&(b.browser_fingerprint_id=this.D);v&&(b.tracking_disabled=v);return Xb(this.V,a,b,this.c,function(a,b){c(a,b)})};function U(a){var b=L(a.c);return(b=b&&b.referring_link)?b:(a=a.c.get("click_id"))?"https://bnc.lt/c/"+a:null}function N(a,b,c){for(var d=0;d<a.g.length;d++)a.g[d].event&&a.g[d].event!==b||a.g[d].listener(b,c)}
...
l,l.branch_view_id||b.event_data.branch_view_data.id,b.event_data.branch_view_data,d,b.journey_link_data):((b.auto_branchify||!n&&Ma("branchify_url")&&U(h))&&this.branch.deepview({},{make_new_link:!1,open_app:!0,auto_branchify:!0}),N(R,"willNotShowJourney"))}v&&(wa=!0)})})}function f(a){t&&(a.identity=h.h);return a}function k(a){var b={sdk:"2.57.1",branch_key:h.i},c=L(h.c)||{},d=L(h.c,!0)||{};d.browser_fingerprint_id&&(b._t=d.browser_fingerprint_id);Ka()||La()||h.b(kb,b,function(a,b){a&&(h.l=3,h.s=
a.message);b&&(c.browser_fingerprint_id=b)});h.b(zb,{browser_fingerprint_id:c.browser_fingerprint_id},function(b,d){b&&(h.l=4,h.s=b.message);b||!d||c.has_app||(c.has_app=!0,Pb(h.c,c),N(h,"didDownloadApp"));a&&a(null,c)})}function m(a){a.link_click_id&&(h.$=a.link_click_id.toString());a.session_id&&(h.H=a.session_id.toString());a.identity_id&&(h.j=a.identity_id.toString());a.identity&&(h.h=a.identity.toString());a.link&&(h.N=a.link);if(a.referring_link){var b=a.referring_link;a.referring_link=b?"http"!==
...
r=c&&c.nonce?c.nonce:r;v=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;wa=!1;v&&Aa(h);b=L(h.c,!0);h.j=b&&b.identity_id;b=L(h.c);var n=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,l=n||Ma("_branch_match_id")||Ga(),t=!h.j;h.C=!!h.c.get("branch_view_enabled");if(b&&b.session_id&&!l&&!Ma("branchify_url"))Pb(h.c,{data:""}),Pb(h.c,{referring_link:""}),d(),k(e);else{b={sdk:"2.57.1",branch_key:h.i};var w=L(h.c,!0)||{};w.browser_fingerprint_id&&(b._t=
w.browser_fingerprint_id);w.identity&&(h.h=w.identity);var W=parseInt(Ma("[?&]_open_delay_ms"),10);Ka()||La()?ib(function(){h.b(jb,{link_identifier:l,browser_fingerprint_id:l||w.browser_fingerprint_id,alternative_browser_fingerprint_id:w.browser_fingerprint_id,options:c,initial_referrer:gb(U(h)),current_url:y()&&Ha()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(h.l=2,h.s=a.message);a||"object"!==typeof b||(b.branch_view_enabled&&
...
Z.prototype.setIdentity=Y(2,function(a,b){var c=this;this.b(rb,{identity:b},function(d,e){d&&a(d);e=e||{};c.j=e.identity_id?e.identity_id.toString():null;c.N=e.link;c.h=b;e.developer_identity=b;e.referring_data_parsed=e.referring_data?p(e.referring_data):null;Qb(c.c,{identity:b,identity_id:c.j});a(null,e)})});
Z.prototype.logout=Y(1,function(a){var b=this;this.b(qb,{},function(c,d){c&&a(c);d=d||{};d={data_parsed:null,data:null,referring_link:null,click_id:null,link_click_id:null,identity:null,session_id:d.session_id,identity_id:d.identity_id,link:d.link,device_fingerprint_id:b.ia||null};b.N=d.link;b.H=d.session_id;b.j=d.identity_id;b.h=null;Qb(b.c,d,!0);a(null)})});Z.prototype.getBrowserFingerprintId=Y(2,function(a){var b=L(this.c,!0)||{};a(null,b.browser_fingerprint_id||null)});
...
e(c.click_id)})})});Z.prototype.qrCode=Y(2,function(a,b,c){z(b).qr_code_settings=q(eb(c||{}));this.b(xb,z(b),function(b,c){function d(){}d.ba=c;d.g=function(){if(this.ba)return btoa(String.fromCharCode.apply(null,new Uint8Array(this.ba)));throw Error("QrCode.rawBuffer is empty.");};return a(b||null,d||null)})});
...
Z.prototype.getCode=Y(2,function(a,b){b.type="credit";b.creation_source=b.creation_source||2;this.b(nb,b,a)});Z.prototype.validateCode=Y(1,function(a,b){this.b(ob,{code:b},a)});Z.prototype.applyCode=Y(1,function(a,b){this.b(pb,{code:b},a)});Z.prototype.credits=Y(2,function(a){this.b(ub,{branch_key:this.i,identity:this.h},a)});Z.prototype.creditHistory=Y(2,function(a,b){this.b(tb,b||{},a)});Z.prototype.redeem=Y(1,function(a,b,c){this.b(vb,{amount:b,bucket:c},function(b){a(b||null)})});
Z.prototype.addListener=function(a,b){"function"===typeof a&&void 0===b&&(b=a,a=null);b&&this.g.push({listener:b,event:a||null})};Z.prototype.removeListener=function(a){a&&(this.g=this.g.filter(function(b){if(b.listener!==a)return b}))};function jd(a,b,c){c=c||{};try{a.m=p(q(c))}finally{a.m=a.m||{}}b()}Z.prototype.setBranchViewData=Y(1,function(a,b){jd.call(null,this,a,b)},!0);
...
Z.prototype.banner=Y(1,function(a,b,c){c=c||{};jd.call(null,this,function(){},c);"undefined"===typeof b.showAgain&&"undefined"!==typeof b.forgetHide&&(b.showAgain=b.forgetHide);var d={icon:E(b.icon)||"",title:E(b.title)||"",description:E(b.description)||"",M:"number"===typeof b.reviewCount&&0<b.reviewCount?Math.floor(b.reviewCount):null,B:"number"===typeof b.rating&&5>=b.rating&&0<b.rating?Math.round(2*b.rating)/2:null,oa:E(b.openAppButtonText)||"View in app",ka:E(b.downloadAppButtonText)||"Download App",
ta:E(b.sendLinkText)||"Send Link",qa:E(b.phonePreviewText)||"(999) 999-9999",F:"undefined"===typeof b.iframe?!0:b.iframe,U:"undefined"===typeof b.showiOS?!0:b.showiOS,va:"undefined"===typeof b.showiPad?!0:b.showiPad,P:"undefined"===typeof b.showAndroid?!0:b.showAndroid,R:"undefined"===typeof b.showBlackberry?!0:b.showBlackberry,T:"undefined"===typeof b.showWindowsPhone?!0:b.showWindowsPhone,S:"undefined"===typeof b.showKindle?!0:b.showKindle,ua:"undefined"===typeof b.showDesktop?!0:b.showDesktop,
ja:!!b.disableHide,K:"number"===typeof b.forgetHide?b.forgetHide:!!b.forgetHide,sa:"undefined"===typeof b.respectDNT?!1:b.respectDNT,position:b.position||"top",ga:b.customCSS||"",na:"undefined"===typeof b.mobileSticky?!1:b.mobileSticky,ha:"undefined"===typeof b.desktopSticky?!0:b.desktopSticky,ya:b.buttonBorderColor||"",wa:b.buttonBackgroundColor||"",Aa:b.buttonFontColor||"",za:b.buttonBorderColorHover||"",xa:b.buttonBackgroundColorHover||"",Ba:b.buttonFontColorHover||"",ma:!!b.make_new_link,pa:!!b.open_app,
