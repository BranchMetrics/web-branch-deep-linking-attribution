...
function Uc(a,b,c,d,e,f,m,k){var g=m?0:Qc(f);P(U,a,V);xc=!0;Sc(c);if(!m){void 0!==g&&b.set("globalJourneysDismiss",g,!0);Vc(b,d,e);var n=function(){U.removeListener(n);var l=Xc(k,qa[a]);U.i(xb,l,function(p,u){!p&&f.dismissRedirect?window.location=f.dismissRedirect:!p&&"object"===typeof u&&u.template&&k.U(u,null,!1)&&k.O(u.template,l,l.branch_view_id||u.event_data.branch_view_data.id,u.event_data.branch_view_data,!1,u.journey_link_data)})};U.addListener("branch_internal_event_didCloseJourney",n)}}
