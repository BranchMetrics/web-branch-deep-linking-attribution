...
function Ea(a){a&&(a.Ia=null,a.ia=null,a.J=null,a.v=null,a.m=null,a.L=null,a.F&&delete a.F,a.G&&delete a.G,a.g.remove("branch_view_enabled"),Fa(a.g,{},!0))}function A(a,b,c){a=a.replace(/\$(\d)/g,function(d,e){return b[parseInt(e,10)-1]});c&&(a+="\n Failure Code:"+c);na&&console&&console.log(a);return a}
...
function lb(a){var b={};b=G(b,"http_origin",document.URL);b=G(b,"user_agent",navigator.userAgent);b=G(b,"language",$a());b=G(b,"screen_width",screen.width||0);b=G(b,"screen_height",screen.height||0);b=G(b,"http_referrer",document.referrer);b=G(b,"browser_fingerprint_id",a.L);b=G(b,"developer_identity",a.m);b=G(b,"identity",a.m);b=G(b,"sdk","web");b=G(b,"sdk_version","2.84.0");b=mb(b,"model",y?y.model:"");return b=mb(b,"os_version",y?y.platformVersion:"")}
...
endpoint:"/v1/url",method:"POST",ua:"obj",h:tb({alias:K(!1,1),campaign:K(!1,1),channel:K(!1,1),data:K(!1,1),feature:K(!1,1),identity_id:K(!0,1),stage:K(!1,1),tags:K(!1,3),type:K(!1,2),source:K(!1,1),instrumentation:K(!1,1)})},xb={destination:t,endpoint:"/v1/qr-code",method:"POST",ua:"obj",h:tb({alias:K(!1,1),campaign:K(!1,1),channel:K(!1,1),data:K(!1,1),qr_code_settings:K(!1,1),feature:K(!1,1),identity_id:K(!0,1),stage:K(!1,1),tags:K(!1,3),type:K(!1,2),source:K(!1,1)})},yb={destination:t,endpoint:"/v1/deepview",
...
g=b.M?f.contentWindow.document:document;if(!["other","desktop"].includes(F())){b.open_app=b.ta;b.append_deeplink_path=b.la;b.make_new_link=b.qa;b.deepview_type="banner";a.deepview(c,b);var l=g.getElementById("branch-mobile-action");l&&(l.onclick=function(q){q.preventDefault();a.deepviewCta()})}l=Ub("margin-top");var p=Ub("margin-bottom");Rb(document.body,"branch-banner-is-active");"top"===b.position?document.body.style.marginTop=Vb(l):"bottom"===b.position&&(document.body.style.marginBottom=Vb(p));
...
function Sc(){var a="",b="";document.body.style.transition="";document.getElementById("branch-banner-iframe")&&(document.getElementById("branch-banner-iframe").style.transition="");Dc||(a="body { -webkit-transition: all 0.375s ease; }\n",document.body.style.transition="all 00.375s ease",b="-webkit-transition: all 0.25s ease; transition: all 00.25s ease;");a=a||"";if(ic){var c=R,d=fc.xa,e=Q;"overlay"===jc&&(d=c="100%!important",e="fixed");a=a+("#branch-banner-iframe-embed { z-index: 99999!important; height: "+
...
function X(a,b,c){return function(){var d=this,e=arguments[arguments.length-1];if(0===a||"function"!==typeof e){var f=function(){};var m=Array.prototype.slice.call(arguments)}else m=Array.prototype.slice.call(arguments,0,arguments.length-1)||[],f=e;d.ja(function(k){function g(u,l){try{if(u&&0===a)throw u;1===a?f(u):2===a&&f(u,l)}finally{k()}}if(!c){if(1===d.A)return g(Error(A("Branch SDK initialization pending and a Branch method was called outside of the queue order")),null);if(2===d.A)return g(Error(A("Branch SDK initialization failed, so further methods cannot be called",d.B,
d.D)),null);if(0===d.A||!d.A)return g(Error(A("Branch SDK not initialized")),null)}m.unshift(g);b.apply(d,m)})}}function Z(){if(!(this instanceof Z))return kd||(kd=new Z),kd;this.ja=ec();this.g=new Fb;this.$=new Lb;this.u=[];this.ca="web2.84.0";this.l={};this.B=this.A=0;this.D=null}
...
H.branch_view_id||S.event_data.branch_view_data.id,S.event_data.branch_view_data,E,S.journey_link_data):((S.auto_branchify||!u&&Ra("branchify_url")&&W(g))&&this.branch.deepview({},{make_new_link:!1,open_app:!0,auto_branchify:!0}),O(T,"willNotShowJourney")));z&&(Aa=!0)})})}function f(n){p&&(n.identity=g.m);return n}function m(n){var r={sdk:"2.84.0",branch_key:g.o},H=N(g.g)||{},E=N(g.g,!0)||{};E.browser_fingerprint_id&&(r._t=E.browser_fingerprint_id);Pa()||Qa()||g.j(vb,r,function(S,ac){S&&(g.B=3,g.D=
S.message);ac&&(H.browser_fingerprint_id=ac)});n&&n(null,H)}function k(n){n.link_click_id&&(g.fa=n.link_click_id.toString());n.session_link_click_id&&(g.Ja=n.session_link_click_id.toString());n.session_id&&(g.J=n.session_id.toString());n.identity_id&&(g.v=n.identity_id.toString());n.identity&&(g.m=n.identity.toString());n.link&&(g.ia=n.link);if(n.referring_link){var r=n.referring_link;n.referring_link=r?"http"!==r.substring(0,4)?"https://bnc.lt"+r:r:null}!n.click_id&&n.referring_link&&(n.click_id=
...
Z.prototype.renderQueue=X(0,function(a,b){this.ka?b():(this.C=this.C||[],this.C.push(b));a(null,null)});Z.prototype.renderFinalize=X(2,function(a){this.C&&0<this.C.length&&(this.C.forEach(function(b){b.call(this)}),delete this.C);this.ka=!0;a(null,null)});Z.prototype.data=X(2,function(a){var b=Ga(N(this.g));b.referring_link=W(this);b.data_parsed=b.data&&0!==b.data.length?v(b.data):{};a(null,b)});Z.prototype.first=X(2,function(a){a(null,Ga(N(this.g,!0)))});
Z.prototype.setIdentity=X(2,function(a,b){if(b){var c={v:this.v,J:this.J,link:this.ia,Ha:b};this.m=b;Zb(this.g,{identity:b});a(null,c)}else a(Error(A("setIdentity - required argument identity should have a non-null value")))});Z.prototype.logout=X(1,function(a){this.m=null;Zb(this.g,{identity:null},!0);a(null)});Z.prototype.getBrowserFingerprintId=X(2,function(a){var b=N(this.g,!0)||{};a(null,b.browser_fingerprint_id||null)});
...
function(f){return a(f||null)})});Z.prototype.link=X(2,function(a,b){var c=Ja(b),d=this.o;this.j(wb,c,function(e,f){if(e)return a(e,Ca(d,c));a(null,f&&f.url)})});Z.prototype.qrCode=X(2,function(a,b,c){Ja(b).qr_code_settings=w(kb(c||{}));this.j(xb,Ja(b),(d,e)=>d?a(d,null):a(null,{ha:e,ya(){if(!this.ha)throw Error("QrCode.rawBuffer is empty.");const f=Array.from(new Uint8Array(this.ha)).map(m=>String.fromCharCode(m)).join("");return btoa(f)}}))});
