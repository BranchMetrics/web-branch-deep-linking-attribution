...
function Zb(a,b){var c=a.get("hideBanner",!0);if(b.ra&&navigator&&Number(navigator.doNotTrack))return!1;try{"string"===typeof c&&(c=p(c))}catch(e){c=!1}var c="number"===typeof c?new Date>=new Date(c):!c,d=b.K;"number"===typeof d&&(d=!1);return!document.getElementById("branch-banner")&&!document.getElementById("branch-banner-iframe")&&(c||d)&&(b.ta&&!B()||b.O&&"android"===B()||b.ua&&"ipad"===B()||b.T&&"ios"===B()||b.P&&"blackberry"===B()||b.S&&"windows_phone"===B()||b.R&&"kindle"===B())};function $b(a,b){return"#branch-banner-iframe { position: "+("top"!==b||a?"fixed":"absolute")+"; }\n"}
...
function cc(a,b){var c='<div id="branch-sms-form-container">'+(B()?'<a id="branch-mobile-action" class="button" href="#" target="_parent">'+((M(b)||{}).has_app?a.oa:a.ja)+"</a>":'<div class="branch-icon-wrapper" id="branch-loader-wrapper" style="opacity: 0;"><div id="branch-spinner"></div></div><div id="branch-sms-block"><form id="sms-form"><input type="phone" aria-label="Enter phone number" class="branch-animation" name="branch-sms-phone" id="branch-sms-phone" placeholder="'+a.qa+'"><button type="submit" id="branch-sms-send" class="branch-animation button">'+
...
c()},270),setTimeout(function(){"top"===b.position?document.body.style.marginTop=n:"bottom"===b.position&&(document.body.style.marginBottom=t);Vb("branch-banner-is-active")},20))}function f(){"top"===b.position?k.style.top="0":"bottom"===b.position&&(k.style.bottom="0");O(a,"didShowBanner")}if(!Zb(d,b))return O(a,"willNotShowBanner"),null;O(a,"willShowBanner");var k=cc(b,d);ac(b,k);c.channel=c.channel||"app banner";var l=b.F?k.contentWindow.document:document;if(B()){b.open_app=b.pa;b.append_deeplink_path=
b.ca;b.make_new_link=b.ma;b.deepview_type="banner";a.deepview(c,b);var g=l.getElementById("branch-mobile-action");g&&(g.onclick=function(b){b.preventDefault();a.deepviewCta()})}else l.getElementById("sms-form")?l.getElementById("sms-form").addEventListener("submit",function(d){d.preventDefault();dc(l,a,b,c)}):k.onload=function(){l=k.contentWindow.document;l.getElementById("sms-form")&&l.getElementById("sms-form").addEventListener("submit",function(d){d.preventDefault();dc(l,a,b,c)})};var g=Xb("margin-top"),
...
function Wc(a){function b(a){return c.reduce(function(a,b){if(a[b])return a;var c;c=fc.ka(b)?S.o.data[b]:void 0;c&&(a[b]=c);return a},a)}var c;c=void 0===c?["$android_url","$ios_url","$fallback_url","$desktop_url"]:c;if(!a)return console.log("setDefaultUrls - no data set"),a;try{var d=JSON.parse(a.data);a.data=JSON.stringify(b(d))}catch(e){console.log(e)}return a};var U={};
function Xc(a,b){var c=b?"OPEN":"GET",d=a,e=Ec(d);e&&e.bannerHeight&&e.position&&e.sticky?(Q=e.bannerHeight,P=e.position,ic=e.sticky):(d=d.match(uc))?(P="top",(d=d[1].match(vc))&&(Q=d[1]),ic="absolute"):(P="bottom",ic="fixed");if(-1!==Q.indexOf("vh")||-1!==Q.indexOf("%"))d=Q.indexOf("vh")?Q.slice(0,-2):Q.slice(0,-1),Q=d/100*mc+"px",100>d?kc=!0:jc=!0;if(d=Ec(a)){var f;b&&d&&d.ctaText&&d.ctaText.has_app?f=d.ctaText.has_app:d&&d.ctaText&&d.ctaText.no_app&&(f=d.ctaText.no_app);c=f;R=[];if(d&&d.injectorSelector&&
...
U.la=function(a){S.b(Bb,{event:"pageview",journey_displayed:!0,audience_rule_id:a.audience_rule_id,branch_view_id:a.branch_view_id},function(){})};
U.J=function(a,b,c,d,e,f){gc=c;Vc(f);var k=d.audience_rule_id;(f=document.getElementById("branch-iframe-css"))&&f.parentElement.removeChild(f);f=document.createElement("div");f.id="branch-banner";document.body.insertBefore(f,null);Ub(f,"branch-banner-is-active");var l=!1,g=b.callback_string,n=null,m=null,t=S.c;if(a){var A=Ec(a)||{},Qc=window.setTimeout(function(){window[g]=function(){}},ra);window[g]=function(a){window.clearTimeout(Qc);l||(m=a,Mc(c,k,t,m,n,A,e))};wc=n=Xc(a,b.has_app_websdk);if(null===
n){l=!0;return}Mc(c,k,t,m,n,A,e);sa&&(u["journey-load-time"]=(Date.now()-window.performance.timing.navigationStart).toString())}document.body.removeChild(f);v||e||U.la(d)};
U.I=function(a,b,c,d){console.log("PAGEVIEW");S=c;b||(b={});a||(a={});zc=b.disable_entry_animation||!1;yc=b.disable_exit_animation||!1;var e=z({},c.o),f=M(c.c)||{},k=f.hasOwnProperty("has_app")?f.has_app:!1,l=c.c.get("journeyDismissals",!0),g=(b.user_language||Va()||"en").toLowerCase()||null,n=fb(V(c)),m;(m=b.branch_view_id)||(m="_branch_view_id".replace(/[\[\]]/g,"\\$&"),m=(m=(new RegExp("[?&]"+m+"(=([^&#]*)|&|#|$)")).exec(Fa()))&&m[2]?decodeURIComponent(m[2].replace(/\+/g," ")):"");m=m||null;c=
...
function Zc(a){var b={"~channel":"Firebase App Indexing","~feature":"Auto App Indexing",$canonical_url:Fa()};if("object"===typeof X.data)for(var c in X.data)X.data.hasOwnProperty(c)&&!b.hasOwnProperty(c)&&(b[c]=X.data[c]);return a+(-1<a.indexOf("?")?"&":"?")+"link_click_id=a-"+btoa(q(b))}function $c(a){var b=document.createElement("link");b.setAttribute("rel","alternate");b.setAttribute("href",a);document.head.appendChild(b)}
...
"/"))}ad(a)};var cd;
function Y(a,b,c){return function(){var d=this,e,f,k=arguments[arguments.length-1];a&&"function"===typeof k?(e=Array.prototype.slice.call(arguments,0,arguments.length-1)||[],f=k):(f=function(){},e=Array.prototype.slice.call(arguments));d.aa(function(k){function g(b,c){try{if(b&&!a)throw b;1===a?f(b):2===a&&f(b,c)}finally{k()}}if(!c){if(1===d.l)return g(Error(w("Branch SDK initialization pending and a Branch method was called outside of the queue order")),null);if(2===d.l)return g(Error(w("Branch SDK initialization failed, so further methods cannot be called",d.j,
d.m)),null);if(0===d.l||!d.l)return g(Error(w("Branch SDK not initialized")),null)}e.unshift(g);b.apply(d,e)})}}function Z(){if(!(this instanceof Z))return cd||(cd=new Z),cd;this.aa=oa();this.c=new Fb(["session","cookie","pojo"]);this.da=new Nb;this.h=[];this.V="web2.52.6";this.j=this.l=0;this.m=null}
Z.prototype.b=function(a,b,c){this.U&&(b.app_id=this.U);this.i&&(b.branch_key=this.i);(a.a&&a.a.session_id||a.f&&a.f.session_id)&&this.H&&(b.session_id=this.H);(a.a&&a.a.identity_id||a.f&&a.f.identity_id)&&this.A&&(b.identity_id=this.A);0>a.endpoint.indexOf("/v1/")?(a.a&&a.a.developer_identity||a.f&&a.f.developer_identity)&&this.g&&(b.developer_identity=this.g):(a.a&&a.a.identity||a.f&&a.f.identity)&&this.g&&(b.identity=this.g);(a.a&&a.a.link_click_id||a.f&&a.f.link_click_id)&&this.Z&&(b.link_click_id=
...
b&&(c.browser_fingerprint_id=b)});g.b(wb,{browser_fingerprint_id:c.browser_fingerprint_id},function(b,d){b&&(g.j=4,g.m=b.message);b||!d||c.has_app||(c.has_app=!0,Lb(g.c,c),O(g,"didDownloadApp"));a&&a(null,c)})}function l(a){a.link_click_id&&(g.Z=a.link_click_id.toString());a.session_id&&(g.H=a.session_id.toString());a.identity_id&&(g.A=a.identity_id.toString());a.identity&&(g.g=a.identity.toString());a.link&&(g.M=a.link);if(a.referring_link){var b=a.referring_link;a.referring_link=b?"http"!==b.substring(0,
4)?"https://bnc.lt"+b:b:null}!a.click_id&&a.referring_link&&(a.click_id=Ha(a.referring_link));g.D=a.browser_fingerprint_id;return a}sa&&(u["init-began-at"]=(Date.now()-window.performance.timing.navigationStart).toString());var g=this;g.l=1;-1<b.indexOf("key_")?g.i=b:g.U=b;c=c&&H(c,"object")?c:{};pa=(g.G=c)&&c.retries&&Number.isInteger(c.retries)?c.retries:pa;qa=c&&c.retry_delay&&Number.isInteger(c.retry_delay)?c.retry_delay:qa;ra=c&&c.timeout&&Number.isInteger(c.timeout)?c.timeout:ra;r=c&&c.nonce?
...
Z.prototype.link=Y(2,function(a,b){console.log(b);var c=Ga(b),c=Wc(b),d=this.i;console.log(c);this.b(ub,c,function(b,f){if(b)return a(b,za(d,c));if(fc.ka("$journeys_cta")&&0<S.o.data.$.length)return a(null,S.o.data.$);a(null,f&&f.url)})});
...
Z.prototype.addListener=function(a,b){"function"===typeof a&&void 0===b&&(b=a,a=null);b&&this.h.push({listener:b,event:a||null})};Z.prototype.removeListener=function(a){a&&(this.h=this.h.filter(function(b){if(b.listener!==a)return b}))};function dd(a,b,c){c=c||{};try{a.o=p(q(c))}finally{a.o=a.o||{}}b()}Z.prototype.setBranchViewData=Y(1,function(a,b){dd.call(null,this,a,b)});
...
Z.prototype.disableTracking=Y(1,function(a,b){if(!1===b||"false"===b)xa=v=!1,this.i&&this.G&&(!0===this.G.tracking_disabled&&delete this.G.tracking_disabled,this.init(this.i,this.G));else if(void 0===b||!0===b||"true"===b)Ba(this),xa=v=!0,this.closeBanner(),this.closeJourney();a()});var ed=new Z;if(window.branch&&window.branch._q)for(var fd=window.branch._q,gd=0;gd<fd.length;gd++){var hd=fd[gd];ed[hd[0]].apply(ed,hd[1])}"function"===typeof define&&define.amd?define("branch",function(){return ed}):"object"===typeof exports&&(module.exports=ed);window&&(window.branch=ed);})();
