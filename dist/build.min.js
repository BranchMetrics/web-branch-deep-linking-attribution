...
d.l)),null);if(0===d.j||!d.j)return g(Error(u("Branch SDK not initialized")),null)}e.unshift(g);b.apply(d,e)})}}function Y(){if(!(this instanceof Y))return kc||(kc=new Y),kc;this.X=sa();this.b=new E(["session","cookie","pojo"]);this.N=new kb;this.g=[];this.P="web25.2.0";this.h=this.j=0;this.l=null}
...
!1;try{a=!!(document.querySelectorAll('*[itemtype^="http://schema.org"]')||[]).length}catch(lb){a=!1}return a}function h(a){var b={sdk:"25.2.0",branch_key:g.i},c=H(g.b)||{},d=H(g.b,!0)||{};d.browser_fingerprint_id&&(b._t=d.browser_fingerprint_id);za()||g.c(Oa,b,function(a,b){a&&(g.h=3,g.l=a.message);b&&(c.browser_fingerprint_id=b)});g.c(bb,{browser_fingerprint_id:c.browser_fingerprint_id},function(b,d){b&&(g.h=4,g.l=b.message);b||!d||c.has_app||(c.has_app=!0,jb(g.b,c),J(g,"didDownloadApp"));a&&a(null,
...
String(window.location),q=(c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null)||Aa()||ya(),F=!m||!m.identity_id;g.m=!!g.b.get("branch_view_enabled");if(m&&m.session_id&&!q)jb(g.b,{data:""}),d(),h(e);else{var m={sdk:"25.2.0",branch_key:g.i},U=H(g.b,!0)||{};U.browser_fingerprint_id&&(m._t=U.browser_fingerprint_id);za()?g.c(Na,{link_identifier:q,browser_fingerprint_id:q||U.browser_fingerprint_id,alternative_browser_fingerprint_id:U.browser_fingerprint_id,options:c,
