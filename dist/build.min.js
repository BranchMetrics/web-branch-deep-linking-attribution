...
m,m.branch_view_id||b.event_data.branch_view_data.id,b.event_data.branch_view_data,d,b.journey_link_data):((b.auto_branchify||!n&&Ma("branchify_url")&&V(h))&&this.branch.deepview({},{make_new_link:!1,open_app:!0,auto_branchify:!0}),N(R,"willNotShowJourney"))}v&&(wa=!0)})})}function f(a){t&&(a.identity=h.h);return a}function m(a){var b={sdk:"2.61.0",branch_key:h.i},c=L(h.b)||{},d=L(h.b,!0)||{};d.browser_fingerprint_id&&(b._t=d.browser_fingerprint_id);Ka()||La()||h.c(kb,b,function(a,b){a&&(h.l=3,h.s=
...
r=c&&c.nonce?c.nonce:r;v=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;wa=!1;v&&Aa(h);b=L(h.b,!0);h.j=b&&b.identity_id;b=L(h.b);var n=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,k=n||Ma("_branch_match_id")||Ga(),t=!h.j;h.C=!!h.b.get("branch_view_enabled");if(b&&b.session_id&&!k&&!Ma("branchify_url"))Ib(h.b,{data:""}),Ib(h.b,{referring_link:""}),d(),m(e);else{b={sdk:"2.61.0",branch_key:h.i};var y=L(h.b,!0)||{};y.browser_fingerprint_id&&(b._t=
