...
function Wc(a){return fc&&S&&S.i&&S.i.data?S.i.data[a]:!1}function Xc(a){function b(a){return c.reduce(function(a,b){if(a[b])return a;var c;c=Wc(b)?S.i.data[b]:void 0;c&&(a[b]=c);return a},a)}var c;c=void 0===c?["$android_url","$ios_url","$fallback_url","$desktop_url"]:c;if(!a)return console.log("setDefaultUrls - no data set"),a;try{var d=JSON.parse(a.data);a.data=JSON.stringify(b(d))}catch(e){console.log(e)}return a};var U={};
...
Z.prototype.link=Y(2,function(a,b){var c=Ga(b),c=Xc(b),d=this.j;this.b(ub,c,function(b,f){if(b)return a(b,za(d,c));if(Wc("$journeys_cta")&&0<S.i.data.$.length)return a(null,S.i.data.$);a(null,f&&f.url)})});
