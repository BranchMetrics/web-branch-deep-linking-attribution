...
function la(a,b){b.push('"',a.replace(na,function(a){var b=ma[a];b||(b="\\u"+(a.charCodeAt(0)|65536).toString(16).substr(1),ma[a]=b);return b}),'"')};function p(a){a=String(a);try{return JSON.parse(a)}catch(b){}throw Error("Invalid JSON string: "+a);}function q(a){try{return"object"===typeof JSON&&"function"===typeof JSON.stringify?JSON.stringify(a):h(a)}catch(b){}throw Error("Could not stringify object");};function oa(){function a(){if(b.length)b[0](function(){b.shift();a()})}var b=[];return function(c){b.push(c);1===b.length&&a()}};var pa=2,qa=200,ra=5E3,r="",u={},sa="undefined"!==typeof window&&!!(window.performance&&window.performance.timing&&window.performance.timing.navigationStart),ua="";function va(a){return a&&"number"===typeof a?(Date.now()-a).toString():null}var wa={didClickJourneyClose:"Button(X)",didClickJourneyContinue:"Dismiss Journey text"},v=!1,xa={"/v1/open":{link_identifier:"\\d+"},"/v1/pageview":{event:"pageview"},"/v1/dismiss":{event:"dismiss"}},ya=!1;
function za(a,b){var c=document.createElement("a");c.href=a;c=c.pathname;"/"!=c[0]&&(c="/"+c);c=xa[c];if(!c)return!0;if(0<Object.keys(c).length){if(!b)return!0;for(var d in c){var e=new RegExp(c[d]);if(!b.hasOwnProperty(d)||!e.test(b[d]))return!0}}return!1}
function Aa(a,b){if(a||b){for(var c="https://bnc.lt/a/"+a+"?",d="tags alias channel feature stage campaign type duration sdk source data".split(" "),e=0;e<d.length;e++){var f=d[e],k=b[f];if(k)if("tags"===f&&Array.isArray(k))for(var l=0;l<k.length;l++)c=("?"===c[c.length-1]?c+f:c+"&"+f)+"="+encodeURIComponent(k[l]);else if("string"===typeof k&&0<k.length||"number"===typeof k)"data"===f&&"string"===typeof k&&(k=Ba(k)),c=("?"===c[c.length-1]?c+f:c+"&"+f)+"="+encodeURIComponent(k)}return c}}
function Ca(a){a&&(a.ha=null,a.N=null,a.G=null,a.w=null,a.g=null,a.C=null,a.s&&delete a.s,a.u&&delete a.u,a.c.remove("branch_view_enabled"),Da(a.c,{},!0))}function x(a,b,c){a=a.replace(/\$(\d)/g,function(a,c){return b[parseInt(c,10)-1]});c&&(a+="\n Failure Code:"+c);return a}
function Ea(a){var b=a.has_app;return{data:a.data||"",data_parsed:a.data_parsed||{},has_app:void 0===b?null:b,identity:a.developer_identity||null,developer_identity:a.developer_identity||null,referring_identity:a.referring_identity||null,referring_link:a.referring_link||null}}
function Fa(a){var b=/^\$journeys_\S+$/,c=a.data,d={};if(!c)return{};switch(typeof c){case "string":try{c=p(c)}catch(e){c={}}break;case "object":break;default:c={}}Object.keys(c).forEach(function(a){b.test(a)&&(d[a]=c[a])});return d}function Ga(){return y()?document.referrer:String(window.location)}
function Ha(a){a.source="web-sdk";var b=a.data;switch(typeof b){case "string":try{b=p(b)}catch(c){b={_bncNoEval:!0}}break;case "object":break;default:b={}}b.$canonical_url||(b.$canonical_url=Ga());b.$og_title||(b.$og_title=z("title"));b.$og_description||(b.$og_description=z("description"));b.$og_image_url||(b.$og_image_url=z("image"));b.$og_video||(b.$og_video=z("video"));b.$og_type||(b.$og_type=z("type"));"string"===typeof b.$desktop_url&&(b.$desktop_url=b.$desktop_url.replace(/#r:[a-z0-9-_]+$/i,
"").replace(/([\?\&]_branch_match_id=\d+)/,""));try{p(b)}catch(c){b=h(b)}a.data=b;return a}function Ia(a){function b(a){return""!==a}if(!a||"string"!==typeof a)return"";var c=document.createElement("a");c.href=a;a=c.pathname&&c.pathname.split("/").filter(b);return Array.isArray(a)&&a.length?a[a.length-1]+c.search:c.search}
function A(a,b,c){a&&"object"===typeof a||(a={});if(!b||"object"!==typeof b)return a;for(var d in b)if(b.hasOwnProperty(d)){var e=b[d];!c||void 0!==e&&null!==e?a[d]=e:delete a[d]}return a}function Ja(){try{var a=(y()&&Ka()?window.top.location.hash:window.location.hash).match(/r:([^&]*)/);if(a&&1<=a.length)return a[1]}catch(b){}}function La(a){return!!/^((?!chrome|android|crios|fxios).)*safari/i.test(a)}
function Ma(a,b){b=b||11;var c=/version\/([^ ]*)/i.exec(a);if(c&&c[1])try{if(parseFloat(c[1])>=b)return!0}catch(d){}return!1}
...
function fb(a){var b={},b=G(b,"http_origin",document.URL),b=G(b,"user_agent",navigator.userAgent),b=G(b,"language",Wa()),b=G(b,"screen_width",screen.width||0),b=G(b,"screen_height",screen.height||0),b=G(b,"http_referrer",document.referrer),b=G(b,"browser_fingerprint_id",a.C),b=G(b,"developer_identity",a.g),b=G(b,"identity",a.g),b=G(b,"sdk","web");return b=G(b,"sdk_version","2.55.0")}function y(){return window.self!==window.top}
function Ka(){var a="true";try{window.top.location.search&&(a="true")}catch(b){return!1}return"true"===a}function gb(a){return a?a:y()?Ka()?window.top.document.referrer:"":document.referrer}function eb(a){if(!H(a,"object")||!Object.keys(a).length)return{};for(var b in a)a.hasOwnProperty(b)&&(a[b]=H(a[b],"object")||H(a[b],"array")?q(a[b]):a[b].toString());return a}function hb(a,b){var c=a?A({},a):{};return b&&0<Object.keys(b).length?0<Object.keys(c).length?A(c,b):A({},b):c}
...
Hb.prototype.pojo={getAll:function(){return this.v},get:function(a){return this.v[a]||null},set:function(a,b){this.v[a]=b},remove:function(a){delete this.v[a]},clear:function(){this.v={}},isEnabled:function(){return!0}};function M(a,b){try{var c=p(a.get(b?"branch_session_first":"branch_session",b))||null;return Ta(c)}catch(d){return null}}function Da(a,b,c){b=Sa(b);a.set("branch_session",h(b));c&&a.set("branch_session_first",h(b),!0)}function Nb(a,b){if(b){var c=M(a)||{},c=h(Sa(A(c,b)));a.set("branch_session",c)}}
function Ob(a,b,c){function d(a,b){return Sa(A(ia(a),b,c))}var e=a.get("branch_session",!1)||{};a.set("branch_session",h(d(e,b)));e=a.get("branch_session_first",!0)||{};a.set("branch_session_first",h(d(e,b)),!0)};function Pb(){}Pb.prototype.h=0;function Qb(a,b,c){if("undefined"===typeof b)return"";var d=[];if(b instanceof Array){for(a=0;a<b.length;a++)d.push(encodeURIComponent(c)+"="+encodeURIComponent(b[a]));return d.join("&")}for(var e in b)b.hasOwnProperty(e)&&(b[e]instanceof Array||"object"===typeof b[e]?d.push(Qb(a,b[e],c?c+"."+e:e)):d.push(encodeURIComponent(c?c+"."+e:e)+"="+encodeURIComponent(b[e])));return d.join("&")}
function Rb(a,b,c){function d(a,c){"undefined"===typeof c&&(c={});if(a.branch_key&&g.test(a.branch_key))return c.branch_key=a.branch_key,c;if(a.app_id&&l.test(a.app_id))return c.app_id=a.app_id,c;if(a.instrumentation)c.instrumentation=a.instrumentation;else throw Error(x("API request $1 missing parameter $2",[b.endpoint,"branch_key or app_id"]));}var e,f,k=b.destination+b.endpoint,l=/^[0-9]{15,20}$/,g=/key_(live|test)_[A-Za-z0-9]{32}/;if("/v1/has-app"===b.endpoint)try{b.f=d(c,b.f)}catch(m){return{error:m.message}}if("undefined"!==
...
function Tb(a,b,c,d,e){var f=Date.now(),k=ua;!a.h&&Na()&&a.h++;var l="branch_callback__"+a.h++;a=0<=b.indexOf("branch.io")?"&data=":"&post_data=";c="POST"===d?encodeURIComponent(Ba(h(c))):"";var g=window.setTimeout(function(){window[l]=function(){};G(u,k,va(f));e(Error("Request timed out"),null,504)},ra);window[l]=function(a){window.clearTimeout(g);e(null,a)};Sb(b+(0>b.indexOf("?")?"?":"")+(c?a+c:"")+(0<=b.indexOf("/c/")?"&click=1":"")+"&callback="+l,function(){e(Error("Request blocked by client, probably adblock"),
null)},function(){G(u,k,va(f));try{"function"===typeof this.remove?this.remove():this.parentNode.removeChild(this)}catch(n){}delete window[l]})}
function Ub(a,b,c,d,e,f){var k=Date.now(),l=ua,g=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");g.ontimeout=function(){G(u,l,va(k));f(Error("Request timed out"),null,504)};g.onerror=function(a){f(Error(a.error||"Error in API: "+g.status),null,g.status)};g.onreadystatechange=function(){var a;if(4===g.readyState)if(G(u,l,va(k)),200===g.status){try{a=p(g.responseText)}catch(m){a={}}f(null,a,g.status)}else if(402===g.status)f(Error("Not enough credits to redeem."),null,
g.status);else if("4"===g.status.toString().substring(0,1)||"5"===g.status.toString().substring(0,1))g.responseURL&&g.responseURL.includes("v2/event")?f(g.responseText,null,g.status):f(Error("Error in API: "+g.status),null,g.status)};try{g.open(d,b,!0),g.timeout=ra,g.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),g.send(c)}catch(n){e.set("use_jsonp",!0),Tb(a,b,c,d,f)}}
function Vb(a,b,c,d,e){function f(){d.get("use_jsonp")||b.L?Tb(a,n,c,b.method,k):Ub(a,n,m,b.method,d,k)}function k(c,d,g){"function"===typeof a.aa&&a.aa(n,b.method,t,c,g,d);c&&0<w&&"5"===(g||"").toString().substring(0,1)?(w--,window.setTimeout(function(){f()},qa)):e(c,d)}ua="/v1/pageview"===b.endpoint&&c&&c.journey_displayed?b.endpoint+"-1-brtt":b.endpoint+"-brtt";("/v1/url"===b.endpoint||"/v1/has-app"===b.endpoint)&&1<Object.keys(u).length&&(delete u["-brtt"],c.instrumentation=q(A({},u)),u={});if(v)for(var l=
["browser_fingerprint_id","alternative_browser_fingerprint_id","identity_id","session_id"],g=0;g<l.length;g++)c.hasOwnProperty(l[g])&&delete c[l[g]];l=Rb(a,b,c);if(l.error)return e(Error(q({message:l.error,endpoint:b.endpoint,data:c})));var n,m="";"GET"===b.method?n=l.url+"?"+l.data:(n=l.url,m=l.data);var t;d.get("use_jsonp")||b.L?t=c:t=m;var w=pa;if(v&&za(n,c))return ya?k(Error("Requested operation cannot be completed since tracking is disabled"),null,300):k(null,{},200);f()};function N(a){a&&a.parentNode.removeChild(a)}function Wb(a,b){a&&!a.className.match(new RegExp("(\\s|^)"+b+"(\\s|$)"))&&(a.className+=" "+b)}function Xb(a){var b=document.body;b&&b.className.match(new RegExp("(\\s|^)"+a+"(\\s|$)"))&&(b.className=b.className.replace(new RegExp("(\\s|^)"+a+"(\\s|$)")," "))}function Yb(a){var b=new Date;return b.setDate(b.getDate()+a)}
...
d=document.createElement("style");d.type="text/css";d.id="branch-css";d.innerHTML=c;I(d);c=a.D?b.contentWindow.document:document;(c=c.head||c.getElementsByTagName("head")[0])&&"function"===typeof c.appendChild&&c.appendChild(d);"top"===a.position?b.style.top="-76px":"bottom"===a.position&&(b.style.bottom="-76px")};function dc(a,b){var c;if(a.A||a.M){if(a.A){c="";for(var d=0;5>d;d++)c+='<span class="star"><svg class="star" fill="#555555" height="12" viewBox="3 2 20 19" width="12"><path d="M22 9.24l-7.19-.62L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21 12 17.27 18.18 21l-1.63-7.03L22 9.24zM12 15.4l-3.76 2.27 1-4.28-3.32-2.88 4.38-.38L12 6.1l1.71 4.04 4.38.38-3.32 2.88 1 4.28L12 15.4z"/><path d="M0 0h24v24H0z" fill="none"/><foreignObject display="none"><span class="star">\u2606</span></foreignObject></svg>',a.A>d&&
...
m.appendChild(t);g.style.opacity="0";l.style.opacity="0";n.style.opacity="0";setTimeout(function(){t.style.opacity="1"},20);l.value=""}function k(){g.removeAttribute("disabled");l.removeAttribute("disabled");g.style.opacity="1";l.style.opacity="1";n.style.opacity="0"}var l=a.getElementById("branch-sms-phone"),g=a.getElementById("branch-sms-send"),n=a.getElementById("branch-loader-wrapper"),m=a.getElementById("branch-sms-form-container"),t;if(l){var w=l.value;/^\d{7,}$/.test(w.replace(/[\s()+\-\.]|ext/gi,
""))?(O(b,"willSendBannerSMS"),g.setAttribute("disabled",""),l.setAttribute("disabled",""),g.style.opacity=".4",l.style.opacity=".4",n.style.opacity="1",l.className="",b.sendSMS(w,d,c,function(a){a?(O(b,"sendBannerSMSError"),e()):(O(b,"didSendBannerSMS"),f(),setTimeout(function(){m.removeChild(t);k()},3E3))})):e()}}
...
c()},270),setTimeout(function(){"top"===b.position?document.body.style.marginTop=n:"bottom"===b.position&&(document.body.style.marginBottom=t);Xb("branch-banner-is-active")},20))}function f(){"top"===b.position?k.style.top="0":"bottom"===b.position&&(k.style.bottom="0");O(a,"didShowBanner")}if(!ac(d,b))return O(a,"willNotShowBanner"),null;O(a,"willShowBanner");var k=ec(b,d);cc(b,k);c.channel=c.channel||"app banner";var l=b.D?k.contentWindow.document:document;if(B()){b.open_app=b.oa;b.append_deeplink_path=
...
n=document.body.style.marginTop,m=Zb("margin-bottom"),t=document.body.style.marginBottom,w=l.getElementById("branch-banner-close");w&&(w.onclick=function(b){b.preventDefault();O(a,"willCloseBanner");e({},function(){O(a,"didCloseBanner")})});Wb(document.body,"branch-banner-is-active");"top"===b.position?document.body.style.marginTop=$b(g):"bottom"===b.position&&(document.body.style.marginBottom=$b(m));b.Z?f():setTimeout(f,20);return e};var hc,ic=1,P="top",jc="absolute",Q="76px",kc=!1,lc=!1,R=[],mc=!1,nc=window.innerHeight,oc=window.innerWidth;window.innerHeight<window.innerWidth&&(nc=window.innerWidth,oc=window.innerHeight);
...
function Hc(a){var b=document.createElement("style");b.type="text/css";b.id="branch-iframe-css";pc=Zb("margin-top");var c=+pc.slice(0,-2);qc=Zb("margin-bottom");var d=+qc.slice(0,-2),e=+Q.slice(0,-2);a||("top"===P?document.body.style.marginTop=(+e+c).toString()+"px":"bottom"===P&&(document.body.style.marginBottom=(+e+d).toString()+"px"));0<R.length&&R.forEach(function(a){var b,c=window.getComputedStyle(a);c&&(b=kc&&"fixed"===c.getPropertyValue("position"));b||(a.style.marginTop=Q)});"top"===Ec&&Ec!==
...
function Rc(a,b,c,d,e,f,k,l){var g=k?0:Nc(f);O(S,a,T);Cc=!0;Pc(c);if(!k)if(void 0!==g&&b.set("globalJourneysDismiss",g,!0),Sc(b,d,e),f.dismissRedirect)window.location=f.dismissRedirect;else{var n=function(){S.removeListener(n);var b=Uc(l,wa[a]);S.b(Eb,b,function(a,c){!a&&"object"===typeof c&&c.template&&l.O(c,null,!1)&&l.J(c.template,b,b.branch_view_id||c.event_data.branch_view_data.id,c.event_data.branch_view_data,!1,c.journey_link_data)})};S.addListener("branch_internal_event_didCloseJourney",n)}}
function Vc(a,b){return A({url:a&&a.url||Ga(),user_agent:navigator.userAgent,language:navigator.language,screen_width:screen.width||-1,screen_height:screen.height||-1,window_device_pixel_ratio:window.devicePixelRatio||1},b||{})}
...
function Xc(a,b){var c=b?"OPEN":"GET",d=a,e=Gc(d);e&&e.bannerHeight&&e.position&&e.sticky?(Q=e.bannerHeight,P=e.position,jc=e.sticky):(d=d.match(wc))?(P="top",(d=d[1].match(xc))&&(Q=d[1]),jc="absolute"):(P="bottom",jc="fixed");if(-1!==Q.indexOf("vh")||-1!==Q.indexOf("%"))d=Q.indexOf("vh")?Q.slice(0,-2):Q.slice(0,-1),Q=d/100*nc+"px",100>d?lc=!0:kc=!0;if(d=Gc(a)){var f;b&&d&&d.ctaText&&d.ctaText.has_app?f=d.ctaText.has_app:d&&d.ctaText&&d.ctaText.no_app&&(f=d.ctaText.no_app);c=f;R=[];if(d&&d.injectorSelector&&
...
U.J=function(a,b,c,d,e,f){if(!rc){hc=c;Wc(f);var k=d.audience_rule_id;(f=document.getElementById("branch-iframe-css"))&&f.parentElement.removeChild(f);f=document.createElement("div");f.id="branch-banner";document.body.insertBefore(f,null);Wb(f,"branch-banner-is-active");var l=!1,g=b.callback_string,n=null,m=null,t=S.c;if(a){var w=Gc(a)||{},ta=window.setTimeout(function(){window[g]=function(){}},ra);window[g]=function(a){window.clearTimeout(ta);l||(m=a,Oc(c,k,t,m,n,w,e))};yc=n=Xc(a,b.has_app_websdk);
if(null===n){l=!0;return}Oc(c,k,t,m,n,w,e);sa&&(u["journey-load-time"]=(Date.now()-window.performance.timing.navigationStart).toString())}document.body.removeChild(f);v||e||U.ka(d)}};
U.I=function(a,b,c,d){S=c;b||(b={});a||(a={});Bc=b.disable_entry_animation||!1;Ac=b.disable_exit_animation||!1;var e=A({},c.H),f=M(c.c)||{},k=f.hasOwnProperty("has_app")?f.has_app:!1,l=c.c.get("journeyDismissals",!0),g=(b.user_language||Wa()||"en").toLowerCase()||null,n=gb(V(c)),m;(m=b.branch_view_id)||(m="_branch_view_id".replace(/[\[\]]/g,"\\$&"),m=(m=(new RegExp("[?&]"+m+"(=([^&#]*)|&|#|$)")).exec(Ga()))&&m[2]?decodeURIComponent(m[2].replace(/\+/g," ")):"");m=m||null;c=b.make_new_link?null:Ia(V(c));
e.event=d?"dismiss":"pageview";e.metadata=a;e=G(e,"initial_referrer",n);e=G(e,"branch_view_id",m);e=G(e,"no_journeys",b.no_journeys);e=G(e,"is_iframe",y());e=G(e,"journey_dismissals",l);e.user_language=g;e.open_app=b.open_app||!1;e.has_app_websdk=k;e.feature="journeys";e.callback_string="branch_view_callback__"+ic++;e.data||(e.data={});e.data=A(D(),e.data);e.data=A(Fa(f||{}),e.data);c&&(e.data.link_click_id=c);(a=f.data?JSON.parse(f.data):null)&&a["+referrer"]&&(e.data["+referrer"]=a["+referrer"]);
return e=Ha(e)};var W={androidAppIndexingTagsPresent:!1,iosAppIndexingTagsPresent:!1,androidDetailsComplete:!1,iosDetailsComplete:!1},X={};function Yc(a){var b;"android"===a&&W.androidDetailsComplete&&(b="android-app://"+X.androidPackageName+"/"+X.androidURL,b=Zc(b),$c(b));"ios"===a&&W.iosDetailsComplete&&(b="ios-app://"+X.iosAppId+"/"+X.iosURL,b=Zc(b),$c(b))}
function Zc(a){var b={"~channel":"Firebase App Indexing","~feature":"Auto App Indexing",$canonical_url:Ga()};if("object"===typeof X.data)for(var c in X.data)X.data.hasOwnProperty(c)&&!b.hasOwnProperty(c)&&(b[c]=X.data[c]);return a+(-1<a.indexOf("?")?"&":"?")+"link_click_id=a-"+btoa(q(b))}function $c(a){var b=document.createElement("link");b.setAttribute("rel","alternate");b.setAttribute("href",a);document.head.appendChild(b)}
function ad(a){"android"===a&&"string"===typeof X.androidPackageName&&"string"===typeof X.androidURL&&(W.androidDetailsComplete=!0,Yc("android"));"ios"===a&&"string"===typeof X.iosAppId&&"string"===typeof X.iosURL&&(W.iosDetailsComplete=!0,Yc("ios"))}
function bd(a){for(var b=document.getElementsByTagName("meta"),c=0;c<b.length;c++){var d=b[c];"ios"===a&&"al:ios:app_store_id"===d.getAttribute("property")&&(X.iosAppId=d.getAttribute("content"));"ios"===a&&"al:ios:url"===d.getAttribute("property")&&(X.iosURL=d.getAttribute("content").replace("://","/"));"android"===a&&"al:android:package"===d.getAttribute("property")&&(X.androidPackageName=d.getAttribute("content"));"android"===a&&"al:android:url"===d.getAttribute("property")&&(X.androidURL=d.getAttribute("content").replace("://",
"/"))}ad(a)};var cd;
function Y(a,b,c){return function(){var d=this,e,f,k=arguments[arguments.length-1];a&&"function"===typeof k?(e=Array.prototype.slice.call(arguments,0,arguments.length-1)||[],f=k):(f=function(){},e=Array.prototype.slice.call(arguments));d.ba(function(k){function g(b,c){try{if(b&&!a)throw b;1===a?f(b):2===a&&f(b,c)}finally{k()}}if(!c){if(1===d.l)return g(Error(x("Branch SDK initialization pending and a Branch method was called outside of the queue order")),null);if(2===d.l)return g(Error(x("Branch SDK initialization failed, so further methods cannot be called",d.j,
d.m)),null);if(0===d.l||!d.l)return g(Error(x("Branch SDK not initialized")),null)}e.unshift(g);b.apply(d,e)})}}function Z(){if(!(this instanceof Z))return cd||(cd=new Z),cd;this.ba=oa();this.c=new Hb(["session","cookie","pojo"]);this.V=new Pb;this.h=[];this.X="web2.55.0";this.j=this.l=0;this.m=null}
Z.prototype.b=function(a,b,c){this.W&&(b.app_id=this.W);this.i&&(b.branch_key=this.i);(a.a&&a.a.session_id||a.f&&a.f.session_id)&&this.G&&(b.session_id=this.G);(a.a&&a.a.identity_id||a.f&&a.f.identity_id)&&this.w&&(b.identity_id=this.w);0>a.endpoint.indexOf("/v1/")?(a.a&&a.a.developer_identity||a.f&&a.f.developer_identity)&&this.g&&(b.developer_identity=this.g):(a.a&&a.a.identity||a.f&&a.f.identity)&&this.g&&(b.identity=this.g);(a.a&&a.a.link_click_id||a.f&&a.f.link_click_id)&&this.$&&(b.link_click_id=
this.$);(a.a&&a.a.sdk||a.f&&a.f.sdk)&&this.X&&(b.sdk=this.X);(a.a&&a.a.browser_fingerprint_id||a.f&&a.f.browser_fingerprint_id)&&this.C&&(b.browser_fingerprint_id=this.C);v&&(b.tracking_disabled=v);return Vb(this.V,a,b,this.c,function(a,b){c(a,b)})};function V(a){var b=M(a.c);return(b=b&&b.referring_link)?b:(a=a.c.get("click_id"))?"https://bnc.lt/c/"+a:null}function O(a,b,c){for(var d=0;d<a.h.length;d++)a.h[d].event&&a.h[d].event!==b||a.h[d].listener(b,c)}
...
d){d&&(d=l(d),v||(d=f(d),Da(g.c,d,t)),g.l=3,d.data_parsed=d.data&&0!==d.data.length?p(d.data):{});if(b)return g.l=2,g.j||(g.j=1,g.m=b.message),a(b,d&&Ea(d));try{a(b,d&&Ea(d))}catch(id){}finally{g.renderFinalize()}var e=ab(),k=H(c.metadata,"object")?c.metadata:null;k&&(k=hb(e.hosted_deeplink_data,k))&&0<Object.keys(k).length&&(e.hosted_deeplink_data=k);var m=U.I(Vc(c,e),c,g,!1);g.renderQueue(function(){g.b(Db,m,function(a,b){if(!a&&"object"===typeof b){var d=m.branch_view_id?!0:!1;U.O(b,c,d)?U.J(b.template,
m,m.branch_view_id||b.event_data.branch_view_data.id,b.event_data.branch_view_data,d,b.journey_link_data):((b.auto_branchify||!n&&Oa("branchify_url")&&V(g))&&this.branch.deepview({},{make_new_link:!1,open_app:!0,auto_branchify:!0}),O(S,"willNotShowJourney"))}v&&(ya=!0)})})}function f(a){t&&(a.identity=g.g);return a}function k(a){var b={sdk:"2.55.0",branch_key:g.i},c=M(g.c)||{},d=M(g.c,!0)||{};d.browser_fingerprint_id&&(b._t=d.browser_fingerprint_id);Na()||g.b(kb,b,function(a,b){a&&(g.j=3,g.m=a.message);
b&&(c.browser_fingerprint_id=b)});g.b(yb,{browser_fingerprint_id:c.browser_fingerprint_id},function(b,d){b&&(g.j=4,g.m=b.message);b||!d||c.has_app||(c.has_app=!0,Nb(g.c,c),O(g,"didDownloadApp"));a&&a(null,c)})}function l(a){a.link_click_id&&(g.$=a.link_click_id.toString());a.session_id&&(g.G=a.session_id.toString());a.identity_id&&(g.w=a.identity_id.toString());a.identity&&(g.g=a.identity.toString());a.link&&(g.N=a.link);if(a.referring_link){var b=a.referring_link;a.referring_link=b?"http"!==b.substring(0,
4)?"https://bnc.lt"+b:b:null}!a.click_id&&a.referring_link&&(a.click_id=Ia(a.referring_link));g.C=a.browser_fingerprint_id;return a}sa&&(u["init-began-at"]=(Date.now()-window.performance.timing.navigationStart).toString());var g=this;g.l=1;-1<b.indexOf("key_")?g.i=b:g.W=b;c=c&&H(c,"object")?c:{};pa=(g.F=c)&&c.retries&&Number.isInteger(c.retries)?c.retries:pa;qa=c&&c.retry_delay&&Number.isInteger(c.retry_delay)?c.retry_delay:qa;ra=c&&c.timeout&&Number.isInteger(c.timeout)?c.timeout:ra;r=c&&c.nonce?
c.nonce:r;v=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;ya=!1;v&&Ca(g);b=M(g.c);var n=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,m=n||Oa("_branch_match_id")||Ja(),t=!b||!b.identity_id;g.B=!!g.c.get("branch_view_enabled");if(b&&b.session_id&&!m&&!Oa("branchify_url"))Nb(g.c,{data:""}),Nb(g.c,{referring_link:""}),d(),k(e);else{b={sdk:"2.55.0",branch_key:g.i};var w=M(g.c,!0)||{};w.browser_fingerprint_id&&(b._t=w.browser_fingerprint_id);w.identity&&
(g.g=w.identity);var ta=parseInt(Oa("[?&]_open_delay_ms"),10);Na()?ib(function(){g.b(jb,{link_identifier:m,browser_fingerprint_id:m||w.browser_fingerprint_id,alternative_browser_fingerprint_id:w.browser_fingerprint_id,options:c,initial_referrer:gb(V(g)),current_url:y()&&Ka()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(g.j=2,g.m=a.message);a||"object"!==typeof b||(b.branch_view_enabled&&(g.B=!!b.branch_view_enabled,g.c.set("branch_view_enabled",
g.B)),m&&(b.click_id=m));d();e(a,b)})},ta):g.b(kb,b,function(a,b){if(a)return g.j=3,g.m=a.message,e(a,null);ib(function(){g.b(jb,{link_identifier:m,browser_fingerprint_id:m||b,alternative_browser_fingerprint_id:w.browser_fingerprint_id,options:c,initial_referrer:gb(V(g)),current_url:y()&&Ka()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(g.j=2,g.m=a.message);a||"object"!==typeof b||(b.branch_view_enabled&&(g.B=!!b.branch_view_enabled,
g.c.set("branch_view_enabled",g.B)),m&&(b.click_id=m));d();e(a,b)})},ta)})}},!0);Z.prototype.renderQueue=Y(0,function(a,b){this.ca?b():(this.o=this.o||[],this.o.push(b));a(null,null)});Z.prototype.renderFinalize=Y(2,function(a){this.o&&0<this.o.length&&(this.o.forEach(function(a){a.call(this)}),delete this.o);this.ca=!0;a(null,null)});Z.prototype.data=Y(2,function(a){var b=Ea(M(this.c));b.referring_link=V(this);b.data_parsed=b.data&&0!==b.data.length?p(b.data):{};a(null,b)});
Z.prototype.first=Y(2,function(a){a(null,Ea(M(this.c,!0)))});Z.prototype.setIdentity=Y(2,function(a,b){var c=this;this.b(rb,{identity:b},function(d,e){d&&a(d);e=e||{};c.w=e.identity_id?e.identity_id.toString():null;c.N=e.link;c.g=b;e.developer_identity=b;e.referring_data_parsed=e.referring_data?p(e.referring_data):null;Ob(c.c,{identity:b});a(null,e)})});
Z.prototype.logout=Y(1,function(a){var b=this;this.b(qb,{},function(c,d){c&&a(c);d=d||{};d={data_parsed:null,data:null,referring_link:null,click_id:null,link_click_id:null,identity:null,session_id:d.session_id,identity_id:d.identity_id,link:d.link,device_fingerprint_id:b.ha||null};b.N=d.link;b.G=d.session_id;b.w=d.identity_id;b.g=null;Ob(b.c,d,!0);a(null)})});Z.prototype.getBrowserFingerprintId=Y(2,function(a){var b=M(this.c,!0)||{};a(null,b.browser_fingerprint_id||null)});
...
metadata:A({url:Ga(),user_agent:navigator.userAgent,language:navigator.language},c),initial_referrer:gb(V(this))},function(b,c){"function"===typeof a&&a.apply(this,arguments)})});
...
Z.prototype.link=Y(2,function(a,b){var c=Ha(b),d=this.i;this.b(wb,c,function(b,f){if(b)return a(b,Aa(d,c));a(null,f&&f.url)})});
Z.prototype.sendSMS=Y(1,function(a,b,c,d){function e(c){f.b(mb,{link_url:c,phone:b},function(b){a(b||null)})}var f=this;if("function"===typeof d)d={};else if("undefined"===typeof d||null===d)d={};d.make_new_link=d.make_new_link||!1;c.channel&&"app banner"!==c.channel||(c.channel="sms");var k=V(f);k&&!d.make_new_link?e(Ia(k)):f.b(wb,Ha(c),function(b,c){if(b)return a(b);var d=c.url;/(bnc.lt\/|app\.link\/)/.test(d)||(d="https://bnc.lt/"+Va(d));f.b(lb,{link_url:d,click:"click"},function(b,c){if(b)return a(b);
e(c.click_id)})})});
Z.prototype.deepview=Y(1,function(a,b,c){var d=this;c||(c={});c.deepview_type="undefined"===typeof c.deepview_type?"deepview":"banner";b.data=A(D(),b.data);b=y()?A({is_iframe:!0},b):b;b=Ha(b);var e=Aa(this.i,b);if(c.open_app||null===c.open_app||"undefined"===typeof c.open_app)b.open_app=!0;b.append_deeplink_path=!!c.append_deeplink_path;b.deepview_type=c.deepview_type;var f=V(d);f&&!c.make_new_link&&(b.link_click_id=Ia(f));b.banner_options=c;c.auto_branchify&&(b.auto_branchify=!0);d.u=ga(this.b,d,
xb,b,function(b,c){if(b)return v||(d.s=function(){window.top.location=e}),a(b);"function"===typeof c&&(d.s=c);a(null)});d.u()});
Z.prototype.deepviewCta=Y(1,function(a){if("undefined"===typeof this.s)return v?a(Error("Requested operation cannot be completed since tracking is disabled"),null):a(Error("Cannot call Deepview CTA, please call branch.deepview() first"),null);window.event&&(window.event.preventDefault?window.event.preventDefault():window.event.returnValue=!1);O(this,"didDeepviewCTA");this.s();a()});Z.prototype.referrals=Y(2,function(a){this.b(sb,{},a)});
...
Z.prototype.addListener=function(a,b){"function"===typeof a&&void 0===b&&(b=a,a=null);b&&this.h.push({listener:b,event:a||null})};Z.prototype.removeListener=function(a){a&&(this.h=this.h.filter(function(b){if(b.listener!==a)return b}))};function dd(a,b,c){c=c||{};try{a.H=p(q(c))}finally{a.H=a.H||{}}b()}Z.prototype.setBranchViewData=Y(1,function(a,b){dd.call(null,this,a,b)},!0);
...
Z.prototype.banner=Y(1,function(a,b,c){c=c||{};dd.call(null,this,function(){},c);"undefined"===typeof b.showAgain&&"undefined"!==typeof b.forgetHide&&(b.showAgain=b.forgetHide);var d={icon:F(b.icon)||"",title:F(b.title)||"",description:F(b.description)||"",M:"number"===typeof b.reviewCount&&0<b.reviewCount?Math.floor(b.reviewCount):null,A:"number"===typeof b.rating&&5>=b.rating&&0<b.rating?Math.round(2*b.rating)/2:null,na:F(b.openAppButtonText)||"View in app",ja:F(b.downloadAppButtonText)||"Download App",
...
Z.prototype.autoAppIndex=Y(1,function(a,b){b=b||{};var c=document.getElementsByTagName("link"),d=c.length;if(d)for(var e=0;e<d;e++){var f=c[e],k=f.href;k&&(k.includes("ios-app")&&(W.iosAppIndexingTagsPresent=!0,f.setAttribute("href",Zc(k))),k.includes("android-app")&&(W.androidAppIndexingTagsPresent=!0,f.setAttribute("href",Zc(k))))}X=b;W.androidAppIndexingTagsPresent||(ad("android"),W.androidDetailsComplete||bd("android"));W.iosAppIndexingTagsPresent||(ad("ios"),W.iosDetailsComplete||bd("ios"));
...
Z.prototype.disableTracking=Y(1,function(a,b){if(!1===b||"false"===b)ya=v=!1,this.i&&this.F&&(!0===this.F.tracking_disabled&&delete this.F.tracking_disabled,this.init(this.i,this.F));else if(void 0===b||!0===b||"true"===b)Ca(this),ya=v=!0,this.closeBanner(),this.closeJourney();a()},!0);Z.prototype.setAPIResponseCallback=Y(0,function(a,b){this.V.aa=b;a()},!0);var ed=new Z;if(window.branch&&window.branch._q)for(var fd=window.branch._q,gd=0;gd<fd.length;gd++){var hd=fd[gd];ed[hd[0]].apply(ed,hd[1])}"function"===typeof define&&define.amd?define("branch",function(){return ed}):"object"===typeof exports&&(module.exports=ed);window&&(window.branch=ed);})();
