...
function fb(a){var b={},b=F(b,"http_origin",document.URL),b=F(b,"user_agent",navigator.userAgent),b=F(b,"language",Va()),b=F(b,"screen_width",screen.width||0),b=F(b,"screen_height",screen.height||0),b=F(b,"http_referrer",document.referrer),b=F(b,"browser_fingerprint_id",a.D),b=F(b,"developer_identity",a.g),b=F(b,"identity",a.g),b=F(b,"sdk","web");return b=F(b,"sdk_version","2.58.3")}function y(){return window.self!==window.top}
function Ha(){var a="true";try{window.top.location.search&&(a="true")}catch(b){return!1}return"true"===a}function gb(a){return a?a:y()?Ha()?window.top.document.referrer:"":document.referrer}function eb(a){if(!G(a,"object")||!Object.keys(a).length)return{};for(var b in a)if(a.hasOwnProperty(b)){var c=b,d;d=a[b];d=G(d,"object")||G(d,"array")?q(d):null===d?"null":d.toString();a[c]=d}return a}
...
function Tb(a,b,c){function d(a,c){"undefined"===typeof c&&(c={});if(a.branch_key&&h.test(a.branch_key))return c.branch_key=a.branch_key,c;if(a.app_id&&k.test(a.app_id))return c.app_id=a.app_id,c;if(a.instrumentation)c.instrumentation=a.instrumentation;else throw Error(x("API request $1 missing parameter $2",[b.endpoint,"branch_key or app_id"]));}var e,f,l=b.destination+b.endpoint,k=/^[0-9]{15,20}$/,h=/key_(live|test)_[A-Za-z0-9]{32}/;if("/v1/has-app"===b.endpoint)try{b.f=d(c,b.f)}catch(m){return{error:m.message}}if("undefined"!==
...
m.appendChild(t);h.style.opacity="0";k.style.opacity="0";n.style.opacity="0";setTimeout(function(){t.style.opacity="1"},20);k.value=""}function l(){h.removeAttribute("disabled");k.removeAttribute("disabled");h.style.opacity="1";k.style.opacity="1";n.style.opacity="0"}var k=a.getElementById("branch-sms-phone"),h=a.getElementById("branch-sms-send"),n=a.getElementById("branch-loader-wrapper"),m=a.getElementById("branch-sms-form-container"),t;if(k){var u=k.value;/^\d{7,}$/.test(u.replace(/[\s()+\-\.]|ext/gi,
""))?(N(b,"willSendBannerSMS"),h.setAttribute("disabled",""),k.setAttribute("disabled",""),h.style.opacity=".4",k.style.opacity=".4",n.style.opacity="1",k.className="",b.sendSMS(u,d,c,function(a){a?(N(b,"sendBannerSMSError"),e()):(N(b,"didSendBannerSMS"),f(),setTimeout(function(){m.removeChild(t);l()},3E3))})):e()}}
function ic(a,b,c,d){function e(a,c){"function"===typeof a&&(c=a,a={});a=a||{};"top"===b.position?l.style.top="-76px":"bottom"===b.position&&(l.style.bottom="-76px");"number"===typeof b.K?d.set("hideBanner",$b(b.K),!0):d.set("hideBanner",!0,!0);a.Z?("top"===b.position?document.body.style.marginTop=n:"bottom"===b.position&&(document.body.style.marginBottom=t),Zb("branch-banner-is-active"),M(l),M(document.getElementById("branch-css")),c()):(setTimeout(function(){M(l);M(document.getElementById("branch-css"));
c()},270),setTimeout(function(){"top"===b.position?document.body.style.marginTop=n:"bottom"===b.position&&(document.body.style.marginBottom=t);Zb("branch-banner-is-active")},20))}function f(){"top"===b.position?l.style.top="0":"bottom"===b.position&&(l.style.bottom="0");N(a,"didShowBanner")}if(!cc(d,b))return N(a,"willNotShowBanner"),null;N(a,"willShowBanner");var l=gc(b,d);ec(b,l);c.channel=c.channel||"app banner";var k=b.F?l.contentWindow.document:document;if(C()){b.open_app=b.oa;b.append_deeplink_path=
b.ea;b.make_new_link=b.la;b.deepview_type="banner";a.deepview(c,b);var h=k.getElementById("branch-mobile-action");h&&(h.onclick=function(b){b.preventDefault();a.deepviewCta()})}else k.getElementById("sms-form")?k.getElementById("sms-form").addEventListener("submit",function(d){d.preventDefault();hc(k,a,b,c)}):l.onload=function(){k=l.contentWindow.document;k.getElementById("sms-form")&&k.getElementById("sms-form").addEventListener("submit",function(d){d.preventDefault();hc(k,a,b,c)})};var h=ac("margin-top"),
n=document.body.style.marginTop,m=ac("margin-bottom"),t=document.body.style.marginBottom,u=k.getElementById("branch-banner-close");u&&(u.onclick=function(b){b.preventDefault();N(a,"willCloseBanner");e({},function(){N(a,"didCloseBanner")})});Yb(document.body,"branch-banner-is-active");"top"===b.position?document.body.style.marginTop=bc(h):"bottom"===b.position&&(document.body.style.marginBottom=bc(m));b.Z?f():setTimeout(f,20);return e};var jc={},kc,lc=1,O="top",mc="absolute",P="76px",nc=!1,oc=!1,Q=[],pc=!1,qc=window.innerHeight,rc=window.innerWidth;window.innerHeight<window.innerWidth&&(qc=window.innerWidth,rc=window.innerHeight);
var sc=0,tc=0,uc=!1,vc=/<script type="application\/json">((.|\s)*?)<\/script>/,wc=/<script type="text\/javascript">((.|\s)*?)<\/script>/,xc=/<style type="text\/css" id="branch-css">((.|\s)*?)<\/style>/,yc=/<style type="text\/css" id="branch-iframe-css">((.|\s)*?)<\/style>/,zc=/#branch-banner-spacer {((.|\s)*?)}/,Ac=/margin-bottom: (.*?);/,R=null,Bc=null,Cc=!1,Dc=!1,Ec=!1,Fc=!1,Gc=!1,Hc="",Ic=[],S=null;
function Jc(a){var b=Kc(a);b&&b.bannerHeight&&b.position&&b.sticky?(P=b.bannerHeight,O=b.position,mc=b.sticky):(a=a.match(zc))?(O="top",(a=a[1].match(Ac))&&(P=a[1]),mc="absolute"):(O="bottom",mc="fixed");if(-1!==P.indexOf("vh")||-1!==P.indexOf("%"))a=P.indexOf("vh")?P.slice(0,-2):P.slice(0,-1),P=a/100*qc+"px",100>a?oc=!0:nc=!0}function Kc(a){if(a=a.match(vc))return p(a[1])}function Lc(a){if(a=a.match(yc))return a[1]}
function Mc(a,b){var c;b&&a&&a.ctaText&&a.ctaText.has_app?c=a.ctaText.has_app:a&&a.ctaText&&a.ctaText.no_app&&(c=a.ctaText.no_app);return c}function Nc(a){Q=[];if(a&&a.injectorSelector&&(a=document.querySelectorAll(a.injectorSelector)))for(var b=0;b<a.length;b++)Q.push(a[b].parentElement)}function Oc(a){if(a=a.match(xc))return a[1]}function Pc(a){if(a=a.match(wc)){a=a[1];var b=document.createElement("script");b.id="branch-journey-cta";H(b);b.innerHTML=a;document.body.appendChild(b)}}
function Qc(a){var b=a.match(vc),c=a.match(wc),d=a.match(xc),e=a.match(yc);b&&(a=a.replace(vc,""));c&&(a=a.replace(wc,""));d&&(a=a.replace(xc,""));e&&(a=a.replace(yc,""));return a}function Rc(){var a=document.createElement("iframe");a.src="about:blank";a.style.overflow="hidden";a.scrolling="no";a.id="branch-banner-iframe";a.className="branch-animation";a.title="Branch Banner";a.setAttribute("aria-label","Branch Banner");H(a);return a}
function Sc(a){var b=document.createElement("style");b.type="text/css";b.id="branch-iframe-css";sc=ac("margin-top");var c=+sc.slice(0,-2);tc=ac("margin-bottom");var d=+tc.slice(0,-2),e=+P.slice(0,-2);a||("top"===O?document.body.style.marginTop=(+e+c).toString()+"px":"bottom"===O&&(document.body.style.marginBottom=(+e+d).toString()+"px"));0<Q.length&&Q.forEach(function(a){var b,c=window.getComputedStyle(a);c&&(b=nc&&"fixed"===c.getPropertyValue("position"));b||(a.style.marginTop=P)});"top"===Hc&&Hc!==
O&&Gc&&Ic&&0<Ic.length&&Ic.forEach(function(a){a.style.marginTop=0});Gc=!1;Hc="";Ic=[];Fc=!1;a?b.innerHTML=a:b.innerHTML=Tc();H(b);document.head.appendChild(b)}
function Tc(){var a="",b="";document.body.style.transition="";document.getElementById("branch-banner-iframe")&&(document.getElementById("branch-banner-iframe").style.transition="");Ec||(a="body { -webkit-transition: all 0.375s ease; }\n",document.body.style.transition="all 00.375s ease",b="-webkit-transition: all 0.25s ease; transition: all 00.25s ease;");return(a?a:"")+("#branch-banner-iframe { box-shadow: 0 0 5px rgba(0, 0, 0, .35); width: 1px; min-width:100%; left: 0; right: 0; border: 0; height: "+
...
function Uc(a,b){Yb(document.body,"branch-banner-is-active");if(nc&&"fixed"===mc){var c=document.createElement("style");c.type="text/css";c.innerHTML=".branch-banner-no-scroll {overflow: hidden;}";document.head.appendChild(c);Yb(document.body,"branch-banner-no-scroll")}setTimeout(function(){b?(a.style.top=null,a.style.bottom=null):"top"===O?a.style.top="0":"bottom"===O&&(S&&S.journey_link_data&&!S.journey_link_data.safeAreaRequired?a.style.bottom="0":(pc=!0,document.getElementById("branch-banner-iframe").style.transition=
"all 0s",Vc(!1,!0),window.addEventListener("resize",Wc),window.addEventListener("scroll",Xc)));N(R,"didShowJourney",S);Cc=!0},20)}function Wc(){pc&&Vc(!1,!1)}function Xc(){pc&&(window.pageYOffset>window.innerHeight?Vc(!0,!1):Vc(!1,!1))}function Vc(a,b){var c=document.getElementById("branch-banner-iframe"),d=c.offsetHeight,e=c.offsetTop,f=window.innerHeight;b&&window.pageYOffset?c.style.bottom="0":a?c.style.top=f-d+d/2+"px":f-e!=d&&(c.style.top=""+(f-d)+"px")}
function Yc(a){a=a.globalDismissPeriod;if("number"===typeof a){if(-1===a)a=!0;else{var b=new Date;a=b.setSeconds(b.getSeconds()+a)}return a}}
function Zc(a,b,c,d,e,f,l){var k=U;d&&e&&(Array.prototype.forEach.call(e.contentWindow.document.querySelectorAll("#branch-mobile-action"),function(a){a.addEventListener("click",function(){N(R,"didClickJourneyCTA",S);Fc=!0;d();$c(e)})}),ad(".branch-banner-continue","didClickJourneyContinue",c,e,a,b,f,l,k),ad(".branch-banner-close","didClickJourneyClose",c,e,a,b,f,l,k))}
function ad(a,b,c,d,e,f,l,k,h){Array.prototype.forEach.call(d.contentWindow.document.querySelectorAll(a),function(a){a.addEventListener("click",function(){bd(b,c,d,e,f,l,k,h)})})}function cd(a,b,c){var d=a.get("journeyDismissals",!0),d=d?p(d):{};d[c]={view_id:b,dismiss_time:Date.now()};a.set("journeyDismissals",q(d),!0)}
function dd(a){return void 0===a||null===a?null:a.replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&amp;/g,"&").replace(/&quot;/g,'"').replace(/&apos;/g,"'").replace(/&brvbar;/g,"\u00a6").replace(/&laquo;/g,"\u00ab").replace(/&acute;/g,"\u00b4").replace(/&middot;/g,"\u00b7").replace(/&raquo;/g,"\u00bb").replace(/&amp;/g,"&").replace(/&iquest;/g,"\u00bf").replace(/&times;/g,"\u00d7").replace(/&divide;/g,"\u00f7").replace(/&Agrave;/g,"\u00c0").replace(/&Aacute;/g,"\u00c1").replace(/&Acirc;/g,"\u00c2").replace(/&Atilde;/g,
...
function ed(a,b){var c={},d=Ua();d&&0<Object.keys(d).length&&(c.hosted_deeplink_data=d);c=a.I(fd(null,c),null,R,!0);if(S&&S.journey_link_data){F(c,"journey_id",S.journey_link_data.journey_id);F(c,"journey_name",dd(S.journey_link_data.journey_name));F(c,"view_id",S.journey_link_data.view_id);F(c,"view_name",dd(S.journey_link_data.view_name));F(c,"channel",dd(S.journey_link_data.channel));F(c,"campaign",dd(S.journey_link_data.campaign));try{F(c,"tags",JSON.stringify(S.journey_link_data.tags))}catch(e){c.tags=
JSON.stringify([])}}F(c,"dismissal_source",b);return c}
function bd(a,b,c,d,e,f,l,k){var h=l?0:Yc(f);N(R,a,S);Fc=!0;$c(c);if(!l)if(void 0!==h&&b.set("globalJourneysDismiss",h,!0),cd(b,d,e),f.dismissRedirect)window.location=f.dismissRedirect;else{var n=function(){R.removeListener(n);var b=ed(k,ua[a]);R.b(Fb,b,function(a,c){!a&&"object"===typeof c&&c.template&&k.O(c,null,!1)&&k.J(c.template,b,b.branch_view_id||c.event_data.branch_view_data.id,c.event_data.branch_view_data,!1,c.journey_link_data)})};R.addListener("branch_internal_event_didCloseJourney",n)}}
function fd(a,b){return B({url:a&&a.url||Ea(),user_agent:navigator.userAgent,language:navigator.language,screen_width:screen.width||-1,screen_height:screen.height||-1,window_device_pixel_ratio:window.devicePixelRatio||1},b||{})}
function $c(a,b){Dc||(uc=!0);if(Ec&&!Dc){document.body.style.transition="all 00.375s ease";document.getElementById("branch-banner-iframe").style.transition="all 00.25s ease";var c=document.getElementById("branch-iframe-css").innerHTML+"\n";document.getElementById("branch-iframe-css").innerHTML="";document.getElementById("branch-iframe-css").innerHTML=c+"body { -webkit-transition: all 0.375s ease; }\n#branch-banner-iframe { -webkit-transition: all 0.25s ease; }\n"}"top"===O?a.style.top="-"+P:"bottom"===
...
Wc),window.removeEventListener("scroll",Xc));N(R,"didCloseJourney",S);b||N(R,"branch_internal_event_didCloseJourney",S);Cc=!1;setTimeout(function(){uc=!1},250)},Dc?0:270)}
function gd(a){var b={banner_id:kc};if(a&&"object"===typeof a&&0<Object.keys(a).length){var c=["browser_fingerprint_id","app_id","source","open_app","link_click_id"];if(a&&"object"===typeof a&&!Array.isArray(a)&&0<Object.keys(a).length&&c&&Array.isArray(c)&&0<c.length)for(var d in a)a.hasOwnProperty(d)&&-1<c.indexOf(d)&&delete a[d];b.journey_link_data={};B(b.journey_link_data,a)}S=b}function hd(){return jc&&R&&R.m&&R.m.data?R.m.data.$journeys_cta:!1}
function id(){if(hd())return R.m.data.$journeys_cta}function jd(a){try{if(hd()&&0<id().length)return a.replace(/validate[(].+[)];/g,'validate("'+id()+'")').replace("window.top.location.replace(","window.top.location = ")}catch(b){}return a};var U={};
function kd(a,b,c){var d=b?"OPEN":"GET";Jc(a);var e=Kc(a);e&&(d=Mc(e,b),Nc(e));var f=Oc(a);Pc(a);var l=Lc(a);a=Qc(a);var k=Rc();k.onload=function(){var b=a,e=C(),m=k.contentDocument||k.contentWindow.document;m.head=m.createElement("head");m.body=m.createElement("body");m.body.innerHTML=b;m.body.className="ios"===e||"ipad"===e?"branch-banner-ios":"android"===e?"branch-banner-android":"branch-banner-desktop";Sc(l);b=document.createElement("style");b.type="text/css";b.id="branch-css";b.innerHTML=f;H(b);
e=k.contentWindow.document;e.head.appendChild(b);if(oc||nc){var t=e.getElementsByClassName("branch-banner-content")[0];t&&(t.style.height=P)}"top"===O?k.style.top="-"+P:"bottom"===O&&(k.style.bottom="-"+P);try{var t=e.getElementsByClassName("branch-banner-content")[0],u=window.getComputedStyle(t).getPropertyValue("background-color").split(", ");u[3]&&!parseFloat(u[3])&&(k.style.boxShadow="none")}catch(T){}k.contentWindow.document.getElementById("branch-mobile-action").innerHTML=d;N(R,"willShowJourney",
S);Uc(k,l);c(k)};document.body.appendChild(k)}U.O=function(a,b,c){if(document.getElementById("branch-banner")||document.getElementById("branch-banner-iframe")||document.getElementById("branch-banner-container")||!C()||!a.event_data||!a.template)return!1;if(c)return!0;(a=!a.event_data.branch_view_data.id||b&&b.no_journeys)||(a=R,b=a.c.get("globalJourneysDismiss",!0),!0===b||b>Date.now()?a=!0:(a.c.remove("globalJourneysDismiss",!0),a=!1));return a?(U.Ba=1,!1):!0};
...
U.J=function(a,b,c,d,e,f){if(!uc){kc=c;gd(f);var l=d.audience_rule_id;(f=document.getElementById("branch-iframe-css"))&&f.parentElement.removeChild(f);var k=document.createElement("div");k.id="branch-banner";document.body.insertBefore(k,null);Yb(k,"branch-banner-is-active");var h=!1,n=b.callback_string,m=null,t=R.c;if(a){var u=Kc(a)||{};a=jd(a);var T=window.setTimeout(function(){window[n]=function(){}},qa);window[n]=function(a){window.clearTimeout(T);h||(m=a,Zc(c,l,t,m,null,u,e))};kd(a,b.has_app_websdk,
function(a){Bc=a;null===a?h=!0:(Zc(c,l,t,m,a,u,e),ra&&(v["journey-load-time"]=(Date.now()-window.performance.timing.navigationStart).toString()),document.body.removeChild(k),w||e||U.$(d))})}else document.body.removeChild(k),w||e||U.$(d)}};
...
e.event=d?"dismiss":"pageview";e.metadata=a;e=F(e,"initial_referrer",n);e=F(e,"branch_view_id",m);e=F(e,"no_journeys",b.no_journeys);e=F(e,"is_iframe",y());e=F(e,"journey_dismissals",k);e.user_language=h;e.open_app=b.open_app||!1;e.has_app_websdk=l;e.feature="journeys";e.callback_string="branch_view_callback__"+lc++;e.data||(e.data={});e.data=B(Ua(),e.data);e.data=B(Da(f||{}),e.data);c&&(e.data.link_click_id=c);(a=f.data?p(f.data):null)&&a["+referrer"]&&(e.data["+referrer"]=a["+referrer"]);return e=
z(e)};var W={androidAppIndexingTagsPresent:!1,iosAppIndexingTagsPresent:!1,androidDetailsComplete:!1,iosDetailsComplete:!1},X={};function ld(a){var b;"android"===a&&W.androidDetailsComplete&&(b="android-app://"+X.androidPackageName+"/"+X.androidURL,b=md(b),nd(b));"ios"===a&&W.iosDetailsComplete&&(b="ios-app://"+X.iosAppId+"/"+X.iosURL,b=md(b),nd(b))}
function md(a){var b={"~channel":"Firebase App Indexing","~feature":"Auto App Indexing",$canonical_url:Ea()};if("object"===typeof X.data)for(var c in X.data)X.data.hasOwnProperty(c)&&!b.hasOwnProperty(c)&&(b[c]=X.data[c]);return a+(-1<a.indexOf("?")?"&":"?")+"link_click_id=a-"+btoa(q(b))}function nd(a){var b=document.createElement("link");b.setAttribute("rel","alternate");b.setAttribute("href",a);document.head.appendChild(b)}
function od(a){"android"===a&&"string"===typeof X.androidPackageName&&"string"===typeof X.androidURL&&(W.androidDetailsComplete=!0,ld("android"));"ios"===a&&"string"===typeof X.iosAppId&&"string"===typeof X.iosURL&&(W.iosDetailsComplete=!0,ld("ios"))}
function pd(a){for(var b=document.getElementsByTagName("meta"),c=0;c<b.length;c++){var d=b[c];"ios"===a&&"al:ios:app_store_id"===d.getAttribute("property")&&(X.iosAppId=d.getAttribute("content"));"ios"===a&&"al:ios:url"===d.getAttribute("property")&&(X.iosURL=d.getAttribute("content").replace("://","/"));"android"===a&&"al:android:package"===d.getAttribute("property")&&(X.androidPackageName=d.getAttribute("content"));"android"===a&&"al:android:url"===d.getAttribute("property")&&(X.androidURL=d.getAttribute("content").replace("://",
"/"))}od(a)};var qd;
function Y(a,b,c){return function(){var d=this,e,f,l=arguments[arguments.length-1];a&&"function"===typeof l?(e=Array.prototype.slice.call(arguments,0,arguments.length-1)||[],f=l):(f=function(){},e=Array.prototype.slice.call(arguments));d.ca(function(k){function h(b,c){try{if(b&&!a)throw b;1===a?f(b):2===a&&f(b,c)}finally{k()}}if(!c){if(1===d.o)return h(Error(x("Branch SDK initialization pending and a Branch method was called outside of the queue order")),null);if(2===d.o)return h(Error(x("Branch SDK initialization failed, so further methods cannot be called",d.l,
d.s)),null);if(0===d.o||!d.o)return h(Error(x("Branch SDK not initialized")),null)}e.unshift(h);b.apply(d,e)})}}function Z(){if(!(this instanceof Z))return qd||(qd=new Z),qd;this.ca=na();this.c=new Jb(["session","cookie","pojo"]);this.V=new Rb;this.h=[];this.X="web2.58.3";this.l=this.o=0;this.s=null}
...
d){d&&(d=k(d),w||(d=f(d),Ba(h.c,d,t)),h.o=3,d.data_parsed=d.data&&0!==d.data.length?p(d.data):{});if(b)return h.o=2,h.l||(h.l=1,h.s=b.message),a(b,d&&Ca(d));try{a(b,d&&Ca(d))}catch(wd){}finally{h.renderFinalize()}var e=ab(),l=G(c.metadata,"object")?c.metadata:null;l&&(l=hb(e.hosted_deeplink_data,l))&&0<Object.keys(l).length&&(e.hosted_deeplink_data=l);var m=U.I(fd(c,e),c,h,!1);h.renderQueue(function(){h.b(Eb,m,function(a,b){if(!a&&"object"===typeof b){var d=m.branch_view_id?!0:!1;U.O(b,c,d)?U.J(b.template,
m,m.branch_view_id||b.event_data.branch_view_data.id,b.event_data.branch_view_data,d,b.journey_link_data):((b.auto_branchify||!n&&Ma("branchify_url")&&V(h))&&this.branch.deepview({},{make_new_link:!1,open_app:!0,auto_branchify:!0}),N(R,"willNotShowJourney"))}w&&(wa=!0)})})}function f(a){t&&(a.identity=h.g);return a}function l(a){var b={sdk:"2.58.3",branch_key:h.i},c=L(h.c)||{},d=L(h.c,!0)||{};d.browser_fingerprint_id&&(b._t=d.browser_fingerprint_id);Ka()||La()||h.b(kb,b,function(a,b){a&&(h.l=3,h.s=
...
b.substring(0,4)?"https://bnc.lt"+b:b:null}!a.click_id&&a.referring_link&&(a.click_id=Fa(a.referring_link));h.D=a.browser_fingerprint_id;return a}ra&&(v["init-began-at"]=(Date.now()-window.performance.timing.navigationStart).toString());var h=this;h.o=1;-1<b.indexOf("key_")?h.i=b:h.W=b;c=c&&G(c,"object")?c:{};oa=(h.G=c)&&c.retries&&Number.isInteger(c.retries)?c.retries:oa;pa=c&&c.retry_delay&&Number.isInteger(c.retry_delay)?c.retry_delay:pa;qa=c&&c.timeout&&Number.isInteger(c.timeout)?c.timeout:qa;
r=c&&c.nonce?c.nonce:r;w=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;wa=!1;w&&Aa(h);b=L(h.c,!0);h.j=b&&b.identity_id;b=L(h.c);var n=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,m=n||Ma("_branch_match_id")||Ga(),t=!h.j;h.C=!!h.c.get("branch_view_enabled");if(b&&b.session_id&&!m&&!Ma("branchify_url"))Pb(h.c,{data:""}),Pb(h.c,{referring_link:""}),d(),l(e);else{b={sdk:"2.58.3",branch_key:h.i};var u=L(h.c,!0)||{};u.browser_fingerprint_id&&(b._t=
u.browser_fingerprint_id);u.identity&&(h.g=u.identity);var T=parseInt(Ma("[?&]_open_delay_ms"),10);Ka()||La()?ib(function(){h.b(jb,{link_identifier:m,browser_fingerprint_id:m||u.browser_fingerprint_id,alternative_browser_fingerprint_id:u.browser_fingerprint_id,options:c,initial_referrer:gb(V(h)),current_url:y()&&Ha()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(h.l=2,h.s=a.message);a||"object"!==typeof b||(b.branch_view_enabled&&
(h.C=!!b.branch_view_enabled,h.c.set("branch_view_enabled",h.C)),m&&(b.click_id=m));d();e(a,b)})},T):h.b(kb,b,function(a,b){if(a)return h.l=3,h.s=a.message,e(a,null);ib(function(){h.b(jb,{link_identifier:m,browser_fingerprint_id:m||b,alternative_browser_fingerprint_id:u.browser_fingerprint_id,options:c,initial_referrer:gb(V(h)),current_url:y()&&Ha()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(h.l=2,h.s=a.message);a||
...
yb,b,function(b,c){if(b)return w||(d.v=function(){window.top.location=e}),a(b);"function"===typeof c&&(d.v=c);a(null)});d.w()});
...
Z.prototype.addListener=function(a,b){"function"===typeof a&&void 0===b&&(b=a,a=null);b&&this.h.push({listener:b,event:a||null})};Z.prototype.removeListener=function(a){a&&(this.h=this.h.filter(function(b){if(b.listener!==a)return b}))};function rd(a,b,c){c=c||{};try{a.m=p(q(c))}finally{a.m=a.m||{}}b()}Z.prototype.setBranchViewData=Y(1,function(a,b){rd.call(null,this,a,b)},!0);
Z.prototype.closeJourney=Y(1,function(a){var b=this;b.renderQueue(function(){if(Bc&&Cc)N(b,"didCallJourneyClose",S),$c(Bc,!0);else return a("Journey already dismissed.")});a()});
Z.prototype.banner=Y(1,function(a,b,c){c=c||{};rd.call(null,this,function(){},c);"undefined"===typeof b.showAgain&&"undefined"!==typeof b.forgetHide&&(b.showAgain=b.forgetHide);var d={icon:E(b.icon)||"",title:E(b.title)||"",description:E(b.description)||"",M:"number"===typeof b.reviewCount&&0<b.reviewCount?Math.floor(b.reviewCount):null,B:"number"===typeof b.rating&&5>=b.rating&&0<b.rating?Math.round(2*b.rating)/2:null,na:E(b.openAppButtonText)||"View in app",ka:E(b.downloadAppButtonText)||"Download App",
...
Z.prototype.autoAppIndex=Y(1,function(a,b){b=b||{};var c=document.getElementsByTagName("link"),d=c.length;if(d)for(var e=0;e<d;e++){var f=c[e],l=f.href;l&&(l.includes("ios-app")&&(W.iosAppIndexingTagsPresent=!0,f.setAttribute("href",md(l))),l.includes("android-app")&&(W.androidAppIndexingTagsPresent=!0,f.setAttribute("href",md(l))))}X=b;W.androidAppIndexingTagsPresent||(od("android"),W.androidDetailsComplete||pd("android"));W.iosAppIndexingTagsPresent||(od("ios"),W.iosDetailsComplete||pd("ios"));
