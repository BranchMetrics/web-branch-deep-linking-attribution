(function() {for(var aa="function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){if(c.get||c.set)throw new TypeError("ES3 does not support getters and setters.");a!=Array.prototype&&a!=Object.prototype&&(a[b]=c.value)},l="undefined"!=typeof window&&window===this?this:"undefined"!=typeof global&&null!=global?global:this,ba=["String","prototype","includes"],ca=0;ca<ba.length-1;ca++){var da=ba[ca];da in l||(l[da]={});l=l[da]}
var ea=ba[ba.length-1],fa=l[ea],ga=fa?fa:function(a,b){if(null==this)throw new TypeError("The 'this' value for String.prototype.includes must not be null or undefined");if(a instanceof RegExp)throw new TypeError("First argument to String.prototype.includes must not be a regular expression");return-1!==(this+"").indexOf(a,b||0)};ga!=fa&&null!=ga&&aa(l,ea,{configurable:!0,writable:!0,value:ga});
...
function na(a,b,c){if(null==b)c.push("null");else{if("object"==typeof b){if("array"==ha(b)){var d=b;b=d.length;c.push("[");for(var e="",g=0;g<b;g++)c.push(e),na(a,d[g],c),e=",";c.push("]");return}if(b instanceof String||b instanceof Number||b instanceof Boolean)b=b.valueOf();else{c.push("{");e="";for(d in b)Object.prototype.hasOwnProperty.call(b,d)&&(g=b[d],"function"!=typeof g&&(c.push(e),pa(d,c),c.push(":"),na(a,g,c),e=","));c.push("}");return}}switch(typeof b){case "string":pa(b,c);break;case "number":c.push(isFinite(b)&&
...
function pa(a,b){b.push('"',a.replace(ra,function(b){var a=qa[b];a||(a="\\u"+(b.charCodeAt(0)|65536).toString(16).substr(1),qa[b]=a);return a}),'"')};function q(a){a=String(a);try{return JSON.parse(a)}catch(b){}throw Error("Invalid JSON string: "+a);}function t(a){try{return"object"===typeof JSON&&"function"===typeof JSON.stringify?JSON.stringify(a):n(a)}catch(b){}throw Error("Could not stringify object");};function sa(){function a(){if(b.length)b[0](function(){b.shift();a()})}var b=[];return function(c){b.push(c);1===b.length&&a()}};function u(a,b,c){a=a.replace(/\$(\d)/g,function(a,c){return b[parseInt(c,10)-1]});c&&(a+="\n Failure Code:"+c);return a}function ta(a){return{data:a.data||"",data_parsed:a.data_parsed||{},has_app:a.has_app||null,identity:a.identity||null,referring_identity:a.referring_identity||null,referring_link:a.referring_link||null}}
...
function Ca(a){var b="",c,d,e,g,f,k,h=0;a=a.replace(/\r\n/g,"\n");d="";for(e=0;e<a.length;e++)g=a.charCodeAt(e),128>g?d+=String.fromCharCode(g):(127<g&&2048>g?d+=String.fromCharCode(g>>6|192):(d+=String.fromCharCode(g>>12|224),d+=String.fromCharCode(g>>6&63|128)),d+=String.fromCharCode(g&63|128));for(a=d;h<a.length;)c=a.charCodeAt(h++),d=a.charCodeAt(h++),e=a.charCodeAt(h++),g=c>>2,c=(c&3)<<4|d>>4,f=(d&15)<<2|e>>6,k=e&63,isNaN(d)?k=f=64:isNaN(e)&&(k=64),b=b+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(g)+
"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(c)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(f)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(k);return b}function Da(a,b,c){"function"===typeof a.addEventListener?a.addEventListener(b,c,void 0):"function"===typeof a.attachEvent?a.attachEvent("on"+b,c):a["on"+b]=c}
...
b(e):b(e))}},isEnabled:function(){return navigator.cookieEnabled}}}E.prototype.cookie=function(){return hb(!1)};E.prototype.permcookie=function(){return hb(!0)};E.prototype.pojo={getAll:function(){return this.s},get:function(a){return this.s[a]||null},set:function(a,b){this.s[a]=b},remove:function(a){delete this.s[a]},clear:function(){this.s={}},isEnabled:function(){return!0}};function H(a,b){try{return q(a.get(b?"branch_session_first":"branch_session",b))||null}catch(c){return null}}function ib(a,b,c){a.set("branch_session",n(b));c&&a.set("branch_session_first",n(b),!0)}function jb(a,b){if(b){var c=H(a)||{},c=w(c,b);a.set("branch_session",n(c))}};function kb(){}kb.prototype.g=0;function lb(a,b,c){if("undefined"===typeof b)return"";var d=[];if(b instanceof Array){for(a=0;a<b.length;a++)d.push(encodeURIComponent(c)+"="+encodeURIComponent(b[a]));return d.join("&")}for(var e in b)b.hasOwnProperty(e)&&(b[e]instanceof Array||"object"===typeof b[e]?d.push(lb(a,b[e],c?c+"."+e:e)):d.push(encodeURIComponent(c?c+"."+e:e)+"="+encodeURIComponent(b[e])));return d.join("&")}
function mb(a,b,c){function d(a,c){"undefined"===typeof c&&(c={});if(a.branch_key&&h.test(a.branch_key))return c.branch_key=a.branch_key,c;if(a.app_id&&k.test(a.app_id))return c.app_id=a.app_id,c;throw Error(u("API request $1 missing parameter $2",[b.endpoint,"branch_key or app_id"]));}var e,g,f=b.destination+b.endpoint,k=/^[0-9]{15,20}$/,h=/key_(live|test)_[A-Za-z0-9]{32}/;if("/v1/has-app"===b.endpoint)try{b.f=d(c,b.f)}catch(r){return{error:r.message}}if("undefined"!==typeof b.f)for(e in b.f)if(b.f.hasOwnProperty(e)){if(g=
...
b.endpoint&&(m.options=t(m.options||{}));return{data:lb(a,m,""),url:f.replace(/^\//,"")}}function ob(a,b,c){var d=document.createElement("script");d.type="text/javascript";d.async=!0;d.src=a;a=document.getElementsByTagName("head");!a||1>a.length?"function"===typeof b&&b():(a[0].appendChild(d),"function"===typeof b&&Da(d,"error",b),"function"===typeof c&&Da(d,"load",c))}
function pb(a,b,c,d,e){var g="branch_callback__"+a.g++;a=0<=b.indexOf("branch.io")?"&data=":"&post_data=";c="POST"===d?encodeURIComponent(Ca(n(c))):"";var f=window.setTimeout(function(){window[g]=function(){};e(Error("Request timed out"),null,504)},5E3);window[g]=function(a){window.clearTimeout(f);e(null,a)};ob(b+(0>b.indexOf("?")?"?":"")+(c?a+c:"")+(0<=b.indexOf("/c/")?"&click=1":"")+"&callback="+g,function(){e(Error("Request blocked by client, probably adblock"),null)},function(){try{"function"===
typeof this.remove?this.remove():this.parentNode.removeChild(this)}catch(k){}delete window[g]})}
function qb(a,b,c,d,e,g,f){var k=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");k.ontimeout=function(){g(Error("Request timed out"),null,504)};k.onerror=function(a){g(Error(a.error||"Error in API: "+k.status),null,k.status)};k.onreadystatechange=function(){var a;if(4===k.readyState)if(200===k.status){if(f)a=k.responseText;else try{a=q(k.responseText)}catch(m){a={}}g(null,a,k.status)}else 402===k.status?g(Error("Not enough credits to redeem."),null,k.status):"4"!==
k.status.toString().substring(0,1)&&"5"!==k.status.toString().substring(0,1)||g(Error("Error in API: "+k.status),null,k.status)};try{k.open(d,b,!0),k.timeout=5E3,k.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),k.send(c)}catch(h){e.set("use_jsonp",!0),pb(a,b,c,d,g)}}
function rb(a,b,c,d,e){function g(){d.get("use_jsonp")||b.U?pb(a,h,c,b.method,f):qb(a,h,m,b.method,d,f)}function f(a,b,c){a&&0<r&&"5"===(c||"").toString().substring(0,1)?(r--,window.setTimeout(function(){g()},200)):e(a,b)}var k=mb(a,b,c);if(k.error)return e(Error(t({message:k.error,endpoint:b.endpoint,data:c})));var h,m="";"GET"===b.method?h=k.url+"?"+k.data:(h=k.url,m=k.data);var r=2;g()};function I(a){a&&a.parentNode.removeChild(a)}function sb(a,b){a&&!a.className.match(new RegExp("(\\s|^)"+b+"(\\s|$)"))&&(a.className+=" "+b)}function tb(a){var b=document.body;b&&b.className.match(new RegExp("(\\s|^)"+a+"(\\s|$)"))&&(b.className=b.className.replace(new RegExp("(\\s|^)"+a+"(\\s|$)")," "))}function ub(a){var b=new Date;return b.setDate(b.getDate()+a)}
...
d.contentWindow.document.write(c);d.contentWindow.document.close()}else d=document.createElement("div"),d.id="branch-banner",d.className="branch-animation",d.innerHTML=Ab(a,c),document.body.appendChild(d);return c=d};function Cb(a,b,c,d){function e(){f();h.style.background="#FFD4D4";k.className="error";setTimeout(function(){h.style.background="#FFFFFF";k.className=""},2E3)}function g(){p=a.createElement("div");p.className="branch-icon-wrapper";p.id="branch-checkmark";p.style="opacity: 0;";p.innerHTML=window.ActiveXObject?'<span class="checkmark">&#x2713;</span>':'<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 98.5 98.5" enable-background="new 0 0 98.5 98.5" xml:space="preserve"><path class="checkmark" fill="none" stroke-width="8" stroke-miterlimit="10" d="M81.7,17.8C73.5,9.3,62,4,49.2,4C24.3,4,4,24.3,4,49.2s20.3,45.2,45.2,45.2s45.2-20.3,45.2-45.2c0-8.6-2.4-16.6-6.5-23.4l0,0L45.6,68.2L24.7,47.3"/></svg>';
r.appendChild(p);h.style.opacity="0";k.style.opacity="0";m.style.opacity="0";setTimeout(function(){p.style.opacity="1"},20);k.value=""}function f(){h.removeAttribute("disabled");k.removeAttribute("disabled");h.style.opacity="1";k.style.opacity="1";m.style.opacity="0"}var k=a.getElementById("branch-sms-phone"),h=a.getElementById("branch-sms-send"),m=a.getElementById("branch-loader-wrapper"),r=a.getElementById("branch-sms-form-container"),p;if(k){var F=k.value;/^\d{7,}$/.test(F.replace(/[\s()+\-\.]|ext/gi,
""))?(J(b,"willSendBannerSMS"),h.setAttribute("disabled",""),k.setAttribute("disabled",""),h.style.opacity=".4",k.style.opacity=".4",m.style.opacity="1",k.className="",b.sendSMS(F,d,c,function(a){a?(J(b,"sendBannerSMSError"),e()):(J(b,"didSendBannerSMS"),g(),setTimeout(function(){r.removeChild(p);f()},3E3))})):e()}}
function Db(a,b,c,d){function e(a,c){"function"===typeof a&&(c=a,a={});a=a||{};"top"===b.position?f.style.top="-76px":"bottom"===b.position&&(f.style.bottom="-76px");"number"===typeof b.F?d.set("hideBanner",ub(b.F),!0):d.set("hideBanner",!0,!0);a.T?("top"===b.position?document.body.style.marginTop=m:"bottom"===b.position&&(document.body.style.marginBottom=p),tb("branch-banner-is-active"),I(f),I(document.getElementById("branch-css")),c()):(setTimeout(function(){I(f);I(document.getElementById("branch-css"));
c()},270),setTimeout(function(){"top"===b.position?document.body.style.marginTop=m:"bottom"===b.position&&(document.body.style.marginBottom=p);tb("branch-banner-is-active")},20))}function g(){"top"===b.position?f.style.top="0":"bottom"===b.position&&(f.style.bottom="0");J(a,"didShowBanner")}if(!xb(d,b))return J(a,"willNotShowBanner"),null;J(a,"willShowBanner");var f=Bb(b,d);zb(b,f);c.channel=c.channel||"app banner";var k=b.w?f.contentWindow.document:document;if(x()){b.open_app=b.ga;b.append_deeplink_path=
b.Z;b.make_new_link=b.da;b.deepview_type="banner";a.deepview(c,b);var h=k.getElementById("branch-mobile-action");h&&(h.onclick=function(b){b.preventDefault();a.deepviewCta()})}else k.getElementById("sms-form")?k.getElementById("sms-form").addEventListener("submit",function(d){d.preventDefault();Cb(k,a,b,c)}):f.onload=function(){k=f.contentWindow.document;k.getElementById("sms-form")&&k.getElementById("sms-form").addEventListener("submit",function(d){d.preventDefault();Cb(k,a,b,c)})};var h=vb("margin-top"),
m=document.body.style.marginTop,r=vb("margin-bottom"),p=document.body.style.marginBottom,F=k.getElementById("branch-banner-close");F&&(F.onclick=function(b){b.preventDefault();J(a,"willCloseBanner");e({},function(){J(a,"didCloseBanner")})});sb(document.body,"branch-banner-is-active");"top"===b.position?document.body.style.marginTop=wb(h):"bottom"===b.position&&(document.body.style.marginBottom=wb(r));b.T?g():setTimeout(g,20);return e};var Eb,K="top",L="absolute",M="76px",N=!1,Fb=!1,O=[],Gb=window.innerHeight,Hb=window.innerWidth;window.innerHeight<window.innerWidth&&(Gb=window.innerWidth,Hb=window.innerHeight);
var Ib=0,Jb=0,Kb=/<script type="application\/json">((.|\s)*?)<\/script>/,Lb=/<script type="text\/javascript">((.|\s)*?)<\/script>/,Mb=/<style type="text\/css" id="branch-css">((.|\s)*?)<\/style>/,Nb=/#branch-banner-spacer {((.|\s)*?)}/,Ob=/margin-bottom: (.*?);/,Pb=/<script id="journeyLinkData" type="application\/json">((.|\s)*?)<\/script>/,P=null,Qb=null,Rb=!1,Q=!1,Sb=!1,R=!1,Tb=!1,Ub="",S=[],T=null;function Vb(a){if(a=a.match(Kb))return q(a[1])}
function Wb(){var a=document.createElement("style");a.type="text/css";a.id="branch-iframe-css";Ib=vb("margin-top");var b=+Ib.slice(0,-2);Jb=vb("margin-bottom");var c=+Jb.slice(0,-2),d=+M.slice(0,-2);"top"===K?document.body.style.marginTop=(+d+b).toString()+"px":"bottom"===K&&(document.body.style.marginBottom=(+d+c).toString()+"px");0<O.length&&O.forEach(function(a){var b,c=window.getComputedStyle(a);c&&(b=N&&"fixed"===c.getPropertyValue("position"));b||(a.style.marginTop=M)});"top"===Ub&&Ub!==K&&
Tb&&S&&0<S.length&&S.forEach(function(a){a.style.marginTop=0});Tb=!1;Ub="";S=[];R=!1;a.innerHTML=Xb();document.head.appendChild(a)}
function Xb(){var a="",b="";document.body.style.transition="";document.getElementById("branch-banner-iframe")&&(document.getElementById("branch-banner-iframe").style.transition="");Sb||(a="body { -webkit-transition: all 0.375s ease; }\n",document.body.style.transition="all 00.375s ease",b="-webkit-transition: all 0.25s ease; transition: all 00.25s ease;");return(a?a:"")+("#branch-banner-iframe { box-shadow: 0 0 5px rgba(0, 0, 0, .35); width: 1px; min-width:100%; left: 0; right: 0; border: 0; height: "+
M+"; z-index: 99999; "+b+" }\n#branch-banner-iframe { position: "+L+"; }\n@media only screen and (orientation: landscape) { body { "+("top"===K?"margin-top: ":"margin-bottom: ")+(N?Hb+"px":M)+"; }\n#branch-banner-iframe { height: "+(N?Hb+"px":M)+"; }")}function Yb(a){sb(document.body,"branch-banner-is-active");N&&"fixed"===L&&sb(document.body,"branch-banner-no-scroll");setTimeout(function(){"top"===K?a.style.top="0":"bottom"===K&&(a.style.bottom="0");J(P,"didShowJourney",T);Rb=!0},20)}
function Zb(a){var b=7;if(a=a.match(Kb))a=q(a[1])||{},"number"===typeof a.dismissPeriod&&(b=a.dismissPeriod);return-1===b?!0:ub(b)}
function $b(a,b,c,d,e){Qb=d;if(c&&d){var g=d.contentWindow.document;Array.prototype.forEach.call(g.querySelectorAll("#branch-mobile-action"),function(a){a.addEventListener("click",function(){J(P,"didClickJourneyCTA",T);R=!0;c();ac(d)})});var f=g.querySelectorAll(".branch-banner-continue");Array.prototype.forEach.call(f,function(c){c.addEventListener("click",function(){J(P,"didClickJourneyContinue",T);R=!0;ac(d);b.set("hideBanner"+a.id,e,!0)})});f=g.querySelectorAll(".branch-banner-close");Array.prototype.forEach.call(f,
function(c){c.addEventListener("click",function(){J(P,"didClickJourneyClose",T);R=!0;ac(d);b.set("hideBanner"+a.id,e,!0)})})}}
function ac(a){if(Sb&&!Q){document.body.style.transition="all 00.375s ease";document.getElementById("branch-banner-iframe").style.transition="all 00.25s ease";var b=document.getElementById("branch-iframe-css").innerHTML+"\n";document.getElementById("branch-iframe-css").innerHTML="";document.getElementById("branch-iframe-css").innerHTML=b+"body { -webkit-transition: all 0.375s ease; }\n#branch-banner-iframe { -webkit-transition: all 0.25s ease; }\n"}"top"===K?a.style.top="-"+M:"bottom"===K&&(a.style.bottom=
"-"+M);J(P,"willCloseJourney",T);setTimeout(function(){I(a);I(document.getElementById("branch-css"));I(document.getElementById("branch-iframe-css"));I(document.getElementById("branch-journey-cta"));(!Q||R)&&O&&0<O.length?O.forEach(function(a){a.style.marginTop=0}):(Tb=Q,Ub=K,S=O);"top"===K?document.body.style.marginTop=Ib:"bottom"===K&&(document.body.style.marginBottom=Jb);tb("branch-banner-is-active");tb("branch-banner-no-scroll");J(P,"didCloseJourney",T);Rb=!1},Q?0:270)};var bc=1;
function cc(a,b){var c={banner_id:Eb},d=a.match(Pb);if(d&&(d=q(d[1]))){var e=d.journey_link_data,g=["browser_fingerprint_id","app_id","source","open_app","link_click_id"];if(e&&"object"===typeof e&&!Array.isArray(e)&&0<Object.keys(e).length&&g&&Array.isArray(g)&&0<g.length)for(var f in e)e.hasOwnProperty(f)&&-1<g.indexOf(f)&&delete e[f];c=w(c,d)}T=c;J(P,"willShowJourney",T);c=b?"OPEN":"GET";f=a;(d=Vb(f))&&d.bannerHeight&&d.position&&d.sticky?(M=d.bannerHeight,K=d.position,L=d.sticky):(f=f.match(Nb))?
(K="top",(f=f[1].match(Ob))&&(M=f[1]),L="absolute"):(K="bottom",L="fixed");if(-1!==M.indexOf("vh")||-1!==M.indexOf("%"))f=M.indexOf("vh")?M.slice(0,-2):M.slice(0,-1),M=f/100*Gb+"px",100>f?Fb=!0:N=!0;if(f=Vb(a)){var k;b&&f&&f.ctaText&&f.ctaText.has_app?k=f.ctaText.has_app:f&&f.ctaText&&f.ctaText.no_app&&(k=f.ctaText.no_app);c=k;O=[];if(f&&f.injectorSelector&&(k=document.querySelectorAll(f.injectorSelector)))for(f=0;f<k.length;f++)O.push(k[f].parentElement)}k=(k=a.match(Mb))?k[1]:void 0;if(f=a.match(Lb))f=
f[1],d=document.createElement("script"),d.id="branch-journey-cta",d.innerHTML=f,document.body.appendChild(d);f=a;var d=f.match(Kb),e=f.match(Lb),g=f.match(Mb),h=f.match(Pb);d&&(f=f.replace(Kb,""));e&&(f=f.replace(Lb,""));g&&(f=f.replace(Mb,""));h&&(f=f.replace(Pb,""));a=f;f=document.createElement("iframe");f.src="about:blank";f.style.overflow="hidden";f.scrolling="no";f.id="branch-banner-iframe";f.className="branch-animation";document.body.appendChild(f);d=x();d='<html><head></head><body class="'+
("ios"===d||"ipad"===d?"branch-banner-ios":"android"===d?"branch-banner-android":"branch-banner-desktop")+'">'+a+"</body></html>";f.contentWindow.document.open();f.contentWindow.document.write(d);f.contentWindow.document.close();Wb();d=document.createElement("style");d.type="text/css";d.id="branch-css";d.innerHTML=k;k=f.contentWindow.document;k.head.appendChild(d);if(Fb||N){var m=k.getElementsByClassName("branch-banner-content")[0];m&&(m.style.height=M)}"top"===K?f.style.top="-"+M:"bottom"===K&&(f.style.bottom=
"-"+M);try{var m=k.getElementsByClassName("branch-banner-content")[0],r=window.getComputedStyle(m).getPropertyValue("background-color").split(", ");r[3]&&!parseFloat(r[3])&&(f.style.boxShadow="none")}catch(p){}f.contentWindow.document.getElementById("branch-mobile-action").innerHTML=c;Yb(f);return f}
function dc(a,b,c,d,e,g,f){if(!(document.getElementById("branch-banner")||document.getElementById("branch-banner-iframe")||document.getElementById("branch-banner-container"))){P=f;var k=null,h=null;c=c||{};c.feature="journeys";c=wa(c);(f=document.getElementById("branch-iframe-css"))&&f.parentElement.removeChild(f);var m=document.createElement("div");m.id="branch-banner";document.body.insertBefore(m,null);sb(m,"branch-banner-is-active");if(b.html)cc(b.html,e);else if(b.url){var r="branch_view_callback__"+
bc++;c=encodeURIComponent(Ca(n(c)));f=b.url+"&callback="+r;f+="&_lan="+(P.ma||Ha());qb(a,f+("&data="+c),{},"GET",{},function(a,c){var f=!1;if(!a&&c){var gb=g?0:Zb(c),nb=window.setTimeout(function(){window[r]=function(){}},5E3);window[r]=function(a){window.clearTimeout(nb);f||(h=a,$b(b,d,h,k,gb))};k=cc(c,e);if(null===k){f=!0;return}$b(b,d,h,k,gb)}document.body.removeChild(m)},!0)}}}
function ec(a,b){var c=b.b.get("hideBanner"+a.id,!0);if(!0===c||c>Date.now())return!0;b.b.remove("hideBanner"+a.id,!0);return!1}
function fc(a,b,c,d,e){e.m=!!c.branch_view_enabled;e.b.set("branch_view_enabled",e.m);var g=null,f=null,k=null,h=null,m=null,r=!1,p=!1,F=!1;d&&(g=d.branch_view_id||null,f=d.no_journeys||null,e.ma=d.user_language||Ha(),Sb=d.disable_entry_animation||!1,Q=d.disable_exit_animation||!1,p=d.make_new_link||!1,F=d.open_app||!1);(g=g||va()||null)&&x()&&(r=!0,h={id:g,ua:-1,url:"https://api.branch.io/v1/branchview/"+a+"/"+g+"?_a=audience_rule_id&_t="+b.D});!h&&c.hasOwnProperty("branch_view_data")&&(h=c.branch_view_data,
k=ec(h,e));!h||k||f?J(e,"willNotShowJourney"):(Eb=h.id,e.renderQueue(function(){var a=p,c=F,d=e.A||{};d.data||(d.data={});a=a?null:xa(gc(e));d.data=w(Ga(),d.data);d.data=w(ua(H(e.b)||{}),d.data);d.data=a?w({link_click_id:a},d.data):d.data;m=d=w({open_app:c},d);dc(e.N,h,m,e.b,b.has_app,r,e)}))};var V={androidAppIndexingTagsPresent:!1,iosAppIndexingTagsPresent:!1,androidDetailsComplete:!1,iosDetailsComplete:!1},W={};function hc(a){var b;"android"===a&&V.androidDetailsComplete&&(b="android-app://"+W.androidPackageName+"/"+W.androidURL,b=ic(b),jc(b));"ios"===a&&V.iosDetailsComplete&&(b="ios-app://"+W.iosAppId+"/"+W.iosURL,b=ic(b),jc(b))}
function ic(a){var b={"~channel":"Firebase App Indexing","~feature":"Auto App Indexing",$canonical_url:String(window.location)};if("object"===typeof W.data)for(var c in W.data)W.data.hasOwnProperty(c)&&!b.hasOwnProperty(c)&&(b[c]=W.data[c]);return a+(-1<a.indexOf("?")?"&":"?")+"link_click_id=a-"+btoa(t(b))}function jc(a){var b=document.createElement("link");b.setAttribute("rel","alternate");b.setAttribute("href",a);document.head.appendChild(b)}
function kc(a){"android"===a&&"string"===typeof W.androidPackageName&&"string"===typeof W.androidURL&&(V.androidDetailsComplete=!0,hc("android"));"ios"===a&&"string"===typeof W.iosAppId&&"string"===typeof W.iosURL&&(V.iosDetailsComplete=!0,hc("ios"))}
function lc(a){for(var b=document.getElementsByTagName("meta"),c=0;c<b.length;c++){var d=b[c];"ios"===a&&"al:ios:app_store_id"===d.getAttribute("property")&&(W.iosAppId=d.getAttribute("content"));"ios"===a&&"al:ios:url"===d.getAttribute("property")&&(W.iosURL=d.getAttribute("content").replace("://","/"));"android"===a&&"al:android:package"===d.getAttribute("property")&&(W.androidPackageName=d.getAttribute("content"));"android"===a&&"al:android:url"===d.getAttribute("property")&&(W.androidURL=d.getAttribute("content").replace("://",
"/"))}kc(a)};var mc;
function X(a,b,c){return function(){var d=this,e,g,f=arguments[arguments.length-1];a&&"function"===typeof f?(e=Array.prototype.slice.call(arguments,0,arguments.length-1)||[],g=f):(g=function(){},e=Array.prototype.slice.call(arguments));d.X(function(f){function h(b,c){try{if(b&&!a)throw b;1===a?g(b):2===a&&g(b,c)}finally{f()}}if(!c){if(1===d.j)return h(Error(u("Branch SDK initialization pending and a Branch method was called outside of the queue order")),null);if(2===d.j)return h(Error(u("Branch SDK initialization failed, so further methods cannot be called",d.h,
d.l)),null);if(0===d.j||!d.j)return h(Error(u("Branch SDK not initialized")),null)}e.unshift(h);b.apply(d,e)})}}function Y(){if(!(this instanceof Y))return mc||(mc=new Y),mc;this.X=sa();this.b=new E(["session","cookie","pojo"]);this.N=new kb;this.g=[];this.P="web2.26.0";this.h=this.j=0;this.l=null}
...
b,this.b,function(a,b){c(a,b)})};function gc(a){var b=H(a.b);return(b=b&&b.referring_link)?b:(a=a.b.get("click_id"))?"https://bnc.lt/c/"+a:null}function J(a,b,c){for(var d=0;d<a.g.length;d++)a.g[d].event&&a.g[d].event!==b||a.g[d].listener(b,c)}
Y.prototype.init=X(2,function(a,b,c){function d(){var a,b;"undefined"!==typeof document.hidden?(a="hidden",b="visibilitychange"):"undefined"!==typeof document.mozHidden?(a="mozHidden",b="mozvisibilitychange"):"undefined"!==typeof document.msHidden?(a="msHidden",b="msvisibilitychange"):"undefined"!==typeof document.webkitHidden&&(a="webkitHidden",b="webkitvisibilitychange");b&&document.addEventListener(b,function(){document[a]||(f(null),"function"===typeof h.C&&h.C())},!1)}function e(d,e){e&&(e=k(e),
ib(h.b,e,F),h.j=3,e.data_parsed=e.data&&0!==e.data.length?q(e.data):{});if(d)return h.j=2,h.h||(h.h=1,h.l=d.message),a(d,e&&ta(e));var f=Ma();h.c(cb,{event:"pageview",metadata:w({url:r,user_agent:navigator.userAgent,language:navigator.language,page_has_microdata:g(),screen_width:screen.width||-1,screen_height:screen.height||-1},f||{}),initial_referrer:document.referrer},function(d,f){d||"object"!==typeof f||fc(b,e,f,c,h);try{a(d,e&&ta(e))}catch(rc){}finally{h.renderFinalize()}})}function g(){var a=
!1;try{a=!!(document.querySelectorAll('*[itemtype^="http://schema.org"]')||[]).length}catch(nb){a=!1}return a}function f(a){var b={sdk:"2.26.0",branch_key:h.i},c=H(h.b)||{},d=H(h.b,!0)||{};d.browser_fingerprint_id&&(b._t=d.browser_fingerprint_id);za()||h.c(Oa,b,function(a,b){a&&(h.h=3,h.l=a.message);b&&(c.browser_fingerprint_id=b)});h.c(bb,{browser_fingerprint_id:c.browser_fingerprint_id},function(b,d){b&&(h.h=4,h.l=b.message);b||!d||c.has_app||(c.has_app=!0,jb(h.b,c),J(h,"didDownloadApp"));a&&a(null,
c)})}function k(a){a.link_click_id&&(h.V=a.link_click_id.toString());a.session_id&&(h.H=a.session_id.toString());a.identity_id&&(h.v=a.identity_id.toString());a.link&&(h.W=a.link);if(a.referring_link){var b=a.referring_link;a.referring_link=b?"http"!==b.substring(0,4)?"https://bnc.lt"+b:b:null}!a.click_id&&a.referring_link&&(a.click_id=xa(a.referring_link));h.D=a.browser_fingerprint_id;return a}var h=this;h.j=1;-1<b.indexOf("key_")?h.i=b:h.O=b;c=c&&"function"===typeof c?{}:c;var m=H(h.b),r=c&&c.url||
String(window.location),p=(c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null)||Aa()||ya(),F=!m||!m.identity_id;h.m=!!h.b.get("branch_view_enabled");if(m&&m.session_id&&!p)jb(h.b,{data:""}),d(),f(e);else{var m={sdk:"2.26.0",branch_key:h.i},U=H(h.b,!0)||{};U.browser_fingerprint_id&&(m._t=U.browser_fingerprint_id);za()?h.c(Na,{link_identifier:p,browser_fingerprint_id:p||U.browser_fingerprint_id,alternative_browser_fingerprint_id:U.browser_fingerprint_id,options:c,
initial_referrer:document.referrer},function(a,b){a&&(h.h=2,h.l=a.message);a||"object"!==typeof b||(h.m=!!b.branch_view_enabled,h.b.set("branch_view_enabled",h.m),p&&(b.click_id=p));d();e(a,b)}):h.c(Oa,m,function(a,b){if(a)return h.h=3,h.l=a.message,e(a,null);h.c(Na,{link_identifier:p,browser_fingerprint_id:p||b,alternative_browser_fingerprint_id:U.browser_fingerprint_id,options:c,initial_referrer:document.referrer},function(a,b){a&&(h.h=2,h.l=a.message);a||"object"!==typeof b||(h.m=!!b.branch_view_enabled,
h.b.set("branch_view_enabled",h.m),p&&(b.click_id=p));d();e(a,b)})})}},!0);Y.prototype.renderQueue=X(0,function(a,b){this.Y?b():(this.o=this.o||[],this.o.push(b));a(null,null)});Y.prototype.renderFinalize=X(2,function(a){this.o&&0<this.o.length&&(this.o.forEach(function(a){a.call(this)}),delete this.o);this.Y=!0;a(null,null)});Y.prototype.data=X(2,function(a){var b=ta(H(this.b));b.referring_link=gc(this);b.data_parsed=b.data&&0!==b.data.length?q(b.data):{};a(null,b)});
Y.prototype.first=X(2,function(a){a(null,ta(H(this.b,!0)))});Y.prototype.setIdentity=X(2,function(a,b){var c=this;this.c(Va,{identity:b},function(d,e){d&&a(d);e=e||{};c.v=e.identity_id?e.identity_id.toString():null;c.W=e.link;c.S=b;e.referring_data_parsed=e.referring_data?q(e.referring_data):null;jb(c.b,e);a(null,e)})});
...
Y.prototype.track=X(1,function(a,b,c,d){var e=this;c=c||{};d=d||{};e.c(cb,{event:b,metadata:w({url:document.URL,user_agent:navigator.userAgent,language:navigator.language},c),initial_referrer:document.referrer},function(c,f){c||"object"!==typeof f||"pageview"!==b||fc(e.i,H(e.b),f,d,e);"function"===typeof a&&a.apply(this,arguments)})});Y.prototype.link=X(2,function(a,b){this.c($a,wa(b),function(b,d){a(b,d&&d.url)})});
Y.prototype.sendSMS=X(1,function(a,b,c,d){function e(c){g.c(Qa,{link_url:c,phone:b},function(b){a(b||null)})}var g=this;if("function"===typeof d)d={};else if("undefined"===typeof d||null===d)d={};d.make_new_link=d.make_new_link||!1;c.channel&&"app banner"!==c.channel||(c.channel="sms");var f=gc(g);f&&!d.make_new_link?e(f.substring(f.lastIndexOf("/")+1,f.length)):g.c($a,wa(c),function(b,c){if(b)return a(b);var d=c.url;/(bnc.lt\/|app\.link\/)/.test(d)||(d="https://bnc.lt/"+Ea(d));g.c(Pa,{link_url:d,
click:"click"},function(b,c){if(b)return a(b);e(c.click_id)})})});
Y.prototype.deepview=X(1,function(a,b,c){var d=this;c||(c={});c.deepview_type="undefined"===typeof c.deepview_type?"deepview":"banner";b.data=w(Ga(),b.data);var e="https://bnc.lt/a/"+d.i,g=!0,f;for(f in b)b.hasOwnProperty(f)&&"data"!==f&&(g?(e+="?",g=!1):e+="&",e+=encodeURIComponent(f)+"="+encodeURIComponent(b[f]));b=wa(b);if(c.open_app||null===c.open_app||"undefined"===typeof c.open_app)b.open_app=!0;b.append_deeplink_path=!!c.append_deeplink_path;b.deepview_type=c.deepview_type;(g=gc(d))&&!c.make_new_link&&
...
Y.prototype.autoAppIndex=X(1,function(a,b){b=b||{};var c=document.getElementsByTagName("link"),d=c.length;if(d)for(var e=0;e<d;e++){var g=c[e],f=g.href;f&&(f.includes("ios-app")&&(V.iosAppIndexingTagsPresent=!0,g.setAttribute("href",ic(f))),f.includes("android-app")&&(V.androidAppIndexingTagsPresent=!0,g.setAttribute("href",ic(f))))}W=b;V.androidAppIndexingTagsPresent||(kc("android"),V.androidDetailsComplete||lc("android"));V.iosAppIndexingTagsPresent||(kc("ios"),V.iosDetailsComplete||lc("ios"));
V.iosDetailsComplete||V.androidDetailsComplete?a(null):a("Firebase App Indexing tags were not added to your webpage. Please check your configuration.")});Y.prototype.trackCommerceEvent=X(1,function(a,b,c,d){var e=this;e.renderQueue(function(){var g=La(b,c);if(g)return a(Error(g));e.c(db,{event:b,metadata:w({url:document.URL,user_agent:navigator.userAgent,language:navigator.language},d||{}),initial_referrer:document.referrer,commerce_data:c},function(b){a(b||null)})});a()});var Z=new Y;if(window.branch&&window.branch._q)for(var oc=window.branch._q,pc=0;pc<oc.length;pc++){var qc=oc[pc];Z[qc[0]].apply(Z,qc[1])}"function"===typeof define&&define.amd?define("branch",function(){return Z}):"object"===typeof exports&&(module.exports=Z);window&&(window.branch=Z);})();
