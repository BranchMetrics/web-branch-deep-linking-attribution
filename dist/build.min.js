...
function Ba(a){a&&(a.ha=null,a.M=null,a.H=null,a.A=null,a.g=null,a.D=null,a.u&&delete a.u,a.v&&delete a.v,a.c.remove("branch_view_enabled"),Ca(a.c,{},!0))}function w(a,b,c){a=a.replace(/\$(\d)/g,function(a,c){return b[parseInt(c,10)-1]});c&&(a+="\n Failure Code:"+c);return a}
...
"").replace(/([\?\&]_branch_match_id=\d+)/,""));try{p(b)}catch(c){b=h(b)}a.data=b;return a}function Ha(a){function b(a){return""!==a}if(!a||"string"!==typeof a)return"";var c=document.createElement("a");c.href=a;a=c.pathname&&c.pathname.split("/").filter(b);return Array.isArray(a)&&a.length?a[a.length-1]+c.search:c.search}function z(a,b){a&&"object"===typeof a||(a={});if(!b||"object"!==typeof b)return a;for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c]);return a}
...
typeof e)return w("API request $1, parameter $2 is not $3",[c,d,"a string"]);if(1!==b&&!b.test(e))return w("API request $1, parameter $2 is not $3",[c,d,"in the proper format"])}else if(a)return w("API request $1 missing parameter $2",[c,d]);return!1}}function K(a){return z(a,{browser_fingerprint_id:J(!0,1),identity_id:J(!0,1),sdk:J(!0,1),session_id:J(!0,1)})}
var hb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/open",method:"POST",a:{browser_fingerprint_id:J(!1,1),alternative_browser_fingerprint_id:J(!1,1),identity_id:J(!1,1),link_identifier:J(!1,1),sdk:J(!1,1),options:J(!1,0),initial_referrer:J(!1,1),tracking_disabled:J(!1,4),current_url:J(!1,1),screen_height:J(!1,2),screen_width:J(!1,2)}},ib={destination:"https://app.link",endpoint:"/_r",method:"GET",Y:!0,a:{sdk:J(!0,1),_t:J(!1,1),branch_key:J(!0,1)}},jb={destination:"",endpoint:"",
method:"GET",f:{link_url:J(!0,1)},a:{click:J(!0,1)}},kb={destination:"https://bnc.lt",endpoint:"/c",method:"POST",f:{link_url:J(!0,1)},a:{sdk:J(!1,1),phone:J(!0,1)}},lb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/referralcode",method:"POST",a:K({amount:J(!0,2),bucket:J(!1,1),calculation_type:J(!0,2),creation_source:J(!0,2),expiration:J(!1,1),location:J(!0,2),prefix:J(!1,1),type:J(!0,1)})},mb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/referralcode",
method:"POST",f:{code:J(!0,1)},a:K({})},nb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/applycode",method:"POST",f:{code:J(!0,1)},a:K({})},ob={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/logout",method:"POST",a:K({session_id:J(!0,1)})},pb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/profile",method:"POST",a:K({identity_id:J(!0,1),identity:J(!0,1)})},qb={destination:"https://nightlyregression.api.beta.branch.io",
endpoint:"/v1/referrals",method:"GET",f:{identity_id:J(!0,1)},a:K({})},rb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/credithistory",method:"GET",a:K({begin_after_id:J(!1,1),bucket:J(!1,1),direction:J(!1,2),length:J(!1,2),link_click_id:J(!1,1)})},sb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/credits",method:"GET",a:K({branch_key:J(!0,1),identity:J(!0,1)})},tb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/redeem",
method:"POST",a:K({amount:J(!0,2),bucket:J(!0,1),identity_id:J(!0,1)})},ub={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/url",method:"POST",Ca:"obj",a:K({alias:J(!1,1),campaign:J(!1,1),channel:J(!1,1),data:J(!1,1),feature:J(!1,1),identity_id:J(!0,1),stage:J(!1,1),tags:J(!1,3),type:J(!1,2),source:J(!1,1),instrumentation:J(!1,1)})},vb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/deepview",Y:!0,method:"POST",a:K({campaign:J(!1,1),_t:J(!1,1),channel:J(!1,
1),data:J(!0,1),feature:J(!1,1),link_click_id:J(!1,1),open_app:J(!1,4),append_deeplink_path:J(!1,4),stage:J(!1,1),tags:J(!1,3),deepview_type:J(!0,1),source:J(!0,1),identity:J(!0,1)})},wb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/has-app",method:"GET",a:{browser_fingerprint_id:J(!0,1),instrumentation:J(!1,1)}},xb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/event",method:"POST",a:K({event:J(!0,1),metadata:J(!0,0),initial_referrer:J(!1,1),
tracking_disabled:J(!1,4)})},yb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/event",method:"POST",a:K({event:J(!0,1),metadata:J(!1,0),initial_referrer:J(!1,1),commerce_data:J(!0,0)})},zb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v2/event/standard",method:"POST",a:{name:J(!0,1),user_data:J(!0,1),custom_data:J(!1,1),event_data:J(!1,1),content_items:J(!1,1),customer_event_alias:J(!1,1)}},Ab={destination:"https://nightlyregression.api.beta.branch.io",
endpoint:"/v2/event/custom",method:"POST",a:{name:J(!0,1),user_data:J(!0,1),custom_data:J(!1,1)}},Bb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/pageview",method:"POST",a:K({event:J(!0,1),metadata:J(!1,0),initial_referrer:J(!1,1),tracking_disabled:J(!1,4),branch_view_id:J(!1,1),no_journeys:J(!1,4),user_language:J(!1,1),open_app:J(!1,4),has_app_websdk:J(!1,4),source:J(!1,1),feature:J(!1,1),is_iframe:J(!1,4),data:J(!1,0),callback_string:J(!1,1),journey_displayed:J(!1,4),
audience_rule_id:J(!1,1),journey_dismissals:J(!1,0)})},Cb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/dismiss",method:"POST",a:K({event:J(!0,1),metadata:J(!1,0),initial_referrer:J(!1,1),tracking_disabled:J(!1,4),branch_view_id:J(!1,1),no_journeys:J(!1,4),user_language:J(!1,1),open_app:J(!1,4),has_app_websdk:J(!1,4),source:J(!1,1),feature:J(!1,1),is_iframe:J(!1,4),data:J(!1,0),callback_string:J(!1,1),journey_displayed:J(!1,4),audience_rule_id:J(!1,1),journey_dismissals:J(!1,
0),dismissal_source:J(!1,1)})},Db={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/cpid",method:"POST",a:{user_data:J(!0,1)}},Eb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/cpid/latd",method:"POST",a:{user_data:J(!0,1)}};function Fb(a){for(var b=0;b<a.length;b++){var c=this[a[b]],c="function"===typeof c?c():c;if(c.isEnabled())return c.w={},c}}function L(a){return"branch_session"===a||"branch_session_first"===a?a:"BRANCH_WEBSDK_KEY"+a}function Gb(a){return"true"===a?!0:"false"===a?!1:a}function Hb(a){return"branch_session"===a||"branch_session_first"===a||0===a.indexOf("BRANCH_WEBSDK_KEY")}function Ib(a){a=a.trim();var b=a.indexOf("=");return{name:a.substring(0,b),value:Gb(a.substring(b+1,a.length))}}
...
function Rb(a,b,c,d,e){var f=Date.now(),k=ta;!a.h&&Ma()&&a.h++;var l="branch_callback__"+a.h++;a=0<=b.indexOf("branch.io")?"&data=":"&post_data=";c="POST"===d?encodeURIComponent(Aa(h(c))):"";var g=window.setTimeout(function(){window[l]=function(){};G(t,k,ua(f));e(Error("Request timed out"),null,504)},ra);window[l]=function(a){window.clearTimeout(g);e(null,a)};Qb(b+(0>b.indexOf("?")?"?":"")+(c?a+c:"")+(0<=b.indexOf("/c/")?"&click=1":"")+"&callback="+l,function(){e(Error("Request blocked by client, probably adblock"),
null)},function(){G(t,k,ua(f));try{"function"===typeof this.remove?this.remove():this.parentNode.removeChild(this)}catch(n){}delete window[l]})}
function Sb(a,b,c,d,e,f){var k=Date.now(),l=ta,g=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");g.ontimeout=function(){G(t,l,ua(k));f(Error("Request timed out"),null,504)};g.onerror=function(a){f(Error(a.error||"Error in API: "+g.status),null,g.status)};g.onreadystatechange=function(){var a;if(4===g.readyState)if(G(t,l,ua(k)),200===g.status){try{a=p(g.responseText)}catch(m){a={}}f(null,a,g.status)}else if(402===g.status)f(Error("Not enough credits to redeem."),null,
...
function Tb(a,b,c,d,e){function f(){d.get("use_jsonp")||b.Y?Rb(a,n,c,b.method,k):Sb(a,n,m,b.method,d,k)}function k(a,b,c){a&&0<u&&"5"===(c||"").toString().substring(0,1)?(u--,window.setTimeout(function(){f()},qa)):e(a,b)}ta="/v1/pageview"===b.endpoint&&c&&c.journey_displayed?b.endpoint+"-1-brtt":b.endpoint+"-brtt";("/v1/url"===b.endpoint||"/v1/has-app"===b.endpoint)&&1<Object.keys(t).length&&(delete t["-brtt"],c.instrumentation=q(z({},t)),t={});if(v)for(var l=["browser_fingerprint_id","alternative_browser_fingerprint_id",
"identity_id","session_id"],g=0;g<l.length;g++)c.hasOwnProperty(l[g])&&delete c[l[g]];l=Pb(a,b,c);if(l.error)return e(Error(q({message:l.error,endpoint:b.endpoint,data:c})));var n,m="";"GET"===b.method?n=l.url+"?"+l.data:(n=l.url,m=l.data);var u=pa;if(v&&ya(n,c))return xa?k(Error("Requested operation cannot be completed since tracking is disabled"),null,300):k(null,{},200);f()};function N(a){a&&a.parentNode.removeChild(a)}function Ub(a,b){a&&!a.className.match(new RegExp("(\\s|^)"+b+"(\\s|$)"))&&(a.className+=" "+b)}function Vb(a){var b=document.body;b&&b.className.match(new RegExp("(\\s|^)"+a+"(\\s|$)"))&&(b.className=b.className.replace(new RegExp("(\\s|^)"+a+"(\\s|$)")," "))}function Wb(a){var b=new Date;return b.setDate(b.getDate()+a)}
...
function Zb(a,b){var c=a.get("hideBanner",!0);if(b.qa&&navigator&&Number(navigator.doNotTrack))return!1;try{"string"===typeof c&&(c=p(c))}catch(e){c=!1}var c="number"===typeof c?new Date>=new Date(c):!c,d=b.K;"number"===typeof d&&(d=!1);return!document.getElementById("branch-banner")&&!document.getElementById("branch-banner-iframe")&&(c||d)&&(b.sa&&!B()||b.O&&"android"===B()||b.ta&&"ipad"===B()||b.T&&"ios"===B()||b.P&&"blackberry"===B()||b.S&&"windows_phone"===B()||b.R&&"kindle"===B())};function $b(a,b){return"#branch-banner-iframe { position: "+("top"!==b||a?"fixed":"absolute")+"; }\n"}
...
c+=a.fa;a.F&&(c+="body { margin: 0; }\n",d=document.createElement("style"),d.type="text/css",d.id="branch-iframe-css",I(d),d.innerHTML="body { -webkit-transition: all 0.375s ease; transition: all 00.375s ease; }\n#branch-banner-iframe { box-shadow: 0 0 5px rgba(0, 0, 0, .35); width: 1px; min-width:100%; left: 0; right: 0; border: 0; height: 76px; z-index: 99999; -webkit-transition: all 0.25s ease; transition: all 00.25s ease; }\n"+(B()?$b(a.ma,a.position):$b(a.ga,a.position)),(document.head||document.getElementsByTagName("head")[0]).appendChild(d));
d=document.createElement("style");d.type="text/css";d.id="branch-css";d.innerHTML=c;I(d);c=a.F?b.contentWindow.document:document;(c=c.head||c.getElementsByTagName("head")[0])&&"function"===typeof c.appendChild&&c.appendChild(d);"top"===a.position?b.style.top="-76px":"bottom"===a.position&&(b.style.bottom="-76px")};function bc(a,b){var c;if(a.B||a.L){if(a.B){c="";for(var d=0;5>d;d++)c+='<span class="star"><svg class="star" fill="#555555" height="12" viewBox="3 2 20 19" width="12"><path d="M22 9.24l-7.19-.62L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21 12 17.27 18.18 21l-1.63-7.03L22 9.24zM12 15.4l-3.76 2.27 1-4.28-3.32-2.88 4.38-.38L12 6.1l1.71 4.04 4.38.38-3.32 2.88 1 4.28L12 15.4z"/><path d="M0 0h24v24H0z" fill="none"/><foreignObject display="none"><span class="star">\u2606</span></foreignObject></svg>',a.B>d&&
...
d.contentWindow.document.write(c);d.contentWindow.document.close()}else d=document.createElement("div"),d.id="branch-banner",d.className="branch-animation",d.innerHTML=bc(a,c),document.body.appendChild(d);return c=d};function dc(a,b,c,d){function e(){k();g.style.background="#FFD4D4";l.className="error";setTimeout(function(){g.style.background="#FFFFFF";l.className=""},2E3)}function f(){u=a.createElement("div");u.className="branch-icon-wrapper";u.id="branch-checkmark";u.style="opacity: 0;";u.innerHTML=window.ActiveXObject?'<span class="checkmark">&#x2713;</span>':'<svg version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 98.5 98.5" enable-background="new 0 0 98.5 98.5" xml:space="preserve"><path class="checkmark" fill="none" stroke-width="8" stroke-miterlimit="10" d="M81.7,17.8C73.5,9.3,62,4,49.2,4C24.3,4,4,24.3,4,49.2s20.3,45.2,45.2,45.2s45.2-20.3,45.2-45.2c0-8.6-2.4-16.6-6.5-23.4l0,0L45.6,68.2L24.7,47.3"/></svg>';
m.appendChild(u);g.style.opacity="0";l.style.opacity="0";n.style.opacity="0";setTimeout(function(){u.style.opacity="1"},20);l.value=""}function k(){g.removeAttribute("disabled");l.removeAttribute("disabled");g.style.opacity="1";l.style.opacity="1";n.style.opacity="0"}var l=a.getElementById("branch-sms-phone"),g=a.getElementById("branch-sms-send"),n=a.getElementById("branch-loader-wrapper"),m=a.getElementById("branch-sms-form-container"),u;if(l){var A=l.value;/^\d{7,}$/.test(A.replace(/[\s()+\-\.]|ext/gi,
""))?(O(b,"willSendBannerSMS"),g.setAttribute("disabled",""),l.setAttribute("disabled",""),g.style.opacity=".4",l.style.opacity=".4",n.style.opacity="1",l.className="",b.sendSMS(A,d,c,function(a){a?(O(b,"sendBannerSMSError"),e()):(O(b,"didSendBannerSMS"),f(),setTimeout(function(){m.removeChild(u);k()},3E3))})):e()}}
function ec(a,b,c,d){function e(a,c){"function"===typeof a&&(c=a,a={});a=a||{};"top"===b.position?k.style.top="-76px":"bottom"===b.position&&(k.style.bottom="-76px");"number"===typeof b.K?d.set("hideBanner",Wb(b.K),!0):d.set("hideBanner",!0,!0);a.X?("top"===b.position?document.body.style.marginTop=n:"bottom"===b.position&&(document.body.style.marginBottom=u),Vb("branch-banner-is-active"),N(k),N(document.getElementById("branch-css")),c()):(setTimeout(function(){N(k);N(document.getElementById("branch-css"));
c()},270),setTimeout(function(){"top"===b.position?document.body.style.marginTop=n:"bottom"===b.position&&(document.body.style.marginBottom=u);Vb("branch-banner-is-active")},20))}function f(){"top"===b.position?k.style.top="0":"bottom"===b.position&&(k.style.bottom="0");O(a,"didShowBanner")}if(!Zb(d,b))return O(a,"willNotShowBanner"),null;O(a,"willShowBanner");var k=cc(b,d);ac(b,k);c.channel=c.channel||"app banner";var l=b.F?k.contentWindow.document:document;if(B()){b.open_app=b.oa;b.append_deeplink_path=
b.ca;b.make_new_link=b.la;b.deepview_type="banner";a.deepview(c,b);var g=l.getElementById("branch-mobile-action");g&&(g.onclick=function(b){b.preventDefault();a.deepviewCta()})}else l.getElementById("sms-form")?l.getElementById("sms-form").addEventListener("submit",function(d){d.preventDefault();dc(l,a,b,c)}):k.onload=function(){l=k.contentWindow.document;l.getElementById("sms-form")&&l.getElementById("sms-form").addEventListener("submit",function(d){d.preventDefault();dc(l,a,b,c)})};var g=Xb("margin-top"),
n=document.body.style.marginTop,m=Xb("margin-bottom"),u=document.body.style.marginBottom,A=l.getElementById("branch-banner-close");A&&(A.onclick=function(b){b.preventDefault();O(a,"willCloseBanner");e({},function(){O(a,"didCloseBanner")})});Ub(document.body,"branch-banner-is-active");"top"===b.position?document.body.style.marginTop=Yb(g):"bottom"===b.position&&(document.body.style.marginBottom=Yb(m));b.X?f():setTimeout(f,20);return e};var fc={},gc,hc=1,P="top",ic="absolute",Q="76px",jc=!1,kc=!1,R=[],lc=!1,mc=window.innerHeight,nc=window.innerWidth;window.innerHeight<window.innerWidth&&(mc=window.innerWidth,nc=window.innerHeight);
var oc=0,pc=0,qc=/<script type="application\/json">((.|\s)*?)<\/script>/,rc=/<script type="text\/javascript">((.|\s)*?)<\/script>/,sc=/<style type="text\/css" id="branch-css">((.|\s)*?)<\/style>/,tc=/<style type="text\/css" id="branch-iframe-css">((.|\s)*?)<\/style>/,uc=/#branch-banner-spacer {((.|\s)*?)}/,vc=/margin-bottom: (.*?);/,S=null,wc=null,xc=!1,yc=!1,zc=!1,Ac=!1,Bc=!1,Cc="",Dc=[],T=null;function Ec(a){if(a=a.match(qc))return p(a[1])}
function Fc(a){var b=document.createElement("style");b.type="text/css";b.id="branch-iframe-css";oc=Xb("margin-top");var c=+oc.slice(0,-2);pc=Xb("margin-bottom");var d=+pc.slice(0,-2),e=+Q.slice(0,-2);a||("top"===P?document.body.style.marginTop=(+e+c).toString()+"px":"bottom"===P&&(document.body.style.marginBottom=(+e+d).toString()+"px"));0<R.length&&R.forEach(function(a){var b,c=window.getComputedStyle(a);c&&(b=jc&&"fixed"===c.getPropertyValue("position"));b||(a.style.marginTop=Q)});"top"===Cc&&Cc!==
P&&Bc&&Dc&&0<Dc.length&&Dc.forEach(function(a){a.style.marginTop=0});Bc=!1;Cc="";Dc=[];Ac=!1;a?b.innerHTML=a:b.innerHTML=Gc();I(b);document.head.appendChild(b)}
function Gc(){var a="",b="";document.body.style.transition="";document.getElementById("branch-banner-iframe")&&(document.getElementById("branch-banner-iframe").style.transition="");zc||(a="body { -webkit-transition: all 0.375s ease; }\n",document.body.style.transition="all 00.375s ease",b="-webkit-transition: all 0.25s ease; transition: all 00.25s ease;");return(a?a:"")+("#branch-banner-iframe { box-shadow: 0 0 5px rgba(0, 0, 0, .35); width: 1px; min-width:100%; left: 0; right: 0; border: 0; height: "+
Q+"; z-index: 99999; "+b+" }\n#branch-banner-iframe { position: "+ic+"; }\n@media only screen and (orientation: landscape) { body { "+("top"===P?"margin-top: ":"margin-bottom: ")+(jc?nc+"px":Q)+"; }\n#branch-banner-iframe { height: "+(jc?nc+"px":Q)+"; }")}
function Hc(a,b){Ub(document.body,"branch-banner-is-active");jc&&"fixed"===ic&&Ub(document.body,"branch-banner-no-scroll");setTimeout(function(){b?(a.style.top=null,a.style.bottom=null):"top"===P?a.style.top="0":"bottom"===P&&(T&&T.journey_link_data&&!T.journey_link_data.safeAreaRequired?a.style.bottom="0":(lc=!0,document.getElementById("branch-banner-iframe").style.transition="all 0s",Ic(!1,!0),window.addEventListener("resize",Jc),window.addEventListener("scroll",Kc)));O(S,"didShowJourney",T);xc=
!0},20)}function Jc(){lc&&Ic(!1,!1)}function Kc(){lc&&(window.pageYOffset>window.innerHeight?Ic(!0,!1):Ic(!1,!1))}function Ic(a,b){var c=document.getElementById("branch-banner-iframe"),d=c.offsetHeight,e=c.offsetTop,f=window.innerHeight;b&&window.pageYOffset?c.style.bottom="0":a?c.style.top=f-d+d/2+"px":f-e!=d&&(c.style.top=""+(f-d)+"px")}function Lc(a){a=a.globalDismissPeriod;if("number"===typeof a){if(-1===a)a=!0;else{var b=new Date;a=b.setSeconds(b.getSeconds()+a)}return a}}
function Mc(a,b,c,d,e,f,k){var l=U;d&&e&&(Array.prototype.forEach.call(e.contentWindow.document.querySelectorAll("#branch-mobile-action"),function(a){a.addEventListener("click",function(){O(S,"didClickJourneyCTA",T);Ac=!0;d();Nc(e)})}),Oc(".branch-banner-continue","didClickJourneyContinue",c,e,a,b,f,k,l),Oc(".branch-banner-close","didClickJourneyClose",c,e,a,b,f,k,l))}
function Oc(a,b,c,d,e,f,k,l,g){Array.prototype.forEach.call(d.contentWindow.document.querySelectorAll(a),function(a){a.addEventListener("click",function(){Pc(b,c,d,e,f,k,l,g)})})}function Rc(a,b,c){var d=a.get("journeyDismissals",!0),d=d?p(d):{};d[c]={view_id:b,dismiss_time:Date.now()};a.set("journeyDismissals",q(d),!0)}
function Sc(a){return void 0===a||null===a?null:a.replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&amp;/g,"&").replace(/&quot;/g,'"').replace(/&apos;/g,"'").replace(/&brvbar;/g,"\u00a6").replace(/&laquo;/g,"\u00ab").replace(/&acute;/g,"\u00b4").replace(/&middot;/g,"\u00b7").replace(/&raquo;/g,"\u00bb").replace(/&amp;/g,"&").replace(/&iquest;/g,"\u00bf").replace(/&times;/g,"\u00d7").replace(/&divide;/g,"\u00f7").replace(/&Agrave;/g,"\u00c0").replace(/&Aacute;/g,"\u00c1").replace(/&Acirc;/g,"\u00c2").replace(/&Atilde;/g,
...
function Tc(a,b){var c={},d=D();d&&0<Object.keys(d).length&&(c.hosted_deeplink_data=d);c=a.I(Uc(null,c),null,S,!0);if(T&&T.journey_link_data){G(c,"journey_id",T.journey_link_data.journey_id);G(c,"journey_name",Sc(T.journey_link_data.journey_name));G(c,"view_id",T.journey_link_data.view_id);G(c,"view_name",Sc(T.journey_link_data.view_name));G(c,"channel",Sc(T.journey_link_data.channel));G(c,"campaign",Sc(T.journey_link_data.campaign));try{G(c,"tags",JSON.stringify(T.journey_link_data.tags))}catch(e){c.tags=
JSON.stringify([])}}G(c,"dismissal_source",b);return c}
function Pc(a,b,c,d,e,f,k,l){var g=k?0:Lc(f);O(S,a,T);Ac=!0;Nc(c);if(!k)if(void 0!==g&&b.set("globalJourneysDismiss",g,!0),Rc(b,d,e),f.dismissRedirect)window.location=f.dismissRedirect;else{var n=function(){S.removeListener(n);var b=Tc(l,va[a]);S.b(Cb,b,function(a,c){!a&&"object"===typeof c&&c.template&&l.N(c,null,!1)&&l.J(c.template,b,b.branch_view_id||c.event_data.branch_view_data.id,c.event_data.branch_view_data,!1,c.journey_link_data)})};S.addListener("branch_internal_event_didCloseJourney",n)}}
function Uc(a,b){return z({url:a&&a.url||Fa(),user_agent:navigator.userAgent,language:navigator.language,screen_width:screen.width||-1,screen_height:screen.height||-1,window_device_pixel_ratio:window.devicePixelRatio||1},b||{})}
function Nc(a,b){if(zc&&!yc){document.body.style.transition="all 00.375s ease";document.getElementById("branch-banner-iframe").style.transition="all 00.25s ease";var c=document.getElementById("branch-iframe-css").innerHTML+"\n";document.getElementById("branch-iframe-css").innerHTML="";document.getElementById("branch-iframe-css").innerHTML=c+"body { -webkit-transition: all 0.375s ease; }\n#branch-banner-iframe { -webkit-transition: all 0.25s ease; }\n"}"top"===P?a.style.top="-"+Q:"bottom"===P&&(a.style.bottom=
"-"+Q);O(S,"willCloseJourney",T);setTimeout(function(){N(a);N(document.getElementById("branch-css"));N(document.getElementById("branch-iframe-css"));N(document.getElementById("branch-journey-cta"));(!yc||Ac)&&R&&0<R.length?R.forEach(function(a){a.style.marginTop=0}):(Bc=yc,Cc=P,Dc=R);"top"===P?document.body.style.marginTop=oc:"bottom"===P&&(document.body.style.marginBottom=pc);Vb("branch-banner-is-active");Vb("branch-banner-no-scroll");lc&&(lc=!1,window.removeEventListener("resize",Jc),window.removeEventListener("scroll",
Kc));O(S,"didCloseJourney",T);b||O(S,"branch_internal_event_didCloseJourney",T);xc=!1},yc?0:270)}function Vc(a){var b={banner_id:gc};if(a&&"object"===typeof a&&0<Object.keys(a).length){var c=["browser_fingerprint_id","app_id","source","open_app","link_click_id"];if(a&&"object"===typeof a&&!Array.isArray(a)&&0<Object.keys(a).length&&c&&Array.isArray(c)&&0<c.length)for(var d in a)a.hasOwnProperty(d)&&-1<c.indexOf(d)&&delete a[d];b.journey_link_data={};z(b.journey_link_data,a)}T=b}
function Wc(a){return fc&&S&&S.i&&S.i.data?S.i.data[a]:!1}
function Xc(a){function b(a){return c.reduce(function(a,b){console.log({url:b,value:a[b]});if(a[b])return a;var c;c=Wc(b)?S.i.data[b]:void 0;c&&(a[b]=c);return a},a)}var c;c=void 0===c?["$android_url","$ios_url","$fallback_url","$desktop_url"]:c;if(!a)return console.log("setDefaultUrls - no data set"),a;try{var d=JSON.parse(a.data);console.log(JSON.stringify({ua:d}));a.data=JSON.stringify(b(d));console.log(a.data)}catch(e){console.log(e)}return a};var U={};
function Yc(a,b){var c=b?"OPEN":"GET",d=a,e=Ec(d);e&&e.bannerHeight&&e.position&&e.sticky?(Q=e.bannerHeight,P=e.position,ic=e.sticky):(d=d.match(uc))?(P="top",(d=d[1].match(vc))&&(Q=d[1]),ic="absolute"):(P="bottom",ic="fixed");if(-1!==Q.indexOf("vh")||-1!==Q.indexOf("%"))d=Q.indexOf("vh")?Q.slice(0,-2):Q.slice(0,-1),Q=d/100*mc+"px",100>d?kc=!0:jc=!0;if(d=Ec(a)){var f;b&&d&&d.ctaText&&d.ctaText.has_app?f=d.ctaText.has_app:d&&d.ctaText&&d.ctaText.no_app&&(f=d.ctaText.no_app);c=f;R=[];if(d&&d.injectorSelector&&
(f=document.querySelectorAll(d.injectorSelector)))for(d=0;d<f.length;d++)R.push(f[d].parentElement)}f=(f=a.match(sc))?f[1]:void 0;if(d=a.match(rc))d=d[1],e=document.createElement("script"),e.id="branch-journey-cta",I(e),e.innerHTML=d,document.body.appendChild(e);d=(d=a.match(tc))?d[1]:void 0;var e=a,k=e.match(qc),l=e.match(rc),g=e.match(sc),n=e.match(tc);k&&(e=e.replace(qc,""));l&&(e=e.replace(rc,""));g&&(e=e.replace(sc,""));n&&(e=e.replace(tc,""));a=e;e=document.createElement("iframe");e.src="about:blank";
e.style.overflow="hidden";e.scrolling="no";e.id="branch-banner-iframe";e.className="branch-animation";e.title="Branch Banner";e.setAttribute("aria-label","Branch Banner");I(e);document.body.appendChild(e);k=B();k='<html><head></head><body class="'+("ios"===k||"ipad"===k?"branch-banner-ios":"android"===k?"branch-banner-android":"branch-banner-desktop")+'">'+a+"</body></html>";e.contentWindow.document.open();e.contentWindow.document.write(k);e.contentWindow.document.close();Fc(d);k=document.createElement("style");
k.type="text/css";k.id="branch-css";k.innerHTML=f;I(k);f=e.contentWindow.document;f.head.appendChild(k);if(kc||jc){var m=f.getElementsByClassName("branch-banner-content")[0];m&&(m.style.height=Q)}"top"===P?e.style.top="-"+Q:"bottom"===P&&(e.style.bottom="-"+Q);try{var m=f.getElementsByClassName("branch-banner-content")[0],u=window.getComputedStyle(m).getPropertyValue("background-color").split(", ");u[3]&&!parseFloat(u[3])&&(e.style.boxShadow="none")}catch(A){}e.contentWindow.document.getElementById("branch-mobile-action").innerHTML=
c;O(S,"willShowJourney",T);Hc(e,d);return e}U.N=function(a,b,c){if(document.getElementById("branch-banner")||document.getElementById("branch-banner-iframe")||document.getElementById("branch-banner-container")||!B()||!a.event_data||!a.template)return!1;if(c)return!0;(a=!a.event_data.branch_view_data.id||b&&b.no_journeys)||(a=S,b=a.c.get("globalJourneysDismiss",!0),!0===b||b>Date.now()?a=!0:(a.c.remove("globalJourneysDismiss",!0),a=!1));return a?(U.Ba=1,!1):!0};
U.ka=function(a){S.b(Bb,{event:"pageview",journey_displayed:!0,audience_rule_id:a.audience_rule_id,branch_view_id:a.branch_view_id},function(){})};
U.J=function(a,b,c,d,e,f){gc=c;Vc(f);var k=d.audience_rule_id;(f=document.getElementById("branch-iframe-css"))&&f.parentElement.removeChild(f);f=document.createElement("div");f.id="branch-banner";document.body.insertBefore(f,null);Ub(f,"branch-banner-is-active");var l=!1,g=b.callback_string,n=null,m=null,u=S.c;if(a){var A=Ec(a)||{},Qc=window.setTimeout(function(){window[g]=function(){}},ra);window[g]=function(a){window.clearTimeout(Qc);l||(m=a,Mc(c,k,u,m,n,A,e))};wc=n=Yc(a,b.has_app_websdk);if(null===
n){l=!0;return}Mc(c,k,u,m,n,A,e);sa&&(t["journey-load-time"]=(Date.now()-window.performance.timing.navigationStart).toString())}document.body.removeChild(f);v||e||U.ka(d)};
U.I=function(a,b,c,d){console.log("PAGEVIEW");S=c;b||(b={});a||(a={});zc=b.disable_entry_animation||!1;yc=b.disable_exit_animation||!1;var e=z({},c.i),f=M(c.c)||{},k=f.hasOwnProperty("has_app")?f.has_app:!1,l=c.c.get("journeyDismissals",!0),g=(b.user_language||Va()||"en").toLowerCase()||null,n=fb(V(c)),m;(m=b.branch_view_id)||(m="_branch_view_id".replace(/[\[\]]/g,"\\$&"),m=(m=(new RegExp("[?&]"+m+"(=([^&#]*)|&|#|$)")).exec(Fa()))&&m[2]?decodeURIComponent(m[2].replace(/\+/g," ")):"");m=m||null;c=
b.make_new_link?null:Ha(V(c));e.event=d?"dismiss":"pageview";e.metadata=a;e=G(e,"initial_referrer",n);e=G(e,"branch_view_id",m);e=G(e,"no_journeys",b.no_journeys);e=G(e,"is_iframe",x());e=G(e,"journey_dismissals",l);e.user_language=g;e.open_app=b.open_app||!1;e.has_app_websdk=k;e.feature="journeys";e.callback_string="branch_view_callback__"+hc++;e.data||(e.data={});e.data=z(D(),e.data);e.data=z(Ea(f||{}),e.data);c&&(e.data.link_click_id=c);(a=f.data?JSON.parse(f.data):null)&&a["+referrer"]&&(e.data["+referrer"]=
a["+referrer"]);return e=Ga(e)};var W={androidAppIndexingTagsPresent:!1,iosAppIndexingTagsPresent:!1,androidDetailsComplete:!1,iosDetailsComplete:!1},X={};function Zc(a){var b;"android"===a&&W.androidDetailsComplete&&(b="android-app://"+X.androidPackageName+"/"+X.androidURL,b=$c(b),ad(b));"ios"===a&&W.iosDetailsComplete&&(b="ios-app://"+X.iosAppId+"/"+X.iosURL,b=$c(b),ad(b))}
function $c(a){var b={"~channel":"Firebase App Indexing","~feature":"Auto App Indexing",$canonical_url:Fa()};if("object"===typeof X.data)for(var c in X.data)X.data.hasOwnProperty(c)&&!b.hasOwnProperty(c)&&(b[c]=X.data[c]);return a+(-1<a.indexOf("?")?"&":"?")+"link_click_id=a-"+btoa(q(b))}function ad(a){var b=document.createElement("link");b.setAttribute("rel","alternate");b.setAttribute("href",a);document.head.appendChild(b)}
function bd(a){"android"===a&&"string"===typeof X.androidPackageName&&"string"===typeof X.androidURL&&(W.androidDetailsComplete=!0,Zc("android"));"ios"===a&&"string"===typeof X.iosAppId&&"string"===typeof X.iosURL&&(W.iosDetailsComplete=!0,Zc("ios"))}
function cd(a){for(var b=document.getElementsByTagName("meta"),c=0;c<b.length;c++){var d=b[c];"ios"===a&&"al:ios:app_store_id"===d.getAttribute("property")&&(X.iosAppId=d.getAttribute("content"));"ios"===a&&"al:ios:url"===d.getAttribute("property")&&(X.iosURL=d.getAttribute("content").replace("://","/"));"android"===a&&"al:android:package"===d.getAttribute("property")&&(X.androidPackageName=d.getAttribute("content"));"android"===a&&"al:android:url"===d.getAttribute("property")&&(X.androidURL=d.getAttribute("content").replace("://",
"/"))}bd(a)};var dd;
function Y(a,b,c){return function(){var d=this,e,f,k=arguments[arguments.length-1];a&&"function"===typeof k?(e=Array.prototype.slice.call(arguments,0,arguments.length-1)||[],f=k):(f=function(){},e=Array.prototype.slice.call(arguments));d.aa(function(k){function g(b,c){try{if(b&&!a)throw b;1===a?f(b):2===a&&f(b,c)}finally{k()}}if(!c){if(1===d.m)return g(Error(w("Branch SDK initialization pending and a Branch method was called outside of the queue order")),null);if(2===d.m)return g(Error(w("Branch SDK initialization failed, so further methods cannot be called",d.l,
d.o)),null);if(0===d.m||!d.m)return g(Error(w("Branch SDK not initialized")),null)}e.unshift(g);b.apply(d,e)})}}function Z(){if(!(this instanceof Z))return dd||(dd=new Z),dd;this.aa=oa();this.c=new Fb(["session","cookie","pojo"]);this.da=new Nb;this.h=[];this.V="web2.52.6";this.l=this.m=0;this.o=null}
Z.prototype.b=function(a,b,c){this.U&&(b.app_id=this.U);this.j&&(b.branch_key=this.j);(a.a&&a.a.session_id||a.f&&a.f.session_id)&&this.H&&(b.session_id=this.H);(a.a&&a.a.identity_id||a.f&&a.f.identity_id)&&this.A&&(b.identity_id=this.A);0>a.endpoint.indexOf("/v1/")?(a.a&&a.a.developer_identity||a.f&&a.f.developer_identity)&&this.g&&(b.developer_identity=this.g):(a.a&&a.a.identity||a.f&&a.f.identity)&&this.g&&(b.identity=this.g);(a.a&&a.a.link_click_id||a.f&&a.f.link_click_id)&&this.Z&&(b.link_click_id=
this.Z);(a.a&&a.a.sdk||a.f&&a.f.sdk)&&this.V&&(b.sdk=this.V);(a.a&&a.a.browser_fingerprint_id||a.f&&a.f.browser_fingerprint_id)&&this.D&&(b.browser_fingerprint_id=this.D);v&&(b.tracking_disabled=v);return Tb(this.da,a,b,this.c,function(a,b){c(a,b)})};function V(a){var b=M(a.c);return(b=b&&b.referring_link)?b:(a=a.c.get("click_id"))?"https://bnc.lt/c/"+a:null}function O(a,b,c){for(var d=0;d<a.h.length;d++)a.h[d].event&&a.h[d].event!==b||a.h[d].listener(b,c)}
...
d){d&&(d=l(d),v||(d=f(d),Ca(g.c,d,u)),g.m=3,d.data_parsed=d.data&&0!==d.data.length?p(d.data):{});if(b)return g.m=2,g.l||(g.l=1,g.o=b.message),a(b,d&&Da(d));try{a(b,d&&Da(d))}catch(jd){}finally{g.renderFinalize()}var e=$a(),k=H(c.metadata,"object")?c.metadata:null;k&&(k=gb(e.hosted_deeplink_data,k))&&0<Object.keys(k).length&&(e.hosted_deeplink_data=k);var m=U.I(Uc(c,e),c,g,!1);g.renderQueue(function(){g.b(Bb,m,function(a,b){if(!a&&"object"===typeof b){var d=m.branch_view_id?!0:!1;U.N(b,c,d)?U.J(b.template,
m,m.branch_view_id||b.event_data.branch_view_data.id,b.event_data.branch_view_data,d,b.journey_link_data):((b.auto_branchify||!n&&Na("branchify_url")&&V(g))&&this.branch.deepview({},{make_new_link:!1,open_app:!0,auto_branchify:!0}),O(S,"willNotShowJourney"))}v&&(xa=!0)})})}function f(a){u&&(a.identity=g.g);return a}function k(a){var b={sdk:"2.52.6",branch_key:g.j},c=M(g.c)||{},d=M(g.c,!0)||{};d.browser_fingerprint_id&&(b._t=d.browser_fingerprint_id);Ma()||g.b(ib,b,function(a,b){a&&(g.l=3,g.o=a.message);
b&&(c.browser_fingerprint_id=b)});g.b(wb,{browser_fingerprint_id:c.browser_fingerprint_id},function(b,d){b&&(g.l=4,g.o=b.message);b||!d||c.has_app||(c.has_app=!0,Lb(g.c,c),O(g,"didDownloadApp"));a&&a(null,c)})}function l(a){a.link_click_id&&(g.Z=a.link_click_id.toString());a.session_id&&(g.H=a.session_id.toString());a.identity_id&&(g.A=a.identity_id.toString());a.identity&&(g.g=a.identity.toString());a.link&&(g.M=a.link);if(a.referring_link){var b=a.referring_link;a.referring_link=b?"http"!==b.substring(0,
4)?"https://bnc.lt"+b:b:null}!a.click_id&&a.referring_link&&(a.click_id=Ha(a.referring_link));g.D=a.browser_fingerprint_id;return a}sa&&(t["init-began-at"]=(Date.now()-window.performance.timing.navigationStart).toString());var g=this;g.m=1;-1<b.indexOf("key_")?g.j=b:g.U=b;c=c&&H(c,"object")?c:{};pa=(g.G=c)&&c.retries&&Number.isInteger(c.retries)?c.retries:pa;qa=c&&c.retry_delay&&Number.isInteger(c.retry_delay)?c.retry_delay:qa;ra=c&&c.timeout&&Number.isInteger(c.timeout)?c.timeout:ra;r=c&&c.nonce?
c.nonce:r;v=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;xa=!1;v&&Ba(g);b=M(g.c);var n=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,m=n||Na("_branch_match_id")||Ia(),u=!b||!b.identity_id;g.C=!!g.c.get("branch_view_enabled");if(b&&b.session_id&&!m&&!Na("branchify_url"))Lb(g.c,{data:""}),Lb(g.c,{referring_link:""}),d(),k(e);else{b={sdk:"2.52.6",branch_key:g.j};var A=M(g.c,!0)||{};A.browser_fingerprint_id&&(b._t=A.browser_fingerprint_id);A.identity&&
(g.g=A.identity);Ma()?g.b(hb,{link_identifier:m,browser_fingerprint_id:m||A.browser_fingerprint_id,alternative_browser_fingerprint_id:A.browser_fingerprint_id,options:c,initial_referrer:fb(V(g)),current_url:x()&&Ja()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(g.l=2,g.o=a.message);a||"object"!==typeof b||(b.branch_view_enabled&&(g.C=!!b.branch_view_enabled,g.c.set("branch_view_enabled",g.C)),m&&(b.click_id=m));d();e(a,
b)}):g.b(ib,b,function(a,b){if(a)return g.l=3,g.o=a.message,e(a,null);g.b(hb,{link_identifier:m,browser_fingerprint_id:m||b,alternative_browser_fingerprint_id:A.browser_fingerprint_id,options:c,initial_referrer:fb(V(g)),current_url:x()&&Ja()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(g.l=2,g.o=a.message);a||"object"!==typeof b||(b.branch_view_enabled&&(g.C=!!b.branch_view_enabled,g.c.set("branch_view_enabled",g.C)),
m&&(b.click_id=m));d();e(a,b)})})}},!0);Z.prototype.renderQueue=Y(0,function(a,b){this.ba?b():(this.s=this.s||[],this.s.push(b));a(null,null)});Z.prototype.renderFinalize=Y(2,function(a){this.s&&0<this.s.length&&(this.s.forEach(function(a){a.call(this)}),delete this.s);this.ba=!0;a(null,null)});Z.prototype.data=Y(2,function(a){var b=Da(M(this.c));b.referring_link=V(this);b.data_parsed=b.data&&0!==b.data.length?p(b.data):{};a(null,b)});Z.prototype.first=Y(2,function(a){a(null,Da(M(this.c,!0)))});
Z.prototype.setIdentity=Y(2,function(a,b){var c=this;this.b(pb,{identity:b},function(d,e){d&&a(d);e=e||{};c.A=e.identity_id?e.identity_id.toString():null;c.M=e.link;c.g=b;e.developer_identity=b;e.referring_data_parsed=e.referring_data?p(e.referring_data):null;Mb(c.c,{identity:b});a(null,e)})});
Z.prototype.logout=Y(1,function(a){var b=this;this.b(ob,{},function(c,d){c&&a(c);d=d||{};d={data_parsed:null,data:null,referring_link:null,click_id:null,link_click_id:null,identity:d.identity,session_id:d.session_id,identity_id:d.identity_id,link:d.link,device_fingerprint_id:b.ha||null};b.M=d.link;b.H=d.session_id;b.A=d.identity_id;b.g=d.identity;Lb(b.c,d);a(null)})});Z.prototype.getBrowserFingerprintId=Y(2,function(a){var b=M(this.c,!0)||{};a(null,b.browser_fingerprint_id||null)});
...
Z.prototype.link=Y(2,function(a,b){console.log(b);var c=Ga(b),c=Xc(b),d=this.j;console.log(c);this.b(ub,c,function(b,f){if(b)return a(b,za(d,c));if(Wc("$journeys_cta")&&0<S.i.data.$.length)return a(null,S.i.data.$);a(null,f&&f.url)})});
...
e(c.click_id)})})});
Z.prototype.deepview=Y(1,function(a,b,c){var d=this;c||(c={});c.deepview_type="undefined"===typeof c.deepview_type?"deepview":"banner";b.data=z(D(),b.data);b=x()?z({is_iframe:!0},b):b;b=Ga(b);var e=za(this.j,b);if(c.open_app||null===c.open_app||"undefined"===typeof c.open_app)b.open_app=!0;b.append_deeplink_path=!!c.append_deeplink_path;b.deepview_type=c.deepview_type;var f=V(d);f&&!c.make_new_link&&(b.link_click_id=Ha(f));b.banner_options=c;c.auto_branchify&&(b.auto_branchify=!0);d.v=ga(this.b,d,
vb,b,function(b,c){if(b)return v||(d.u=function(){window.top.location=e}),a(b);"function"===typeof c&&(d.u=c);a(null)});d.v()});
Z.prototype.deepviewCta=Y(1,function(a){if("undefined"===typeof this.u)return v?a(Error("Requested operation cannot be completed since tracking is disabled"),null):a(Error("Cannot call Deepview CTA, please call branch.deepview() first"),null);window.event&&(window.event.preventDefault?window.event.preventDefault():window.event.returnValue=!1);O(this,"didDeepviewCTA");this.u();a()});Z.prototype.referrals=Y(2,function(a){this.b(qb,{},a)});
Z.prototype.getCode=Y(2,function(a,b){b.type="credit";b.creation_source=b.creation_source||2;this.b(lb,b,a)});Z.prototype.validateCode=Y(1,function(a,b){this.b(mb,{code:b},a)});Z.prototype.applyCode=Y(1,function(a,b){this.b(nb,{code:b},a)});Z.prototype.credits=Y(2,function(a){this.b(sb,{branch_key:this.j,identity:this.g},a)});Z.prototype.creditHistory=Y(2,function(a,b){this.b(rb,b||{},a)});Z.prototype.redeem=Y(1,function(a,b,c){this.b(tb,{amount:b,bucket:c},function(b){a(b||null)})});
Z.prototype.addListener=function(a,b){"function"===typeof a&&void 0===b&&(b=a,a=null);b&&this.h.push({listener:b,event:a||null})};Z.prototype.removeListener=function(a){a&&(this.h=this.h.filter(function(b){if(b.listener!==a)return b}))};function ed(a,b,c){c=c||{};try{a.i=p(q(c))}finally{a.i=a.i||{}}b()}Z.prototype.setBranchViewData=Y(1,function(a,b){ed.call(null,this,a,b)});
Z.prototype.closeJourney=Y(1,function(a){var b=this;b.renderQueue(function(){if(wc&&xc)O(b,"didCallJourneyClose",T),Nc(wc,!0);else return a("Journey already dismissed.")});a()});
Z.prototype.banner=Y(1,function(a,b,c){c=c||{};ed.call(null,this,function(){},c);"undefined"===typeof b.showAgain&&"undefined"!==typeof b.forgetHide&&(b.showAgain=b.forgetHide);var d={icon:F(b.icon)||"",title:F(b.title)||"",description:F(b.description)||"",L:"number"===typeof b.reviewCount&&0<b.reviewCount?Math.floor(b.reviewCount):null,B:"number"===typeof b.rating&&5>=b.rating&&0<b.rating?Math.round(2*b.rating)/2:null,na:F(b.openAppButtonText)||"View in app",ja:F(b.downloadAppButtonText)||"Download App",
...
X:!!b.immediate,ca:!!b.append_deeplink_path};"undefined"!==typeof b.showMobile&&(d.T=b.showMobile,d.O=b.showMobile,d.P=b.showMobile,d.S=b.showMobile,d.R=b.showMobile);c.data=z(D(),c.data);var e=this;e.renderQueue(function(){e.W=ec(e,d,c,e.c)});a()});Z.prototype.closeBanner=Y(0,function(a){var b=this;b.renderQueue(function(){b.W&&(O(b,"willCloseBanner"),b.W(function(){O(b,"didCloseBanner")}))});a()});
Z.prototype.autoAppIndex=Y(1,function(a,b){b=b||{};var c=document.getElementsByTagName("link"),d=c.length;if(d)for(var e=0;e<d;e++){var f=c[e],k=f.href;k&&(k.includes("ios-app")&&(W.iosAppIndexingTagsPresent=!0,f.setAttribute("href",$c(k))),k.includes("android-app")&&(W.androidAppIndexingTagsPresent=!0,f.setAttribute("href",$c(k))))}X=b;W.androidAppIndexingTagsPresent||(bd("android"),W.androidDetailsComplete||cd("android"));W.iosAppIndexingTagsPresent||(bd("ios"),W.iosDetailsComplete||cd("ios"));
W.iosDetailsComplete||W.androidDetailsComplete?a(null):a("Firebase App Indexing tags were not added to your webpage. Please check your configuration.")});Z.prototype.trackCommerceEvent=Y(1,function(a,b,c,d){var e=this;e.renderQueue(function(){var f=Za(b,c);if(f)return a(Error(f));e.b(yb,{event:b,metadata:z({url:document.URL,user_agent:navigator.userAgent,language:navigator.language},d||{}),initial_referrer:fb(V(e)),commerce_data:c},function(b){a(b||null)})});a()});
Z.prototype.disableTracking=Y(1,function(a,b){if(!1===b||"false"===b)xa=v=!1,this.j&&this.G&&(!0===this.G.tracking_disabled&&delete this.G.tracking_disabled,this.init(this.j,this.G));else if(void 0===b||!0===b||"true"===b)Ba(this),xa=v=!0,this.closeBanner(),this.closeJourney();a()});var fd=new Z;if(window.branch&&window.branch._q)for(var gd=window.branch._q,hd=0;hd<gd.length;hd++){var id=gd[hd];fd[id[0]].apply(fd,id[1])}"function"===typeof define&&define.amd?define("branch",function(){return fd}):"object"===typeof exports&&(module.exports=fd);window&&(window.branch=fd);})();
