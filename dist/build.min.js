...
function Da(a){a.source="web-sdk";var b=a.data;switch(typeof b){case "string":try{b=p(b)}catch(c){b={_bncNoEval:!0}}break;case "object":break;default:b={}}b.$canonical_url||(b.$canonical_url=Ca());b.$og_title||(b.$og_title=y("title"));b.$og_description||(b.$og_description=y("description"));b.$og_image_url||(b.$og_image_url=y("image"));b.$og_video||(b.$og_video=y("video"));b.$og_type||(b.$og_type=y("type"));"string"===typeof b.$desktop_url&&(b.$desktop_url=b.$desktop_url.replace(/#r:[a-z0-9-_]+$/i,
"").replace(/([\?\&]_branch_match_id=\d+)/,""));try{p(b)}catch(c){b=h(b)}a.data=b;return a}function Ea(a){function b(b){return""!==b}if(!a||"string"!==typeof a)return"";var c=document.createElement("a");c.href=a;a=c.pathname&&c.pathname.split("/").filter(b);return Array.isArray(a)&&a.length?a[a.length-1]+c.search:c.search}function z(a,b){a&&"object"===typeof a||(a={});if(!b||"object"!==typeof b)return a;for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c]);return a}
...
function Xa(a){var b={},b=E(b,"http_origin",document.URL),b=E(b,"user_agent",navigator.userAgent),b=E(b,"language",Ma()),b=E(b,"screen_width",screen.width),b=E(b,"screen_height",screen.height),b=E(b,"http_referrer",document.referrer),b=E(b,"browser_fingerprint_id",a.B),b=E(b,"developer_identity",a.C),b=E(b,"sdk","web");return b=E(b,"sdk_version","2.50.1")}function x(){return window.self!==window.top}
...
function Ab(){function a(b,a){a&&(b=K(b));document.cookie=b+"=; expires=Thu, 01 Jan 1970 00:00:01 GMT; path=/"}return{getAll:function(){for(var b={},a=document.cookie.split(";"),d=0;d<a.length;d++){var e=yb(a[d]);e&&e.hasOwnProperty("name")&&e.hasOwnProperty("value")&&xb(e.name)&&(b[e.name.replace("BRANCH_WEBSDK_KEY","")]=e.value)}return b},get:function(b){b=K(b);for(var a=document.cookie.split(";"),d=0;d<a.length;d++){var e=yb(a[d]);if(e&&e.hasOwnProperty("name")&&e.hasOwnProperty("value")&&e.name===
b)return e.value}return null},set:function(a,c){document.cookie=K(a)+"="+c+"; path=/"},remove:function(b){a(b,!0)},clear:function(){for(var b=document.cookie.split(";"),c=0;c<b.length;c++){var d=yb(b[c]);d&&d.hasOwnProperty("name")&&xb(d.name)&&a(d.name,!1)}},isEnabled:function(){return navigator.cookieEnabled}}}vb.prototype.cookie=function(){return Ab()};
...
function Eb(a,b,c){function d(a,c){"undefined"===typeof c&&(c={});if(a.branch_key&&l.test(a.branch_key))return c.branch_key=a.branch_key,c;if(a.app_id&&g.test(a.app_id))return c.app_id=a.app_id,c;if(a.instrumentation)c.instrumentation=a.instrumentation;else throw Error(w("API request $1 missing parameter $2",[b.endpoint,"branch_key or app_id"]));}var e,f,k=b.destination+b.endpoint,g=/^[0-9]{15,20}$/,l=/key_(live|test)_[A-Za-z0-9]{32}/;if("/v1/has-app"===b.endpoint)try{b.f=d(c,b.f)}catch(n){return{error:n.message}}if("undefined"!==
...
d(c,m)}catch(n){return{error:n.message}}"/v1/event"===b.endpoint&&(m.metadata=q(m.metadata||{}),m.hasOwnProperty("commerce_data")&&(m.commerce_data=q(m.commerce_data||{})));("/v1/pageview"===b.endpoint||"/v1/dismiss"===b.endpoint)&&m.metadata&&(m.metadata=q(m.metadata||{}));"/v1/open"===b.endpoint&&(m.options=q(m.options||{}));return{data:Db(a,m,""),url:k.replace(/^\//,"")}}
...
n.appendChild(t);l.style.opacity="0";g.style.opacity="0";m.style.opacity="0";setTimeout(function(){t.style.opacity="1"},20);g.value=""}function k(){l.removeAttribute("disabled");g.removeAttribute("disabled");l.style.opacity="1";g.style.opacity="1";m.style.opacity="0"}var g=a.getElementById("branch-sms-phone"),l=a.getElementById("branch-sms-send"),m=a.getElementById("branch-loader-wrapper"),n=a.getElementById("branch-sms-form-container"),t;if(g){var P=g.value;/^\d{7,}$/.test(P.replace(/[\s()+\-\.]|ext/gi,
""))?(N(b,"willSendBannerSMS"),l.setAttribute("disabled",""),g.setAttribute("disabled",""),l.style.opacity=".4",g.style.opacity=".4",m.style.opacity="1",g.className="",b.sendSMS(P,d,c,function(a){a?(N(b,"sendBannerSMSError"),e()):(N(b,"didSendBannerSMS"),f(),setTimeout(function(){n.removeChild(t);k()},3E3))})):e()}}
...
m=document.body.style.marginTop,n=Mb("margin-bottom"),t=document.body.style.marginBottom,P=g.getElementById("branch-banner-close");P&&(P.onclick=function(b){b.preventDefault();N(a,"willCloseBanner");e({},function(){N(a,"didCloseBanner")})});Jb(document.body,"branch-banner-is-active");"top"===b.position?document.body.style.marginTop=Nb(l):"bottom"===b.position&&(document.body.style.marginBottom=Nb(n));b.X?f():setTimeout(f,20);return e};var Vb,Wb=1,O="top",Xb="absolute",Q="76px",Yb=!1,Zb=!1,R=[],$b=!1,ac=window.innerHeight,bc=window.innerWidth;window.innerHeight<window.innerWidth&&(ac=window.innerWidth,bc=window.innerHeight);
var cc=0,dc=0,ec=/<script type="application\/json">((.|\s)*?)<\/script>/,fc=/<script type="text\/javascript">((.|\s)*?)<\/script>/,gc=/<style type="text\/css" id="branch-css">((.|\s)*?)<\/style>/,hc=/<style type="text\/css" id="branch-iframe-css">((.|\s)*?)<\/style>/,ic=/#branch-banner-spacer {((.|\s)*?)}/,jc=/margin-bottom: (.*?);/,S=null,kc=null,lc=!1,mc=!1,nc=!1,oc=!1,pc=!1,qc="",rc=[],T=null;function sc(a){if(a=a.match(ec))return p(a[1])}
function tc(a){var b=document.createElement("style");b.type="text/css";b.id="branch-iframe-css";cc=Mb("margin-top");var c=+cc.slice(0,-2);dc=Mb("margin-bottom");var d=+dc.slice(0,-2),e=+Q.slice(0,-2);a||("top"===O?document.body.style.marginTop=(+e+c).toString()+"px":"bottom"===O&&(document.body.style.marginBottom=(+e+d).toString()+"px"));0<R.length&&R.forEach(function(a){var b,c=window.getComputedStyle(a);c&&(b=Yb&&"fixed"===c.getPropertyValue("position"));b||(a.style.marginTop=Q)});"top"===qc&&qc!==
O&&pc&&rc&&0<rc.length&&rc.forEach(function(a){a.style.marginTop=0});pc=!1;qc="";rc=[];oc=!1;a?b.innerHTML=a:b.innerHTML=uc();G(b);document.head.appendChild(b)}
function uc(){var a="",b="";document.body.style.transition="";document.getElementById("branch-banner-iframe")&&(document.getElementById("branch-banner-iframe").style.transition="");nc||(a="body { -webkit-transition: all 0.375s ease; }\n",document.body.style.transition="all 00.375s ease",b="-webkit-transition: all 0.25s ease; transition: all 00.25s ease;");return(a?a:"")+("#branch-banner-iframe { box-shadow: 0 0 5px rgba(0, 0, 0, .35); width: 1px; min-width:100%; left: 0; right: 0; border: 0; height: "+
Q+"; z-index: 99999; "+b+" }\n#branch-banner-iframe { position: "+Xb+"; }\n@media only screen and (orientation: landscape) { body { "+("top"===O?"margin-top: ":"margin-bottom: ")+(Yb?bc+"px":Q)+"; }\n#branch-banner-iframe { height: "+(Yb?bc+"px":Q)+"; }")}
function vc(a,b){Jb(document.body,"branch-banner-is-active");Yb&&"fixed"===Xb&&Jb(document.body,"branch-banner-no-scroll");setTimeout(function(){b?(a.style.top=null,a.style.bottom=null):"top"===O?a.style.top="0":"bottom"===O&&(T&&T.journey_link_data&&!T.journey_link_data.safeAreaRequired?a.style.bottom="0":($b=!0,document.getElementById("branch-banner-iframe").style.transition="all 0s",wc(!1,!0),window.addEventListener("resize",xc),window.addEventListener("scroll",yc)));N(S,"didShowJourney",T);lc=
!0},20)}function xc(){$b&&wc(!1,!1)}function yc(){$b&&(window.pageYOffset>window.innerHeight?wc(!0,!1):wc(!1,!1))}function wc(a,b){var c=document.getElementById("branch-banner-iframe"),d=c.offsetHeight,e=c.offsetTop,f=window.innerHeight;b&&window.pageYOffset?c.style.bottom="0":a?c.style.top=f-d+d/2+"px":f-e!=d&&(c.style.top=""+(f-d)+"px")}function zc(a){a=a.globalDismissPeriod;if("number"===typeof a){if(-1===a)a=!0;else{var b=new Date;a=b.setSeconds(b.getSeconds()+a)}return a}}
function Ac(a,b,c,d,e,f,k){var g=U;d&&e&&(Array.prototype.forEach.call(e.contentWindow.document.querySelectorAll("#branch-mobile-action"),function(a){a.addEventListener("click",function(){N(S,"didClickJourneyCTA",T);oc=!0;d();Bc(e)})}),Cc(".branch-banner-continue","didClickJourneyContinue",c,e,a,b,f,k,g),Cc(".branch-banner-close","didClickJourneyClose",c,e,a,b,f,k,g))}
function Cc(a,b,c,d,e,f,k,g,l){Array.prototype.forEach.call(d.contentWindow.document.querySelectorAll(a),function(a){a.addEventListener("click",function(){Ec(b,c,d,e,f,k,g,l)})})}function Fc(a,b,c){var d=a.get("journeyDismissals",!0),d=d?p(d):{};d[c]={view_id:b,dismiss_time:Date.now()};a.set("journeyDismissals",q(d),!0)}function Gc(a){var b={},c=C();c&&0<Object.keys(c).length&&(b.hosted_deeplink_data=c);return a.I(Hc(null,b),null,S,!0)}
function Ec(a,b,c,d,e,f,k,g){var l=k?0:zc(f);N(S,a,T);oc=!0;Bc(c);if(!k)if(void 0!==l&&b.set("globalJourneysDismiss",l,!0),Fc(b,d,e),f.dismissRedirect)window.location=f.dismissRedirect;else{var m=function(){S.removeListener(m);var a=Gc(g);S.b(ub,a,function(b,c){!b&&"object"===typeof c&&c.template&&g.N(c,null,!1)&&g.J(c.template,a,a.branch_view_id||c.event_data.branch_view_data.id,c.event_data.branch_view_data,!1,c.journey_link_data)})};S.addListener("branch_internal_event_didCloseJourney",m)}}
function Hc(a,b){return z({url:a&&a.url||Ca(),user_agent:navigator.userAgent,language:navigator.language,screen_width:screen.width||-1,screen_height:screen.height||-1,window_device_pixel_ratio:window.devicePixelRatio||1},b||{})}
function Bc(a,b){if(nc&&!mc){document.body.style.transition="all 00.375s ease";document.getElementById("branch-banner-iframe").style.transition="all 00.25s ease";var c=document.getElementById("branch-iframe-css").innerHTML+"\n";document.getElementById("branch-iframe-css").innerHTML="";document.getElementById("branch-iframe-css").innerHTML=c+"body { -webkit-transition: all 0.375s ease; }\n#branch-banner-iframe { -webkit-transition: all 0.25s ease; }\n"}"top"===O?a.style.top="-"+Q:"bottom"===O&&(a.style.bottom=
"-"+Q);N(S,"willCloseJourney",T);setTimeout(function(){M(a);M(document.getElementById("branch-css"));M(document.getElementById("branch-iframe-css"));M(document.getElementById("branch-journey-cta"));(!mc||oc)&&R&&0<R.length?R.forEach(function(a){a.style.marginTop=0}):(pc=mc,qc=O,rc=R);"top"===O?document.body.style.marginTop=cc:"bottom"===O&&(document.body.style.marginBottom=dc);Kb("branch-banner-is-active");Kb("branch-banner-no-scroll");$b&&($b=!1,window.removeEventListener("resize",xc),window.removeEventListener("scroll",
yc));N(S,"didCloseJourney",T);b||N(S,"branch_internal_event_didCloseJourney",T);lc=!1},mc?0:270)}function Ic(a){var b={banner_id:Vb};if(a&&"object"===typeof a&&0<Object.keys(a).length){var c=["browser_fingerprint_id","app_id","source","open_app","link_click_id"];if(a&&"object"===typeof a&&!Array.isArray(a)&&0<Object.keys(a).length&&c&&Array.isArray(c)&&0<c.length)for(var d in a)a.hasOwnProperty(d)&&-1<c.indexOf(d)&&delete a[d];b.journey_link_data={};z(b.journey_link_data,a)}T=b};var U={};
function Jc(a,b){var c=b?"OPEN":"GET",d=a,e=sc(d);e&&e.bannerHeight&&e.position&&e.sticky?(Q=e.bannerHeight,O=e.position,Xb=e.sticky):(d=d.match(ic))?(O="top",(d=d[1].match(jc))&&(Q=d[1]),Xb="absolute"):(O="bottom",Xb="fixed");if(-1!==Q.indexOf("vh")||-1!==Q.indexOf("%"))d=Q.indexOf("vh")?Q.slice(0,-2):Q.slice(0,-1),Q=d/100*ac+"px",100>d?Zb=!0:Yb=!0;if(d=sc(a)){var f;b&&d&&d.ctaText&&d.ctaText.has_app?f=d.ctaText.has_app:d&&d.ctaText&&d.ctaText.no_app&&(f=d.ctaText.no_app);c=f;R=[];if(d&&d.injectorSelector&&
(f=document.querySelectorAll(d.injectorSelector)))for(d=0;d<f.length;d++)R.push(f[d].parentElement)}f=(f=a.match(gc))?f[1]:void 0;if(d=a.match(fc))d=d[1],e=document.createElement("script"),e.id="branch-journey-cta",G(e),e.innerHTML=d,document.body.appendChild(e);d=(d=a.match(hc))?d[1]:void 0;var e=a,k=e.match(ec),g=e.match(fc),l=e.match(gc),m=e.match(hc);k&&(e=e.replace(ec,""));g&&(e=e.replace(fc,""));l&&(e=e.replace(gc,""));m&&(e=e.replace(hc,""));a=e;e=document.createElement("iframe");e.src="about:blank";
e.style.overflow="hidden";e.scrolling="no";e.id="branch-banner-iframe";e.className="branch-animation";e.title="Branch Banner";e.setAttribute("aria-label","Branch Banner");G(e);document.body.appendChild(e);k=A();k='<html><head></head><body class="'+("ios"===k||"ipad"===k?"branch-banner-ios":"android"===k?"branch-banner-android":"branch-banner-desktop")+'">'+a+"</body></html>";e.contentWindow.document.open();e.contentWindow.document.write(k);e.contentWindow.document.close();tc(d);k=document.createElement("style");
k.type="text/css";k.id="branch-css";k.innerHTML=f;G(k);f=e.contentWindow.document;f.head.appendChild(k);if(Zb||Yb){var n=f.getElementsByClassName("branch-banner-content")[0];n&&(n.style.height=Q)}"top"===O?e.style.top="-"+Q:"bottom"===O&&(e.style.bottom="-"+Q);try{var n=f.getElementsByClassName("branch-banner-content")[0],t=window.getComputedStyle(n).getPropertyValue("background-color").split(", ");t[3]&&!parseFloat(t[3])&&(e.style.boxShadow="none")}catch(P){}e.contentWindow.document.getElementById("branch-mobile-action").innerHTML=
c;N(S,"willShowJourney",T);vc(e,d);return e}U.N=function(a,b,c){if(document.getElementById("branch-banner")||document.getElementById("branch-banner-iframe")||document.getElementById("branch-banner-container")||!A()||!a.event_data||!a.template)return!1;if(c)return!0;(a=!a.event_data.branch_view_data.id||b&&b.no_journeys)||(a=S,b=a.c.get("globalJourneysDismiss",!0),!0===b||b>Date.now()?a=!0:(a.c.remove("globalJourneysDismiss",!0),a=!1));return a?(U.za=1,!1):!0};
...
U.J=function(a,b,c,d,e,f){Vb=c;Ic(f);var k=d.audience_rule_id;(f=document.getElementById("branch-iframe-css"))&&f.parentElement.removeChild(f);f=document.createElement("div");f.id="branch-banner";document.body.insertBefore(f,null);Jb(f,"branch-banner-is-active");var g=!1,l=b.callback_string,m=null,n=null,t=S.c;if(a){var P=sc(a)||{},Dc=window.setTimeout(function(){window[l]=function(){}},pa);window[l]=function(a){window.clearTimeout(Dc);g||(n=a,Ac(c,k,t,n,m,P,e))};kc=m=Jc(a,b.has_app_websdk);if(null===
m){g=!0;return}Ac(c,k,t,n,m,P,e);qa&&(u["journey-load-time"]=(Date.now()-window.performance.timing.navigationStart).toString())}document.body.removeChild(f);v||e||U.ja(d)};
U.I=function(a,b,c,d){S=c;b||(b={});a||(a={});nc=b.disable_entry_animation||!1;mc=b.disable_exit_animation||!1;var e=z({},c.H),f=L(c.c)||{},k=f.hasOwnProperty("has_app")?f.has_app:!1,g=c.c.get("journeyDismissals",!0),l=(b.user_language||Ma()||"en").toLowerCase()||null,m=Ya(V(c)),n;(n=b.branch_view_id)||(n="_branch_view_id".replace(/[\[\]]/g,"\\$&"),n=(n=(new RegExp("[?&]"+n+"(=([^&#]*)|&|#|$)")).exec(Ca()))&&n[2]?decodeURIComponent(n[2].replace(/\+/g," ")):"");n=n||null;c=b.make_new_link?null:Ea(V(c));
...
return e=Da(e)};var W={androidAppIndexingTagsPresent:!1,iosAppIndexingTagsPresent:!1,androidDetailsComplete:!1,iosDetailsComplete:!1},X={};function Kc(a){var b;"android"===a&&W.androidDetailsComplete&&(b="android-app://"+X.androidPackageName+"/"+X.androidURL,b=Lc(b),Mc(b));"ios"===a&&W.iosDetailsComplete&&(b="ios-app://"+X.iosAppId+"/"+X.iosURL,b=Lc(b),Mc(b))}
function Lc(a){var b={"~channel":"Firebase App Indexing","~feature":"Auto App Indexing",$canonical_url:Ca()};if("object"===typeof X.data)for(var c in X.data)X.data.hasOwnProperty(c)&&!b.hasOwnProperty(c)&&(b[c]=X.data[c]);return a+(-1<a.indexOf("?")?"&":"?")+"link_click_id=a-"+btoa(q(b))}function Mc(a){var b=document.createElement("link");b.setAttribute("rel","alternate");b.setAttribute("href",a);document.head.appendChild(b)}
function Nc(a){"android"===a&&"string"===typeof X.androidPackageName&&"string"===typeof X.androidURL&&(W.androidDetailsComplete=!0,Kc("android"));"ios"===a&&"string"===typeof X.iosAppId&&"string"===typeof X.iosURL&&(W.iosDetailsComplete=!0,Kc("ios"))}
function Oc(a){for(var b=document.getElementsByTagName("meta"),c=0;c<b.length;c++){var d=b[c];"ios"===a&&"al:ios:app_store_id"===d.getAttribute("property")&&(X.iosAppId=d.getAttribute("content"));"ios"===a&&"al:ios:url"===d.getAttribute("property")&&(X.iosURL=d.getAttribute("content").replace("://","/"));"android"===a&&"al:android:package"===d.getAttribute("property")&&(X.androidPackageName=d.getAttribute("content"));"android"===a&&"al:android:url"===d.getAttribute("property")&&(X.androidURL=d.getAttribute("content").replace("://",
"/"))}Nc(a)};var Pc;
...
d.l)),null);if(0===d.j||!d.j)return k(Error(w("Branch SDK not initialized")),null)}e.unshift(k);b.apply(d,e)})}}function Z(){if(!(this instanceof Z))return Pc||(Pc=new Z),Pc;this.$=ma();this.c=new vb(["session","cookie","pojo"]);this.ca=new Cb;this.g=[];this.V="web2.50.1";this.i=this.j=0;this.l=null}
...
v&&ya(g);b=L(g.c);var l=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,m=l||Ia("_branch_match_id")||Fa(),n=!b||!b.identity_id;g.A=!!g.c.get("branch_view_enabled");if(b&&b.session_id&&!m&&!Ia("branchify_url"))Bb(g.c,{data:""}),Bb(g.c,{referring_link:""}),d(),f(e);else{b={sdk:"2.50.1",branch_key:g.h};var t=L(g.c,!0)||{};t.browser_fingerprint_id&&(b._t=t.browser_fingerprint_id);Ha()?g.b($a,{link_identifier:m,browser_fingerprint_id:m||t.browser_fingerprint_id,
alternative_browser_fingerprint_id:t.browser_fingerprint_id,options:c,initial_referrer:Ya(V(g)),current_url:window.top.location.href||""},function(a,b){a&&(g.i=2,g.l=a.message);a||"object"!==typeof b||(b.branch_view_enabled&&(g.A=!!b.branch_view_enabled,g.c.set("branch_view_enabled",g.A)),m&&(b.click_id=m));d();e(a,b)}):g.b(ab,b,function(a,b){if(a)return g.i=3,g.l=a.message,e(a,null);g.b($a,{link_identifier:m,browser_fingerprint_id:m||b,alternative_browser_fingerprint_id:t.browser_fingerprint_id,
options:c,initial_referrer:Ya(V(g)),current_url:window.top.location.href||""},function(a,b){a&&(g.i=2,g.l=a.message);a||"object"!==typeof b||(b.branch_view_enabled&&(g.A=!!b.branch_view_enabled,g.c.set("branch_view_enabled",g.A)),m&&(b.click_id=m));d();e(a,b)})})}},!0);Z.prototype.renderQueue=Y(0,function(a,b){this.aa?b():(this.m=this.m||[],this.m.push(b));a(null,null)});
Z.prototype.renderFinalize=Y(2,function(a){this.m&&0<this.m.length&&(this.m.forEach(function(a){a.call(this)}),delete this.m);this.aa=!0;a(null,null)});Z.prototype.data=Y(2,function(a){var b=Aa(L(this.c));b.referring_link=V(this);b.data_parsed=b.data&&0!==b.data.length?p(b.data):{};a(null,b)});Z.prototype.first=Y(2,function(a){a(null,Aa(L(this.c,!0)))});
...
Z.prototype.autoAppIndex=Y(1,function(a,b){b=b||{};var c=document.getElementsByTagName("link"),d=c.length;if(d)for(var e=0;e<d;e++){var f=c[e],k=f.href;k&&(k.includes("ios-app")&&(W.iosAppIndexingTagsPresent=!0,f.setAttribute("href",Lc(k))),k.includes("android-app")&&(W.androidAppIndexingTagsPresent=!0,f.setAttribute("href",Lc(k))))}X=b;W.androidAppIndexingTagsPresent||(Nc("android"),W.androidDetailsComplete||Oc("android"));W.iosAppIndexingTagsPresent||(Nc("ios"),W.iosDetailsComplete||Oc("ios"));
...
Z.prototype.disableTracking=Y(1,function(a,b){if(!1===b||"false"===b)ua=v=!1,this.h&&this.F&&(!0===this.F.tracking_disabled&&delete this.F.tracking_disabled,this.init(this.h,this.F));else if(void 0===b||!0===b||"true"===b)ya(this),ua=v=!0,this.closeBanner(),this.closeJourney();a()});var Rc=new Z;if(window.branch&&window.branch._q)for(var Sc=window.branch._q,Tc=0;Tc<Sc.length;Tc++){var Uc=Sc[Tc];Rc[Uc[0]].apply(Rc,Uc[1])}"function"===typeof define&&define.amd?define("branch",function(){return Rc}):"object"===typeof exports&&(module.exports=Rc);window&&(window.branch=Rc);})();
