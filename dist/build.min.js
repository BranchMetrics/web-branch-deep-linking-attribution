...
function Ha(a,b){if((a=/version\/([^ ]*)/i.exec(a))&&a[1])try{if(parseFloat(a[1])>=(b||11))return!0}catch(c){}return!1}
function D(){var a=navigator.userAgent;return a.match(/android/i)?"android":a.match(/ipad/i)||a&&Fa(a)&&a&&-1<a.indexOf("Macintosh")&&Ha(a,13)&&screen.height>screen.width?"ipad":a.match(/i(os|p(hone|od))/i)?"ios":a.match(/\(BB[1-9][0-9]*;/i)?"blackberry":a.match(/Windows Phone/i)?"windows_phone":a.match(/Kindle/i)||a.match(/Silk/i)||a.match(/KFTT/i)||a.match(/KFOT/i)||a.match(/KFJWA/i)||a.match(/KFJWI/i)||a.match(/KFSOWI/i)||a.match(/KFTHWA/i)||a.match(/KFTHWI/i)||a.match(/KFAPWA/i)||a.match(/KFAPWI/i)?
"kindle":!1}function Ia(){var a=navigator.userAgent;return Fa(a)?Ha(a,11):!1}function Ja(){var a=navigator.userAgent;return!!window.webkitURL&&a&&a&&/(iPad|iPod|iPhone)/.test(a)&&!/(chrome|crios)/i.test(a)&&!/(fxios|firefox)/i.test(a)&&!/edg/i.test(a)&&!/(opt|opr)/i.test(a)&&!/yabrowser/i.test(a)}function Ka(a){try{var b=(z()&&Ea()?window.top.location.search:window.location.search).substring(1).match(new RegExp(a+"=([^&]*)"));if(b&&1<=b.length)return b[1]}catch(c){}}
...
function eb(a){var b={};b=G(b,"http_origin",document.URL);b=G(b,"user_agent",navigator.userAgent);b=G(b,"language",Ua());b=G(b,"screen_width",screen.width||0);b=G(b,"screen_height",screen.height||0);b=G(b,"http_referrer",document.referrer);b=G(b,"browser_fingerprint_id",a.J);b=G(b,"developer_identity",a.m);b=G(b,"identity",a.m);b=G(b,"sdk","web");return b=G(b,"sdk_version","2.62.0")}function z(){return window.self!==window.top}
function Ea(){var a="true";try{window.top.location.search&&(a="true")}catch(b){return!1}return"true"===a}function fb(a){return a?a:z()?Ea()?window.top.document.referrer:"":document.referrer}function db(a){if(!H(a,"object")||0===Object.keys(a).length)return{};for(var b in a)if(a.hasOwnProperty(b)){var c=b;var d=a[b];d=H(d,"object")||H(d,"array")?u(d):null===d?"null":d.toString();a[c]=d}return a}
...
function Jb(a,b,c,d,e){var f=Date.now(),m=oa;0===a.l&&Ia()&&a.l++;var l="branch_callback__"+a.l++,g=0<=b.indexOf("branch.io")?"&data=":"&post_data=";c="POST"===d?encodeURIComponent(va(h(c))):"";var n=window.setTimeout(function(){window[l]=function(){};G(w,m,pa(f));e(Error("Request timed out"),null,504)},la);window[l]=function(k){window.clearTimeout(n);e(null,k)};a.createScript(b+(0>b.indexOf("?")?"?":"")+(c?g+c:"")+(0<=b.indexOf("/c/")?"&click=1":"")+"&callback="+l,function(){e(Error("Request blocked by client, probably adblock"),
null)},function(){G(w,m,pa(f));try{"function"===typeof this.remove?this.remove():this.parentNode.removeChild(this)}catch(k){}delete window[l]})}
function Kb(a,b,c,d,e,f,m,l){var g=Date.now(),n=oa,k=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");l&&(k.responseType=l);k.ontimeout=function(){G(w,n,pa(g));f(Error("Request timed out"),null,504)};k.onerror=function(q){f(Error(q.error||"Error in API: "+k.status),null,k.status)};k.onreadystatechange=function(){if(4===k.readyState)if(G(w,n,pa(g)),200===k.status){if("arraybuffer"===k.responseType)var q=k.response;else if(m)q=k.responseText;else try{q=t(k.responseText)}catch(v){q=
...
function Lb(a,b,c,d,e){function f(){d.get("use_jsonp")||b.R?Jb(a,k,c,b.method,m):Kb(a,k,n,b.method,d,m,R,p)}function m(r,B,E){"function"===typeof a.ga&&a.ga(k,b.method,q,r,E,B);r&&0<v&&"5"===(E||"").toString().substring(0,1)?(v--,window.setTimeout(function(){f()},ka)):e(r,B)}oa="/v1/pageview"===b.endpoint&&c&&c.journey_displayed?b.endpoint+"-1-brtt":b.endpoint+"-brtt";("/v1/url"===b.endpoint||"/v1/has-app"===b.endpoint)&&1<Object.keys(w).length&&(delete w["-brtt"],c.instrumentation=u(C({},w)),w={});
if(x)for(var l=["browser_fingerprint_id","alternative_browser_fingerprint_id","identity_id","session_id"],g=0;g<l.length;g++)c.hasOwnProperty(l[g])&&delete c[l[g]];l=Ib(a,b,c);if(l.error)return e(Error(u({message:l.error,endpoint:b.endpoint,data:c})));var n="";if("GET"===b.method)var k=l.url+"?"+l.data;else k=l.url,n=l.data;var q;d.get("use_jsonp")||b.R?q=c:q=n;var v=ja;if(x&&ta(k,c))return sa?m(Error("Requested operation cannot be completed since tracking is disabled"),null,300):m(null,{},200);var R=
!1;if("/v1/qr-code"===b.endpoint){R=!0;var p="arraybuffer"}f()};function N(a){a&&a.parentNode.removeChild(a)}function Mb(a,b){a&&!a.className.match(new RegExp("(\\s|^)"+b+"(\\s|$)"))&&(a.className+=" "+b)}function Nb(a){var b=document.body;b&&b.className.match(new RegExp("(\\s|^)"+a+"(\\s|$)"))&&(b.className=b.className.replace(new RegExp("(\\s|^)"+a+"(\\s|$)")," "))}function Ob(a){var b=new Date;return b.setDate(b.getDate()+a)}
...
k.appendChild(q);g.style.opacity="0";l.style.opacity="0";n.style.opacity="0";setTimeout(function(){q.style.opacity="1"},20);l.value=""}function m(){g.removeAttribute("disabled");l.removeAttribute("disabled");g.style.opacity="1";l.style.opacity="1";n.style.opacity="0"}var l=a.getElementById("branch-sms-phone"),g=a.getElementById("branch-sms-send"),n=a.getElementById("branch-loader-wrapper"),k=a.getElementById("branch-sms-form-container"),q;if(l){var v=l.value;/^\d{7,}$/.test(v.replace(/[\s()+\-\.]|ext/gi,
""))?(P(b,"willSendBannerSMS"),g.setAttribute("disabled",""),l.setAttribute("disabled",""),g.style.opacity=".4",l.style.opacity=".4",n.style.opacity="1",l.className="",b.sendSMS(v,d,c,function(R){R?(P(b,"sendBannerSMSError"),e()):(P(b,"didSendBannerSMS"),f(),setTimeout(function(){k.removeChild(q);m()},3E3))})):e()}}
function $b(a,b,c,d){function e(g,n){"function"===typeof g&&(n=g,g={});g=g||{};"top"===b.position?f.style.top="-76px":"bottom"===b.position&&(f.style.bottom="-76px");"number"===typeof b.P?d.set("hideBanner",Ob(b.P),!0):d.set("hideBanner",!0,!0);g.da?("top"===b.position?document.body.style.marginTop=m:"bottom"===b.position&&(document.body.style.marginBottom=l),Nb("branch-banner-is-active"),N(f),N(document.getElementById("branch-css")),n()):(setTimeout(function(){N(f);N(document.getElementById("branch-css"));
n()},270),setTimeout(function(){"top"===b.position?document.body.style.marginTop=m:"bottom"===b.position&&(document.body.style.marginBottom=l);Nb("branch-banner-is-active")},20))}if(!Rb(d,b))return P(a,"willNotShowBanner"),null;P(a,"willShowBanner");var f,m=document.body.style.marginTop,l=document.body.style.marginBottom;Yb(b,d,function(g){function n(){"top"===b.position?f.style.top="0":"bottom"===b.position&&(f.style.bottom="0");P(a,"didShowBanner")}f=g;Tb(b,f);c.channel=c.channel||"app banner";
var k=b.K?f.contentWindow.document:document;if(D()){if(b.open_app=b.ta,b.append_deeplink_path=b.ja,b.make_new_link=b.qa,b.deepview_type="banner",a.deepview(c,b),g=k.getElementById("branch-mobile-action"))g.onclick=function(v){v.preventDefault();a.deepviewCta()}}else k.getElementById("sms-form")?k.getElementById("sms-form").addEventListener("submit",function(v){v.preventDefault();Zb(k,a,b,c)}):f.onload=function(){k=f.contentWindow.document;k.getElementById("sms-form")&&k.getElementById("sms-form").addEventListener("submit",
function(v){v.preventDefault();Zb(k,a,b,c)})};g=Pb("margin-top");var q=Pb("margin-bottom");Mb(document.body,"branch-banner-is-active");"top"===b.position?document.body.style.marginTop=Qb(g):"bottom"===b.position&&(document.body.style.marginBottom=Qb(q));if(g=k.getElementById("branch-banner-close"))g.onclick=function(v){v.preventDefault();P(a,"willCloseBanner");e({},function(){P(a,"didCloseBanner")})};b.da?n():setTimeout(n,20)});return e};function ac(){function a(){if(b.length)b[0](function(){b.shift();a()})}var b=[];return function(c){b.push(c);1===b.length&&a()}};var bc={},cc,dc=1,Q="top",ec="absolute",S="76px",fc=!1,gc=!1,T=[],hc=!1,ic=window.innerHeight,jc=window.innerWidth;window.innerHeight<window.innerWidth&&(ic=window.innerWidth,jc=window.innerHeight);
...
function Kc(a,b){var c=document.createElement("style");c.type="text/css";c.id="branch-iframe-css";kc=Pb("margin-top");var d=+kc.slice(0,-2);lc=Pb("margin-bottom");var e=+lc.slice(0,-2),f=+S.slice(0,-2);a||("top"===Q?document.body.style.marginTop=(+f+d).toString()+"px":"bottom"===Q&&(document.body.style.marginBottom=(+f+e).toString()+"px"));0<T.length&&T.forEach(function(m){var l,g=window.getComputedStyle(m);g&&(l=fc&&"fixed"===g.getPropertyValue("position"));l||(m.style.marginTop=S)});"top"===zc&&
zc!==Q&&yc&&Ac&&0<Ac.length&&Ac.forEach(function(m){m.style.marginTop=0});yc=!1;zc="";Ac=[];xc=!1;c.innerHTML=a?a:Lc(b);I(c);document.head.appendChild(c)}
function Lc(a){var b="",c="";document.body.style.transition="";document.getElementById("branch-banner-iframe")&&(document.getElementById("branch-banner-iframe").style.transition="");wc||(b="body { -webkit-transition: all 0.375s ease; }\n",document.body.style.transition="all 00.375s ease",c="-webkit-transition: all 0.25s ease; transition: all 00.25s ease;");if(a=a&&"center_overlay"===a.type)document.body.style.background="rgba(0,0,0,0.4)";return(b?b:"")+("#branch-banner-iframe { box-shadow: 0 0 5px rgba(0, 0, 0, .35); width: 1px; min-width: "+
(a?"null;":"100%;")+" left: 0; right: 0; border: 0; height: "+S+"; z-index: 99999; "+c+" }\n#branch-banner-iframe { position: "+ec+"; }\n@media only screen and (orientation: landscape) { body { "+("top"===Q?"margin-top: ":"margin-bottom: ")+(fc?jc+"px":S)+"; }\n#branch-banner-iframe { height: "+(fc?jc+"px":S)+"; }")}
function Mc(a,b,c){Mb(document.body,"branch-banner-is-active");if(fc&&"fixed"===ec){var d=document.createElement("style");d.type="text/css";d.innerHTML=".branch-banner-no-scroll {overflow: hidden;}";document.head.appendChild(d);Mb(document.body,"branch-banner-no-scroll")}setTimeout(function(){b?(a.style.top=null,a.style.bottom=null):"top"===Q?a.style.top="0":"bottom"===Q&&(V&&V.journey_link_data&&!V.journey_link_data.safeAreaRequired?(a.style.bottom="0","center_overlay"===c.type&&a&&a.style&&(a.style.bottom=
"140px",a.style.width="94%",a.style.borderRadius="20px",a.style.margin="auto")):(hc=!0,document.getElementById("branch-banner-iframe").style.transition="all 0s",Nc(!1,!0),window.addEventListener("resize",Oc),window.addEventListener("scroll",Pc)));P(U,"didShowJourney",V);uc=!0},20)}function Oc(){hc&&Nc(!1,!1)}function Pc(){hc&&(window.pageYOffset>window.innerHeight?Nc(!0,!1):Nc(!1,!1))}
function Nc(a,b){var c=document.getElementById("branch-banner-iframe"),d=c.offsetHeight,e=c.offsetTop,f=window.innerHeight;b&&0!==window.pageYOffset?c.style.bottom="0":a?c.style.top=f-d+d/2+"px":f-e!=d&&(c.style.top=""+(f-d)+"px")}function Qc(a){a=a.globalDismissPeriod;if("number"===typeof a){if(-1===a)a=!0;else{var b=new Date;a=b.setSeconds(b.getSeconds()+a)}return a}}
function Rc(a,b,c,d,e,f,m){var l=W;d&&e&&(Array.prototype.forEach.call(e.contentWindow.document.querySelectorAll("#branch-mobile-action"),function(g){g.addEventListener("click",function(){P(U,"didClickJourneyCTA",V);xc=!0;d();Sc(e)})}),Tc(".branch-banner-continue","didClickJourneyContinue",c,e,a,b,f,m,l),Tc(".branch-banner-close","didClickJourneyClose",c,e,a,b,f,m,l))}
function Tc(a,b,c,d,e,f,m,l,g){Array.prototype.forEach.call(d.contentWindow.document.querySelectorAll(a),function(n){n.addEventListener("click",function(){Uc(b,c,d,e,f,m,l,g)})})}function Vc(a,b,c){var d=a.get("journeyDismissals",!0);d=d?t(d):{};d[c]={view_id:b,dismiss_time:Date.now()};a.set("journeyDismissals",u(d),!0)}
...
function Uc(a,b,c,d,e,f,m,l){var g=m?0:Qc(f);P(U,a,V);xc=!0;Sc(c);if(!m)if(void 0!==g&&b.set("globalJourneysDismiss",g,!0),Vc(b,d,e),f.dismissRedirect)window.location=f.dismissRedirect;else{var n=function(){U.removeListener(n);var k=Xc(l,qa[a]);U.i(xb,k,function(q,v){!q&&"object"===typeof v&&v.template&&l.U(v,null,!1)&&l.O(v.template,k,k.branch_view_id||v.event_data.branch_view_data.id,v.event_data.branch_view_data,!1,v.journey_link_data)})};U.addListener("branch_internal_event_didCloseJourney",n)}}
...
function cd(a,b,c){var d=b?"OPEN":"GET";Bc(a);var e=Cc(a);e&&(d=Ec(e,b),Fc(e));var f=Gc(a);Hc(a);var m=Dc(a);a=Ic(a);var l=Jc();l.onload=function(){var g=a,n=D(),k=l.contentDocument||l.contentWindow.document;k.head=k.createElement("head");k.body=k.createElement("body");k.body.innerHTML=g;k.body.className="ios"===n||"ipad"===n?"branch-banner-ios":"android"===n?"branch-banner-android":"branch-banner-desktop";(g=k.querySelector('meta[name="accessibility"]'))&&"wcag"===g.content&&(g=k.createElement("script"),g.type=
...
k.querySelector("body").append(g));Kc(m,e);k=document.createElement("style");k.type="text/css";k.id="branch-css";k.innerHTML=f;I(k);g=l.contentWindow.document;g.head.appendChild(k);if(gc||fc){var q=g.getElementsByClassName("branch-banner-content")[0];q&&(q.style.height=S)}"top"===Q?l.style.top="-"+S:"bottom"===Q&&(l.style.bottom="-"+S);try{q=g.getElementsByClassName("branch-banner-content")[0];var v=window.getComputedStyle(q).getPropertyValue("background-color").split(", ");v[3]&&0===parseFloat(v[3])&&
(l.style.boxShadow="none")}catch(R){}q=d;l.contentWindow.document.getElementById("branch-mobile-action").innerHTML=q;P(U,"willShowJourney",V);Mc(l,m,e);c(l)};document.body.appendChild(l)}
...
r){r&&(r=l(r),x||(r=f(r),xa(g.h,r,q)),g.A=3,r.data_parsed=r.data&&0!==r.data.length?t(r.data):{});if(p)return g.A=2,g.u||(g.u=1,g.B=p.message),a(p,r&&ya(r));try{a(p,r&&ya(r))}catch(E){}finally{g.renderFinalize()}p=$a();(r=H(c.metadata,"object")?c.metadata:null)&&(r=gb(p.hosted_deeplink_data,r))&&0<Object.keys(r).length&&(p.hosted_deeplink_data=r);var B=W.N(Yc(c,p),c,g,!1);g.renderQueue(function(){g.i(wb,B,function(E,K){E||"object"!==typeof K||(E=B.branch_view_id?!0:!1,W.U(K,c,E)?W.O(K.template,B,
B.branch_view_id||K.event_data.branch_view_data.id,K.event_data.branch_view_data,E,K.journey_link_data):((K.auto_branchify||!n&&Ka("branchify_url")&&X(g))&&this.branch.deepview({},{make_new_link:!1,open_app:!0,auto_branchify:!0}),P(U,"willNotShowJourney")));x&&(sa=!0)})})}function f(p){q&&(p.identity=g.m);return p}function m(p){var r={sdk:"2.62.0",branch_key:g.o},B=O(g.h)||{},E=O(g.h,!0)||{};E.browser_fingerprint_id&&(r._t=E.browser_fingerprint_id);Ia()||Ja()||g.i(jb,r,function(K,Ga){K&&(g.u=3,g.B=
K.message);Ga&&(B.browser_fingerprint_id=Ga)});g.i(rb,{browser_fingerprint_id:B.browser_fingerprint_id},function(K,Ga){K&&(g.u=4,g.B=K.message);K||!Ga||B.has_app||(B.has_app=!0,Ub(g.h,B),P(g,"didDownloadApp"));p&&p(null,B)})}function l(p){p.link_click_id&&(g.fa=p.link_click_id.toString());p.session_id&&(g.M=p.session_id.toString());p.identity_id&&(g.s=p.identity_id.toString());p.identity&&(g.m=p.identity.toString());p.link&&(g.T=p.link);if(p.referring_link){var r=p.referring_link;p.referring_link=
r?"http"!==r.substring(0,4)?"https://bnc.lt"+r:r:null}!p.click_id&&p.referring_link&&(p.click_id=Ca(p.referring_link));g.J=p.browser_fingerprint_id;return p}na&&(w["init-began-at"]=(Date.now()-window.performance.timing.navigationStart).toString());var g=this;g.A=1;-1<b.indexOf("key_")?g.o=b:g.aa=b;c=c&&H(c,"object")?c:{};ja=(g.L=c)&&c.retries&&Number.isInteger(c.retries)?c.retries:ja;ka=c&&c.retry_delay&&Number.isInteger(c.retry_delay)?c.retry_delay:ka;la=c&&c.timeout&&Number.isInteger(c.timeout)?
c.timeout:la;ma=c&&c.nonce?c.nonce:ma;x=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;sa=!1;x&&wa(g);b=O(g.h,!0);g.s=b&&b.identity_id;b=O(g.h);var n=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,k=n||Ka("_branch_match_id")||Da(),q=!g.s;g.I=!!g.h.get("branch_view_enabled");if(b&&b.session_id&&!k&&!Ka("branchify_url"))Ub(g.h,{data:""}),Ub(g.h,{referring_link:""}),d(),m(e);else{b={sdk:"2.62.0",branch_key:g.o};var v=O(g.h,!0)||{};v.browser_fingerprint_id&&
(b._t=v.browser_fingerprint_id);v.identity&&(g.m=v.identity);var R=parseInt(Ka("[?&]_open_delay_ms"),10);Ia()||Ja()?hb(function(){g.i(ib,{link_identifier:k,browser_fingerprint_id:k||v.browser_fingerprint_id,alternative_browser_fingerprint_id:v.browser_fingerprint_id,options:c,initial_referrer:fb(X(g)),current_url:z()&&Ea()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(p,r){p&&(g.u=2,g.B=p.message);p||"object"!==typeof r||(r.branch_view_enabled&&
(g.I=!!r.branch_view_enabled,g.h.set("branch_view_enabled",g.I)),k&&(r.click_id=k));d();e(p,r)})},R):g.i(jb,b,function(p,r){if(p)return g.u=3,g.B=p.message,e(p,null);hb(function(){g.i(ib,{link_identifier:k,browser_fingerprint_id:k||r,alternative_browser_fingerprint_id:v.browser_fingerprint_id,options:c,initial_referrer:fb(X(g)),current_url:z()&&Ea()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(B,E){B&&(g.u=2,g.B=B.message);B||
...
Z.prototype.crossPlatformIds=Y(2,function(a){this.i(yb,{user_data:u(eb(this))},function(b,c){return a(b||null,c&&c.user_data||null)})});Z.prototype.lastAttributedTouchData=Y(2,function(a,b){b=H(b,"number")?b:null;var c=eb(this);G(c,"attribution_window",b);this.i(zb,{user_data:u(c)},function(d,e){return a(d||null,e||null)})});
Z.prototype.track=Y(1,function(a,b,c,d){c=c||{};d=d||{};ma=d.nonce?d.nonce:ma;if("pageview"===b){(b=gb(Ta(),c))&&0<Object.keys(b).length&&(c.hosted_deeplink_data=b);var e=W.N(Yc(d,c),d,this,!1);this.i(wb,e,function(f,m){if(!f&&"object"===typeof m){var l=e.branch_view_id?!0:!1;W.U(m,d,l)?W.O(m.template,e,e.branch_view_id||m.event_data.branch_view_data.id,m.event_data.branch_view_data,l,m.journey_link_data):P(U,"willNotShowJourney")}"function"===typeof a&&a.apply(this,arguments)})}else this.i(sb,{event:b,
...
Z.prototype.logEvent=Y(1,function(a,b,c,d,e){b=H(b,"string")?b:null;c=H(c,"object")?c:null;e=H(e,"string")?e:null;c=cb(c);b&&-1<ab.indexOf(b)?(d=H(d,"array")?d:null,this.i(ub,{name:b,user_data:u(eb(this)),custom_data:u(c&&c.custom_data||{}),event_data:u(c&&c.event_data||{}),content_items:u(d||[]),customer_event_alias:e},function(f){return a(f||null)})):this.i(vb,{name:b,user_data:u(eb(this)),custom_data:u(c&&c.custom_data||{}),event_data:u(c&&c.event_data||{}),content_items:u(d||[]),customer_event_alias:e},
...
b,function(m,l){if(m)return x||(d.D=function(){window.top.location=e}),a(m);"function"===typeof l&&(d.D=l);a(null)});d.F()});
