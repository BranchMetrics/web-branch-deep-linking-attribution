...
function Ba(a){a&&(a.ga=null,a.M=null,a.H=null,a.A=null,a.g=null,a.D=null,a.u&&delete a.u,a.v&&delete a.v,a.c.remove("branch_view_enabled"),Ca(a.c,{},!0))}function w(a,b,c){a=a.replace(/\$(\d)/g,function(a,c){return b[parseInt(c,10)-1]});c&&(a+="\n Failure Code:"+c);return a}
...
c()},270),setTimeout(function(){"top"===b.position?document.body.style.marginTop=n:"bottom"===b.position&&(document.body.style.marginBottom=t);Vb("branch-banner-is-active")},20))}function f(){"top"===b.position?k.style.top="0":"bottom"===b.position&&(k.style.bottom="0");O(a,"didShowBanner")}if(!Zb(d,b))return O(a,"willNotShowBanner"),null;O(a,"willShowBanner");var k=cc(b,d);ac(b,k);c.channel=c.channel||"app banner";var l=b.F?k.contentWindow.document:document;if(B()){b.open_app=b.na;b.append_deeplink_path=
...
function Oc(a,b,c,d,e,f,k,l,g){Array.prototype.forEach.call(d.contentWindow.document.querySelectorAll(a),function(a){a.addEventListener("click",function(){Pc(b,c,d,e,f,k,l,g)})})}function Qc(a,b,c){var d=a.get("journeyDismissals",!0),d=d?p(d):{};d[c]={view_id:b,dismiss_time:Date.now()};a.set("journeyDismissals",q(d),!0)}
...
function Pc(a,b,c,d,e,f,k,l){var g=k?0:Lc(f);O(S,a,T);Ac=!0;Nc(c);if(!k)if(void 0!==g&&b.set("globalJourneysDismiss",g,!0),Qc(b,d,e),f.dismissRedirect)window.location=f.dismissRedirect;else{var n=function(){S.removeListener(n);var b=Tc(l,va[a]);S.b(Cb,b,function(a,c){!a&&"object"===typeof c&&c.template&&l.N(c,null,!1)&&l.J(c.template,b,b.branch_view_id||c.event_data.branch_view_data.id,c.event_data.branch_view_data,!1,c.journey_link_data)})};S.addListener("branch_internal_event_didCloseJourney",n)}}
...
function Wc(a){return fc&&S&&S.l&&S.l.data?S.l.data[a]:!1}function Xc(a){if(Wc(a))return S.l.data[a]}function Yc(a){function b(a){return c.reduce(function(a,b){if(a[b])return a;var c=Xc(b);c&&(a[b]=c);return a},a)}var c;c=void 0===c?["$android_url","$ios_url","$fallback_url","$desktop_url"]:c;if(!a)return console.log("setDefaultUrls - no data set"),a;try{var d=JSON.parse(a.data);a.data=JSON.stringify(b(d))}catch(e){console.log(e)}return a};var U={};
function Zc(a,b){var c=b?"OPEN":"GET",d=a,e=Ec(d);e&&e.bannerHeight&&e.position&&e.sticky?(Q=e.bannerHeight,P=e.position,ic=e.sticky):(d=d.match(uc))?(P="top",(d=d[1].match(vc))&&(Q=d[1]),ic="absolute"):(P="bottom",ic="fixed");if(-1!==Q.indexOf("vh")||-1!==Q.indexOf("%"))d=Q.indexOf("vh")?Q.slice(0,-2):Q.slice(0,-1),Q=d/100*mc+"px",100>d?kc=!0:jc=!0;if(d=Ec(a)){var f;b&&d&&d.ctaText&&d.ctaText.has_app?f=d.ctaText.has_app:d&&d.ctaText&&d.ctaText.no_app&&(f=d.ctaText.no_app);c=f;R=[];if(d&&d.injectorSelector&&
...
U.J=function(a,b,c,d,e,f){gc=c;Vc(f);var k=d.audience_rule_id;(f=document.getElementById("branch-iframe-css"))&&f.parentElement.removeChild(f);f=document.createElement("div");f.id="branch-banner";document.body.insertBefore(f,null);Ub(f,"branch-banner-is-active");var l=!1,g=b.callback_string,n=null,m=null,t=S.c;if(a){var A=Ec(a)||{},Rc=window.setTimeout(function(){window[g]=function(){}},ra);window[g]=function(a){window.clearTimeout(Rc);l||(m=a,Mc(c,k,t,m,n,A,e))};wc=n=Zc(a,b.has_app_websdk);if(null===
n){l=!0;return}Mc(c,k,t,m,n,A,e);sa&&(u["journey-load-time"]=(Date.now()-window.performance.timing.navigationStart).toString())}document.body.removeChild(f);v||e||U.ja(d)};
U.I=function(a,b,c,d){S=c;b||(b={});a||(a={});zc=b.disable_entry_animation||!1;yc=b.disable_exit_animation||!1;var e=z({},c.l),f=M(c.c)||{},k=f.hasOwnProperty("has_app")?f.has_app:!1,l=c.c.get("journeyDismissals",!0),g=(b.user_language||Va()||"en").toLowerCase()||null,n=fb(V(c)),m;(m=b.branch_view_id)||(m="_branch_view_id".replace(/[\[\]]/g,"\\$&"),m=(m=(new RegExp("[?&]"+m+"(=([^&#]*)|&|#|$)")).exec(Fa()))&&m[2]?decodeURIComponent(m[2].replace(/\+/g," ")):"");m=m||null;c=b.make_new_link?null:Ha(V(c));
...
return e=Ga(e)};var W={androidAppIndexingTagsPresent:!1,iosAppIndexingTagsPresent:!1,androidDetailsComplete:!1,iosDetailsComplete:!1},X={};function $c(a){var b;"android"===a&&W.androidDetailsComplete&&(b="android-app://"+X.androidPackageName+"/"+X.androidURL,b=ad(b),bd(b));"ios"===a&&W.iosDetailsComplete&&(b="ios-app://"+X.iosAppId+"/"+X.iosURL,b=ad(b),bd(b))}
function ad(a){var b={"~channel":"Firebase App Indexing","~feature":"Auto App Indexing",$canonical_url:Fa()};if("object"===typeof X.data)for(var c in X.data)X.data.hasOwnProperty(c)&&!b.hasOwnProperty(c)&&(b[c]=X.data[c]);return a+(-1<a.indexOf("?")?"&":"?")+"link_click_id=a-"+btoa(q(b))}function bd(a){var b=document.createElement("link");b.setAttribute("rel","alternate");b.setAttribute("href",a);document.head.appendChild(b)}
function cd(a){"android"===a&&"string"===typeof X.androidPackageName&&"string"===typeof X.androidURL&&(W.androidDetailsComplete=!0,$c("android"));"ios"===a&&"string"===typeof X.iosAppId&&"string"===typeof X.iosURL&&(W.iosDetailsComplete=!0,$c("ios"))}
function dd(a){for(var b=document.getElementsByTagName("meta"),c=0;c<b.length;c++){var d=b[c];"ios"===a&&"al:ios:app_store_id"===d.getAttribute("property")&&(X.iosAppId=d.getAttribute("content"));"ios"===a&&"al:ios:url"===d.getAttribute("property")&&(X.iosURL=d.getAttribute("content").replace("://","/"));"android"===a&&"al:android:package"===d.getAttribute("property")&&(X.androidPackageName=d.getAttribute("content"));"android"===a&&"al:android:url"===d.getAttribute("property")&&(X.androidURL=d.getAttribute("content").replace("://",
"/"))}cd(a)};var ed;
...
d.o)),null);if(0===d.m||!d.m)return g(Error(w("Branch SDK not initialized")),null)}e.unshift(g);b.apply(d,e)})}}function Z(){if(!(this instanceof Z))return ed||(ed=new Z),ed;this.$=oa();this.c=new Fb(["session","cookie","pojo"]);this.ca=new Nb;this.h=[];this.V="web2.52.6";this.j=this.m=0;this.o=null}
...
this.Z);(a.a&&a.a.sdk||a.f&&a.f.sdk)&&this.V&&(b.sdk=this.V);(a.a&&a.a.browser_fingerprint_id||a.f&&a.f.browser_fingerprint_id)&&this.D&&(b.browser_fingerprint_id=this.D);v&&(b.tracking_disabled=v);return Tb(this.ca,a,b,this.c,function(a,b){c(a,b)})};function V(a){var b=M(a.c);return(b=b&&b.referring_link)?b:(a=a.c.get("click_id"))?"https://bnc.lt/c/"+a:null}function O(a,b,c){for(var d=0;d<a.h.length;d++)a.h[d].event&&a.h[d].event!==b||a.h[d].listener(b,c)}
...
d){d&&(d=l(d),v||(d=f(d),Ca(g.c,d,t)),g.m=3,d.data_parsed=d.data&&0!==d.data.length?p(d.data):{});if(b)return g.m=2,g.j||(g.j=1,g.o=b.message),a(b,d&&Da(d));try{a(b,d&&Da(d))}catch(kd){}finally{g.renderFinalize()}var e=$a(),k=H(c.metadata,"object")?c.metadata:null;k&&(k=gb(e.hosted_deeplink_data,k))&&0<Object.keys(k).length&&(e.hosted_deeplink_data=k);var m=U.I(Uc(c,e),c,g,!1);g.renderQueue(function(){g.b(Bb,m,function(a,b){if(!a&&"object"===typeof b){var d=m.branch_view_id?!0:!1;U.N(b,c,d)?U.J(b.template,
m,m.branch_view_id||b.event_data.branch_view_data.id,b.event_data.branch_view_data,d,b.journey_link_data):((b.auto_branchify||!n&&Na("branchify_url")&&V(g))&&this.branch.deepview({},{make_new_link:!1,open_app:!0,auto_branchify:!0}),O(S,"willNotShowJourney"))}v&&(xa=!0)})})}function f(a){t&&(a.identity=g.g);return a}function k(a){var b={sdk:"2.52.6",branch_key:g.i},c=M(g.c)||{},d=M(g.c,!0)||{};d.browser_fingerprint_id&&(b._t=d.browser_fingerprint_id);Ma()||g.b(ib,b,function(a,b){a&&(g.j=3,g.o=a.message);
b&&(c.browser_fingerprint_id=b)});g.b(wb,{browser_fingerprint_id:c.browser_fingerprint_id},function(b,d){b&&(g.j=4,g.o=b.message);b||!d||c.has_app||(c.has_app=!0,Lb(g.c,c),O(g,"didDownloadApp"));a&&a(null,c)})}function l(a){a.link_click_id&&(g.Z=a.link_click_id.toString());a.session_id&&(g.H=a.session_id.toString());a.identity_id&&(g.A=a.identity_id.toString());a.identity&&(g.g=a.identity.toString());a.link&&(g.M=a.link);if(a.referring_link){var b=a.referring_link;a.referring_link=b?"http"!==b.substring(0,
4)?"https://bnc.lt"+b:b:null}!a.click_id&&a.referring_link&&(a.click_id=Ha(a.referring_link));g.D=a.browser_fingerprint_id;return a}sa&&(u["init-began-at"]=(Date.now()-window.performance.timing.navigationStart).toString());var g=this;g.m=1;-1<b.indexOf("key_")?g.i=b:g.U=b;c=c&&H(c,"object")?c:{};pa=(g.G=c)&&c.retries&&Number.isInteger(c.retries)?c.retries:pa;qa=c&&c.retry_delay&&Number.isInteger(c.retry_delay)?c.retry_delay:qa;ra=c&&c.timeout&&Number.isInteger(c.timeout)?c.timeout:ra;r=c&&c.nonce?
...
b)}):g.b(ib,b,function(a,b){if(a)return g.j=3,g.o=a.message,e(a,null);g.b(hb,{link_identifier:m,browser_fingerprint_id:m||b,alternative_browser_fingerprint_id:A.browser_fingerprint_id,options:c,initial_referrer:fb(V(g)),current_url:x()&&Ja()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(g.j=2,g.o=a.message);a||"object"!==typeof b||(b.branch_view_enabled&&(g.C=!!b.branch_view_enabled,g.c.set("branch_view_enabled",g.C)),
m&&(b.click_id=m));d();e(a,b)})})}},!0);Z.prototype.renderQueue=Y(0,function(a,b){this.aa?b():(this.s=this.s||[],this.s.push(b));a(null,null)});Z.prototype.renderFinalize=Y(2,function(a){this.s&&0<this.s.length&&(this.s.forEach(function(a){a.call(this)}),delete this.s);this.aa=!0;a(null,null)});Z.prototype.data=Y(2,function(a){var b=Da(M(this.c));b.referring_link=V(this);b.data_parsed=b.data&&0!==b.data.length?p(b.data):{};a(null,b)});Z.prototype.first=Y(2,function(a){a(null,Da(M(this.c,!0)))});
...
Z.prototype.logout=Y(1,function(a){var b=this;this.b(ob,{},function(c,d){c&&a(c);d=d||{};d={data_parsed:null,data:null,referring_link:null,click_id:null,link_click_id:null,identity:d.identity,session_id:d.session_id,identity_id:d.identity_id,link:d.link,device_fingerprint_id:b.ga||null};b.M=d.link;b.H=d.session_id;b.A=d.identity_id;b.g=d.identity;Lb(b.c,d);a(null)})});Z.prototype.getBrowserFingerprintId=Y(2,function(a){var b=M(this.c,!0)||{};a(null,b.browser_fingerprint_id||null)});
...
Z.prototype.link=Y(2,function(a,b){var c=Ga(b),c=Yc(b),d=this.i;this.b(ub,c,function(b,f){if(b)return a(b,za(d,c));console.log(33);if(Wc("$journeys_cta")&&0<Xc("$journeys_cta").length)return console.log(123),a(null,Xc("$journeys_cta"));a(null,f&&f.url)})});
...
Z.prototype.addListener=function(a,b){"function"===typeof a&&void 0===b&&(b=a,a=null);b&&this.h.push({listener:b,event:a||null})};Z.prototype.removeListener=function(a){a&&(this.h=this.h.filter(function(b){if(b.listener!==a)return b}))};function fd(a,b,c){c=c||{};try{a.l=p(q(c))}finally{a.l=a.l||{}}b()}Z.prototype.setBranchViewData=Y(1,function(a,b){fd.call(null,this,a,b)});
...
Z.prototype.autoAppIndex=Y(1,function(a,b){b=b||{};var c=document.getElementsByTagName("link"),d=c.length;if(d)for(var e=0;e<d;e++){var f=c[e],k=f.href;k&&(k.includes("ios-app")&&(W.iosAppIndexingTagsPresent=!0,f.setAttribute("href",ad(k))),k.includes("android-app")&&(W.androidAppIndexingTagsPresent=!0,f.setAttribute("href",ad(k))))}X=b;W.androidAppIndexingTagsPresent||(cd("android"),W.androidDetailsComplete||dd("android"));W.iosAppIndexingTagsPresent||(cd("ios"),W.iosDetailsComplete||dd("ios"));
...
Z.prototype.disableTracking=Y(1,function(a,b){if(!1===b||"false"===b)xa=v=!1,this.i&&this.G&&(!0===this.G.tracking_disabled&&delete this.G.tracking_disabled,this.init(this.i,this.G));else if(void 0===b||!0===b||"true"===b)Ba(this),xa=v=!0,this.closeBanner(),this.closeJourney();a()});var gd=new Z;if(window.branch&&window.branch._q)for(var hd=window.branch._q,id=0;id<hd.length;id++){var jd=hd[id];gd[jd[0]].apply(gd,jd[1])}"function"===typeof define&&define.amd?define("branch",function(){return gd}):"object"===typeof exports&&(module.exports=gd);window&&(window.branch=gd);})();
