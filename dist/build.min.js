...
function Ca(a){var b=a.has_app;return{data:a.data||"",data_parsed:a.data_parsed||{},has_app:void 0===b?null:b,identity:a.identity||null,developer_identity:a.identity||null,referring_identity:a.referring_identity||null,referring_link:a.referring_link||null}}function Da(a){var b=/^\$journeys_\S+$/,c=a.data,d={};if(!c)return{};switch(typeof c){case "string":try{c=n(c)}catch(e){c={}}break;case "object":break;default:c={}}Object.keys(c).forEach(function(a){b.test(a)&&(d[a]=c[a])});return d}
function Ea(){return x()?document.referrer:String(window.location)}
function z(a){a.source="web-sdk";var b=a.data;switch(typeof b){case "string":try{b=n(b)}catch(c){b={_bncNoEval:!0}}break;case "object":break;default:b={}}b.$canonical_url||(b.$canonical_url=Ea());b.$og_title||(b.$og_title=A("title"));b.$og_description||(b.$og_description=A("description"));b.$og_image_url||(b.$og_image_url=A("image"));b.$og_video||(b.$og_video=A("video"));b.$og_type||(b.$og_type=A("type"));"string"===typeof b.$desktop_url&&(b.$desktop_url=b.$desktop_url.replace(/#r:[a-z0-9-_]+$/i,
"").replace(/([\?\&]_branch_match_id=\d+)/,""));try{n(b)}catch(c){b=g(b)}a.data=b;return a}function Fa(a){function b(a){return""!==a}if(!a||"string"!==typeof a)return"";var c=document.createElement("a");c.href=a;a=c.pathname&&c.pathname.split("/").filter(b);return Array.isArray(a)&&a.length?a[a.length-1]+c.search:c.search}
...
function fb(a){var b={},b=F(b,"http_origin",document.URL),b=F(b,"user_agent",navigator.userAgent),b=F(b,"language",Va()),b=F(b,"screen_width",screen.width||0),b=F(b,"screen_height",screen.height||0),b=F(b,"http_referrer",document.referrer),b=F(b,"browser_fingerprint_id",a.D),b=F(b,"developer_identity",a.h),b=F(b,"identity",a.h),b=F(b,"sdk","web");return b=F(b,"sdk_version","2.61.0")}function x(){return window.self!==window.top}
function Ha(){var a="true";try{window.top.location.search&&(a="true")}catch(b){return!1}return"true"===a}function gb(a){return a?a:x()?Ha()?window.top.document.referrer:"":document.referrer}function eb(a){if(!G(a,"object")||!Object.keys(a).length)return{};for(var b in a)if(a.hasOwnProperty(b)){var c=b,d;d=a[b];d=G(d,"object")||G(d,"array")?p(d):null===d?"null":d.toString();a[c]=d}return a}
...
Bb.prototype.pojo={getAll:function(){return this.A},get:function(a){return this.A[a]||null},set:function(a,b){this.A[a]=b},remove:function(a){delete this.A[a]},clear:function(){this.A={}},isEnabled:function(){return!0}};function L(a,b){try{var c=n(a.get(b?"branch_session_first":"branch_session",b))||null;return Ra(c)}catch(d){return null}}function Ba(a,b,c){b=Qa(b);a.set("branch_session",g(b));c&&a.set("branch_session_first",g(b),!0)}function Ib(a,b){if(b){var c=L(a)||{},c=g(Qa(B(c,b)));a.set("branch_session",c)}}
function Jb(a,b,c){function d(a,b){return Qa(B(n(a),b,c))}var e=a.get("branch_session",!1)||{};a.set("branch_session",g(d(e,b)));e=a.get("branch_session_first",!0)||{};a.set("branch_session_first",g(d(e,b)),!0)};function Kb(){}Kb.prototype.g=0;function Lb(a,b,c){if("undefined"===typeof b)return"";var d=[];if(b instanceof Array){for(a=0;a<b.length;a++)d.push(encodeURIComponent(c)+"="+encodeURIComponent(b[a]));return d.join("&")}for(var e in b)b.hasOwnProperty(e)&&(b[e]instanceof Array||"object"===typeof b[e]?d.push(Lb(a,b[e],c?c+"."+e:e)):d.push(encodeURIComponent(c?c+"."+e:e)+"="+encodeURIComponent(b[e])));return d.join("&")}
function Mb(a,b,c){var d,e,f=b.destination+b.endpoint,k=/^[0-9]{15,20}$/,l=/key_(live|test)_[A-Za-z0-9]{32}/;if("/v1/has-app"===b.endpoint)try{var h;var q=b.f;"undefined"===typeof q&&(q={});if(c.branch_key&&l.test(c.branch_key))q.branch_key=c.branch_key,h=q;else if(c.app_id&&k.test(c.app_id))q.app_id=c.app_id,h=q;else{if(c.instrumentation)q.instrumentation=c.instrumentation;else throw Error(w("API request $1 missing parameter $2",[b.endpoint,"branch_key or app_id"]));h=void 0}b.f=h}catch(m){return{error:m.message}}if("undefined"!==
typeof b.f)for(d in b.f)if(b.f.hasOwnProperty(d)){if(e="function"===typeof b.f[d]?b.f[d](b.endpoint,d,c[d]):e)return{error:e};f+="/"+c[d]}k={};if("undefined"!==typeof b.a&&"/v1/pageview"!==b.endpoint&&"/v1/dismiss"!==b.endpoint)for(d in b.a){if(b.a.hasOwnProperty(d)){if(e=b.a[d](b.endpoint,d,c[d]))return{error:e};e=c[d];"undefined"!==typeof e&&""!==e&&null!==e&&(k[d]=e)}}else"/v1/pageview"!==b.endpoint&&"/v1/dismiss"!==b.endpoint||B(k,c);"/v1/event"===b.endpoint&&(k.metadata=p(k.metadata||{}),k.hasOwnProperty("commerce_data")&&
(k.commerce_data=p(k.commerce_data||{})));("/v1/pageview"===b.endpoint||"/v1/dismiss"===b.endpoint)&&k.metadata&&(k.metadata=p(k.metadata||{}));"/v1/open"===b.endpoint&&(k.options=p(k.options||{}));return{data:Lb(a,k,""),url:f.replace(/^\//,"")}}
...
function Ob(a,b,c,d,e){var f=Date.now(),k=sa;!a.g&&Ka()&&a.g++;var l="branch_callback__"+a.g++;a=0<=b.indexOf("branch.io")?"&data=":"&post_data=";c="POST"===d?encodeURIComponent(za(g(c))):"";var h=window.setTimeout(function(){window[l]=function(){};F(u,k,ta(f));e(Error("Request timed out"),null,504)},qa);window[l]=function(a){window.clearTimeout(h);e(null,a)};Nb(b+(0>b.indexOf("?")?"?":"")+(c?a+c:"")+(0<=b.indexOf("/c/")?"&click=1":"")+"&callback="+l,function(){e(Error("Request blocked by client, probably adblock"),
null)},function(){F(u,k,ta(f));try{"function"===typeof this.remove?this.remove():this.parentNode.removeChild(this)}catch(q){}delete window[l]})}
function Pb(a,b,c,d,e,f,k,l){var h=Date.now(),q=sa,m=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");l&&(m.responseType=l);m.ontimeout=function(){F(u,q,ta(h));f(Error("Request timed out"),null,504)};m.onerror=function(a){f(Error(a.error||"Error in API: "+m.status),null,m.status)};m.onreadystatechange=function(){var a;if(4===m.readyState)if(F(u,q,ta(h)),200===m.status){if("arraybuffer"===m.responseType)a=m.response;else if(k)a=m.responseText;else try{a=n(m.responseText)}catch(y){a=
{}}f(null,a,m.status)}else if("4"===m.status.toString().substring(0,1)||"5"===m.status.toString().substring(0,1))m.responseURL&&m.responseURL.includes("v2/event")?f(m.responseText,null,m.status):f(Error("Error in API: "+m.status),null,m.status)};try{m.open(d,b,!0),m.timeout=qa,m.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),m.send(c)}catch(t){e.set("use_jsonp",!0),Ob(a,b,c,d,f)}}
function Qb(a,b,c,d,e){function f(){d.get("use_jsonp")||b.L?Ob(a,q,c,b.method,k):Pb(a,q,m,b.method,d,k,T,Hb)}function k(c,d,h){"function"===typeof a.ba&&a.ba(q,b.method,t,c,h,d);c&&0<y&&"5"===(h||"").toString().substring(0,1)?(y--,window.setTimeout(function(){f()},pa)):e(c,d)}sa="/v1/pageview"===b.endpoint&&c&&c.journey_displayed?b.endpoint+"-1-brtt":b.endpoint+"-brtt";("/v1/url"===b.endpoint||"/v1/has-app"===b.endpoint)&&1<Object.keys(u).length&&(delete u["-brtt"],c.instrumentation=p(B({},u)),u=
{});if(v)for(var l=["browser_fingerprint_id","alternative_browser_fingerprint_id","identity_id","session_id"],h=0;h<l.length;h++)c.hasOwnProperty(l[h])&&delete c[l[h]];l=Mb(a,b,c);if(l.error)return e(Error(p({message:l.error,endpoint:b.endpoint,data:c})));var q,m="";"GET"===b.method?q=l.url+"?"+l.data:(q=l.url,m=l.data);var t;d.get("use_jsonp")||b.L?t=c:t=m;var y=oa;if(v&&xa(q,c))return wa?k(Error("Requested operation cannot be completed since tracking is disabled"),null,300):k(null,{},200);var T=
...
m.appendChild(t);h.style.opacity="0";l.style.opacity="0";q.style.opacity="0";setTimeout(function(){t.style.opacity="1"},20);l.value=""}function k(){h.removeAttribute("disabled");l.removeAttribute("disabled");h.style.opacity="1";l.style.opacity="1";q.style.opacity="0"}var l=a.getElementById("branch-sms-phone"),h=a.getElementById("branch-sms-send"),q=a.getElementById("branch-loader-wrapper"),m=a.getElementById("branch-sms-form-container"),t;if(l){var y=l.value;/^\d{7,}$/.test(y.replace(/[\s()+\-\.]|ext/gi,
""))?(N(b,"willSendBannerSMS"),h.setAttribute("disabled",""),l.setAttribute("disabled",""),h.style.opacity=".4",l.style.opacity=".4",q.style.opacity="1",l.className="",b.sendSMS(y,d,c,function(a){a?(N(b,"sendBannerSMSError"),e()):(N(b,"didSendBannerSMS"),f(),setTimeout(function(){m.removeChild(t);k()},3E3))})):e()}}
function cc(a,b,c,d){function e(a,c){"function"===typeof a&&(c=a,a={});a=a||{};"top"===b.position?f.style.top="-76px":"bottom"===b.position&&(f.style.bottom="-76px");"number"===typeof b.K?d.set("hideBanner",Tb(b.K),!0):d.set("hideBanner",!0,!0);a.Z?("top"===b.position?document.body.style.marginTop=k:"bottom"===b.position&&(document.body.style.marginBottom=l),Sb("branch-banner-is-active"),M(f),M(document.getElementById("branch-css")),c()):(setTimeout(function(){M(f);M(document.getElementById("branch-css"));
c()},270),setTimeout(function(){"top"===b.position?document.body.style.marginTop=k:"bottom"===b.position&&(document.body.style.marginBottom=l);Sb("branch-banner-is-active")},20))}if(!Wb(d,b))return N(a,"willNotShowBanner"),null;N(a,"willShowBanner");var f,k=document.body.style.marginTop,l=document.body.style.marginBottom;ac(b,d,function(d){function h(){"top"===b.position?f.style.top="0":"bottom"===b.position&&(f.style.bottom="0");N(a,"didShowBanner")}f=d;Yb(b,f);c.channel=c.channel||"app banner";
...
function Tc(a,b,c,d,e,f,k){var l=U;d&&e&&(Array.prototype.forEach.call(e.contentWindow.document.querySelectorAll("#branch-mobile-action"),function(a){a.addEventListener("click",function(){N(R,"didClickJourneyCTA",S);zc=!0;d();Uc(e)})}),Vc(".branch-banner-continue","didClickJourneyContinue",c,e,a,b,f,k,l),Vc(".branch-banner-close","didClickJourneyClose",c,e,a,b,f,k,l))}
function Vc(a,b,c,d,e,f,k,l,h){Array.prototype.forEach.call(d.contentWindow.document.querySelectorAll(a),function(a){a.addEventListener("click",function(){Wc(b,c,d,e,f,k,l,h)})})}function Xc(a,b,c){var d=a.get("journeyDismissals",!0),d=d?n(d):{};d[c]={view_id:b,dismiss_time:Date.now()};a.set("journeyDismissals",p(d),!0)}
...
function Wc(a,b,c,d,e,f,k,l){var h=k?0:Sc(f);N(R,a,S);zc=!0;Uc(c);if(!k)if(void 0!==h&&b.set("globalJourneysDismiss",h,!0),Xc(b,d,e),f.dismissRedirect)window.location=f.dismissRedirect;else{var q=function(){R.removeListener(q);var b=Zc(l,ua[a]);R.c(yb,b,function(a,c){!a&&"object"===typeof c&&c.template&&l.O(c,null,!1)&&l.J(c.template,b,b.branch_view_id||c.event_data.branch_view_data.id,c.event_data.branch_view_data,!1,c.journey_link_data)})};R.addListener("branch_internal_event_didCloseJourney",q)}}
...
function ed(a,b,c){var d=b?"OPEN":"GET";Dc(a);var e=Ec(a);e&&(d=Gc(e,b),Hc(e));var f=Ic(a);Jc(a);var k=Fc(a);a=Kc(a);var l=Lc();l.onload=function(){var b=a,q=C(),m=l.contentDocument||l.contentWindow.document;m.head=m.createElement("head");m.body=m.createElement("body");m.body.innerHTML=b;m.body.className="ios"===q||"ipad"===q?"branch-banner-ios":"android"===q?"branch-banner-android":"branch-banner-desktop";(b=m.querySelector('meta[name="accessibility"]'))&&"wcag"===b.content&&(b=m.createElement("script"),b.type=
...
m.querySelector("body").append(b));Mc(k,e);m=document.createElement("style");m.type="text/css";m.id="branch-css";m.innerHTML=f;H(m);b=l.contentWindow.document;b.head.appendChild(m);if(ic||hc){var t=b.getElementsByClassName("branch-banner-content")[0];t&&(t.style.height=P)}"top"===O?l.style.top="-"+P:"bottom"===O&&(l.style.bottom="-"+P);try{var t=b.getElementsByClassName("branch-banner-content")[0],y=window.getComputedStyle(t).getPropertyValue("background-color").split(", ");y[3]&&!parseFloat(y[3])&&
(l.style.boxShadow="none")}catch(T){}l.contentWindow.document.getElementById("branch-mobile-action").innerHTML=d;N(R,"willShowJourney",S);Oc(l,k,e);c(l)};document.body.appendChild(l)}
...
U.J=function(a,b,c,d,e,f){if(!oc){ec=c;ad(f);var k=d.audience_rule_id;(f=document.getElementById("branch-iframe-css"))&&f.parentElement.removeChild(f);var l=document.createElement("div");l.id="branch-banner";document.body.insertBefore(l,null);Rb(l,"branch-banner-is-active");var h=!1,q=b.callback_string,m=null,t=R.b;if(a){var y=Ec(a)||{};a=dd(a);var T=window.setTimeout(function(){window[q]=function(){}},qa);window[q]=function(a){window.clearTimeout(T);h||(m=a,Tc(c,k,t,m,null,y,e))};ed(a,b.has_app_websdk,
function(a){vc=a;null===a?h=!0:(Tc(c,k,t,m,a,y,e),ra&&(u["journey-load-time"]=(Date.now()-window.performance.timing.navigationStart).toString()),document.body.removeChild(l),v||e||U.$(d))})}else document.body.removeChild(l),v||e||U.$(d)}};
U.I=function(a,b,c,d){R=c;b||(b={});a||(a={});yc=b.disable_entry_animation||!1;xc=b.disable_exit_animation||!1;var e=B({},c.m),f=L(c.b)||{},k=f.hasOwnProperty("has_app")?f.has_app:!1,l=c.b.get("journeyDismissals",!0),h=(b.user_language||Va()||"en").toLowerCase()||null,q=gb(V(c)),m;(m=b.branch_view_id)||(m="_branch_view_id".replace(/[\[\]]/g,"\\$&"),m=(m=(new RegExp("[?&]"+m+"(=([^&#]*)|&|#|$)")).exec(Ea()))&&m[2]?decodeURIComponent(m[2].replace(/\+/g," ")):"");m=m||null;c=b.make_new_link?null:Fa(V(c));
e.event=d?"dismiss":"pageview";e.metadata=a;e=F(e,"initial_referrer",q);e=F(e,"branch_view_id",m);e=F(e,"no_journeys",b.no_journeys);e=F(e,"is_iframe",x());e=F(e,"journey_dismissals",l);e.user_language=h;e.open_app=b.open_app||!1;e.has_app_websdk=k;e.feature="journeys";e.callback_string="branch_view_callback__"+fc++;e.data||(e.data={});e.data=B(Ua(),e.data);e.data=B(Da(f||{}),e.data);c&&(e.data.link_click_id=c);(a=f.data?n(f.data):null)&&a["+referrer"]&&(e.data["+referrer"]=a["+referrer"]);return e=
...
"/"))}id(a)};var kd;
function Y(a,b,c){return function(){var d=this,e,f,k=arguments[arguments.length-1];a&&"function"===typeof k?(e=Array.prototype.slice.call(arguments,0,arguments.length-1)||[],f=k):(f=function(){},e=Array.prototype.slice.call(arguments));d.ca(function(k){function h(b,c){try{if(b&&!a)throw b;1===a?f(b):2===a&&f(b,c)}finally{k()}}if(!c){if(1===d.o)return h(Error(w("Branch SDK initialization pending and a Branch method was called outside of the queue order")),null);if(2===d.o)return h(Error(w("Branch SDK initialization failed, so further methods cannot be called",d.l,
d.s)),null);if(0===d.o||!d.o)return h(Error(w("Branch SDK not initialized")),null)}e.unshift(h);b.apply(d,e)})}}function Z(){if(!(this instanceof Z))return kd||(kd=new Z),kd;this.ca=na();this.b=new Bb(["session","cookie","pojo"]);this.V=new Kb;this.g=[];this.X="web2.61.0";this.l=this.o=0;this.s=null}
...
d){d&&(d=l(d),v||(d=f(d),Ba(h.b,d,t)),h.o=3,d.data_parsed=d.data&&0!==d.data.length?n(d.data):{});if(b)return h.o=2,h.l||(h.l=1,h.s=b.message),a(b,d&&Ca(d));try{a(b,d&&Ca(d))}catch(qd){}finally{h.renderFinalize()}var e=ab(),k=G(c.metadata,"object")?c.metadata:null;k&&(k=hb(e.hosted_deeplink_data,k))&&0<Object.keys(k).length&&(e.hosted_deeplink_data=k);var m=U.I($c(c,e),c,h,!1);h.renderQueue(function(){h.c(xb,m,function(a,b){if(!a&&"object"===typeof b){var d=m.branch_view_id?!0:!1;U.O(b,c,d)?U.J(b.template,
m,m.branch_view_id||b.event_data.branch_view_data.id,b.event_data.branch_view_data,d,b.journey_link_data):((b.auto_branchify||!q&&Ma("branchify_url")&&V(h))&&this.branch.deepview({},{make_new_link:!1,open_app:!0,auto_branchify:!0}),N(R,"willNotShowJourney"))}v&&(wa=!0)})})}function f(a){t&&(a.identity=h.h);return a}function k(a){var b={sdk:"2.61.0",branch_key:h.i},c=L(h.b)||{},d=L(h.b,!0)||{};d.browser_fingerprint_id&&(b._t=d.browser_fingerprint_id);Ka()||La()||h.c(kb,b,function(a,b){a&&(h.l=3,h.s=
...
r=c&&c.nonce?c.nonce:r;v=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;wa=!1;v&&Aa(h);b=L(h.b,!0);h.j=b&&b.identity_id;b=L(h.b);var q=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,m=q||Ma("_branch_match_id")||Ga(),t=!h.j;h.C=!!h.b.get("branch_view_enabled");if(b&&b.session_id&&!m&&!Ma("branchify_url"))Ib(h.b,{data:""}),Ib(h.b,{referring_link:""}),d(),k(e);else{b={sdk:"2.61.0",branch_key:h.i};var y=L(h.b,!0)||{};y.browser_fingerprint_id&&(b._t=
y.browser_fingerprint_id);y.identity&&(h.h=y.identity);var T=parseInt(Ma("[?&]_open_delay_ms"),10);Ka()||La()?ib(function(){h.c(jb,{link_identifier:m,browser_fingerprint_id:m||y.browser_fingerprint_id,alternative_browser_fingerprint_id:y.browser_fingerprint_id,options:c,initial_referrer:gb(V(h)),current_url:x()&&Ha()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(h.l=2,h.s=a.message);a||"object"!==typeof b||(b.branch_view_enabled&&
(h.C=!!b.branch_view_enabled,h.b.set("branch_view_enabled",h.C)),m&&(b.click_id=m));d();e(a,b)})},T):h.c(kb,b,function(a,b){if(a)return h.l=3,h.s=a.message,e(a,null);ib(function(){h.c(jb,{link_identifier:m,browser_fingerprint_id:m||b,alternative_browser_fingerprint_id:y.browser_fingerprint_id,options:c,initial_referrer:gb(V(h)),current_url:x()&&Ha()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(h.l=2,h.s=a.message);a||
...
Z.prototype.data=Y(2,function(a){var b=Ca(L(this.b));b.referring_link=V(this);b.data_parsed=b.data&&0!==b.data.length?n(b.data):{};a(null,b)});Z.prototype.first=Y(2,function(a){a(null,Ca(L(this.b,!0)))});
Z.prototype.setIdentity=Y(2,function(a,b){var c=this;this.c(ob,{identity:b},function(d,e){d&&a(d);e=e||{};c.j=e.identity_id?e.identity_id.toString():null;c.N=e.link;c.h=b;e.developer_identity=b;e.referring_data_parsed=e.referring_data?n(e.referring_data):null;Jb(c.b,{identity:b,identity_id:c.j});a(null,e)})});
...
Z.prototype.crossPlatformIds=Y(2,function(a){this.c(zb,{user_data:p(fb(this))},function(b,c){return a(b||null,c&&c.user_data||null)})});Z.prototype.lastAttributedTouchData=Y(2,function(a,b){b=G(b,"number")?b:null;var c=fb(this);F(c,"attribution_window",b);this.c(Ab,{user_data:p(c)},function(b,c){return a(b||null,c||null)})});
...
Z.prototype.logEvent=Y(1,function(a,b,c,d,e){b=G(b,"string")?b:null;c=G(c,"object")?c:null;e=G(e,"string")?e:null;c=db(c);b&&-1<bb.indexOf(b)?(d=G(d,"array")?d:null,this.c(vb,{name:b,user_data:p(fb(this)),custom_data:p(c&&c.custom_data||{}),event_data:p(c&&c.event_data||{}),content_items:p(d||[]),customer_event_alias:e},function(b){return a(b||null)})):this.c(wb,{name:b,user_data:p(fb(this)),custom_data:p(c&&c.custom_data||{}),event_data:p(c&&c.event_data||{}),content_items:p(d||[]),customer_event_alias:e},
...
Z.prototype.redeem=function(){console.warn("Credits feature has been deprecated. This is no-op.")};Z.prototype.addListener=function(a,b){"function"===typeof a&&void 0===b&&(b=a,a=null);b&&this.g.push({listener:b,event:a||null})};Z.prototype.removeListener=function(a){a&&(this.g=this.g.filter(function(b){if(b.listener!==a)return b}))};function ld(a,b,c){c=c||{};try{a.m=n(p(c))}finally{a.m=a.m||{}}b()}Z.prototype.setBranchViewData=Y(1,function(a,b){ld.call(null,this,a,b)},!0);
