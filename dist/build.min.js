...
Z.prototype.logEvent=Y(1,function(a,b,c,d,e){b=H(b,"string")?b:null;c=H(c,"object")?c:null;e=H(e,"string")?e:null;b&&-1<ab.indexOf(b)?(d=H(d,"array")?d:null,c=cb(c),this.b(zb,{name:b,user_data:q(eb(this)),custom_data:q(c&&c.custom_data||{}),event_data:q(c&&c.event_data||{}),content_items:q(d||[]),customer_event_alias:e},function(b){return a(b||null)})):this.b(Ab,{name:b,user_data:q(eb(this)),custom_data:q(db(c||{})),customer_event_alias:e},function(b){return a(b||null)})});
