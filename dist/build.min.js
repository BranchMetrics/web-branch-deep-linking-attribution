...
String(window.location),q=(c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null)||Aa()||ya(),F=!m||!m.identity_id;g.m=!!g.b.get("branch_view_enabled");if(m&&m.session_id&&!q)jb(g.b,{data:""}),d(),h(e);else{var m={sdk:"2.25.2",branch_key:g.i},U=H(g.b,!0)||{};U.browser_fingerprint_id&&(m._t=U.browser_fingerprint_id);za()?g.c(Na,{link_identifier:q,browser_fingerprint_id:q||U.browser_fingerprint_id,alternative_browser_fingerprint_id:U.browser_fingerprint_id,options:c,
