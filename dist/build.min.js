...
function ka(a,b){b.push('"',a.replace(ma,function(a){var b=la[a];b||(b="\\u"+(a.charCodeAt(0)|65536).toString(16).substr(1),la[a]=b);return b}),'"')};function p(a){a=String(a);try{return JSON.parse(a)}catch(b){}throw Error("Invalid JSON string: "+a);}function q(a){try{return"object"===typeof JSON&&"function"===typeof JSON.stringify?JSON.stringify(a):g(a)}catch(b){}throw Error("Could not stringify object");};function na(){function a(){if(b.length)b[0](function(){b.shift();a()})}var b=[];return function(c){b.push(c);1===b.length&&a()}};var oa=2,pa=200,qa=5E3,t="",v={},ra="undefined"!==typeof window&&!!(window.performance&&window.performance.timing&&window.performance.timing.navigationStart),sa="";function ta(a){return a&&"number"===typeof a?(Date.now()-a).toString():null}var ua={didClickJourneyClose:"Button(X)",didClickJourneyContinue:"Dismiss Journey text"},w=!1,va={"/v1/open":{link_identifier:"\\d+"},"/v1/pageview":{event:"pageview"},"/v1/dismiss":{event:"dismiss"},"/v1/url":{}},wa=!1;
function xa(a,b){var c=document.createElement("a");c.href=a;var d=c.origin;d.endsWith("/")&&(d=d.substring(0,d.length-1));if(!["https://instacart.api.beta.branch.io","https://app.stage.branch.io","https://link.stage.branch.io"].includes(d))return!1;c=c.pathname;"/"!=c[0]&&(c="/"+c);if(c.startsWith("/c/"))return!1;c=va[c];if(!c)return!0;if(0<Object.keys(c).length){if(!b)return!0;for(var e in c)if(d=new RegExp(c[e]),!b.hasOwnProperty(e)||!d.test(b[e]))return!0}return!1}
function ya(a,b){if(a||b){for(var c="https://link.stage.branch.io/a/"+a+"?",d="tags alias channel feature stage campaign type duration sdk source data".split(" "),e=0;e<d.length;e++){var f=d[e],k=b[f];if(k)if("tags"===f&&Array.isArray(k))for(var l=0;l<k.length;l++)c=("?"===c[c.length-1]?c+f:c+"&"+f)+"="+encodeURIComponent(k[l]);else if("string"===typeof k&&0<k.length||"number"===typeof k)"data"===f&&"string"===typeof k&&(k=za(k)),c=("?"===c[c.length-1]?c+f:c+"&"+f)+"="+encodeURIComponent(k)}return c}}
function Aa(a){a&&(a.ia=null,a.N=null,a.H=null,a.j=null,a.g=null,a.D=null,a.v&&delete a.v,a.w&&delete a.w,a.c.remove("branch_view_enabled"),Ba(a.c,{},!0))}function x(a,b,c){a=a.replace(/\$(\d)/g,function(a,c){return b[parseInt(c,10)-1]});c&&(a+="\n Failure Code:"+c);return a}
...
function Ra(a){a&&a.browser_fingerprint_id&&!Pa(a.browser_fingerprint_id)&&(a.browser_fingerprint_id=btoa(a.browser_fingerprint_id));a&&a.alternative_browser_fingerprint_id&&!Pa(a.alternative_browser_fingerprint_id)&&(a.alternative_browser_fingerprint_id=btoa(a.alternative_browser_fingerprint_id));return a}
function Sa(a){a&&Pa(a.browser_fingerprint_id)&&(a.browser_fingerprint_id=atob(a.browser_fingerprint_id));a&&Pa(a.alternative_browser_fingerprint_id)&&(a.alternative_browser_fingerprint_id=atob(a.alternative_browser_fingerprint_id));return a}function Ta(a,b,c){"function"===typeof a.addEventListener?a.addEventListener(b,c,void 0):"function"===typeof a.attachEvent?a.attachEvent("on"+b,c):a["on"+b]=c}
...
if(e)return e;if(d.length)return Za.invalidKeysForProducts+d.join(", ")}return null}function ab(a,b){if(!a||"string"!==typeof a||-1===Ya.indexOf(a.toLowerCase()))return Za.missingPurchaseEvent;if(!b||"object"!==typeof b||!Object.keys(b).length)return Za.missingCommerceData;var c=$a(b);return c?c:null}function E(a){return"string"!==typeof a?null:a.replace(/</g,"&lt;").replace(/>/g,"&gt;")}
function F(a,b,c){if(null!==c&&void 0!==c){if("object"===typeof c&&!Object.keys(c).length)return a;a[b]=c}return a}
function bb(){var a={},b;b={};b=F(b,"$og_title",A("title"));b=F(b,"$og_description",A("description"));b=F(b,"$og_image_url",A("image"));b=F(b,"$og_video",A("video"));b=(b=F(b,"$og_type",A("type")))&&0<Object.keys(b).length?b:null;a=F(a,"og_data",b);a=F(a,"hosted_deeplink_data",Va());b=document.getElementsByTagName("title");a=F(a,"title",0<b.length?b[0].innerText:null);b=document.querySelector('meta[name="description"]');a=F(a,"description",b&&b.content?b.content:null);b=document.querySelector('link[rel="canonical"]');
return(a=F(a,"canonical_url",b&&b.href?b.href:null))&&0<Object.keys(a).length?a:{}}var cb="ADD_TO_CART ADD_TO_WISHLIST VIEW_CART INITIATE_PURCHASE ADD_PAYMENT_INFO PURCHASE SPEND_CREDITS SEARCH VIEW_ITEM VIEW_ITEMS RATE SHARE COMPLETE_REGISTRATION COMPLETE_TUTORIAL ACHIEVE_LEVEL UNLOCK_ACHIEVEMENT LOGIN SUBSCRIBE START_TRIAL INVITE RESERVE VIEW_AD CLICK_AD INITIATE_STREAM COMPLETE_STREAM".split(" "),db="transaction_id revenue currency shipping tax coupon affiliation search_query description".split(" ");
function eb(a){if(!a||!Object.keys(a).length)return null;for(var b=Xa(db,Object.keys(a)),c={},d=0;d<b.length;d++){var e=b[d];c[e]=a[e];delete a[e]}return{custom_data:fb(c),event_data:a}}function G(a,b){return!b||null===a&&"object"===b?!1:"array"===b?Array.isArray(a):typeof a===b&&!Array.isArray(a)}
function gb(a){var b={},b=F(b,"http_origin",document.URL),b=F(b,"user_agent",navigator.userAgent),b=F(b,"language",Wa()),b=F(b,"screen_width",screen.width||0),b=F(b,"screen_height",screen.height||0),b=F(b,"http_referrer",document.referrer),b=F(b,"browser_fingerprint_id",a.D),b=F(b,"developer_identity",a.g),b=F(b,"identity",a.g),b=F(b,"sdk","web");return b=F(b,"sdk_version","2.59.0")}function y(){return window.self!==window.top}
function Ha(){var a="true";try{window.top.location.search&&(a="true")}catch(b){return!1}return"true"===a}function hb(a){return a?a:y()?Ha()?window.top.document.referrer:"":document.referrer}function fb(a){if(!G(a,"object")||!Object.keys(a).length)return{};for(var b in a)if(a.hasOwnProperty(b)){var c=b,d;d=a[b];d=G(d,"object")||G(d,"array")?q(d):null===d?"null":d.toString();a[c]=d}return a}
function ib(a,b){var c=a?B({},a):{};return b&&0<Object.keys(b).length?0<Object.keys(c).length?B(c,b):B({},b):c}function H(a){""!==t&&a.setAttribute("nonce",t)}function jb(a,b){isNaN(b)||0>=b?a():setTimeout(a,b)};function I(a,b){return function(c,d,e){if(w)return!1;if("number"===typeof e||e)if(0===b){if("object"!==typeof e)return x("API request $1, parameter $2 is not $3",[c,d,"an object"])}else if(3===b){if(!(e instanceof Array))return x("API request $1, parameter $2 is not $3",[c,d,"an array"])}else if(2===b){if("number"!==typeof e)return x("API request $1, parameter $2 is not $3",[c,d,"a number"])}else if(4===b){if("boolean"!==typeof e)return x("API request $1, parameter $2 is not $3",[c,d,"a boolean"])}else{if("string"!==
...
var kb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/open",method:"POST",a:{browser_fingerprint_id:I(!1,1),alternative_browser_fingerprint_id:I(!1,1),identity_id:I(!1,1),link_identifier:I(!1,1),sdk:I(!1,1),options:I(!1,0),initial_referrer:I(!1,1),tracking_disabled:I(!1,4),current_url:I(!1,1),screen_height:I(!1,2),screen_width:I(!1,2)}},lb={destination:"https://app.stage.branch.io",endpoint:"/_r",method:"GET",L:!0,a:{sdk:I(!0,1),_t:I(!1,1),branch_key:I(!0,1)}},mb={destination:"",
endpoint:"",method:"GET",f:{link_url:I(!0,1)},a:{click:I(!0,1)}},nb={destination:"https://link.stage.branch.io",endpoint:"/c",method:"POST",f:{link_url:I(!0,1)},a:{sdk:I(!1,1),phone:I(!0,1)}},ob={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/referralcode",method:"POST",a:J({amount:I(!0,2),bucket:I(!1,1),calculation_type:I(!0,2),creation_source:I(!0,2),expiration:I(!1,1),location:I(!0,2),prefix:I(!1,1),type:I(!0,1)})},pb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/referralcode",
method:"POST",f:{code:I(!0,1)},a:J({})},qb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/applycode",method:"POST",f:{code:I(!0,1)},a:J({})},rb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/logout",method:"POST",a:J({session_id:I(!0,1)})},sb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/profile",method:"POST",a:J({identity_id:I(!0,1),identity:I(!0,1)})},tb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/referrals",method:"GET",
f:{identity_id:I(!0,1)},a:J({})},ub={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/credithistory",method:"GET",a:J({begin_after_id:I(!1,1),bucket:I(!1,1),direction:I(!1,2),length:I(!1,2),link_click_id:I(!1,1)})},vb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/credits",method:"GET",a:J({branch_key:I(!0,1),identity:I(!0,1)})},wb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/redeem",method:"POST",a:J({amount:I(!0,2),bucket:I(!0,1),identity_id:I(!0,
1)})},xb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/url",method:"POST",qa:"obj",a:J({alias:I(!1,1),campaign:I(!1,1),channel:I(!1,1),data:I(!1,1),feature:I(!1,1),identity_id:I(!0,1),stage:I(!1,1),tags:I(!1,3),type:I(!1,2),source:I(!1,1),instrumentation:I(!1,1)})},yb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/qr-code",method:"POST",qa:"obj",a:J({alias:I(!1,1),campaign:I(!1,1),channel:I(!1,1),data:I(!1,1),qr_code_settings:I(!1,1),feature:I(!1,1),identity_id:I(!0,
1),stage:I(!1,1),tags:I(!1,3),type:I(!1,2),source:I(!1,1)})},zb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/deepview",L:!0,method:"POST",a:J({campaign:I(!1,1),_t:I(!1,1),channel:I(!1,1),data:I(!0,1),feature:I(!1,1),link_click_id:I(!1,1),open_app:I(!1,4),append_deeplink_path:I(!1,4),stage:I(!1,1),tags:I(!1,3),deepview_type:I(!0,1),source:I(!0,1)})},Ab={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/has-app",method:"GET",a:{browser_fingerprint_id:I(!0,1),instrumentation:I(!1,
1)}},Bb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/event",method:"POST",a:J({event:I(!0,1),metadata:I(!0,0),initial_referrer:I(!1,1),tracking_disabled:I(!1,4)})},Cb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/event",method:"POST",a:J({event:I(!0,1),metadata:I(!1,0),initial_referrer:I(!1,1),commerce_data:I(!0,0)})},Db={destination:"https://instacart.api.beta.branch.io",endpoint:"/v2/event/standard",method:"POST",a:{name:I(!0,1),user_data:I(!0,1),custom_data:I(!1,
1),event_data:I(!1,1),content_items:I(!1,1),customer_event_alias:I(!1,1)}},Eb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v2/event/custom",method:"POST",a:{name:I(!0,1),user_data:I(!0,1),custom_data:I(!1,1),event_data:I(!1,1),content_items:I(!1,1),customer_event_alias:I(!1,1)}},Fb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/pageview",method:"POST",a:J({event:I(!0,1),metadata:I(!1,0),initial_referrer:I(!1,1),tracking_disabled:I(!1,4),branch_view_id:I(!1,1),
no_journeys:I(!1,4),user_language:I(!1,1),open_app:I(!1,4),has_app_websdk:I(!1,4),source:I(!1,1),feature:I(!1,1),is_iframe:I(!1,4),data:I(!1,0),callback_string:I(!1,1),journey_displayed:I(!1,4),audience_rule_id:I(!1,1),journey_dismissals:I(!1,0),identity_id:I(!1,1)})},Gb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/dismiss",method:"POST",a:J({event:I(!0,1),metadata:I(!1,0),initial_referrer:I(!1,1),tracking_disabled:I(!1,4),branch_view_id:I(!1,1),no_journeys:I(!1,4),user_language:I(!1,
1),open_app:I(!1,4),has_app_websdk:I(!1,4),source:I(!1,1),feature:I(!1,1),is_iframe:I(!1,4),data:I(!1,0),callback_string:I(!1,1),journey_displayed:I(!1,4),audience_rule_id:I(!1,1),journey_dismissals:I(!1,0),dismissal_source:I(!1,1)})},Hb={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/cpid",method:"POST",a:{user_data:I(!0,1)}},Ib={destination:"https://instacart.api.beta.branch.io",endpoint:"/v1/cpid/latd",method:"POST",a:{user_data:I(!0,1)}};function Jb(a){for(var b=0;b<a.length;b++){var c=this[a[b]],c="function"===typeof c?c():c;if(c.isEnabled())return c.A={},c}}function K(a){return"branch_session"===a||"branch_session_first"===a?a:"BRANCH_WEBSDK_KEY"+a}function Kb(a){return"true"===a?!0:"false"===a?!1:a}function Lb(a){return"branch_session"===a||"branch_session_first"===a||0===a.indexOf("BRANCH_WEBSDK_KEY")}function Mb(a){a=a.trim();var b=a.indexOf("=");return{name:a.substring(0,b),value:Kb(a.substring(b+1,a.length))}}
function Nb(a){var b;try{b=a&&localStorage?localStorage:sessionStorage}catch(c){return{isEnabled:function(){return!1}}}return{getAll:function(){if("undefined"===typeof b)return null;var a=null,d;for(d in b)d.indexOf("BRANCH_WEBSDK_KEY")||(null===a&&(a={}),a[d.replace("BRANCH_WEBSDK_KEY","")]=Kb(b.getItem(d)));return Sa(a)},get:function(a,d){return"browser_fingerprint_id"===a||"alternative_browser_fingerprint_id"===a?d&&localStorage?Oa(localStorage.getItem(K(a))):Oa(b.getItem(K(a))):Kb(d&&localStorage?
...
function Ub(a,b,c){var d=document.createElement("script");d.type="text/javascript";d.async=!0;d.src=a;H(d);a=document.getElementsByTagName("head");!a||1>a.length?"function"===typeof b&&b():(a[0].appendChild(d),"function"===typeof b&&Ta(d,"error",b),"function"===typeof c&&Ta(d,"load",c))}
function Vb(a,b,c,d,e){var f=Date.now(),k=sa;!a.h&&Ka()&&a.h++;var l="branch_callback__"+a.h++;a=0<=b.indexOf("branch.io")?"&data=":"&post_data=";c="POST"===d?encodeURIComponent(za(g(c))):"";var h=window.setTimeout(function(){window[l]=function(){};F(v,k,ta(f));e(Error("Request timed out"),null,504)},qa);window[l]=function(a){window.clearTimeout(h);e(null,a)};Ub(b+(0>b.indexOf("?")?"?":"")+(c?a+c:"")+(0<=b.indexOf("/c/")?"&click=1":"")+"&callback="+l,function(){e(Error("Request blocked by client, probably adblock"),
null)},function(){F(v,k,ta(f));try{"function"===typeof this.remove?this.remove():this.parentNode.removeChild(this)}catch(n){}delete window[l]})}
function Wb(a,b,c,d,e,f,k,l){var h=Date.now(),n=sa,m=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");l&&(m.responseType=l);m.ontimeout=function(){F(v,n,ta(h));f(Error("Request timed out"),null,504)};m.onerror=function(a){f(Error(a.error||"Error in API: "+m.status),null,m.status)};m.onreadystatechange=function(){var a;if(4===m.readyState)if(F(v,n,ta(h)),200===m.status){if("arraybuffer"===m.responseType)a=m.response;else if(k)a=m.responseText;else try{a=p(m.responseText)}catch(u){a=
{}}f(null,a,m.status)}else if(402===m.status)f(Error("Not enough credits to redeem."),null,m.status);else if("4"===m.status.toString().substring(0,1)||"5"===m.status.toString().substring(0,1))m.responseURL&&m.responseURL.includes("v2/event")?f(m.responseText,null,m.status):f(Error("Error in API: "+m.status),null,m.status)};try{m.open(d,b,!0),m.timeout=qa,m.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),m.send(c)}catch(r){e.set("use_jsonp",!0),Vb(a,b,c,d,f)}}
function Xb(a,b,c,d,e){function f(){d.get("use_jsonp")||b.L?Vb(a,n,c,b.method,k):Wb(a,n,m,b.method,d,k,P,Qa)}function k(c,d,h){"function"===typeof a.ba&&a.ba(n,b.method,r,c,h,d);c&&0<u&&"5"===(h||"").toString().substring(0,1)?(u--,window.setTimeout(function(){f()},pa)):e(c,d)}sa="/v1/pageview"===b.endpoint&&c&&c.journey_displayed?b.endpoint+"-1-brtt":b.endpoint+"-brtt";("/v1/url"===b.endpoint||"/v1/has-app"===b.endpoint)&&1<Object.keys(v).length&&(delete v["-brtt"],c.instrumentation=q(B({},v)),v=
{});if(w)for(var l=["browser_fingerprint_id","alternative_browser_fingerprint_id","identity_id","session_id"],h=0;h<l.length;h++)c.hasOwnProperty(l[h])&&delete c[l[h]];l=Tb(a,b,c);if(l.error)return e(Error(q({message:l.error,endpoint:b.endpoint,data:c})));var n,m="";"GET"===b.method?n=l.url+"?"+l.data:(n=l.url,m=l.data);var r;d.get("use_jsonp")||b.L?r=c:r=m;var u=oa;if(w&&xa(n,c))return wa?k(Error("Requested operation cannot be completed since tracking is disabled"),null,300):k(null,{},200);var P=
!1,Qa;"/v1/qr-code"===b.endpoint&&(P=!0,Qa="arraybuffer");f()};function M(a){a&&a.parentNode.removeChild(a)}function Yb(a,b){a&&!a.className.match(new RegExp("(\\s|^)"+b+"(\\s|$)"))&&(a.className+=" "+b)}function Zb(a){var b=document.body;b&&b.className.match(new RegExp("(\\s|^)"+a+"(\\s|$)"))&&(b.className=b.className.replace(new RegExp("(\\s|^)"+a+"(\\s|$)")," "))}function $b(a){var b=new Date;return b.setDate(b.getDate()+a)}
...
a.sa+"</button></form></div>")+"</div>";a.F?fc(a,b,c):(a=gc(a,b,document),c(a))};function ic(a,b,c,d){function e(){k();h.style.background="#FFD4D4";l.className="error";setTimeout(function(){h.style.background="#FFFFFF";l.className=""},2E3)}function f(){r=a.createElement("div");r.className="branch-icon-wrapper";r.id="branch-checkmark";r.style="opacity: 0;";r.innerHTML=window.ActiveXObject?'<span class="checkmark">&#x2713;</span>':'<svg version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 98.5 98.5" enable-background="new 0 0 98.5 98.5" xml:space="preserve"><path class="checkmark" fill="none" stroke-width="8" stroke-miterlimit="10" d="M81.7,17.8C73.5,9.3,62,4,49.2,4C24.3,4,4,24.3,4,49.2s20.3,45.2,45.2,45.2s45.2-20.3,45.2-45.2c0-8.6-2.4-16.6-6.5-23.4l0,0L45.6,68.2L24.7,47.3"/></svg>';
m.appendChild(r);h.style.opacity="0";l.style.opacity="0";n.style.opacity="0";setTimeout(function(){r.style.opacity="1"},20);l.value=""}function k(){h.removeAttribute("disabled");l.removeAttribute("disabled");h.style.opacity="1";l.style.opacity="1";n.style.opacity="0"}var l=a.getElementById("branch-sms-phone"),h=a.getElementById("branch-sms-send"),n=a.getElementById("branch-loader-wrapper"),m=a.getElementById("branch-sms-form-container"),r;if(l){var u=l.value;/^\d{7,}$/.test(u.replace(/[\s()+\-\.]|ext/gi,
""))?(N(b,"willSendBannerSMS"),h.setAttribute("disabled",""),l.setAttribute("disabled",""),h.style.opacity=".4",l.style.opacity=".4",n.style.opacity="1",l.className="",b.sendSMS(u,d,c,function(a){a?(N(b,"sendBannerSMSError"),e()):(N(b,"didSendBannerSMS"),f(),setTimeout(function(){m.removeChild(r);k()},3E3))})):e()}}
function jc(a,b,c,d){function e(a,c){"function"===typeof a&&(c=a,a={});a=a||{};"top"===b.position?f.style.top="-76px":"bottom"===b.position&&(f.style.bottom="-76px");"number"===typeof b.K?d.set("hideBanner",$b(b.K),!0):d.set("hideBanner",!0,!0);a.Z?("top"===b.position?document.body.style.marginTop=k:"bottom"===b.position&&(document.body.style.marginBottom=l),Zb("branch-banner-is-active"),M(f),M(document.getElementById("branch-css")),c()):(setTimeout(function(){M(f);M(document.getElementById("branch-css"));
c()},270),setTimeout(function(){"top"===b.position?document.body.style.marginTop=k:"bottom"===b.position&&(document.body.style.marginBottom=l);Zb("branch-banner-is-active")},20))}if(!cc(d,b))return N(a,"willNotShowBanner"),null;N(a,"willShowBanner");var f,k=document.body.style.marginTop,l=document.body.style.marginBottom;hc(b,d,function(d){function h(){"top"===b.position?f.style.top="0":"bottom"===b.position&&(f.style.bottom="0");N(a,"didShowBanner")}f=d;ec(b,f);c.channel=c.channel||"app banner";
...
function(d){d.preventDefault();ic(k,a,b,c)})};d=ac("margin-top");var l=ac("margin-bottom");Yb(document.body,"branch-banner-is-active");"top"===b.position?document.body.style.marginTop=bc(d):"bottom"===b.position&&(document.body.style.marginBottom=bc(l));if(d=k.getElementById("branch-banner-close"))d.onclick=function(b){b.preventDefault();N(a,"willCloseBanner");e({},function(){N(a,"didCloseBanner")})};b.Z?h():setTimeout(h,20)});return e};var kc={},lc,mc=1,O="top",nc="absolute",Q="76px",oc=!1,pc=!1,R=[],qc=!1,rc=window.innerHeight,sc=window.innerWidth;window.innerHeight<window.innerWidth&&(rc=window.innerWidth,sc=window.innerHeight);
var tc=0,uc=0,vc=!1,wc=/<script type="application\/json">((.|\s)*?)<\/script>/,xc=/<script type="text\/javascript">((.|\s)*?)<\/script>/,yc=/<style type="text\/css" id="branch-css">((.|\s)*?)<\/style>/,zc=/<style type="text\/css" id="branch-iframe-css">((.|\s)*?)<\/style>/,Ac=/#branch-banner-spacer {((.|\s)*?)}/,Bc=/margin-bottom: (.*?);/,S=null,Cc=null,Dc=!1,Ec=!1,Fc=!1,Gc=!1,Hc=!1,Ic="",Jc=[],T=null;
function Kc(a){var b=Lc(a);b&&b.bannerHeight&&b.position&&b.sticky?(Q=b.bannerHeight,O=b.position,nc=b.sticky):((a=a.match(Ac))?(O="top",(a=a[1].match(Bc))&&(Q=a[1]),nc="absolute"):(O="bottom",nc="fixed"),"center_overlay"===b.type&&(Q=b.bannerHeight));if(-1!==Q.indexOf("vh")||-1!==Q.indexOf("%"))b=Q.indexOf("vh")?Q.slice(0,-2):Q.slice(0,-1),Q=b/100*rc+"px",100>b?pc=!0:oc=!0}function Lc(a){if(a=a.match(wc))return p(a[1])}function Mc(a){if(a=a.match(zc))return a[1]}
function Nc(a,b){var c;b&&a&&a.ctaText&&a.ctaText.has_app?c=a.ctaText.has_app:a&&a.ctaText&&a.ctaText.no_app&&(c=a.ctaText.no_app);return c}function Oc(a){R=[];if(a&&a.injectorSelector&&(a=document.querySelectorAll(a.injectorSelector)))for(var b=0;b<a.length;b++)R.push(a[b].parentElement)}function Pc(a){if(a=a.match(yc))return a[1]}function Qc(a){if(a=a.match(xc)){a=a[1];var b=document.createElement("script");b.id="branch-journey-cta";H(b);b.innerHTML=a;document.body.appendChild(b)}}
...
function Tc(a,b){var c=document.createElement("style");c.type="text/css";c.id="branch-iframe-css";tc=ac("margin-top");var d=+tc.slice(0,-2);uc=ac("margin-bottom");var e=+uc.slice(0,-2),f=+Q.slice(0,-2);a||("top"===O?document.body.style.marginTop=(+f+d).toString()+"px":"bottom"===O&&(document.body.style.marginBottom=(+f+e).toString()+"px"));0<R.length&&R.forEach(function(a){var b,c=window.getComputedStyle(a);c&&(b=oc&&"fixed"===c.getPropertyValue("position"));b||(a.style.marginTop=Q)});"top"===Ic&&
Ic!==O&&Hc&&Jc&&0<Jc.length&&Jc.forEach(function(a){a.style.marginTop=0});Hc=!1;Ic="";Jc=[];Gc=!1;a?c.innerHTML=a:c.innerHTML=Uc(b);H(c);document.head.appendChild(c)}
function Uc(a){var b="",c="";document.body.style.transition="";document.getElementById("branch-banner-iframe")&&(document.getElementById("branch-banner-iframe").style.transition="");Fc||(b="body { -webkit-transition: all 0.375s ease; }\n",document.body.style.transition="all 00.375s ease",c="-webkit-transition: all 0.25s ease; transition: all 00.25s ease;");if(a="center_overlay"===a.type)document.body.style.background="rgba(0,0,0,0.4)";return(b?b:"")+("#branch-banner-iframe { box-shadow: 0 0 5px rgba(0, 0, 0, .35); width: 1px; min-width: "+
(a?"null;":"100%;")+" left: 0; right: 0; border: 0; height: "+Q+"; z-index: 99999; "+c+" }\n#branch-banner-iframe { position: "+nc+"; }\n@media only screen and (orientation: landscape) { body { "+("top"===O?"margin-top: ":"margin-bottom: ")+(oc?sc+"px":Q)+"; }\n#branch-banner-iframe { height: "+(oc?sc+"px":Q)+"; }")}
function Vc(a,b,c){Yb(document.body,"branch-banner-is-active");if(oc&&"fixed"===nc){var d=document.createElement("style");d.type="text/css";d.innerHTML=".branch-banner-no-scroll {overflow: hidden;}";document.head.appendChild(d);Yb(document.body,"branch-banner-no-scroll")}setTimeout(function(){b?(a.style.top=null,a.style.bottom=null):"top"===O?a.style.top="0":"bottom"===O&&(T&&T.journey_link_data&&!T.journey_link_data.safeAreaRequired?(a.style.bottom="0","center_overlay"===c.type&&(a.style.bottom=
"140px",a.style.width="94%",a.style.borderRadius="20px",a.style.margin="auto")):(qc=!0,document.getElementById("branch-banner-iframe").style.transition="all 0s",Wc(!1,!0),window.addEventListener("resize",Xc),window.addEventListener("scroll",Yc)));N(S,"didShowJourney",T);Dc=!0},20)}function Xc(){qc&&Wc(!1,!1)}function Yc(){qc&&(window.pageYOffset>window.innerHeight?Wc(!0,!1):Wc(!1,!1))}
function Wc(a,b){var c=document.getElementById("branch-banner-iframe"),d=c.offsetHeight,e=c.offsetTop,f=window.innerHeight;b&&window.pageYOffset?c.style.bottom="0":a?c.style.top=f-d+d/2+"px":f-e!=d&&(c.style.top=""+(f-d)+"px")}function Zc(a){a=a.globalDismissPeriod;if("number"===typeof a){if(-1===a)a=!0;else{var b=new Date;a=b.setSeconds(b.getSeconds()+a)}return a}}
function $c(a,b,c,d,e,f,k){var l=U;d&&e&&(Array.prototype.forEach.call(e.contentWindow.document.querySelectorAll("#branch-mobile-action"),function(a){a.addEventListener("click",function(){N(S,"didClickJourneyCTA",T);Gc=!0;d();ad(e)})}),bd(".branch-banner-continue","didClickJourneyContinue",c,e,a,b,f,k,l),bd(".branch-banner-close","didClickJourneyClose",c,e,a,b,f,k,l))}
function bd(a,b,c,d,e,f,k,l,h){Array.prototype.forEach.call(d.contentWindow.document.querySelectorAll(a),function(a){a.addEventListener("click",function(){cd(b,c,d,e,f,k,l,h)})})}function dd(a,b,c){var d=a.get("journeyDismissals",!0),d=d?p(d):{};d[c]={view_id:b,dismiss_time:Date.now()};a.set("journeyDismissals",q(d),!0)}
...
function fd(a,b){var c={},d=Va();d&&0<Object.keys(d).length&&(c.hosted_deeplink_data=d);c=a.I(gd(null,c),null,S,!0);if(T&&T.journey_link_data){F(c,"journey_id",T.journey_link_data.journey_id);F(c,"journey_name",ed(T.journey_link_data.journey_name));F(c,"view_id",T.journey_link_data.view_id);F(c,"view_name",ed(T.journey_link_data.view_name));F(c,"channel",ed(T.journey_link_data.channel));F(c,"campaign",ed(T.journey_link_data.campaign));try{F(c,"tags",JSON.stringify(T.journey_link_data.tags))}catch(e){c.tags=
JSON.stringify([])}}F(c,"dismissal_source",b);return c}
function cd(a,b,c,d,e,f,k,l){var h=k?0:Zc(f);N(S,a,T);Gc=!0;ad(c);if(!k)if(void 0!==h&&b.set("globalJourneysDismiss",h,!0),dd(b,d,e),f.dismissRedirect)window.location=f.dismissRedirect;else{var n=function(){S.removeListener(n);var b=fd(l,ua[a]);S.b(Gb,b,function(a,c){!a&&"object"===typeof c&&c.template&&l.O(c,null,!1)&&l.J(c.template,b,b.branch_view_id||c.event_data.branch_view_data.id,c.event_data.branch_view_data,!1,c.journey_link_data)})};S.addListener("branch_internal_event_didCloseJourney",n)}}
...
function ad(a,b){Ec||(vc=!0);if(Fc&&!Ec){document.body.style.transition="all 00.375s ease";document.getElementById("branch-banner-iframe").style.transition="all 00.25s ease";var c=document.getElementById("branch-iframe-css").innerHTML+"\n";document.getElementById("branch-iframe-css").innerHTML="";document.getElementById("branch-iframe-css").innerHTML=c+"body { -webkit-transition: all 0.375s ease; }\n#branch-banner-iframe { -webkit-transition: all 0.25s ease; }\n"}"top"===O?a.style.top="-"+Q:"bottom"===
O&&(a.style.bottom="-"+Q);N(S,"willCloseJourney",T);setTimeout(function(){M(a);M(document.getElementById("branch-css"));M(document.getElementById("branch-iframe-css"));M(document.getElementById("branch-journey-cta"));(!Ec||Gc)&&R&&0<R.length?R.forEach(function(a){a.style.marginTop=0}):(Hc=Ec,Ic=O,Jc=R);"top"===O?document.body.style.marginTop=tc:"bottom"===O&&(document.body.style.marginBottom=uc);Zb("branch-banner-is-active");Zb("branch-banner-no-scroll");qc&&(qc=!1,window.removeEventListener("resize",
Xc),window.removeEventListener("scroll",Yc));N(S,"didCloseJourney",T);b||N(S,"branch_internal_event_didCloseJourney",T);Dc=!1;setTimeout(function(){vc=!1},250)},Ec?0:270)}
function hd(a){var b={banner_id:lc};if(a&&"object"===typeof a&&0<Object.keys(a).length){var c=["browser_fingerprint_id","app_id","source","open_app","link_click_id"];if(a&&"object"===typeof a&&!Array.isArray(a)&&0<Object.keys(a).length&&c&&Array.isArray(c)&&0<c.length)for(var d in a)a.hasOwnProperty(d)&&-1<c.indexOf(d)&&delete a[d];b.journey_link_data={};B(b.journey_link_data,a)}T=b}function id(){return kc&&S&&S.m&&S.m.data?S.m.data.$journeys_cta:!1}
function jd(){if(id())return S.m.data.$journeys_cta}function kd(a){try{if(id()&&0<jd().length)return a.replace(/validate[(].+[)];/g,'validate("'+jd()+'")').replace("window.top.location.replace(","window.top.location = ")}catch(b){}return a};var U={};
function ld(a,b,c,d){var e=b?"OPEN":"GET";Kc(a);var f=Lc(a);f&&(e=Nc(f,b),Oc(f));var k=Pc(a);Qc(a);var l=Mc(a);a=Rc(a);var h=Sc();h.onload=function(){var b=a,m=C(),r=h.contentDocument||h.contentWindow.document;r.head=r.createElement("head");r.body=r.createElement("body");r.body.innerHTML=b;r.body.className="ios"===m||"ipad"===m?"branch-banner-ios":"android"===m?"branch-banner-android":"branch-banner-desktop";["1042917133147779073"].includes(d)&&(b=r.createElement("script"),b.type="text/javascript",b.text=
...
r.querySelector("body").append(b));Tc(l,f);r=document.createElement("style");r.type="text/css";r.id="branch-css";r.innerHTML=k;H(r);b=h.contentWindow.document;b.head.appendChild(r);if(pc||oc){var u=b.getElementsByClassName("branch-banner-content")[0];u&&(u.style.height=Q)}"top"===O?h.style.top="-"+Q:"bottom"===O&&(h.style.bottom="-"+Q);try{var u=b.getElementsByClassName("branch-banner-content")[0],P=window.getComputedStyle(u).getPropertyValue("background-color").split(", ");P[3]&&!parseFloat(P[3])&&
(h.style.boxShadow="none")}catch(Qa){}h.contentWindow.document.getElementById("branch-mobile-action").innerHTML=e;N(S,"willShowJourney",T);Vc(h,l,f);c(h)};document.body.appendChild(h)}
...
U.$=function(a){S.b(Fb,{event:"pageview",journey_displayed:!0,audience_rule_id:a.audience_rule_id,branch_view_id:a.branch_view_id},function(){})};
U.J=function(a,b,c,d,e,f){if(!vc){lc=c;hd(f);var k=d.audience_rule_id;(f=document.getElementById("branch-iframe-css"))&&f.parentElement.removeChild(f);var l=document.createElement("div");l.id="branch-banner";document.body.insertBefore(l,null);Yb(l,"branch-banner-is-active");var h=!1,n=b.callback_string,m=null,r=S.c;if(a){var u=Lc(a)||{};a=kd(a);var P=window.setTimeout(function(){window[n]=function(){}},qa);window[n]=function(a){window.clearTimeout(P);h||(m=a,$c(c,k,r,m,null,u,e))};ld(a,b.has_app_websdk,
function(a){Cc=a;null===a?h=!0:($c(c,k,r,m,a,u,e),ra&&(v["journey-load-time"]=(Date.now()-window.performance.timing.navigationStart).toString()),document.body.removeChild(l),w||e||U.$(d))},c)}else document.body.removeChild(l),w||e||U.$(d)}};
U.I=function(a,b,c,d){S=c;b||(b={});a||(a={});Fc=b.disable_entry_animation||!1;Ec=b.disable_exit_animation||!1;var e=B({},c.m),f=L(c.c)||{},k=f.hasOwnProperty("has_app")?f.has_app:!1,l=c.c.get("journeyDismissals",!0),h=(b.user_language||Wa()||"en").toLowerCase()||null,n=hb(V(c)),m;(m=b.branch_view_id)||(m="_branch_view_id".replace(/[\[\]]/g,"\\$&"),m=(m=(new RegExp("[?&]"+m+"(=([^&#]*)|&|#|$)")).exec(Ea()))&&m[2]?decodeURIComponent(m[2].replace(/\+/g," ")):"");m=m||null;c=b.make_new_link?null:Fa(V(c));
...
"/"))}pd(a)};var rd;
function Y(a,b,c){return function(){var d=this,e,f,k=arguments[arguments.length-1];a&&"function"===typeof k?(e=Array.prototype.slice.call(arguments,0,arguments.length-1)||[],f=k):(f=function(){},e=Array.prototype.slice.call(arguments));d.ca(function(k){function h(b,c){try{if(b&&!a)throw b;1===a?f(b):2===a&&f(b,c)}finally{k()}}if(!c){if(1===d.o)return h(Error(x("Branch SDK initialization pending and a Branch method was called outside of the queue order")),null);if(2===d.o)return h(Error(x("Branch SDK initialization failed, so further methods cannot be called",d.l,
d.s)),null);if(0===d.o||!d.o)return h(Error(x("Branch SDK not initialized")),null)}e.unshift(h);b.apply(d,e)})}}function Z(){if(!(this instanceof Z))return rd||(rd=new Z),rd;this.ca=na();this.c=new Jb(["session","cookie","pojo"]);this.V=new Rb;this.h=[];this.X="web2.59.0";this.l=this.o=0;this.s=null}
...
this.aa);(a.a&&a.a.sdk||a.f&&a.f.sdk)&&this.X&&(b.sdk=this.X);(a.a&&a.a.browser_fingerprint_id||a.f&&a.f.browser_fingerprint_id)&&this.D&&(b.browser_fingerprint_id=this.D);w&&(b.tracking_disabled=w);return Xb(this.V,a,b,this.c,function(a,b){c(a,b)})};function V(a){var b=L(a.c);return(b=b&&b.referring_link)?b:(a=a.c.get("click_id"))?"https://link.stage.branch.io/c/"+a:null}function N(a,b,c){for(var d=0;d<a.h.length;d++)a.h[d].event&&a.h[d].event!==b||a.h[d].listener(b,c)}
...
d){d&&(d=l(d),w||(d=f(d),Ba(h.c,d,r)),h.o=3,d.data_parsed=d.data&&0!==d.data.length?p(d.data):{});if(b)return h.o=2,h.l||(h.l=1,h.s=b.message),a(b,d&&Ca(d));try{a(b,d&&Ca(d))}catch(xd){}finally{h.renderFinalize()}var e=bb(),k=G(c.metadata,"object")?c.metadata:null;k&&(k=ib(e.hosted_deeplink_data,k))&&0<Object.keys(k).length&&(e.hosted_deeplink_data=k);var m=U.I(gd(c,e),c,h,!1);h.renderQueue(function(){h.b(Fb,m,function(a,b){if(!a&&"object"===typeof b){var d=m.branch_view_id?!0:!1;U.O(b,c,d)?U.J(b.template,
m,m.branch_view_id||b.event_data.branch_view_data.id,b.event_data.branch_view_data,d,b.journey_link_data):((b.auto_branchify||!n&&Ma("branchify_url")&&V(h))&&this.branch.deepview({},{make_new_link:!1,open_app:!0,auto_branchify:!0}),N(S,"willNotShowJourney"))}w&&(wa=!0)})})}function f(a){r&&(a.identity=h.g);return a}function k(a){var b={sdk:"2.59.0",branch_key:h.i},c=L(h.c)||{},d=L(h.c,!0)||{};d.browser_fingerprint_id&&(b._t=d.browser_fingerprint_id);Ka()||La()||h.b(lb,b,function(a,b){a&&(h.l=3,h.s=
a.message);b&&(c.browser_fingerprint_id=b)});h.b(Ab,{browser_fingerprint_id:c.browser_fingerprint_id},function(b,d){b&&(h.l=4,h.s=b.message);b||!d||c.has_app||(c.has_app=!0,Pb(h.c,c),N(h,"didDownloadApp"));a&&a(null,c)})}function l(a){a.link_click_id&&(h.aa=a.link_click_id.toString());a.session_id&&(h.H=a.session_id.toString());a.identity_id&&(h.j=a.identity_id.toString());a.identity&&(h.g=a.identity.toString());a.link&&(h.N=a.link);if(a.referring_link){var b=a.referring_link;a.referring_link=b?"http"!==
b.substring(0,4)?"https://link.stage.branch.io"+b:b:null}!a.click_id&&a.referring_link&&(a.click_id=Fa(a.referring_link));h.D=a.browser_fingerprint_id;return a}ra&&(v["init-began-at"]=(Date.now()-window.performance.timing.navigationStart).toString());var h=this;h.o=1;-1<b.indexOf("key_")?h.i=b:h.W=b;c=c&&G(c,"object")?c:{};oa=(h.G=c)&&c.retries&&Number.isInteger(c.retries)?c.retries:oa;pa=c&&c.retry_delay&&Number.isInteger(c.retry_delay)?c.retry_delay:pa;qa=c&&c.timeout&&Number.isInteger(c.timeout)?
c.timeout:qa;t=c&&c.nonce?c.nonce:t;w=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;wa=!1;w&&Aa(h);b=L(h.c,!0);h.j=b&&b.identity_id;b=L(h.c);var n=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,m=n||Ma("_branch_match_id")||Ga(),r=!h.j;h.C=!!h.c.get("branch_view_enabled");if(b&&b.session_id&&!m&&!Ma("branchify_url"))Pb(h.c,{data:""}),Pb(h.c,{referring_link:""}),d(),k(e);else{b={sdk:"2.59.0",branch_key:h.i};var u=L(h.c,!0)||{};u.browser_fingerprint_id&&
(b._t=u.browser_fingerprint_id);u.identity&&(h.g=u.identity);var P=parseInt(Ma("[?&]_open_delay_ms"),10);Ka()||La()?jb(function(){h.b(kb,{link_identifier:m,browser_fingerprint_id:m||u.browser_fingerprint_id,alternative_browser_fingerprint_id:u.browser_fingerprint_id,options:c,initial_referrer:hb(V(h)),current_url:y()&&Ha()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(h.l=2,h.s=a.message);a||"object"!==typeof b||(b.branch_view_enabled&&
(h.C=!!b.branch_view_enabled,h.c.set("branch_view_enabled",h.C)),m&&(b.click_id=m));d();e(a,b)})},P):h.b(lb,b,function(a,b){if(a)return h.l=3,h.s=a.message,e(a,null);jb(function(){h.b(kb,{link_identifier:m,browser_fingerprint_id:m||b,alternative_browser_fingerprint_id:u.browser_fingerprint_id,options:c,initial_referrer:hb(V(h)),current_url:y()&&Ha()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(h.l=2,h.s=a.message);a||
"object"!==typeof b||(b.branch_view_enabled&&(h.C=!!b.branch_view_enabled,h.c.set("branch_view_enabled",h.C)),m&&(b.click_id=m));d();e(a,b)})},P)})}},!0);Z.prototype.renderQueue=Y(0,function(a,b){this.da?b():(this.u=this.u||[],this.u.push(b));a(null,null)});Z.prototype.renderFinalize=Y(2,function(a){this.u&&0<this.u.length&&(this.u.forEach(function(a){a.call(this)}),delete this.u);this.da=!0;a(null,null)});
...
Z.prototype.setIdentity=Y(2,function(a,b){var c=this;this.b(sb,{identity:b},function(d,e){d&&a(d);e=e||{};c.j=e.identity_id?e.identity_id.toString():null;c.N=e.link;c.g=b;e.developer_identity=b;e.referring_data_parsed=e.referring_data?p(e.referring_data):null;Qb(c.c,{identity:b,identity_id:c.j});a(null,e)})});
...
Z.prototype.crossPlatformIds=Y(2,function(a){this.b(Hb,{user_data:q(gb(this))},function(b,c){return a(b||null,c&&c.user_data||null)})});Z.prototype.lastAttributedTouchData=Y(2,function(a,b){b=G(b,"number")?b:null;var c=gb(this);F(c,"attribution_window",b);this.b(Ib,{user_data:q(c)},function(b,c){return a(b||null,c||null)})});
Z.prototype.track=Y(1,function(a,b,c,d){c=c||{};d=d||{};t=d.nonce?d.nonce:t;if("pageview"===b){(b=ib(Va(),c))&&0<Object.keys(b).length&&(c.hosted_deeplink_data=b);var e=U.I(gd(d,c),d,this,!1);this.b(Fb,e,function(b,c){if(!b&&"object"===typeof c){var f=e.branch_view_id?!0:!1;U.O(c,d,f)?U.J(c.template,e,e.branch_view_id||c.event_data.branch_view_data.id,c.event_data.branch_view_data,f,c.journey_link_data):N(S,"willNotShowJourney")}"function"===typeof a&&a.apply(this,arguments)})}else this.b(Bb,{event:b,
metadata:B({url:Ea(),user_agent:navigator.userAgent,language:navigator.language},c),initial_referrer:hb(V(this))},function(b,c){"function"===typeof a&&a.apply(this,arguments)})});
Z.prototype.logEvent=Y(1,function(a,b,c,d,e){b=G(b,"string")?b:null;c=G(c,"object")?c:null;e=G(e,"string")?e:null;c=eb(c);b&&-1<cb.indexOf(b)?(d=G(d,"array")?d:null,this.b(Db,{name:b,user_data:q(gb(this)),custom_data:q(c&&c.custom_data||{}),event_data:q(c&&c.event_data||{}),content_items:q(d||[]),customer_event_alias:e},function(b){return a(b||null)})):this.b(Eb,{name:b,user_data:q(gb(this)),custom_data:q(c&&c.custom_data||{}),event_data:q(c&&c.event_data||{}),content_items:q(d||[]),customer_event_alias:e},
function(b){return a(b||null)})});Z.prototype.link=Y(2,function(a,b){var c=z(b),d=this.i;this.b(xb,c,function(b,f){if(b)return a(b,ya(d,c));a(null,f&&f.url)})});
Z.prototype.sendSMS=Y(1,function(a,b,c,d){function e(c){f.b(nb,{link_url:c,phone:b},function(b){a(b||null)})}var f=this;if("function"===typeof d)d={};else if("undefined"===typeof d||null===d)d={};d.make_new_link=d.make_new_link||!1;c.channel&&"app banner"!==c.channel||(c.channel="sms");var k=V(f);k&&!d.make_new_link?e(Fa(k)):f.b(xb,z(c),function(b,c){if(b)return a(b);var d=c.url;/(bnc.lt\/|app\.link\/)/.test(d)||(d="https://link.stage.branch.io/"+Ua(d));f.b(mb,{link_url:d,click:"click"},function(b,
c){if(b)return a(b);e(c.click_id)})})});Z.prototype.qrCode=Y(2,function(a,b,c){z(b).qr_code_settings=q(fb(c||{}));this.b(yb,z(b),function(b,c){function d(){}b||(d.rawBuffer=c,d.base64=function(){if(this.rawBuffer)return btoa(String.fromCharCode.apply(null,new Uint8Array(this.rawBuffer)));throw Error("QrCode.rawBuffer is empty.");});return a(b||null,d||null)})});
...
zb,b,function(b,c){if(b)return w||(d.v=function(){window.top.location=e}),a(b);"function"===typeof c&&(d.v=c);a(null)});d.w()});
Z.prototype.deepviewCta=Y(1,function(a){if("undefined"===typeof this.v)return w?a(Error("Requested operation cannot be completed since tracking is disabled"),null):a(Error("Cannot call Deepview CTA, please call branch.deepview() first"),null);window.event&&(window.event.preventDefault?window.event.preventDefault():window.event.returnValue=!1);N(this,"didDeepviewCTA");this.v();a()});Z.prototype.referrals=Y(2,function(a){this.b(tb,{},a)});
...
Z.prototype.closeJourney=Y(1,function(a){var b=this;b.renderQueue(function(){if(Cc&&Dc)N(b,"didCallJourneyClose",T),ad(Cc,!0);else return a("Journey already dismissed.")});a()});
...
Z.prototype.autoAppIndex=Y(1,function(a,b){b=b||{};var c=document.getElementsByTagName("link"),d=c.length;if(d)for(var e=0;e<d;e++){var f=c[e],k=f.href;k&&(k.includes("ios-app")&&(W.iosAppIndexingTagsPresent=!0,f.setAttribute("href",nd(k))),k.includes("android-app")&&(W.androidAppIndexingTagsPresent=!0,f.setAttribute("href",nd(k))))}X=b;W.androidAppIndexingTagsPresent||(pd("android"),W.androidDetailsComplete||qd("android"));W.iosAppIndexingTagsPresent||(pd("ios"),W.iosDetailsComplete||qd("ios"));
W.iosDetailsComplete||W.androidDetailsComplete?a(null):a("Firebase App Indexing tags were not added to your webpage. Please check your configuration.")});Z.prototype.trackCommerceEvent=Y(1,function(a,b,c,d){var e=this;e.renderQueue(function(){var f=ab(b,c);if(f)return a(Error(f));e.b(Cb,{event:b,metadata:B({url:document.URL,user_agent:navigator.userAgent,language:navigator.language},d||{}),initial_referrer:hb(V(e)),commerce_data:c},function(b){a(b||null)})});a()});
Z.prototype.disableTracking=Y(1,function(a,b){if(!1===b||"false"===b)wa=w=!1,this.i&&this.G&&(!0===this.G.tracking_disabled&&delete this.G.tracking_disabled,this.init(this.i,this.G));else if(void 0===b||!0===b||"true"===b)Aa(this),wa=w=!0,this.closeBanner(),this.closeJourney();a()},!0);Z.prototype.setAPIResponseCallback=Y(0,function(a,b){this.V.ba=b;a()},!0);var td=new Z;if(window.branch&&window.branch._q)for(var ud=window.branch._q,vd=0;vd<ud.length;vd++){var wd=ud[vd];td[wd[0]].apply(td,wd[1])}"function"===typeof define&&define.amd?define("branch",function(){return td}):"object"===typeof exports&&(module.exports=td);window&&(window.branch=td);})();
