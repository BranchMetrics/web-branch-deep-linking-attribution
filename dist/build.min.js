...
function eb(a){var b={};b=G(b,"http_origin",document.URL);b=G(b,"user_agent",navigator.userAgent);b=G(b,"language",Ua());b=G(b,"screen_width",screen.width||0);b=G(b,"screen_height",screen.height||0);b=G(b,"http_referrer",document.referrer);b=G(b,"browser_fingerprint_id",a.J);b=G(b,"developer_identity",a.m);b=G(b,"identity",a.m);b=G(b,"sdk","web");return b=G(b,"sdk_version","2.63.0")}function z(){return window.self!==window.top}
...
d.B)),null);if(0===d.A||!d.A)return g(Error(y("Branch SDK not initialized")),null)}m.unshift(g);b.apply(d,m)})}}function Z(){if(!(this instanceof Z))return dd||=new Z,dd;this.ha=ac();this.h=new Ab;this.$=new Gb;this.l=[];this.ca="web2.63.0";this.u=this.A=0;this.B=null}
