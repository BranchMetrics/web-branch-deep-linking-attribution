...
function A(a,b,c){a&&"object"===typeof a||(a={});if(!b||"object"!==typeof b)return a;for(var d in b)if(b.hasOwnProperty(d)){var e=b[d];!c||void 0!==e&&null!==e?a[d]=e:delete a[d]}return a}function Ia(){try{var a=(x()&&Ja()?window.top.location.hash:window.location.hash).match(/r:([^&]*)/);if(a&&1<=a.length)return a[1]}catch(b){}}function Ka(a){return!!/^((?!chrome|android|crios|fxios).)*safari/i.test(a)}
...
function eb(a){var b={},b=G(b,"http_origin",document.URL),b=G(b,"user_agent",navigator.userAgent),b=G(b,"language",Va()),b=G(b,"screen_width",screen.width||0),b=G(b,"screen_height",screen.height||0),b=G(b,"http_referrer",document.referrer),b=G(b,"browser_fingerprint_id",a.C),b=G(b,"developer_identity",a.g),b=G(b,"identity",a.g),b=G(b,"sdk","web");return b=G(b,"sdk_version","2.54.4")}function x(){return window.self!==window.top}
...
var hb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/open",method:"POST",a:{browser_fingerprint_id:J(!1,1),alternative_browser_fingerprint_id:J(!1,1),identity_id:J(!1,1),link_identifier:J(!1,1),sdk:J(!1,1),options:J(!1,0),initial_referrer:J(!1,1),tracking_disabled:J(!1,4),current_url:J(!1,1),screen_height:J(!1,2),screen_width:J(!1,2),identity:J(!1,1)}},ib={destination:"https://app.link",endpoint:"/_r",method:"GET",Y:!0,a:{sdk:J(!0,1),_t:J(!1,1),branch_key:J(!0,1)}},jb=
{destination:"",endpoint:"",method:"GET",f:{link_url:J(!0,1)},a:{click:J(!0,1)}},kb={destination:"https://bnc.lt",endpoint:"/c",method:"POST",f:{link_url:J(!0,1)},a:{sdk:J(!1,1),phone:J(!0,1)}},lb={destination:"https://nightlyregression.api.beta.branch.io",endpoint:"/v1/referralcode",method:"POST",a:K({amount:J(!0,2),bucket:J(!1,1),calculation_type:J(!0,2),creation_source:J(!0,2),expiration:J(!1,1),location:J(!0,2),prefix:J(!1,1),type:J(!0,1)})},mb={destination:"https://nightlyregression.api.beta.branch.io",
...
function Uc(a,b){return A({url:a&&a.url||Fa(),user_agent:navigator.userAgent,language:navigator.language,screen_width:screen.width||-1,screen_height:screen.height||-1,window_device_pixel_ratio:window.devicePixelRatio||1},b||{})}
function Nc(a,b){yc||(pc=!0);if(zc&&!yc){document.body.style.transition="all 00.375s ease";document.getElementById("branch-banner-iframe").style.transition="all 00.25s ease";var c=document.getElementById("branch-iframe-css").innerHTML+"\n";document.getElementById("branch-iframe-css").innerHTML="";document.getElementById("branch-iframe-css").innerHTML=c+"body { -webkit-transition: all 0.375s ease; }\n#branch-banner-iframe { -webkit-transition: all 0.25s ease; }\n"}"top"===P?a.style.top="-"+Q:"bottom"===
P&&(a.style.bottom="-"+Q);O(S,"willCloseJourney",T);setTimeout(function(){N(a);N(document.getElementById("branch-css"));N(document.getElementById("branch-iframe-css"));N(document.getElementById("branch-journey-cta"));(!yc||Ac)&&R&&0<R.length?R.forEach(function(a){a.style.marginTop=0}):(Bc=yc,Cc=P,Dc=R);"top"===P?document.body.style.marginTop=nc:"bottom"===P&&(document.body.style.marginBottom=oc);Vb("branch-banner-is-active");Vb("branch-banner-no-scroll");kc&&(kc=!1,window.removeEventListener("resize",
Jc),window.removeEventListener("scroll",Kc));O(S,"didCloseJourney",T);b||O(S,"branch_internal_event_didCloseJourney",T);xc=!1;setTimeout(function(){pc=!1},250)},yc?0:270)}
function Vc(a){var b={banner_id:fc};if(a&&"object"===typeof a&&0<Object.keys(a).length){var c=["browser_fingerprint_id","app_id","source","open_app","link_click_id"];if(a&&"object"===typeof a&&!Array.isArray(a)&&0<Object.keys(a).length&&c&&Array.isArray(c)&&0<c.length)for(var d in a)a.hasOwnProperty(d)&&-1<c.indexOf(d)&&delete a[d];b.journey_link_data={};A(b.journey_link_data,a)}T=b};var U={};
function Wc(a,b){var c=b?"OPEN":"GET",d=a,e=Ec(d);e&&e.bannerHeight&&e.position&&e.sticky?(Q=e.bannerHeight,P=e.position,hc=e.sticky):(d=d.match(uc))?(P="top",(d=d[1].match(vc))&&(Q=d[1]),hc="absolute"):(P="bottom",hc="fixed");if(-1!==Q.indexOf("vh")||-1!==Q.indexOf("%"))d=Q.indexOf("vh")?Q.slice(0,-2):Q.slice(0,-1),Q=d/100*lc+"px",100>d?jc=!0:ic=!0;if(d=Ec(a)){var f;b&&d&&d.ctaText&&d.ctaText.has_app?f=d.ctaText.has_app:d&&d.ctaText&&d.ctaText.no_app&&(f=d.ctaText.no_app);c=f;R=[];if(d&&d.injectorSelector&&
...
U.J=function(a,b,c,d,e,f){if(!pc){fc=c;Vc(f);var k=d.audience_rule_id;(f=document.getElementById("branch-iframe-css"))&&f.parentElement.removeChild(f);f=document.createElement("div");f.id="branch-banner";document.body.insertBefore(f,null);Ub(f,"branch-banner-is-active");var l=!1,g=b.callback_string,n=null,m=null,t=S.c;if(a){var z=Ec(a)||{},Qc=window.setTimeout(function(){window[g]=function(){}},ra);window[g]=function(a){window.clearTimeout(Qc);l||(m=a,Mc(c,k,t,m,n,z,e))};wc=n=Wc(a,b.has_app_websdk);
if(null===n){l=!0;return}Mc(c,k,t,m,n,z,e);sa&&(u["journey-load-time"]=(Date.now()-window.performance.timing.navigationStart).toString())}document.body.removeChild(f);v||e||U.ja(d)}};
...
d.m)),null);if(0===d.l||!d.l)return g(Error(w("Branch SDK not initialized")),null)}e.unshift(g);b.apply(d,e)})}}function Z(){if(!(this instanceof Z))return bd||(bd=new Z),bd;this.$=oa();this.c=new Fb(["session","cookie","pojo"]);this.ca=new Nb;this.h=[];this.V="web2.54.4";this.j=this.l=0;this.m=null}
...
c.nonce:r;v=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;xa=!1;v&&Ba(g);b=M(g.c);var n=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,m=n||Na("_branch_match_id")||Ia(),t=!b||!b.identity_id;g.B=!!g.c.get("branch_view_enabled");if(b&&b.session_id&&!m&&!Na("branchify_url"))Lb(g.c,{data:""}),Lb(g.c,{referring_link:""}),d(),k(e);else{b={sdk:"2.54.4",branch_key:g.i};var z=M(g.c,!0)||{};z.browser_fingerprint_id&&(b._t=z.browser_fingerprint_id);z.identity&&
...
Z.prototype.logEvent=Y(1,function(a,b,c,d,e){b=H(b,"string")?b:null;c=H(c,"object")?c:null;e=H(e,"string")?e:null;b&&-1<ab.indexOf(b)?(d=H(d,"array")?d:null,c=cb(c),this.b(zb,{name:b,user_data:q(eb(this)),custom_data:q(c&&c.custom_data||{}),event_data:q(c&&c.event_data||{}),content_items:q(d||[]),customer_event_alias:e},function(b){return a(b||null)})):this.b(Ab,{name:b,user_data:q(eb(this)),custom_data:q(db(c||{})),content_items:q(d||[]),customer_event_alias:e},function(b){return a(b||null)})});
...
Z.prototype.addListener=function(a,b){"function"===typeof a&&void 0===b&&(b=a,a=null);b&&this.h.push({listener:b,event:a||null})};Z.prototype.removeListener=function(a){a&&(this.h=this.h.filter(function(b){if(b.listener!==a)return b}))};function cd(a,b,c){c=c||{};try{a.H=p(q(c))}finally{a.H=a.H||{}}b()}Z.prototype.setBranchViewData=Y(1,function(a,b){cd.call(null,this,a,b)},!0);
...
Z.prototype.disableTracking=Y(1,function(a,b){if(!1===b||"false"===b)xa=v=!1,this.i&&this.F&&(!0===this.F.tracking_disabled&&delete this.F.tracking_disabled,this.init(this.i,this.F));else if(void 0===b||!0===b||"true"===b)Ba(this),xa=v=!0,this.closeBanner(),this.closeJourney();a()},!0);var dd=new Z;if(window.branch&&window.branch._q)for(var ed=window.branch._q,fd=0;fd<ed.length;fd++){var gd=ed[fd];dd[gd[0]].apply(dd,gd[1])}"function"===typeof define&&define.amd?define("branch",function(){return dd}):"object"===typeof exports&&(module.exports=dd);window&&(window.branch=dd);})();
