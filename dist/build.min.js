...
method:"POST",a:J({event:I(!0,1),metadata:I(!1,0),initial_referrer:I(!1,1),tracking_disabled:I(!1,4),branch_view_id:I(!1,1),no_journeys:I(!1,4),user_language:I(!1,1),open_app:I(!1,4),has_app_websdk:I(!1,4),source:I(!1,1),feature:I(!1,1),is_iframe:I(!1,4),data:I(!1,0),callback_string:I(!1,1),journey_displayed:I(!1,4),audience_rule_id:I(!1,1),journey_dismissals:I(!1,0),dismissal_source:I(!1,1)})},Hb={destination:"https://api2.branch.io",endpoint:"/v1/cpid",method:"POST",a:{user_data:I(!0,1)}},Ib={destination:"https://api2.branch.io",
...
!1,Gb;"/v1/qr-code"===b.endpoint&&(W=!0,Gb="arraybuffer");f()};function M(a){a&&a.parentNode.removeChild(a)}function Yb(a,b){a&&!a.className.match(new RegExp("(\\s|^)"+b+"(\\s|$)"))&&(a.className+=" "+b)}function Zb(a){var b=document.body;b&&b.className.match(new RegExp("(\\s|^)"+a+"(\\s|$)"))&&(b.className=b.className.replace(new RegExp("(\\s|^)"+a+"(\\s|$)")," "))}function $b(a){var b=new Date;return b.setDate(b.getDate()+a)}
...
function Kc(a){var b=document.createElement("style");b.type="text/css";b.id="branch-iframe-css";sc=ac("margin-top");var c=+sc.slice(0,-2);tc=ac("margin-bottom");var d=+P.slice(0,-2);a||"top"!==O||(document.body.style.transform="translate(0, "+(+d+c).toString()+"px)");0<Q.length&&Q.forEach(function(a){var b,c=window.getComputedStyle(a);c&&(b=nc&&"fixed"===c.getPropertyValue("position"));b||(a.style.marginTop=P)});"top"===Hc&&Hc!==O&&Gc&&Ic&&0<Ic.length&&Ic.forEach(function(a){a.style.marginTop=0});
Gc=!1;Hc="";Ic=[];Fc=!1;a?b.innerHTML=a:b.innerHTML=Lc();H(b);document.head.appendChild(b)}
function Lc(){var a="",b="";document.body.style.transition="";document.getElementById("branch-banner-iframe")&&(document.getElementById("branch-banner-iframe").style.transition="");Ec||(a="body { -webkit-transition: all 0.375s ease; }\n",document.body.style.transition="all 00.375s ease",b="-webkit-transition: all 0.25s ease; transition: all 00.25s ease;");return(a?a:"")+("#branch-banner-iframe { box-shadow: 0 0 5px rgba(0, 0, 0, .35); width: 1px; min-width:100%; left: 0; right: 0; border: 0; height: "+P+
...
function Mc(a,b){Yb(document.body,"branch-banner-is-active");nc&&"fixed"===mc&&Yb(document.body,"branch-banner-no-scroll");setTimeout(function(){b?(a.style.top=null,a.style.bottom=null):"bottom"===O&&(S&&S.journey_link_data&&!S.journey_link_data.safeAreaRequired?a.style.transform="translate(0px, -"+P+")":(pc=!0,document.getElementById("branch-banner-iframe").style.transition="all 0s",Nc(!1,!0),window.addEventListener("resize",Oc),window.addEventListener("scroll",Pc)));N(R,"didShowJourney",S);Cc=!0},
...
Z.prototype.crossPlatformIds=Y(2,function(a){this.b(Hb,{user_data:q(fb(this))},function(b,c){return a(b||null,c&&c.user_data||null)})});Z.prototype.lastAttributedTouchData=Y(2,function(a,b){b=G(b,"number")?b:null;var c=fb(this);F(c,"attribution_window",b);this.b(Ib,{user_data:q(c)},function(b,c){return a(b||null,c||null)})});
