...
// Input 1
var config = {link_service_endpoint:"https://bnc.lt", api_endpoint:"https://api.branch.io", version:"1.5.6"}, WEB_BUILD = !1, CORDOVA_BUILD = !0, TITANIUM_BUILD = !1;
// Input 2
...
Branch.prototype.init = wrap(callback_params.CALLBACK_ERR_DATA, function(a, b, c) {
  ...
  if (e && e.session_id) {
    ...
    var g = utils.readStore(d._permStorage), h = !g.identity_id, k = function(a) {
      h || (a.identity_id = g.identity_id, a.device_fingerprint_id = g.device_fingerprint_id);
      return a;
    };
    CORDOVA_BUILD && (e = [], null !== b && e.push(b ? 1 : 0), cordovaExec(function(a) {
      a = k(a);
    ...
    }, "BranchDevice", h ? "getInstallData" : "getOpenData", e));
    if (TITANIUM_BUILD) {
      var e = require("io.branch.sdk"), m, l;
      (c = c && "undefined" != typeof c.url && null != c.url ? c.url : null) && (m = utils.getParamValue(c));
      l && m && (l.link_identifier = m);
      h ? (l = null == b ? e.getOpenData(-1) : e.getOpenData(b ? 1 : 0), l = k(l), d._api(resources.open, l, function(a, b) {
        f(a, b, !1);
      })) : (l = null == b ? e.getInstallData(d.debug, -1) : e.getInstallData(d.debug, b ? 1 : 0), d._api(resources.install, l, function(a, b) {
        f(a, b, !0);
      }));
    }
    WEB_BUILD && (m = utils.getParamValue("_branch_match_id") || utils.hashValue("r"), d._api(resources._r, {sdk:config.version}, function(a, b) {
      if (a) {
        return f(a, null, !1);
      }
      d._api(resources.open, {link_identifier:m, is_referrable:1, browser_fingerprint_id:b}, function(a, b) {
        b && m && (b.click_id = m);
        f(a, b, !1);
      });
    }));
