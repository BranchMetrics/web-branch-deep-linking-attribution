...
goog.addDependency("../../../../../src/6_branch.js", ['Branch'], ['goog.json', 'utils', 'resources', 'Server', 'banner', 'task_queue', 'storage', 'session', 'config', 'safejson']);
...
goog.addDependency("../../../../../test/banner.js", [], ['utils', 'Branch', 'resources', 'config', 'storage', 'session', 'banner', 'banner_utils', 'banner_html', 'banner_css', 'goog.json', 'goog.testing']);
