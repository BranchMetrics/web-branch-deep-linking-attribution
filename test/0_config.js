  ...
  describe('app_service_endpoint', function () {
    it('app_service_endpoint should be defined', function () {
      assert.isDefined(
        ...
        'app_service_endpoint is un-defined',
      );
    });
    it('app_service_endpoint value is correct', function () {
      assert.isDefined(
        config.app_service_endpoint,
        'https://app.link',
        'app_service_endpoint is incorrect',
      );
    });
  });
  ...
  describe('link_service_endpoint', function () {
    it('link_service_endpoint should be defined', function () {
      assert.isDefined(
        ...
        'link_service_endpoint is un-defined',
      );
    });
    it('link_service_endpoint value is correct', function () {
      assert.isDefined(
        config.link_service_endpoint,
        'https://bnc.lt',
        'link_service_endpoint is incorrect',
      );
    });
  });
