(function (){
	var Branch = function Branch(app_id, debug, callback) {
		...
		this.utils = {};
	          	...
	          	this.app_id = oldBranch.app_id;
	          	this.debug = oldBranch.debug;
	          	this.init_callback = oldBranch.init_callback;
	          	this.queued = oldBranch.queued;

		// Get browser_fingerprint_id
	          	...
	          	Branch._r = function() {
			          ...
			          a.async = !0;
			          a.src = "dist/branch.min.js";
			          document.getElementsByTagName("head")[0].appendChild(a);
		              	} else
                  			window.setTimeout("Branch._r()", 100);
	          	}, Branch._r();
	...
	branch.init(function() {
		if (oldBranch.queued.length) {
			for (var i = 0; i < window.branch.queued.length; i++) {
				window.branch[oldBranch.queued[i].shift()].apply(window.branch, oldBranch.queued[i]);
			}
		}
