								...
								(function() {
									...
									for (var i = 0; i < 5; i++) {
										stars += '<span class="star">' +
												'<svg class="star" fill="#555555" height="12" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">' +
										...
										if (options.rating > i) {
											stars += (i + 1 > options.rating && options.rating % 1) ?
												'<span class="half">' +
													'<svg fill="#555555" height="12" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">' +
													'<defs>' +
													...
													'</span>' :
												'<span class="full">' +
													'<svg fill="#555555" height="12" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">' +
													'<path d="M0 0h24v24H0z" fill="none"/>' +
