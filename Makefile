...
all: dist/build.min.js dist/build.js Reference.md TITANIUM_GUIDE.md WEB_GUIDE.md example.html test/branch-deps.js test/integration-test.html
clean:
	rm -f dist/** docs/web/3_branch_web.md Reference.md example.html test/branch-deps.js dist/build.min.js.gz test/integration-test.html
