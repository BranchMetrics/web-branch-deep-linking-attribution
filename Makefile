...
all: dist/web/build.min.js dist/web/build.js README.md CORDOVA_GUIDE.md CORDOVA_UPGRADE_GUIDE.md testbeds/web/example.html test/branch-deps.js dist/cordova/build.js dist/cordova/build.min.js
clean:
